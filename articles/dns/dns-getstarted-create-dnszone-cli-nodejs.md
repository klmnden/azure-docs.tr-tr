---
title: "Azure CLI 1.0 kullanarak bir DNS bölgesi oluşturma | Microsoft Docs"
description: "Azure DNS&quot;de DNZ bölgesi oluşturmayı öğrenin. Bu kılavuzda, Azure CLI 1.0 kullanarak ilk DNS bölgenizi oluşturmanız ve yönetmeniz için adım adım talimatlar sunulmaktadır."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Azure CLI 1.0 kullanarak bir Azure DNS bölgesi oluşturma
