...
Bu makalede Azure portalı, Azure PowerShell, Azure CLI 1.0 veya Azure CLI 2.0 kullanarak ilk geriye doğru arama DNS bölgenizi ve kaydınızı oluşturma adımlarında size kılavuzluk eder.
