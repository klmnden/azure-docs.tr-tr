...
* [Microsoft Azure ve Amazon Web Hizmetleri](https://azure.microsoft.com/campaigns/azure-vs-aws/mapping/) -tanımları, Azure Hizmetleri ve AWS'dekiler.<!-- I propose to link to https://azure.microsoft.com/en-us/services/ instead of this -->
...
Windows, macOS ve Linux Azure hizmetleri yönetmek için kullanılan bir komut satırı arabirimi.  Bazı hizmet veya hizmet özellikleri yalnızca PowerShell veya CLI yönetilebilir. Bkz: [Azure CLI 2.0](/cli/azure/overview)
