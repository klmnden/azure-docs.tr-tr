...
Azure uygulaması son örnek durumu kritik bir Microsoft gözden geçirme sorunu gösterir.  Bu, bu İnceleme sorun hakkında ayrıntılı bilgi içeren VSTS öğeye etkin bir bağlantı içerir.  Daha fazla bilgi için [Azure yayımlama uygulaması teklif]().
