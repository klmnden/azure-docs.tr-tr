---
title: Teklif ayarları için bir Power BI uygulaması teklif | Azure Market
...
Üzerinde **teklif ayarları** sekmesinde gereken aşağıdaki gerekli alanlara bu bilgileri girin. Gerekli alanlar yıldız (*) indicted.
