---
title: Azure uygulaması Marketi sekmesinden sunma | Microsoft Docs
...
Teklif için bir mağaza oluşturmak için kullanılacak ayarları aşağıdaki tabloda açıklanmaktadır.

|    **Alan**       |  **Açıklama**  |
|  ---------------   |  ---------------  |
|        Unvan            |        Teklif başlığı. Market'te dikkat çekecek şekilde gösterilir. En fazla 50 karakterdir.           |
...
|       Açıklama            |         Teklif açıklaması. En fazla 3000 karakterdir. Basit HTML biçimlendirmeyi izin verilir, da dahil olmak üzere &lt;p&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;ol&gt; ve üst bilgi etiketler.           |
...
|         Faydalı Bağlantılar           |        Kullanıcıların teklifinizin desteği, belgeleri, Forum, vs. gibi çeşitli kaynak bağlantıları sağlayabilir. En az bir bağlantı belgelerinize eklediğinizden emin olun.            |
|         Önerilen kategorileri (en fazla 5)           |         En fazla beş kategorilerini seçin. Seçili kategorilerdeki, teklifinizin Azure Market'te ve Azure Portalı'nda ürün kategorilerini eşleştirmek için kullanılır. Bunlar Gözat sayfalarında ve, Ürün Ayrıntıları sayfası gösterilir.          |
...
|    **Alan**       |  **Açıklama**  |
|  ---------------   |  ---------------  |
|       Küçük             |        PNG biçiminde 40 x 40 piksel           |
|       Orta             |        PNG biçiminde 90 x 90 piksel           |
|       Büyük             |        PNG biçiminde 115 x 115 piksel         |
|       Geniş             |        PNG biçiminde 255 x 115 piksel           |
|       Kahraman             |        PNG biçiminde 815 x 290 piksel. İsteğe bağlı. **Not:** Karşıya yüklendikten sonra hero simge silinemiyor.           |
