...
- Teklifler göz atarken:

    ![Market teklifleri Azure Marketi Web sitesinde - görüntülenme şeklini Gözat](./media/iot-edge-module-ampdotcom-card.png)
...
- Bir teklif için arama yaparken:
...
>[!Important]
>Hero logoyu karşıya yüklendikten sonra bu komut dosyası silinemiyor.
...
* Sağ taraftaki bir kullanılmayan Dikdörtgen alanı hero logonuzun içerir. Bu 415 x 100 piksel yanı sıra, sola 370 piksel uzaklığı boşluktur.  
...
Teklifinizi başarıyla yayımladıktan sonra müşteri adayı bağlantı doğrulanır ve bir test müşteri adayı yapılandırdığınız hedef konuma otomatik olarak gönderilir. 
