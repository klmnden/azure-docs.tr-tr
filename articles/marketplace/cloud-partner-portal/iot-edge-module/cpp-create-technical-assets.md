---
title: Azure IOT Edge modülü teknik varlıklarınızı oluşturun | Microsoft Docs
...
<!-- Add legal time windows--> İş ortakları kendi modüllerinin gibi etkileyen bir değişiklik olduğunda bildirimi alırsınız:
