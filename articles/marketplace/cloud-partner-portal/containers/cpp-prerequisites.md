---
title: Azure kapsayıcıları teklif önkoşulları | Microsoft Docs
...
Yeni bir kapsayıcı görüntüsü yayımlamak için aşağıdaki önkoşulları sağlamanız gerekir:

- Bulut iş ortağı portalına erişim. Daha fazla bilgi için Azure Market'te ve Appsource'ta yayımlama kılavuzuna bakın.
- Azure Marketi koşulları sözleşmesini
- Bir Azure Container Registry, kapsayıcı teknik varlığı barındırın.
