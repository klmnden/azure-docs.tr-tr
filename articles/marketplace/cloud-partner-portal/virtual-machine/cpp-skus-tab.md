---
title: Sanal makine SKU'ları, Azure Market'te bulut iş ortağı portalı sekmede | Microsoft Docs
...
![Sanal makineler için yeni teklifi formdaki için SKU sekmesi](./media/publishvm_006.png)

Amaç, içeriği, aşağıdaki tabloda açıklanmıştır ve bu alanlar biçimlendirme.
...
| **Özet**      | Teklif için görüntü marketi'ndeki Sözün açıklaması. En fazla 100 karakter uzunluğunda. |
| **Açıklama**  | Açıklama metni teklif daha ayrıntılı bir açıklama sağlar.  <!-- TD: max len/guidance? 3k characters -->  |
...
* Microsoft, bazı ülkeler olarak sınıflandırır *vergi havale ülkeleri*.  Bu ülkelerde, Microsoft vergileri müşterilerden toplar sonra (remits) vergileri devlet kurumuna öder.  Diğer ülkelerde, iş ortakları, müşterilerin vergileri toplamak ve devlet kurumuna vergileri ödeme genellikle yükümlü olursunuz. İkinci bir ülkede satın seçerseniz, hesaplama ve bu vergileri yerel Öde yeteneği olmalıdır.  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
