...
**Geliştirme Merkezi hesabınıza bağlamak**: Bulut iş ortağı portalında yayımcı profilinizle birlikte mevcut Geliştirme Merkezi hesabınıza bağlayabilirsiniz.
...
Yoksa bir [Geliştirici Merkezi hesabına](~/articles/marketplace-publishing/marketplace-publishing-accounts-creation-registration.md), hesap oluşturabilirsiniz. Ardından, bulut iş ortağı portalı teklifiniz için bir sahip olarak kayıtlı e-posta adresi ekleyin. Sahibi yalnızca yayımlama profiliniz için kayıtlı e-posta adresi ekleyebilirsiniz **kullanıcı** bölümü. Ardından, aynı e-posta adresini kullanarak portalda oturum açın ve Geliştirme Merkezi hesabınıza bağlayın.
