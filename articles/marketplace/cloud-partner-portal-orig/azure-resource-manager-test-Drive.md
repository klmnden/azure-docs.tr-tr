...
Ürününüzü göstermek için en iyi yollarından nelerdir değerlendirme süresi yeterli miktarda harcama surety olun. Üreten Resource Manager şablonunu yeterince daha kolay getirir özellikle tüm gerekli kaynakları geçici olarak ihtiyacınız.
...
![Azure AD kiracınız için kuruluş, etki alanı ve ülke tanımlayın](./media/azure-resource-manager-test-drive/subdetails5.png)
