...
|---------|---------|
|Microsoft, lisans maliyeti 80 oranında öder    |   80.00 başına aylık     |
|Microsoft, lisans maliyeti %20 tutar.   |  20,00 başına aylık       |
...
|Toplama süresi sonu (en fazla 90 gün) | 15 Ocak 2018 |
|Müşteri ödeme tarihi | 30 Aralık 2018'e |
|Ödeme hesaplama tarihi (aylık 15'inden) | 15 Ocak 2018 |
...
* Her iki hesap arasında aynı kuruluş veya Microsoft oturum açma ayrıntıları kullanabilir ancak Geliştirme Merkezi bulut yayımcı portalı hesaptan ayrı bir hesaptır. Yayımcı transact yayımlama seçeneğini kullanmak için bulut iş ortağı portalına erişim kaydolma yanı sıra Geliştirme Merkezi hesabı oturum açma işlemi tamamlamanız gerekir.
