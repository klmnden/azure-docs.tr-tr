...
- Cihaz içine ve cihazdan dışarı veri kopyalamak için erişim kimlik bilgileri.
...
- Azure’a yapılan yüklenme tamamlandıktan sonra cihazdaki verilerin güvenli bir şekilde silinmesi. Verilerin silinmesi NIST 800-88r1 standartlarıyla uyumludur.
...
- Azure portalda [Azure Data Box](data-box-quickstart-portal.md)’u hızlıca dağıtın.
