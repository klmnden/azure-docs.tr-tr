...
Uygulamanızın ölçeğini genişletme ile ilgili daha fazla bilgi için bkz. [Azure’da uygulamanızı ölçeklendirme](web-sites-scale.md). Ölçeği artırma ile ilgili daha fazla bilgi için bkz. [Örnek sayacını elle veya otomatik olarak ölçeklendirme](../azure-portal/insights-how-to-scale.md).
...
> [!NOTE]
> Uyarı kuralları bir Azure özelliğidir. Daha fazla bilgi için bkz. [Uyarı bildirimleri alma](../azure-portal/insights-receive-alert-notifications.md). 
> 
> 
