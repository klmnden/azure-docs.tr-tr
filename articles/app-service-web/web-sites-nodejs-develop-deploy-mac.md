...
> 
> Bir Azure hesabı için kaydolmadan önce Azure App Service’i kullanmaya başlamak istiyorsanız [App Service’i Deneyin](https://azure.microsoft.com/try/app-service/)’e gidin. Burada, App Service'te hemen bir kısa süreli başlangıç web uygulaması oluşturabilirsiniz; kredi kartı gerekmez ve hiçbir taahhüt yoktur.
> 
> 
...
3. Aşağıdaki kodu **server.js** dosyasına kopyalayın bulun ve dosyayı kaydedin:
...
4. Komut satırını açın ve web uygulamasını yerel olarak başlatmak için aşağıdaki komutu kullanın.
   
        node server.js
5. Web tarayıcınızı açın ve http://localhost:1337 adresine gidin. 
...
2. Komut satırında, dizinleri **helloworld** diziniyle değiştirin ve yerel bir Git deposunu başlatmak için aşağıdaki komutu girin.
   
        git init
3. Depoya dosyaları eklemek için aşağıdaki komutları kullanın:
   
        git add .
        git commit -m "initial commit"
4. Aşağıdaki komutu kullanarak, önceden oluşturduğunuz web uygulamasına güncelleştirmeleri iletmek için Git remote ekleyin:
   
        git remote add azure [URL for remote repository]
5. Aşağıdaki komutu kullanarak değişikliklerinizi Azure’a iletin:
...
6. Uygulamanızı görüntülemek için, Azure portaldaki **Web Uygulaması** bölümünde **Gözat**’a tıklayın.
...
4. Web uygulamanızın URL'sine gittiğiniz tarayıcı penceresini yenileyin.
