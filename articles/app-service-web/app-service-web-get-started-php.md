<properties 
    pageTitle="İlk PHP web uygulamanızı Azure’a beş dakikada dağıtın | Microsoft Azure" 
...
# İlk PHP web uygulamanızı Azure’a beş dakikada dağıtın

Bu öğretici, ilk PHP web uygulamanızı [Azure App Service](../app-service/app-service-value-prop-what-is.md)’e dağıtmanıza yardımcı olur.
...
1. Komut satırı terminalinizde, bir çalışma dizinine (`CD`) geçip örnek uygulamayı şu şekilde kopyalayın:
    ...
    ![Azure’daki ilk web uygulamanız için uygulama örnek kodunu kopyalama](./media/app-service-web-get-started-languages/php-git-clone.png)
...
[Laravel web uygulaması oluşturma, yapılandırma ve Azure’a dağıtma](app-service-web-php-get-started.md). Bu öğreticiyi izleyerek, Azure’da PHP web uygulaması çalıştırmak için ihtiyacınız olan temel becerileri öğrenebilirsiniz:
...
- Ortama özgü değişkenlere erişme.
