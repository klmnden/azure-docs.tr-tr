---
title: "Beş dakika içinde Azure’a ilk PHP web uygulamanızı dağıtın (CLI 2.0 Önizleme) | Microsoft Belgeleri"
...
---
# <a name="deploy-your-first-php-web-app-to-azure-in-five-minutes-cli-20-preview"></a>Beş dakika içinde Azure’a ilk PHP web uygulamanızı dağıtın (CLI 2.0 Önizleme)
...
4. Ardından, dağıtmak istediğiniz örnek PHP kodunu alın. Çalışan bir dizine (`CD`) geçin ve örnek uygulamayı şu şekilde kopyalayın:
