        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Web Apps hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Web Apps'i kullanmaya başlama (Video)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Web Apps Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio'yu kullanarak bir ASP.NET web uygulaması oluşturma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure App Service'te Node.js web uygulamalarını kullanmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Python Tools 2.2'yi kullanarak bir web uygulaması oluşturma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure App Service'te bir Java web uygulaması oluşturma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure App Service'te bir WordPress web uygulaması oluşturma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>PHP web uygulaması oluşturma, yapılandırma ve Azure'a dağıtma</h3>
                    </div>
                </div>
            </div>
        </div>
...
[Web Apps AzureCLI Başvurusu](/cli/azure/)

### <a name="java"></a>Java
[Web Apps Java API Başvurusu](/java/api/)

### <a name="net"></a>.NET
[Web Apps Tarafından Yönetilen Başvuru](/dotnet/api)

### <a name="rest"></a>REST
[Web Apps REST API Başvurusu](/rest/api/appservice)
