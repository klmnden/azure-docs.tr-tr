...
description: "Örnek Python uygulamasını dağıtarak, App Service&quot;te web uygulamaları çalıştırmanın ne kadar kolay olduğunu öğrenin."
...
---
# <a name="create-your-first-python-web-app-in-azure-in-five-minutes"></a>Beş dakika içinde Azure’da ilk Python web uygulamanızı oluşturma
[!INCLUDE [app-service-web-selector-get-started](../../includes/app-service-web-selector-get-started.md)]

Bu Hızlı Başlangıç, ilk Python web uygulamanızı birkaç dakika içinde [Azure Uygulama Hizmeti](../app-service/app-service-value-prop-what-is.md)’ne dağıtmanıza yardımcı olur.
...
4. GitHub’dan örnek bir Python uygulaması dağıtın.
...
Tebrikler, ilk Python web uygulamanız Azure Uygulama Hizmeti’nde çalışıyor.
