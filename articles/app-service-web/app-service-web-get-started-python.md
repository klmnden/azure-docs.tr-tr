---
title: "Beş dakika içinde Azure’a ilk Python web uygulamanızı dağıtın (CLI 2.0 Önizleme) | Microsoft Belgeleri"
...
---
# <a name="deploy-your-first-python-web-app-to-azure-in-five-minutes-cli-20-preview"></a>İlk Python web uygulamanızı Azure'da beş dakikada dağıtma (CLI 2.0 Önizleme)
...
- [Azure CLI 2.0](app-service-web-get-started-python.md): Kaynak yönetimi dağıtım modeline yönelik yeni nesil CLI'mız
...
4. Ardından, dağıtmak istediğiniz örnek Python kodunu alın. Çalışan bir dizine (`CD`) geçin ve örnek uygulamayı şu şekilde kopyalayın:
