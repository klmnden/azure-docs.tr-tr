<properties
    pageTitle="Azure App Service’te bir Java web uygulaması oluşturma | Microsoft Azure"
...
6. Bir **App Service planı/Konum** seçin veya yeni bir tane oluşturun.
...
8. Web uygulaması oluşturulduğunda **Web Apps > {web uygulamanız}**’a tıklayın.
 
    ![Web Uygulaması Seçme][selectwebapp]

9. **Web uygulaması** dikey penceresinde, **Ayarlar**’a tıklayın.

10. **Uygulama ayarları**’na tıklayın.

11. İstediğiniz **Java sürümünü** seçin. 

12. İstediğiniz **Java alt sürümü** seçin. **En Yeni** seçeneğini belirlerseniz, uygulamanız bu Java ana sürümü için App Service'te kullanılabilen en yeni alt sürümü kullanır. **En Yeni** seçeneği, **Uygulama ayarları**’ndan oluşturulan Java uygulamalarına özeldir. Java uygulamanızı galeriden oluşturursanız, kendi kapsayıcınızı ve JVM değişikliklerini yönetmeniz gerekir. 
