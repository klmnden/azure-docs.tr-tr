...
Konuşulan form, içeri aktarma sırasında zorlayabilirsiniz küçük olmalıdır. Ayrıca, veri alma denetimleri sağlamanız gerekir. Sekme konuşulan form veya görüntüleme formu izin verilir. Ancak, orada daha görüntüleme formu karakter Yasak (örneğin, ~ ve ^).
...
Söyleniş girişler .txt dosyasının boyutu 1 megabayt (MB) sınırlıdır. Genellikle, bu dosya büyük miktarlarda veri yüklemek gerekmez. Çoğu özel telaffuz dosya boyutu birkaç kilobayt (KB) etkilenebilir. Tüm yerel ayarlar için .txt dosyasının kodlama UTF-8 AĞACI olmalıdır. İngilizce yerel ayarı için ANSI de kullanılabilir.
