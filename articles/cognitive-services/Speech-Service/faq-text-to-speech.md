...
**S: varsayılan değer veya Portalı'nda sunulan daha yüksek eşzamanlılık gerekiyor?**

**A**: 20 eş zamanlı istek artışlarla modelinizde ölçekleme yapabilirsiniz. İlgili kişi [özel sesli müşteri desteği](mailto:customvoice@microsoft.com?subject=Inquiries%20about%20scripts%20generation%20for%20Custom%20Voice%20creation) için yüksek ölçeklendirme hakkında sorgular.
