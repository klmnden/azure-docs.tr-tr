...
İlk edinmeniz gerekir bir [Azure abonelik anahtarı](https://azure.microsoft.com/try/cognitive-services/) ve ardından danışmanız gerekir [toplu döküm API](batch-transcription.md) belgeleri.
