...
description: Konuşma hizmeti kullanmak için uygulamanızı geçişi ve geliştirici açısından Bing konuşma tanıma ve konuşma hizmeti arasındaki farkları öğrenin.
...
Konuşma hizmeti ile aşağıdaki farklar Bing konuşma, büyük ölçüde benzerdir.
...
WebSockets protokolleri | :heavy_check_mark: | :heavy_check_mark: | Konuşma hizmeti WebSockets API'si, Bing konuşma (farklı uç noktası) ile uyumludur. Mümkünse, konuşma SDK kodunuzu basitleştirerek geçirin.
...
Konuşma hizmeti genel bir uç noktası şu anda sunmaz. Uygulamanızı verimli bir şekilde, bölgesel tek bir uç nokta tüm trafik için kullandığında işlevleri, belirleyin. Aksi durumda, coğrafi konum en verimli uç nokta belirlemek için kullanın. Kullandığınız her bölgede ayrı bir konuşma tanıma hizmeti aboneliği gerekir.
...
1. Konuşma hizmeti üzerinden iş [hızlı başlangıç kılavuzları](quickstart-csharp-dotnet-windows.md) ve [öğreticiler](how-to-recognize-intents-from-speech-csharp.md). Ayrıca bakmak [kod örnekleri](samples.md) deneyimi yeni API'ler ile almak için.
