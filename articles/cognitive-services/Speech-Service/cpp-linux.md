...
> [!NOTE]
> C++ ve Windows için hızlı başlangıç arıyorsanız, Git [burada](cpp-windows.md).
...
Lütfen abonelik anahtarı kodda aldığınız adla değiştirin.
...
* X x64 üzerinde makine, lütfen çalıştırın:

  ```sh
  export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$SPEECHSDK_ROOT/lib/x64"
  ```

* Bir x86 üzerinde makine, lütfen çalıştırın:
