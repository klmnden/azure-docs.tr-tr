...
ms.locfileid: "39331466"
---
# <a name="translate-speech-using-the-speech-sdk-for-java"></a>Java için Speech SDK'sı kullanarak konuşma Çevir
...
- [Konuşma gelen amacı anlamayı](how-to-recognize-intents-from-speech-java.md).
