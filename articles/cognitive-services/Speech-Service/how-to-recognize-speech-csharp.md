...
description: >
  Konuşma tanıma için çeşitli yollar gösterir (dosyasından mikrofon, özelleştirilmiş modeli, sürekli olarak veya kesin) Speech SDK'sı için C# kullanarak.
