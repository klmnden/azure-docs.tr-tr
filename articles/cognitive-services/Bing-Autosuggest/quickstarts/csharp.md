...
2. Yeni bir sınıf içinde API konak ve yol değişkenleri oluşturun [pazara kod](https://docs.microsoft.com/rest/api/cognitiveservices/bing-autosuggest-api-v7-reference#market-codes)ve kısmi arama sorgusu.
