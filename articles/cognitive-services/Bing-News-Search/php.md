---
title: Bilişsel hizmetler Azure, Bing Haberler arama API için PHP hızlı başlangıç | Microsoft Docs
...
---
# <a name="quickstart-for-bing-news-search-api-with-php"></a>Bing Haberler arama API PHP ile için hızlı başlangıç

Bu makalede, Microsoft Bilişsel hizmetler Azure üzerinde bir parçası Bing Haberler arama API kullanma gösterilmektedir. Bu makalede PHP kullanır, ancak bir RESTful Web hizmeti, HTTP isteklerini hale getirebilir ve JSON ayrıştırma programlama dili ile uyumlu API'dir. 

Kod örneği, PHP 5.6 altında çalışması için yazılmıştır.

Başvurmak [API Başvurusu](https://docs.microsoft.com/rest/api/cognitiveservices/bing-news-api-v7-reference) API'leri hakkında teknik ayrıntılar için.
...
[Bing Haberler arama API](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) arama motoru Bing'den haber sonuçları döndürür.

1. Güvenli HTTP desteği etkinleştirildiğinden emin olun, `php.ini` kod açıklamada açıklandığı gibi.
