---
title: Bilişsel hizmetler Azure, Bing Haberler arama API için Söyleniş hızlı başlangıç | Microsoft Docs
...
---
# <a name="quickstart-for-bing-news-search-api-with-ruby"></a>Bing Haberler arama Ruby API'SİYLE için hızlı başlangıç

Bu makalede, Microsoft Bilişsel hizmetler Azure üzerinde bir parçası Bing Haberler arama API kullanma gösterilmektedir. Bu makalede Ruby kullanır, ancak bir RESTful Web hizmeti, HTTP isteklerini hale getirebilir ve JSON ayrıştırma programlama dili ile uyumlu API'dir. 
...
[Bing Haberler arama API](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) haber Bing arama motoru sonuçlarını döndürür.
