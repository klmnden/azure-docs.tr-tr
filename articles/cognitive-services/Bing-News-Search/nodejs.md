---
title: Bilişsel hizmetler Azure, Bing Haberler arama API için node.js hızlı başlangıç | Microsoft Docs
...
ms.locfileid: "35354857"
---
# <a name="quickstart-for-bing-news-search-api-with-nodejs"></a>Bing Haberler arama API Node.js ile için hızlı başlangıç

Bu makalede, Microsoft Bilişsel hizmetler Azure üzerinde bir parçası Bing Haberler arama API kullanma gösterilmektedir. Bu makalede Node.js kullanır, ancak bir RESTful Web hizmeti, HTTP isteklerini hale getirebilir ve JSON ayrıştırma programlama dili ile uyumlu API'dir. 
