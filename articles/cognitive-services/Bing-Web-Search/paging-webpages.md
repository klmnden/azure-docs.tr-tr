---
title: Bing Web araması API'si sonuçları sayfasını nasıl | Microsoft Docs
description: Bing Web araması API'si sonuç öğrenin.
...
ms.locfileid: "42888250"
---
# <a name="how-to-page-through-bing-web-search-api-results"></a>Bing Web araması API'si sonuç nasıl
