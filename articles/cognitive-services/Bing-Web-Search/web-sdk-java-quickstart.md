...
description: Java için Bing Web Araması SDK'sını kullanmayı öğrenin.
...
* [JDK 7 veya 8](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
* [Apache Maven](https://maven.apache.org/download.cgi) veya favori derleme otomasyonu aracınız
* Abonelik anahtarı

## <a name="create-a-project-and-configure-your-pom-file"></a>Proje oluşturma ve POM dosyanızı yapılandırma

Maven veya favori derleme otomasyonu aracınızı kullanarak yeni bir Java projesi oluşturun. Maven kullanıyorsanız POM dosyanıza aşağıdaki dosyaları ekleyin. `mainClass` yerine uygulamanızı yazın.
