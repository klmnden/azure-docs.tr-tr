...
- Bing Web araması API'si için bir abonelik anahtarı. Biri yoksa [ücretsiz deneme için kaydolun](https://azure.microsoft.com/try/cognitive-services/?api=bing-web-search-api).
