---
title: "Hızlı Başlangıç: .NET - Content Moderator'ı kullanarak denetimi işlerini Başlat"
...
ms.locfileid: "55878088"
---
# <a name="quickstart-start-moderation-jobs-using-net"></a>Hızlı Başlangıç: .NET kullanarak denetimi işleri Başlat
