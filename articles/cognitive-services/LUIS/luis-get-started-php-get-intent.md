---
title: PHP kullanarak bir Language Understanding (LUIS) uygulamasını çağırma | Microsoft Docs
...
ms.locfileid: "36265135"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Öğretici: PHP kullanarak bir LUIS uç noktasını çağırma
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>PHP ile Uç Nokta API'sini kullanarak bir LUIS sonucundan faydalanma 
...
3. PHP uygulamasını çalıştırın. Tarayıcı penceresinde daha önce gördüğünüz JSON kodunu görüntüler.
