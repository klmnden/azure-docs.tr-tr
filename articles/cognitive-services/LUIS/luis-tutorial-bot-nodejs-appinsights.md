...
ms.locfileid: "67068536"
---
# <a name="add-luis-results-to-application-insights-with-a-bot-in-nodejs"></a>LUIS sonuçları node.js'de bir Bot ile Application Insights ekleyin
...
Bot, Bot Framework ile derlenir 4.x ve Azure Web app botu. A [Bot Framework 4.x LUIS öğreticisiyle](luis-nodejs-tutorial-bf-v4.md) de kullanılabilir.
...
* Bir LUIS web app botu gelen **[öğretici](luis-nodejs-tutorial-bf-v4.md)** açık Application Insights ile. 
...
Bu öğreticide kod aşağıdaki gibi görünüyor veya tamamladığınızdan emin olduğunuz varsayılır [diğer öğretici](luis-nodejs-tutorial-bf-v4.md): 
