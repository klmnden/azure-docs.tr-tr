---
title: 'Öğretici: Node.js kullanarak bir Language Understanding Intelligent Service (LUIS) uygulamasını çağırma | Microsoft Docs'
...
ms.locfileid: "36263661"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Öğretici: Node.js kullanarak bir LUIS uç noktasını çağırma
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Node.js ile Uç Nokta API'sini kullanarak bir LUIS sonucundan faydalanma
...
2. `LUIS_APP_ID` ortam değişkenini kod açıklamalarında anlatılan şekilde ayarlayın. 

3. `LUIS_SUBSCRIPTION_KEY` ortam değişkenini Bilişsel Hizmetler abonelik anahtarınıza göre ayarlayın.

4. Kodu çalıştırın. Tarayıcı penceresinde daha önce gördüğünüz değerleri görüntüler.
<!-- 
