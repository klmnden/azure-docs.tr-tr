...
![Örnek kapsayıcı çalıştırmanın kavramsal fikir](../text-analytics/media/how-tos/container-instance-sample/containers.png)
...
![Kapsayıcının swagger belgelerini görüntüleyin](../text-analytics/media/how-tos/container-instance-sample/language-detection-container-swagger-documentation.png)
