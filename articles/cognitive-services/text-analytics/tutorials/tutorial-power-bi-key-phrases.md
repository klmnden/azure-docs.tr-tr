...
Metin Analizi hizmetinin [Anahtar İfadeler API](//westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c6)’si, HTTP isteği başına bine kadar metin belgesini işleyebilir. Power BI, kayıtları tek tek işler. Bu nedenle, API’ye yönelik çağrılarınızın her biri yalnızca tek bir belge içerir. Anahtar İfadeler API’si, işlenen her belge için aşağıdaki alanları gerektirir.
