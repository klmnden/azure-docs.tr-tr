...
```
**Request(...)**  Aşağıdaki kod parçacığı HttlClient kullanmayı gösterir. abonelik anahtarını ve veri noktalarınızı uç noktasına Anomali algılama API'si gönderin.
