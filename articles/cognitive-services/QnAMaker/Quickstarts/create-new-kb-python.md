...
Visual Studio ve Python ile ilgili daha fazla yardım için: [Windows’da Visual Studio’da Python ile çalışma](https://docs.microsoft.com/visualstudio/python/overview-of-python-tools-for-visual-studio).
