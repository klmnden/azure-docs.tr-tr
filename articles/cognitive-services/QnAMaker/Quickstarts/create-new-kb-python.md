...
Kaynak olarak **Soru-Cevap Oluşturma** seçilmiş bir [Bilişsel Hizmetler API hesabınızın](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account) olması gerekir. [Azure panonuzdan](https://ms.portal.azure.com/) ücretli bir abonelik anahtarına ihtiyacınız olacak. Anahtarınızı almak için, panonuzda **Kaynak Yönetimi** altında **Anahtarlar** öğesini seçin. Bu hızlı başlangıç için her iki anahtar da çalışır.

![Azure panosu hizmet anahtarı](../media/sub-key.png)

Visual Studio ve Python ile ilgili daha fazla yardım için: [Windows’da Visual Studio’da Python ile çalışma](https://docs.microsoft.com/en-us/visualstudio/python/overview-of-python-tools-for-visual-studio).
...
3. `subscriptionKey` değerini geçerli abonelik anahtarınızla değiştirin.
