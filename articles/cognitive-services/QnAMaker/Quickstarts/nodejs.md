---
title: "Hızlı başlangıç: Soru-Cevap Oluşturma API'si (V4) için Node.js"
...
ms.locfileid: "48884908"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-nodejs"></a>Hızlı başlangıç: Node.js ile Microsoft Soru-Cevap Oluşturma API'si 
<a name="HOLTop"></a>

Bu makalede Node.js ve [Microsoft Soru-Cevap Oluşturma API'si](../Overview/overview.md) ile aşağıdaki işlemlerin nasıl gerçekleştirileceği gösterilmektedir.
