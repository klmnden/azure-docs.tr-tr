---
title: Kağıt varlığın içinde akademik bilgi API'si | Microsoft Docs
description: Bilişsel hizmetler, akademik bilgi API'si kağıt varlıkta ile kullanabileceğiniz öznitelikleri hakkında bilgi edinin.
