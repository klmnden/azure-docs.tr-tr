...
Alternatif olarak, bu hızlı başlangıçta aşağıdaki adımlarla komut satırından çalıştırabilirsiniz:
...
1. Gerektiğinde kodda aşağıdaki değişiklikleri yapın:
    ...
    1. Değiştirin `face_api_url` yüz tanıma API'si kaynak burada elde ettiğiniz abonelik anahtarlarınızın gerekiyorsa, bir Azure bölgesinde uç nokta URL'si ile.
