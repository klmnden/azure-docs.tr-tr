---
title: Görüntü arama uç noktaları - Bing resim arama API'si
...
**Uç nokta 1:** döndürür tarafından tanımlanan kullanıcı arama sorgusu için uygun olan görüntüleri `?q=""`.
```
...
**Uç noktası 3:** başkaları tarafından yapılan arama istekleri temel mu döndürür görüntüler. Görüntüleri farklı kategorilerde gibi önemli kişiler veya olayları göre ayrılır.
```
