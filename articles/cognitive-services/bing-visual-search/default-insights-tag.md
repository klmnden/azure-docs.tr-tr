---
title: Varsayılan ınsights etiket | Microsoft Docs
titleSuffix: Bing Web Search APIs - Cognitive Services
description: Görsel arama hakkında görüntü döndüren varsayılan öngörüleri hakkında ayrıntılar sağlar.
