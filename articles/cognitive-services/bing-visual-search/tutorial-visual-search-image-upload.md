...
İçgörü belirtecini kullanarak içgörüleri alma işleminin nasıl çalıştığını görmek için bkz. [Bing Görsel Arama SDK'sı ImageInsightsToken öğreticisi](./tutorial-visual-search-insights-token.md).