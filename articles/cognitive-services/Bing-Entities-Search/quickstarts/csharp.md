...
ms.locfileid: "48814820"
---
# <a name="quickstart-for-bing-entity-search-api-with-c"></a>Hızlı başlangıç: C# ile Bing Varlık Arama API'si 

Bu makalede [Bing Varlık Arama API'sinin](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/search-the-web) C# ile nasıl kullanılacağı göstermektedir.
