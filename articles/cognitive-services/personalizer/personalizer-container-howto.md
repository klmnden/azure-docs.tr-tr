...
* [Kubernetes](https://kubernetes.io/) kümesi dağıtıldı için [Azure Stack](https://docs.microsoft.com/azure-stack/operator/). Daha fazla bilgi için [Azure Stack dağıtma Kubernetes](https://docs.microsoft.com/azure-stack/user/azure-stack-solution-template-kubernetes-deploy).
