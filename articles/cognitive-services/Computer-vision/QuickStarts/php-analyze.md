...
ms.locfileid: "67604310"
---
# <a name="quickstart-analyze-a-remote-image-using-the-computer-vision-rest-api-and-php"></a>Hızlı Başlangıç: PHP ve görüntü işleme REST API'si kullanarak uzak bir resmi çözümleme
...
1. Kodu, `.php` uzantısıyla bir dosya olarak kaydedin. Örneğin, `analyze-image.php`.
