---
title: Görüntü İşleme API'si C# hızlı başlangıç yerel görüntü analizi | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Bu hızlı başlangıçta, Bilişsel Hizmetler’de C# ile Görüntü İşleme kullanarak bir yerel görüntü analiz edeceksiniz.
...
ms.locfileid: "43772586"
---
# <a name="quickstart-analyze-a-local-image---rest-c35"></a>Hızlı Başlangıç: Yerel görüntü analiz etme - REST, C&#35;

Bu hızlı başlangıçta, Görüntü İşleme kullanarak görsel özellikleri ayıklamak için yerel bir görüntüyü analiz edeceksiniz.
...
> [C# ile Görüntü İşleme'yi kullanma](../Tutorials/CSharpTutorial.md)
