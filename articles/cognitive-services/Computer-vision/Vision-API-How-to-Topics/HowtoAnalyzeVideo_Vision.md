---
title: Bilgisayar görme API ile gerçek zamanlı video çözümleme | Microsoft Docs
description: Bilişsel Hizmetleri'nde bilgisayar görme API'sini kullanarak canlı bir video akıştan geçen çerçeveler yakın gerçek zamanlı analiz gerçekleştirmek öğrenin.
