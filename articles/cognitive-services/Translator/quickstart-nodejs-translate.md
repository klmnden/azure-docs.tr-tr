...
ms.locfileid: "49648488"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Hızlı Başlangıç: Translator Metin Çevirisi REST API’si (Node.js) ile metin çevirme
