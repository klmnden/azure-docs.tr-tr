---
title: Translator Metin Çevirisi Python ile alternatif çeviri bulma | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Bu hızlı başlangıçta, Bilişsel Hizmetler’de Python ile Translator Metin Çevirisi API'sini kullanarak alternatif çeviriler ve bağlam içindeki terim örnekleri bulacaksınız.
...
ms.locfileid: "43770880"
---
# <a name="quickstart-find-alternate-translations-and-usage-with-python"></a>Hızlı Başlangıç: Python ile alternatif çeviri ve kullanım bulma
