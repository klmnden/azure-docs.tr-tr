---
title: Translator Metin Çevirisi Node.js ile alternatif çeviri bulma | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Bu hızlı başlangıçta, Bilişsel Hizmetler’de Node.js ile Translator Metin Çevirisi API'sini kullanarak alternatif çeviriler ve bağlam içindeki terim örnekleri bulacaksınız.
...
ms.locfileid: "43772459"
---
# <a name="quickstart-find-alternate-translations-and-usage-with-nodejs"></a>Hızlı Başlangıç: Node.js ile alternatif çeviri ve kullanım bulma
