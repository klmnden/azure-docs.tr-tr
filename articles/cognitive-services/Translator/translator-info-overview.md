---
title: Microsoft Translator Metin Çevirisi API'sine genel bakış - Azure Bilişsel Hizmetler | Microsoft Docs
description: Microsoft Translator Metin Çevirisi API'si ile uygulamalarınızı, web sitelerinizi, araçlarınızı ve diğer çözümlerinizi çok dilli kullanıcı deneyimleri sağlamak üzere tümleştirin.
...
ms.locfileid: "42889296"
---
# <a name="what-is-microsoft-translator"></a>Microsoft Translator nedir?

Microsoft Translator Metin Çevirisi API'si, [60'tan fazla dilde](languages.md) çok dilli kullanıcı deneyimleri sunmak üzere uygulamalarınızla, web sitelerinize, araçlarınızla veya diğer çözümlerinize sorunsuz bir şekilde tümleştirilebilir. Metinler arası dil çevirisi gerçekleştirmek için herhangi bir donanım platformu üzerinde herhangi bir işletim sistemi ile kullanılabilir.

Microsoft Translator Metin Çevirisi API'si, buluttaki Microsoft [Bilişsel Hizmetler API'si](https://docs.microsoft.com/azure/#pivot=products&panel=ai) makine öğrenimi ve yapak zeka algoritmaları koleksiyonunun bir parçasıdır ve geliştirme projelerinizde kullanılmaya hazırdır.
