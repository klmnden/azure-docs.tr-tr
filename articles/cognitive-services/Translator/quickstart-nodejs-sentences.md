...
ms.locfileid: "49644931"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-nodejs"></a>Hızlı Başlangıç: Translator Metin Çevirisi REST API'si (Node.js) ile cümle uzunluklarını alma
