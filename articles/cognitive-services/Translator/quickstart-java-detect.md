...
ms.locfileid: "52890798"
---
# <a name="quickstart-use-the-translator-text-api-to-detect-text-language-using-java"></a>Hızlı Başlangıç: Java kullanarak metin dili algılamak için Translator Text API kullanın.
