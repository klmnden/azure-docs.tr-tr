---
title: 'Hızlı Başlangıç: Cümle uzunluklarını alma - Translator Metin Çevirisi API’si, C#'
titleSuffix: Azure Cognitive Services
description: Bu hızlı başlangıçta, C# ile Translator Metin Çevirisi API’sini kullanarak metindeki cümlelerin uzunluklarını bulacaksınız.
