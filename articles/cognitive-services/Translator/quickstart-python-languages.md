---
title: 'Hızlı Başlangıç: Desteklenen dilleri alma, Python - Translator Metin Çevirisi API’si'
...
ms.locfileid: "49644734"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-python"></a>Hızlı Başlangıç: Translator Metin Çevirisi REST API'si (Python) ile desteklenen dilleri alma
