---
title: 'Hızlı Başlangıç: Desteklenen dillerin listesini alma, Node.js - Translator Metin Çevirisi API’si'
...
ms.locfileid: "50250674"
---
# <a name="quickstart-use-the-translator-text-api-to-get-a-list-of-supported-languages-with-nodejs"></a>Hızlı Başlangıç: Node.js ve Translator Metin Çevirisi API'sini kullanarak desteklenen dillerin listesini alma
