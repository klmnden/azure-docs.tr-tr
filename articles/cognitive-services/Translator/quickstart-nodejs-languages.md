---
title: 'Hızlı Başlangıç: Desteklenen dilleri alma, Node.js - Translator Metin Çevirisi API’si'
...
ms.locfileid: "49646431"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-nodejs"></a>Hızlı Başlangıç: Translator Metin Çevirisi REST API'si (Node.js) ile desteklenen dilleri alma
