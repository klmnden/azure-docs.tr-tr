...
İçinde `Program` sınıfı, çağrılan bir işlev oluşturma `TranslateText`. Bu sınıf, çeviri kaynak çağırmak ve sonucu konsola yazdırmak için kullanılan kod kapsüller.
