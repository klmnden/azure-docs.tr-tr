...
ms.locfileid: "49647213"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-go"></a>Hızlı Başlangıç: Translator Metin Çevirisi REST API’si (Go) ile metinden dil tanımlama
