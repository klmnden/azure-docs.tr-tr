...
---
#<a name="backup-documentation"></a>Backup Belgeleri

Bulutta Azure Backup hizmetini kullanarak verileri uzun vadeli bekletme ve kurtarmaya yönelik olarak nasıl koruyabileceğinizi öğrenin. Öğreticiler, videolar ve diğer belgeler, verileri, uygulamaları, Windows sunucularını ve Azure sanal makinelerini nasıl yedekleyebileceğinize ilişkin bilgiler içerir.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Backup hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Backup Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Dosya ve klasörleri Azure Backup ile yedeklemeye başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bir VMware sunucusunu Azure Backup Sunucusu ile yedeklemeye başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure sanal makinelerini Azure Backup ile korumaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/recoveryservices">Kurtarma Hizmetleri REST API Başvurusu</a></p>
                    </div>
                </div>
            </div>
        </div>
