...
* Uyarıları oluşturulmaz için başarılı bir yedeğiniz bu nedenle bildirim değil tetiklenir. Bildirim başarılı işler kullanmak için yapılandırmak üzere [etkinlik günlüğü](backup-azure-monitoring-use-azuremonitor.md#using-rs-vaults-activity-logs) veya [Log Analytics](backup-azure-monitoring-use-azuremonitor.md#using-log-analytics-workspace).
