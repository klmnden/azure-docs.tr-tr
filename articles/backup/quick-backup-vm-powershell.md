...
3. Kasayla birlikte depolama yedekliliği yapılandırmasını (GRS/LRS) değiştirmek [kümesi AzRecoveryServicesBackupProperty](https://docs.microsoft.com/powershell/module/az.recoveryservices/Set-AzRecoveryServicesBackupProperty)gibi:
