...
| VMSnapshot uzantısı işlemi başarısız oldu - yönetilen diskleri yedekleme işlemini yeniden deneyin. Sorun devam ederse konumundaki yönergeleri 'http://go.microsoft.com/fwlink/?LinkId=800034'. Sorun devam ederse Microsoft desteğine başvurun. | Backup hizmeti anlık görüntüsünü tetiklemek başarısız olduğunda bu hata oluşur. [Daha fazla bilgi edinin](backup-azure-troubleshoot-vm-backup-fails-snapshot-timeout.md#vmsnapshot-extension-operation-failed) sorunları VM hata ayıklama hakkında anlık görüntüsünü alın. |
