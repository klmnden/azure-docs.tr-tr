<properties
    pageTitle="Azure Backup nedir? | Microsoft Azure"
...
>[AZURE.NOTE] Hazırlama konumunu değiştirmeyin veya düzenlemeyin.
...
>[AZURE.WARNING] Yinelenenleri kaldırma, Azure'da Backup bileşenlerinden herhangi biri için kullanılamaz. System Center DPM ve Backup Sunucusu Azure'da dağıtıldığında, VM'ye bağlı depolama diskleri için yinelenenler kaldırılamaz.
...
>[AZURE.WARNING] Yedekleme verilerini şifrelemek için kullanılan anahtar yalnızca müşteride bulunur. Microsoft, Azure üzerinde anahtarın bir kopyasını tutmaz ve anahtara erişim sahibi değildir. Anahtarın kaybedilmesi durumunda Microsoft yedekleme verilerini kurtaramaz.
