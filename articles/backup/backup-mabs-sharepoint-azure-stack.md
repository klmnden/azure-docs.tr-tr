...
Devam etmeden önce bilgisayarınızda yüklü olduğundan emin olun [yüklü ve Azure yedekleme sunucusu hazırlanan](backup-mabs-install-azure-stack.md) iş yüklerini korumak için.
...
Bkz: [yedekleme SQL Server Azure yığında](backup-mabs-sql-azure-stack.md) makalesi.
