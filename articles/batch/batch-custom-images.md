...
## <a name="benefits-of-custom-images"></a>Özel görüntüleri avantajları
...
* Bağlı veri diskleri kullanarak, gelen diskleri bunları kullanmak için bir VM içinde takmanız ve biçimlendirmeniz gerekir.
