<properties
   ...
   description="Azure’de toplu işlem ve yüksek performanslı bilgi işlem (HPC ve Big Compute) senaryoları ve çözüm seçenekleri sunar."
...
• **Big Compute**, CPU gücüne ve belleğe bağlı uygulamalardan oluşmaya yatkındır; örneğin, mühendislik benzetimleri, finansal risk modelleme ve dijital işleme. Big Compute çözümünü besleyen kümelerde kaba hesaplama gerçekleştirecek özelleştirilmiş çok çekirdekli işlemcilere sahip bilgisayarlar ve bilgisayarları bağlamak için özelleştirilmiş, yüksek hızda ağ donanımları vardır.
...
>[AZURE.NOTE] Düşük gecikme süresi ve yüksek işleme uygulama ağı gereken paralel MPI uygulamaları da dahil, bazı HPC iş yüklerinin performansını artırmak için A8-A11 örneklerinin avantajlarını edinin. Bkz. [A8, A9, A10 ve A11 İşlem Yoğunluklu Örnekler Hakkında](../virtual-machines/virtual-machines-windows-a8-a9-a10-a11-specs.md).  
...
**[Sanal makineler](https://azure.microsoft.com/documentation/services/virtual-machines/)**<br/><br/> |• Microsoft Hyper-V teknolojisi kullanarak işlem hizmet olarak altyapısı (IaaS) sağlarlar<br/><br/>• Standart Windows Server veya Linux görüntülerinden ya da kendinizin veya [Azure Market](https://azure.microsoft.com/marketplace/)’ten sağlanan görüntülerden ve veri disklerinden kalıcı bulut bilgisayarlarını esnek bir biçimde hazırlamanızı ve yönetmenizi sağlarlar<br/><br/>• Kapasiteyi otomatik olarak artıracak veya azaltacak otomatik ölçeklendirmeyle, aynı sanal makinelerden büyük ölçekli hizmetler derlemek için [VM Ölçek Kümeleri](https://azure.microsoft.com/documentation/services/virtual-machine-scale-sets/) olarak dağıtılabilir ve yönetilebilirler<br/><br/>• Bulutun tamamında şirket içi işlem kümesi araçlarını ve uygulamalarını çalıştırırlar<br/><br/>
...
* [Virtual Network](https://azure.microsoft.com/documentation/services/virtual-network/) - Azure kaynaklarını IPSec kullanarak şirket içi veri merkezinize veya tek istemci makineye bağlamak için Azure’de mantıksal yalıtılmış bir bölüm oluşturur; Big Compute uygulamalarının şirket içi verilere, Active Directory hizmetlerine ve lisans sunucularına erişmesini sağlar
...
* [Towers Watson](https://customers.microsoft.com/Pages/CustomerStory.aspx?recid=18222), [Altair](https://azure.microsoft.com/blog/availability-of-altair-radioss-rdma-on-microsoft-azure/) ve [d3VIEW](https://customers.microsoft.com/Pages/CustomerStory.aspx?recid=22088) tarafından sağlanan Azure Big Compute çözümleri hakkında okuyun.
