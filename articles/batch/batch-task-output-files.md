...
Azure depolama alanında sanal dizinleri hakkında daha fazla bilgi için bkz: [BLOB'ları bir kapsayıcıda listelemek](../storage/blobs/storage-dotnet-how-to-use-blobs.md#list-the-blobs-in-a-container).
