---
title: "Eğitmen - Azure Batch Python istemcisini kullanmaya başlama | Microsoft Belgeleri"
...
---
# <a name="get-started-with-the-azure-batch-python-client"></a>Azure Batch Python istemcisini kullanmaya başlama
...
> [!TIP]
> Ayrıcalığı olmayan bir hesap kullanıyorsanız, komutlarınıza `sudo` önekini eklemeniz gerekebilir. Örneğin, `sudo pip install -r requirements.txt`. Python paketlerini yükleme hakkında daha fazla bilgi için bkz. [Paketleri Yükleme][pypi_install] (readthedocs.io).
> 
> 
...
> [!TIP]
> [Python’dan Azure Blob depolama kullanma](../storage/storage-python-how-to-use-blob-storage.md), Azure Storage kapsayıcıları ve blob'larla çalışma hakkında kapsamlı bilgi sağlar. Batch’le çalışmaya başladığınızda okuma listenizin en üstüne yakın olması gerekir.
> 
> 
...
[1]: ./media/batch-python-tutorial/batch_workflow_01_sm.png "Azure Storage’da kapsayıcı oluşturma"
[2]: ./media/batch-python-tutorial/batch_workflow_02_sm.png "Görev uygulamasını ve girdi dosyalarını (veriler) kapsayıcılara yükleme"
...
[7]: ./media/batch-python-tutorial/batch_workflow_07_sm.png "Storage’dan görev çıktısını indirme"
...
[10]: ./media/batch-python-tutorial/credentials_storage_sm.png "Portalda Storage kimlik bilgileri"
