...
1. Açık `Functions\DevKitTranslatorFunction.cs` ve devce adı ve konuşma hizmeti anahtarı not ettiğiniz aşağı aşağıdaki kod satırlarını güncelleştirin.
  ```csharp
