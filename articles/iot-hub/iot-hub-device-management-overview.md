...
* **Yapılandırma**: arka uç uygulaması, cihaz üzerinde çalışan yazılımı yapılandırır istenen özellikleri kullanır. Cihaz, bildirilen özellikleri kullanarak cihazın yapılandırma durumunu güncelleştirir.
...
* **İlerleme ve durumu raporlama**: Çözüm arka ucu bir dizi cihaz üzerinde çalışan eylemlerin ilerlemesini ve durumunu raporlamak için cihazda cihaz çifti sorguları çalıştırır.
