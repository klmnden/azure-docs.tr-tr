...
1. SDK'sı tanımlıyorsa bir **kurtarılamaz bir hata**, tanımlı zaman aşımı sona erdiğinde kadar belirtilen yeniden deneme ilkesine göre yeniden dener.  SDK'sını kullanan Not **Üstsel geri alma ile değişimi** varsayılan yeniden deneme ilkesi.
