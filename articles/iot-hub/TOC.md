...
# Kullanmaya Başlama
## Sanal cihazı kullanmaya başlama
...
## [Dosyaları cihazlardan karşıya yükleme öğreticisi](iot-hub-csharp-csharp-file-upload.md)
## [Buluttan cihaza iletileri gönderme (.NET)](iot-hub-csharp-csharp-c2d.md)
## [Buluttan cihaza iletileri gönderme (Java)](iot-hub-java-java-c2d.md)
## [Buluttan cihaza iletileri gönderme (Node)](iot-hub-node-node-c2d.md)
## [Cihaz ikizlerini kullanmaya başlama (Node)](iot-hub-node-node-twin-getstarted.md)
## [Cihaz ikizlerini kullanmaya başlama (.NET/Node)](iot-hub-csharp-node-twin-getstarted.md)
## [Node.js için doğrudan yöntemleri kullanma](iot-hub-node-node-direct-methods.md)
## [.NET/Node için doğrudan yöntemleri kullanma](iot-hub-csharp-node-direct-methods.md)
## [Node.js için cihaz yönetimini kullanmaya başlama](iot-hub-node-node-device-management-get-started.md)
## [.NET/Node için cihaz yönetimini kullanmaya başlama](iot-hub-csharp-node-device-management-get-started.md)
## [İkiz özellikleri kullanma (Node)](iot-hub-node-node-twin-how-to-configure.md)
## [İkiz özellikleri kullanma (.NET/Node)](iot-hub-csharp-node-twin-how-to-configure.md)
## [Node.js için cihaz üretici yazılımını güncelleştirmek üzere cihaz işlerini kullanma](iot-hub-node-node-firmware-update.md)
...
## Ağ Geçidi SDK'sı
### [Ağ Geçidi SDK öğreticisiyle bir cihazın benzetimini gerçekleştirme (Linux)](iot-hub-linux-gateway-sdk-simulated-device.md)
### [Ağ Geçidi SDK öğreticisiyle bir cihazın benzetimini gerçekleştirme (Windows)](iot-hub-windows-gateway-sdk-simulated-device.md)
### [Ağ Geçidi SDK öğreticisiyle gerçek bir cihazdan mesaj gönderme](iot-hub-gateway-sdk-physical-device.md)
## Güvenlik
