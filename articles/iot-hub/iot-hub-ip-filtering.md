...
IOT Hub'ınızın IP filtreleri alınır ve aracılığıyla ayarlanan [Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview?view=azps-1.2.0). 
