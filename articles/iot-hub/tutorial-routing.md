...
Kaynak grubunu kaldırmak için [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup) komutu. $resourceGroup, yeniden bu öğreticinin başındaki **ContosoIoTRG1** değerine ayarlanır.
