...
Ortam ya da sanal makineyi Otomasyon oluşturulmuş olsa bile, hata bilgilerini aramak için bir son bağlantısı yoktur. Azure Resource Manager şablonu dağıtım günlüğü olmasıdır. Bir laboratuar kaynağı Otomasyon oluşturulduğunda, genellikle bir Azure Resource Manager şablon dağıtımı yapılır. Bkz:[ https://github.com/Azure/azure-devtestlab/tree/master/Samples ](https://github.com/Azure/azure-devtestlab/tree/master/Samples) örnek Azure Resource Manager şablonları, DevTest Labs kaynakları oluşturmak için. 
