...
1. Laboratuvar oluşturulduktan sonra **Laboratuvarıma git**'i seçin. 

    ![Laboratuvarıma git](../media/tutorial-setup-classroom-lab/go-to-my-lab.png)
