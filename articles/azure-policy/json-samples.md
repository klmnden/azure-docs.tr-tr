...
ms.locfileid: "34602620"
---
# <a name="azure-policy-samples"></a>Azure İlkesi Örnekleri

Aşağıdaki tabloda Azure İlkesi’ne ait JSON örneklerinin bağlantıları yer almaktadır. Bu örnekler aynı zamanda [Azure İlkesi örnekleri deposunda](https://github.com/Azure/azure-policy) da bulunur.
