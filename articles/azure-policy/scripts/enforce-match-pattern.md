---
title: "Azure ilke json örnek - eşleşme deseni zorunlu | Microsoft Docs"
description: "Bu json örnek ilke kaynakları adlandırma kuralları için eşleşme deseni karşılamasını gerektirir."
...
---
# <a name="enforce-match-pattern-for-naming-conventions"></a>Adlandırma kuralları için eşleşme deseni zorla

Adlandırma kuralları için benzer bir desen kaynak adları karşılaması gerekir. İzin verilen eşleşme deseni parametre olarak belirtin.
