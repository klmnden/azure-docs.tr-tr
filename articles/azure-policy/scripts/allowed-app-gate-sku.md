---
title: Azure İlkesi JSON örneği - İzin verilen uygulama ağ geçidi SKU’ları | Microsoft Docs
description: Bu JSON örnek ilkesi, uygulama ağ geçitlerinin onaylı bir SKU kullanmasını gerektirir.
