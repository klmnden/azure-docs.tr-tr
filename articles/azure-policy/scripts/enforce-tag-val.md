---
title: Azure İlkesi JSON örneği - Etiketi ve değerini zorunlu tutma | Microsoft Docs
description: Bu JSON örnek ilkesi belirli bir etiket adı ve değeri gerektirir.
