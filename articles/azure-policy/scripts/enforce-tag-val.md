---
title: "Azure ilke json örnek - etiketi ve değerini zorla | Microsoft Docs"
description: "Bu json örnek İlkesi belirtilen etiket adı ve değeri gerektirir."
...
---
# <a name="enforce-tag-and-its-value"></a>Etiket ve değerini zorla

Bu ilke belirtilen etiket adı ve değeri gerektirir. Zorlamak için değer ve etiket adı belirtin.
