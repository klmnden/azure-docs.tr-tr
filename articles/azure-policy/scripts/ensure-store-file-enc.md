---
title: Azure İlkesi JSON örneği - Depolama hesabı şifrelemesini güvence altına alma | Microsoft Docs
description: Bu JSON örnek ilkesi, depolama hesapları için dosya şifrelemenin etkinleştirilmesini gerektirir.
