---
title: Azure İlkesi JSON örneği - etiket eşleştirme desenini zorunlu tutma  | Microsoft Docs
description: Bu JSON örnek ilkesi, kaynakların etiket değeri için eşleştirme deseniyle eşleşmesini gerektirir.
