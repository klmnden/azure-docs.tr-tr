---
title: Azure İlkesi JSON örneği - İzin verilen SQL DB SKU’ları | Microsoft Docs
description: Bu JSON örnek ilkesi, SQL veritabanlarının onaylı bir SKU kullanmasını gerektirir.
