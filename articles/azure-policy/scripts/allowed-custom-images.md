---
title: Azure İlkesi örneği - Onaylı VM görüntüleri
description: Bu ilke, ortamınızda yalnızca onaylı özel görüntülerin dağıtılmasını gerektirir.
...
[![Azure'a dağıtma](../media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-policy%2Fmaster%2Fsamples%2FCompute%2Fallowed-custom-images%2Fazurepolicy.json)
[![Azure Government'a dağıtma](../media/deploy/deployGovbutton.png)](https://portal.azure.us/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-policy%2Fmaster%2Fsamples%2FCompute%2Fallowed-custom-images%2Fazurepolicy.json)
...
[ARMClient](https://github.com/projectkudu/ARMClient) veya PowerShell gibi Resource Manager REST API'si ile etkileşim kurmak için kullanılabilecek birçok araç vardır. PowerShell'den REST API'sini çağırma örneği, [İlke tanımı yapısı](../policy-definition.md#aliases) bölümünün **Diğer Adlar** kısmında bulunabilir.
...
- Ek [Azure İlkesi örneklerini](../json-samples.md) gözden geçirme
- [Azure İlkesi tanımı yapısını](../policy-definition.md) gözden geçirme
