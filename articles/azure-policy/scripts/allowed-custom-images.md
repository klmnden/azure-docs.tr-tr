---
title: Azure İlkesi JSON örneği - Onaylı VM görüntüleri  | Microsoft Docs
description: Bu JSON örnek ilkesi, ortamınızda yalnızca onaylı özel görüntülerin dağıtılmasını gerektirir.
