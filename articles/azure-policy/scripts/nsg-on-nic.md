---
title: Azure İlkesi JSON örneği - Her NIC’de NSG x | Microsoft Docs
description: Bu JSON örnek ilkesi, her sanal ağ arabirimiyle belirli bir ağ güvenlik grubunun kullanılmasını gerektirir.
