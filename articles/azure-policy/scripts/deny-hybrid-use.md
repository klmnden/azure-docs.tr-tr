---
title: "Azure ilke json örnek - karma kullanımı avantajı Reddet | Microsoft Docs"
description: "Bu json örnek ilke kullanım Azure karma kullanma Avantajı (AHUB), engelliyor."
...
---
# <a name="deny-hybrid-use-benefit"></a>Karma kullanımı avantajı Reddet

Azure karma kullanma Avantajı (AHUB), kullanım engelliyor. Şirket içi lisansları kullanımına izin vermek istediğinizde değil işlevini kullanın.
