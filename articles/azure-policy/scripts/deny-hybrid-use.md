---
title: Azure İlkesi JSON örneği - Hibrit kullanım avantajını reddetme | Microsoft Docs
description: Bu JSON örnek ilkesi, Azure Hibrit Kullanım Teklifi (AHUB) kullanımını engeller.
