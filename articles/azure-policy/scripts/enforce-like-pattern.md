---
title: Azure İlkesi JSON örneği - benzer deseni zorunlu tutma  | Microsoft Docs
description: Bu JSON örnek ilkesi, kaynakların adlandırma kuralları için benzer desenle eşleşmesini gerektirir.
