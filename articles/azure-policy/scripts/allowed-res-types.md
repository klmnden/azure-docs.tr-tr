---
title: Azure İlkesi JSON örneği - İzin verilen kaynak türleri | Microsoft Docs
description: Bu JSON örnek ilkesi yalnızca onaylanan kaynak türlerinin dağıtılmasını güvence altına alır.
