---
title: Azure İlkesi JSON örneği - Ağ İzleyicisi bölge için etkin değilse denetle | Microsoft Docs
description: Bu JSON örnek ilkesi, belirli bir bölge için ağ izleyicisi etkinleştirilmediğinde denetler
...
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>Ağ İzleyicisi bölge için etkin değilse denetle
