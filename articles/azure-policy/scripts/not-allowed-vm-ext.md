---
title: Azure İlkesi JSON örneği - İzin verilmeyen VM uzantıları | Microsoft Docs
description: Bu JSON örnek ilkesi, belirtilen uzantıların kullanılmasını engeller.
