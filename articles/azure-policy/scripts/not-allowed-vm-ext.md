---
title: "Azure ilke json örnek VM uzantıları izin verilmiyor - | Microsoft Docs"
description: "Bu json örnek ilke belirtilen uzantıları kullanımını engeller."
...
---
# <a name="not-allowed-vm-extensions"></a>VM uzantıları izin verilmiyor

Belirtilen uzantıları kullanımını engeller. Yasaklanan uzantı türlerini içeren bir dizi belirtin.
