---
title: "Azure ilke json örnek - denetim sunucu düzeyi tehdit algılama ayarı | Microsoft Docs"
...
---
# <a name="audit-server-level-threat-detection-setting"></a>Sunucu düzeyinde tehdit algılama ayarı denetleme
