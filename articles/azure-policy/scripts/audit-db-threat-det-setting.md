---
title: Azure İlkesi JSON örneği - Veritabanı düzeyi tehdit algılama ayarını denetleme | Microsoft Docs
description: Bu JSON örnek ilkesi, SQL veritabanı güvenlik uyarısı ilkeleri belirtilen duruma ayarlanmadıysa bu ilkeleri denetler.
