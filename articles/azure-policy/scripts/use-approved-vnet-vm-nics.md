---
title: Azure İlkesi JSON örneği - VM ağ arabirimleri için onaylı sanal ağ kullanma | Microsoft Docs
description: Bu JSON örnek ilkesi, ağ arabirimlerinin onaylı bir sanal ağ kullanmasını gerektirir.
