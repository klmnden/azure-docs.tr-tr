---
title: Azure İlkesi JSON örneği - İzin verilen depolama hesabı SKU’ları | Microsoft Docs
description: Bu JSON örnek ilkesi, depolama hesaplarının onaylı bir SKU kullanmasını gerektirir.
