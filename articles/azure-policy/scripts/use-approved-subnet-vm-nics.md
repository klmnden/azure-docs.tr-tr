---
title: Azure İlkesi JSON örneği - VM ağ arabirimleri için onaylı alt ağ kullanma | Microsoft Docs
description: Bu JSON örnek ilkesi, ağ arabirimlerinin onaylı bir alt ağ kullanmasını gerektirir.
