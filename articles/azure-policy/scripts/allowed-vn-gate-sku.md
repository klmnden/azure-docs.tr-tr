---
title: "Azure ilke json örnek - izin verilen sanal ağ geçidi SKU'ları | Microsoft Docs"
description: "Bu json örnek ilke sanal ağ geçitlerini onaylanmış bir SKU ve ağ geçidi türü kullanmanızı gerektirir."
...
---
# <a name="allowed-virtual-network-gateway-skus"></a>Sanal ağ geçidi SKU'ları izin

Bu ilke, sanal ağ geçitlerini onaylanmış bir SKU ve ağ geçidi türü kullanmanızı gerektirir. Onaylanan SKU'ları bir dizi ve onaylanan ağ geçidi türleri dizisi belirtin.
