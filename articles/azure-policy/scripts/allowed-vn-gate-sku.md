---
title: Azure İlkesi JSON örneği - İzin verilen sanal ağ geçidi SKU’ları | Microsoft Docs
description: Bu JSON örnek ilkesi, sanal ağ geçitlerinin onaylı bir SKU ve ağ geçidi türü kullanmasını gerektirir.
