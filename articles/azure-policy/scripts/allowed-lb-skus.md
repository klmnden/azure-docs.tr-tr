---
title: Azure İlkesi JSON örneği - İzin verilen yük dengeleyici SKU’ları | Microsoft Docs
description: Bu JSON örnek ilkesi, yük dengeleyicilerin onaylı bir SKU kullanmasını gerektirir.
