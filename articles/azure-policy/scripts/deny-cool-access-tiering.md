---
title: "Azure ilke json Örnek - Depolama hesapları için katmanlama cool erişimini | Microsoft Docs"
description: "Bu json örnek ilke blob storage hesapları için katmanlama seyrek erişimli erişim kullanımını engeller."
...
---
# <a name="deny-cool-access-tiering-for-storage-accounts"></a>Depolama hesapları için katmanlama cool erişimini engelle

Bu ilke için blob storage hesapları katmanlama seyrek erişimli erişim kullanımını engeller.
