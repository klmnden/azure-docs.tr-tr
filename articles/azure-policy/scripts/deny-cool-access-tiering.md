---
title: Azure İlkesi JSON örneği - Depolama hesapları için seyrek erişimli depolama katmanını engelleme | Microsoft Docs
description: Bu JSON örnek ilkesi, blob depolama hesapları için seyrek erişimli depolama katmanının kullanılmasını engeller.
