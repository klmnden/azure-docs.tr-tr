---
title: Azure İlkesi JSON örneği - Kaynak gruplarında etiket ve değerini zorlama | Microsoft Docs
description: Bu JSON örnek ilkesi, kaynak grubunda bir etiket ve değer gerektirir.
