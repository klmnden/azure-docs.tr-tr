---
title: Azure İlkesi JSON örneği - Data Lake Store için şifrelemeyi zorunlu tutma | Microsoft Docs
description: Bu JSON örnek ilkesi,  için şifreleme gerektirir.
