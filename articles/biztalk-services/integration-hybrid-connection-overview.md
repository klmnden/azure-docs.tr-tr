<properties
    pageTitle="Karma Bağlantılara Genel Bakış | Microsoft Azure"
...
- SQL Sunucusu, MySQL, HTTP Web API’leri ve çok sayıda özel Web Hizmeti gibi statik TCP bağlantı noktası kullanan şirket içi kaynaklara bağlanabilir.
    ...
    > [AZURE.NOTE] Dinamik bağlantı noktaları (örneğin, FTP Pasif modu veya Genişletilmiş Pasif modu) kullanan TCP tabanlı hizmetler şu anda desteklenmemektedir. LDAP de desteklenmemektedir. LDAP statik bir TCP bağlantı noktasını kullansa da, UDP de kullanmaktadır. Sonuç olarak desteklenmemektedir.
...
[Azure Web sitesini şirket içi kaynağa bağlama](../app-service-web/web-sites-hybrid-connection-get-started.md)<br/>
...
[Azure Mobile Services ve Karma Bağlantılar](../mobile-services/mobile-services-dotnet-backend-hybrid-connections-get-started.md)
