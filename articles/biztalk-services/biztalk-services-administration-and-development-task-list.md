...
| --- | --- | --- | --- |
| 1. |Yönetici |Bir Microsoft hesabı veya kurumsal bir hesap kullanarak Microsoft Azure aboneliği oluşturma |[Klasik Azure Portalı](http://go.microsoft.com/fwlink/p/?LinkID=213885) |
...
| 8. |Yönetici |Klasik Azure portalını kullanarak, performans ölçümleri de dahil olmak üzere, BizTalk hizmeti durumunu izleyin. |[BizTalk Services: Pano, İzleyici ve Ölçek sekmeleri](http://go.microsoft.com/fwlink/p/?LinkID=302281) |
