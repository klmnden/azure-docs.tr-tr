...
Kullanarak dinleyici için cconfigure yeniden yönlendirme yapabilirsiniz [Ekle AzureRmApplicationGatewayRedirectConfiguration](/powershell/module/azurerm.network/add-azurermapplicationgatewayredirectconfiguration). 
...
![Uygulama ağ geçidi test contoso sitede](./media/redirect-internal-site-powershell/application-gateway-iistest.png)
