---
title: Web uygulaması güvenlik duvarı istek boyutu sınırları ve hariç tutma listeleri Azure Application Gateway'de - Azure portalı | Microsoft Docs
...
- En fazla istek gövdesi boyutu alanı KB'leri ve denetimler genel istek boyutu sınırı dışında herhangi bir dosya yükler belirtilir. Bu alan 1 KB en az 128 KB en büyük değere değişebilir. 128 KB istek gövdesi boyutu için varsayılan değerdir.
