...
SSL İlkesi sürümlerini yapılandırmak ve şifre paketleri Application Gateway hakkında bilgi edinin. SSL İlkesi sürümlerinden farklı yapılandırmaları içerir ve şifre paketleri etkinleştirilen önceden tanımlanmış ilkeleri bir listeden seçebilirsiniz. Tanımlama yeteneği de bir [özel SSL İlkesi](#configure-a-custom-ssl-policy) gereksinimlerinize göre.
