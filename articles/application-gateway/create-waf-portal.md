...
![Web uygulaması güvenlik duvarı örneği](./media/create-waf-portal/scenario-waf.png)
...
3. Uygulama ağ geçidi için bu değerleri girin:
    ...
    ![Yeni uygulama ağ geçidi oluşturma](./media/create-waf-portal/application-gateway-create.png)
...
5. Tıklatın **sanal ağ seçin**, tıklatın **Yeni Oluştur**ve ardından sanal ağ için bu değerleri girin:
    ...
    ![Sanal ağ oluşturma](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Tıklatın **alt ağlar**ve ardından **alt**.
    ...
    ![Alt ağ oluşturma](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Etkileşimli Kabuğu'nu açın ve onu ayarlandığından emin olun **PowerShell**.
    ...
    ![Özel uzantısını yükleyin](./media/create-waf-portal/application-gateway-extension.png)
...
3. Tıklatın **Ekle hedef** oluşturduğunuz her bir sanal makine arka uç havuzuna eklemek için.
    ...
    ![Arka uç sunucuları ekleme](./media/create-waf-portal/application-gateway-backend.png)
...
7. **Kaydet**’e tıklayın.
    ...
    ![Tanılama Yapılandır](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Genel Bakış ekranında uygulama ağ geçidi için genel IP adresini bulun. Tıklatın **tüm kaynakları** ve ardından **myAGPublicIPAddress**.
    ...
    ![Uygulama ağ geçidi genel IP adresi kaydı](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Genel IP adresini kopyalayıp tarayıcınızın adres çubuğuna yapıştırın.

    ![Test uygulama ağ geçidi](./media/create-waf-portal/application-gateway-iistest.png)
