...
4. Girin *Video* ikinci yol adı. Girin */video/* \* yolu. Seçin **videoBackendPool** arka uç havuzu için.
    ...
    ![Yol tabanlı bir kural oluşturun](./media/create-url-route-portal/application-gateway-route-rule.png)
