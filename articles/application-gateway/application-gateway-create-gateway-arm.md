---
title: "Azure Resource Manager kullanarak uygulama ağ geçidi oluşturma, başlatma veya silme | Microsoft Belgeleri"
...
## <a name="create-a-public-ip-address-for-the-frontend-configuration"></a>Ön uç yapılandırma için genel bir IP adresi oluşturun
...
## <a name="create-an-application-gateway-by-using-newazurermapplicationgateway"></a>New-AzureRmApplicationGateway kullanarak bir uygulama ağ geçidi oluşturma
