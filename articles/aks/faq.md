...
## <a name="does-aks-support-kubernetes-rbac"></a>AKS, Kubernetes RBAC destekliyor mu?

Evet, Kubernetes rol tabanlı erişim denetimi (RBAC), Azure CLI ile kümeleri oluşturduğunuzda varsayılan olarak etkindir. RBAC, Azure portalı veya şablonları kullanılarak oluşturulmuş olan kümeler için etkinleştirebilirsiniz.
...
Şu anda değil. Genel bir tam etki alanı adı (FQDN) olarak Kubernetes API sunucusu kullanıma sunulur. Kullanarak kümenize erişimi denetleyebilirsiniz [Kubernetes RBAC ve Azure Active Directory (Azure AD)][aks-rbac-aad].
...
- AKS kümenizi yükseltme tarafından. Küme yükseltme [kordon altına alma ve düğüm boşaltma] [ cordon-drain] otomatik olarak ve ardından yeni bir düğüm çevrimiçi en yeni bir Ubuntu görüntüsünü ve yeni bir düzeltme eki sürümü veya ikincil bir Kubernetes sürümü ile taşıyın. Daha fazla bilgi için [AKS kümesini yükseltme][aks-upgrade].
