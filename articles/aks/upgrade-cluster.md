...
Yükseltme için kullanılabilir iki sürümlerini sunuyoruz: 1.8.0 ve 1.8.1.  Biz kullanabilirsiniz `az aks upgrade` kullanılabilir en son sürüme yükseltmek için komutu.  Yükseltme işlemi sırasında düğüm dikkatle olduğundan [cordoned ve boşaltmış](https://kubernetes.io/docs/tasks/administer-cluster/safely-drain-node/) çalışan uygulamalar engellemeyi en aza indirmek için.
