...
Azure sanal makinelerinde çalışan AKS düğümleri. Depoları düğümlere ve pod’lara bağlayabilir, küme bileşenlerini yükseltebilir ve GPU’lar kullanabilirsiniz.
...
[Azure Diskleri][azure-disk] veya [Azure Dosyaları ][azure-files] ile dinamik kalıcı birimlere başlayın.
...
Azure Kubernetes Service (AKS), SOC, ISO ve PCI DSS ile uyumludur.
