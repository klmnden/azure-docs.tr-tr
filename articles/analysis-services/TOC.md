...
#### [4 - İlişki oluşturma](tutorials/aas-lesson-4-create-relationships.md) 
#### [5 - Hesaplanan sütunlar oluşturma](tutorials/aas-lesson-5-create-calculated-columns.md)
#### [6 - Ölçü oluşturma](tutorials/aas-lesson-6-create-measures.md)  
#### [7 - Ana Performans Göstergeleri oluşturma](tutorials/aas-lesson-7-create-key-performance-indicators.md)  
#### [8 - Perspektif oluşturma](tutorials/aas-lesson-8-create-perspectives.md) 
#### [9 - Hiyerarşi oluşturma](tutorials/aas-lesson-9-create-hierarchies.md) 
#### [10 - Bölüm oluşturma](tutorials/aas-lesson-10-create-partitions.md) 
#### [11 - Rol oluşturma](tutorials/aas-lesson-11-create-roles.md)
#### [12 - Excel’de çözümleme](tutorials/aas-lesson-12-analyze-in-excel.md)
#### [13 - Dağıtma](tutorials/aas-lesson-13-deploy.md)
...
## [Resource Manager Şablonu](/azure/templates/microsoft.analysisservices/servers)
