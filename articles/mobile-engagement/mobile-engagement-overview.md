<properties
    pageTitle="Mobile Engagement’a Genel Bakış | Microsoft Azure"
...
##Yatırım getirisini en üst düzeye çıkarmak için gerçek zamanlı eyleme dönüştürülebilir analiz
...
##Değer katan anında iletme ve iletişim platformu
...
##Açık API'ler ve tümleştirme kolaylığı

Tümleştirmeyi kolay hale getiren açık API'ler ve SDK'ların sağlanmasıyla, mevcut CRM, CMS veya diğer arka uç sistemlerinizdeki verilerden yararlanabilirsiniz. Böylece kitlenizi daha fazla iyi hedefleyebilir ve yatırımlarınızı korursunuz.

##Veri koruma ve dünya çapında gizlilik

Microsoft, gizliliğin korunması konusunda her zaman kararlı olmuştur ve bu kararlılık ürün ve hizmetler yaşam döngümüzün ayrılmaz bir parçasıdır. Gizlilik uygulamalarımızda saydam olmaya çabalar, müşterilere elle tutulur gizlilik seçenekleri sunar ve depoladığımız verileri sorumlu bir şekilde yönetiriz. Tüm Azure hizmetlerinde olduğu gibi Mobile Engagement da müşterilerin varlıklarından türetilen bilgileri paylaşmaz veya satışını yapmaz. Mobile Engagement dünya çapında kullanıma sunulmuştur, bölgesel veya ülkeye özel veri gizliliği yasalarının uygulanmasına olanak tanır.
