...
Azure AD B2C blok reşit olmayanların ebeveyn izni olmadan için veya bunlara izin ve bunlarla yapmanız gerekenler hakkında kararlar uygulama seçebilirsiniz.  

###<a name="allowing-minors-without-parental-consent"></a>Ebeveyn izni olmadan reşit olmayanların izin verme
Ya da imzalama, oturum açma sahip kullanıcı akışları veya her ikisi için izniniz olmadan reşit olmayanların uygulamanıza izin vermeyi seçebilirsiniz.  Ebeveyn izni olmadan reşit olmayanların için bunlar oturum açın veya oturum izin verilmez normal olarak ayarlama ve bir kimliği belirteciyle sorunları `legalAgeGroupClassification` talep.  Bu kullanıcıların deneyimini seçebilirsiniz bu talep kullanarak gibi ebeveyn izni toplamak için bir deneyim giderek (ve güncelleştirme `consentProvidedForMinor` alan).

###<a name="blocking-minors-without-parental-consent"></a>Ebeveyn izni olmadan reşit olmayanların engelleme
Ya da imzalama, oturum açma sahip kullanıcı akışları veya her ikisi için uygulamanıza izniniz olmadan reşit olmayanların engellemeyi seçebilirsiniz.  Azure AD B2C engellenen kullanıcılar işlemek için iki seçenek vardır:
...
###<a name="customization-unavailable-for-new-pages"></a>Özelleştirme için yeni sayfa kullanılamıyor
Geçerlilik süresi geçişi etkinleştirdiğinizde, kullanıcı akışınız kullanılabilir iki yeni sayfalar vardır.  Ülke ve doğum tarihi üzerinde toplamak için bu sayfaları oturum açabilir ve hata sayfası sayfa düzeni veya dil özelleştirme ile kullanılamaz.  Bu seçenek gelecek bir güncelleştirmede kullanılabilir.
...
Kurulum yaş geçişi için yapılandırdığınız dizininize aracılığıyla bir seçenek olarak, `Properties`.  Ya da silerseniz `legalCountry` veya `dateOfBirth`, kiracınız, artık yaş geçişi kullanabilirsiniz ve bu özellikleri yeniden oluşturulamaz.
