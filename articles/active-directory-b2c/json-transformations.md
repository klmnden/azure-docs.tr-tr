...
- Giriş talepleri:
    - **jsonSourceClaim**: [{"anahtarını": "email", "value": "someone@example.com"}, "key": "displayName", "value": "Kişi"}, {"anahtarını": "membershipNum", "value": 6353399}, {"anahtarını": "etkin", "value": true}, {"key": "Doğum", "value": "1980-09-23T00:0 0:00Z"}]
- Giriş parametreleri:
...
| InputParameter | claimToExtract | dize | Ayıklanacak JSON öğesi adı. |
| outputClaim | extractedClaim | boylam | Öğesinin değeri belirtilen bu ClaimsTransformation çağrıldıktan sonra üreten ClaimType _claimToExtract_ giriş parametreleri. |
