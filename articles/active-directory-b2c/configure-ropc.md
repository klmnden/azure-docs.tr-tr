...
*Client_id* uygulama kimliği olarak daha önce not ettiğiniz değer *Offline_access* bir yenileme belirteci almak istiyorsanız isteğe bağlıdır. Kullanıcı adı ve parola kullandığınız Azure AD B2C kiracınızda mevcut bir kullanıcının kimlik bilgileri olmalıdır.
...
```
> [!NOTE]
> Graph API'si üzerinden kullanıcı oluştururken, uygulama "openıd", "offline_access" ve Microsoft Graph "profili" izinleri olması gerekir.
