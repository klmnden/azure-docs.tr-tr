---
title: Azure Active Directory B2C'de Node.js kullanarak bir web API güvenliğini | Microsoft Docs
description: Node.js web B2C kiracısından belirteç kabul API'si oluşturma.
