...
| <center>![Web API'leri](../active-directory/develop/media/active-directory-developers-guide/Web_API.png)<br />Web API'leri</center> | [ASP.NET](active-directory-b2c-devquickstarts-api-dotnet.md)<br /><br />[Node.js](https://github.com/Azure-Samples/active-directory-b2c-javascript-nodejs-webapi)<br /><br />[.NET web API'si çağırma](active-directory-b2c-devquickstarts-web-api-dotnet.md) | &nbsp; |
