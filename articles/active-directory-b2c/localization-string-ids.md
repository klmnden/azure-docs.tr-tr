...
description: Belirtmek içerik tanımı kimliklerini Azure Active Directory B2C, özel bir ilkede api.signuporsignin kimliği.
...
| Kimlik | Varsayılan değer |
| -- | ------------- |
| **UserMessageIfInvalidPassword** | Yanlış parola girdiniz. |
