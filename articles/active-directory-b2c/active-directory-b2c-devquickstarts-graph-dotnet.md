...
>[!NOTE]
>Şu anda kullanmalıdır [Azure AD Graph API](https://msdn.microsoft.com/Library/Azure/Ad/Graph/howto/azure-ad-graph-api-operations-overview?f=255&MSPPError=-2147217396) Azure AD B2C dizini kullanıcıları yönetme.
