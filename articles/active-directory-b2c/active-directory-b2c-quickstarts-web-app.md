...
1. İş akışını başlatmak için ASP.NET web uygulamasında **Kaydol/Oturum aç**'a tıklayın.
    ...
    ![Örnek ASP.NET web uygulaması tarayıcıda oturum yukarı/oturum bağlantısının vurgulandığı](media/active-directory-b2c-quickstarts-web-app/web-app-sign-in.png)
...
2. Azure AD B2C, özel bir oturum açma sayfası için örnek web uygulaması için Wingtip Toys adlı bir kurgusal markaya sunar. Sosyal kimlik sağlayıcısı kullanarak kaydolmak için, kullanmak istediğiniz kimlik sağlayıcısının düğmesine tıklayın.
    ...
    ![Kimlik sağlayıcısı düğmeleri gösteren oturum açma veya kaydolma sayfası](media/active-directory-b2c-quickstarts-web-app/sign-in-or-sign-up-web.png)
...
1. Uygulamanın menü çubuğunda profil adınıza tıklayın ve oluşturduğunuz profili düzenlemek için **Profili düzenle**’yi seçin.
    ...
    ![Düzenleme profili bağlantısının vurgulandığı ile tarayıcısında örnek web uygulaması](media/active-directory-b2c-quickstarts-web-app/edit-profile-web.png)
...
2. Metni **Yeni Öğe** metin kutusuna girin. Yapılacaklar listesi öğesi ekleyen Azure AD B2C korumalı web API’sini çağırmak için **Ekle**’ye tıklayın.
    ...
    ![Yapılacaklar listesi öğesi ekleme ile tarayıcısında örnek web uygulaması](media/active-directory-b2c-quickstarts-web-app/add-todo-item-web.png)
