...
| --------- | -------- | ----------- |
| Başvuru Kimliği | Evet | Kullanıcı yolculuğu ilkesinde tanımlayıcısı. Daha fazla bilgi için bkz. [kullanıcı yolculuklarından](userjourneys.md) |
