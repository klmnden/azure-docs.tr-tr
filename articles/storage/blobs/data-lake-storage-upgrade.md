---
title: Büyük veri analiz çözümlerinizi Azure Data Lake depolama Gen2 önizlemesi için Azure Data Lake depolama Gen1 ' yükseltme
description: Azure Data Lake depolama Gen2 Önizlemesi'ni kullanmak için çözümünüzün yükseltme
services: storage
author: normesta
ms.topic: conceptual
ms.author: normesta
...
ms.locfileid: "52975364"
---
# <a name="upgrade-your-big-data-analytics-solutions-from-azure-data-lake-gen1-to-azure-data-lake-storage-gen2-preview"></a>Büyük veri analiz çözümlerinizi Azure Data Lake depolama Gen2 önizlemesi için Azure Data Lake Gen1 ' yükseltme

Büyük veri analiz çözümlerinizi Azure Data Lake depolama Gen1 kullanıyorsanız, bu kılavuzda, Azure Data Lake depolama Gen2 Önizlemesi'ni kullanmak için bu çözümleri yükseltmenize yardımcı olur. Bu belge, Data Lake depolama Gen1 üzerinde çözümünüzü olan bağımlılıkları değerlendirmek için kullanabilirsiniz. Bu kılavuzda ayrıca nasıl planlayıp yükseltmek gösterir.
...
|-----------------------|-----------------|----------------------|----------------------------------|
| Verileri düzenleme| Klasörleri ve dosyaları depolanan verileri destekler | Nesnelerin/blobların yanı sıra dosya ve klasörleri - depolanan verileri destekler [bağlantı](https://docs.microsoft.com/azure/storage/data-lake-storage/namespace) | Klasör ve dosya – depolanan verileri destekler *kullanıma sunuldu* nesne/BLOB olarak - depolanan verileri destekler *henüz kullanılamıyor* |
| Ad Alanı| Hiyerarşik ad alanı| Düz ad alanı ve hiyerarşik ad alanları | Düz ad alanı: *kullanıma sunuldu*  |
| API  | HTTPS üzerinden REST API | HTTP/HTTPS üzerinden REST API| *Kullanıma sunuldu* |
| Sunucu tarafı API'si| [WebHDFS ile uyumlu REST API](https://msdn.microsoft.com/library/azure/mt693424.aspx) | Azure Blob hizmeti REST API'si [Data Lake depolama Gen2 REST API](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2) | *Data Lake depolama Gen2 REST API'si – artık kullanılabilir Azure Blob hizmeti REST API'si – henüz kullanılamıyor*       |
| Hadoop dosya sistemi istemci | Evet ([Azure Data Lake depolama](https://hadoop.apache.org/docs/current/hadoop-azure-datalake/index.html)) | Evet ([ABFS](https://jira.apache.org/jira/browse/HADOOP-15407))  | *Kullanıma sunuldu*  |  | [Paylaşılan anahtar](https://docs.microsoft.com/rest/api/storageservices/authorize-with-shared-key), [Azure Active Directory kimlikleriniz](https://docs.microsoft.com/azure/active-directory/active-directory-authentication-scenarios), [paylaşılan erişim imzaları (SAS)](https://docs.microsoft.com/azure/storage/common/storage-dotnet-shared-access-signature-part-1?toc=%2fazure%2fstorage%2fqueues%2ftoc.json) | *Kullanıma sunuldu*  |
...
| Java SDK'sı – dosya sistemi                  | [Bağlantı](https://docs.microsoft.com/java/api/overview/azure/datalakestore/client)                                                                                                                                                                                                                                         | *Henüz kullanılamıyor*                                                | *Henüz kullanılamıyor*                                                                                                                                             |
| Node.js - Yönetim                   | [Bağlantı](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Desteklenmiyor                                                      | *Artık kullanılabilir -* [bağlantı](http://azure.github.io/azure-storage-node/)                                                                                            |
...
| Python – dosya sistemi                    | [Bağlantı](http://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Henüz kullanılamıyor*                                                | *Henüz kullanılamıyor*                                                                                                                                             |
...
| PowerShell - yönetim ve dosya sistemi | [Bağlantı](https://docs.microsoft.com/powershell/module/azurerm.datalakestore/?view=azurermps-6.3.0)                                                                                                                                                                                                                        | Yönetim – dosya sistemi - desteklenmeyen *henüz kullanılamıyor*        | Yönetim – *şimdi - kullanılabilir* [bağlantı](https://docs.microsoft.com/powershell/module/azure.storage/?view=azurermps-6.13.0) dosya sistemi - *henüz kullanılamıyor* |
...
|                      | [HDInsight ](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-hdinsight-hadoop-use-portal)                                                               | [HDInsight](https://docs.microsoft.com/azure/storage/data-lake-storage/quickstart-create-connect-hdi-cluster) 3.6 - *kullanıma sunuldu* HDInsight 4.0 - *henüz kullanılamıyor*      | HDInsight 3.6 ESP – *henüz* HDInsight 4.0 ESP - *henüz kullanılamıyor*                                                                 |
|                      | Databricks çalışma zamanı 3.1 ve üzeri                                                                                                                                               | [Databricks çalışma zamanı 4.2 ve üzeri](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake-gen2.html#azure-data-lake-storage-gen2) *- kullanıma sunuldu* | Databricks çalışma zamanı 5.1 ve üzeri – *artık kullanılabilir*                                                                                              |
...
| Üretkenlik         | [Azure Portal](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Desteklenmiyor*                                                                                                                                                              | Hesap Yönetimi *– artık kullanılabilir* veri işlemleri *–**henüz kullanılamıyor*                                                                    |
...
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Çerçeve analizi | Cloudera     | CDH                  | [Bağlantı](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Henüz kullanılamıyor*                                                                                                  | *Henüz kullanılamıyor*                                                                                                  |
|                     | Cloudera     | Altus                | [Bağlantı](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | NA                                                                                                                   | *Henüz kullanılamıyor*                                                                                                  |
...
| **Kopyalama-bir kez-ve-kopyalama artımlı** | Azure Data Factory                                                                                                    | Yönetilen bir bulut hizmeti                                                                                                                | Artımlı kopyalama ADF'de desteklemek için verilerin bir zaman serisi şekilde düzenlenmesini gerekir. Artımlı kopyalar arasındaki en kısa aralık [15 dakikalık](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger)s. Daha kısa aralıklar için ADF çalışmaz. ACL'ler üzerinden şu anda kopyalanamıyor. |
| **Paralel benimseme**              | [WANdisco](http://docs.wandisco.com/bigdata/wdfusion/adls/)                                                           | Saf bir Hadoop ortamı kullanarak Azure Data Lake depolama alanına bağlıysa destek tutarlı çoğaltma iki yönlü çoğaltmayı destekler. | Bir Hadoop saf ortamı kullanılmıyorsa, Çoğaltmada bir gecikme olabilir.                                                                                                                                                                                                                                                  |

Data Lake depolama Gen2'ye yükseltme için Data Lake depolama Gen1 Yukarıdaki veri/meta-araçları veri kopyalama işlemini karıştırılmaksızın işleyebileceği Üçüncü taraflardan olduğunu unutmayın (örneğin: [Cloudera](http://blog.cloudera.com/blog/2017/08/use-amazon-s3-with-cloudera-bdr/)). Bunlar, veri taşıma ve bunun yanı sıra iş yükü geçişi gerçekleştiren bir "tek" deneyimi sağlar. Kendi ekosistemi dışında olan araçlar için bir bant dışı yükseltme gerçekleştirmek zorunda kalabilirsiniz.
...
* Data Lake depolama Gen2, yalnızca desteklediği en çok 5 TB boyutundaki dosyaları. Data Lake depolama 2. nesil yükseltmek için Data Lake depolama Gen1 dosyalarında, 5 TB boyutunda büyük olacak şekilde yeniden boyutlandırmak gerekebilir.
...
Data Lake depolama Gen2 dosyalara erişmek için URI şeması açıklanan [burada](https://docs.microsoft.com/azure/storage/data-lake-storage/use-hdi-cluster?branch=release-preview-abfs) ayrıntı, ancak genel anlamda içinde olduğu *abfss: / /\<FILE_SYSTEM_NAME\> \@ \< ACCOUNT_NAME\>.dfs.core.widows.net/\<yolu\>.*
