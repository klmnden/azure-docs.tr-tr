...
* [PHP için Azure SDK](https://github.com/Azure/azure-storage-php)’yı yükleme
...
Bu hızlı başlangıçta, dosyaları PHP kullanarak yerel bir disk ile Azure blob depolama arasında aktarmayı öğrendiniz. Blob depolamayla çalışma hakkında daha fazla bilgi edinmek için, Blob depolama nasıl yapılır öğreticisiyle devam edin.

> [!div class="nextstepaction"]
> [Blob Depolama İşlemleri Nasıl Yapılır](./storage-php-how-to-use-blobs.md)
