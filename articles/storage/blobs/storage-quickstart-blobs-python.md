---
title: Azure Hızlı Başlangıç - Python kullanarak nesne depolamada blob oluşturma | Microsoft Docs
...
* [Python için Azure Depolama SDK](https://github.com/Azure/azure-sdk-for-python)’yı indirin ve yükleyin. 
...
Ardından örneği çalıştırın. Aşağıdaki çıktı, uygulama çalıştırılırken döndürülen çıktının bir örneğidir:
...
Blob depolama ile Python geliştirmeye yönelik şu ek kaynaklara bakın:
