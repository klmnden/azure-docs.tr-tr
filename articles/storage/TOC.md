...
## [Dosya Depolama](storage-files-introduction.md)
...
### [Dosya paylaşımı oluşturma](storage-file-how-to-create-file-share.md)
...
### [Azure Search ile Blob deposu arama](../search/search-blob-storage-integration.md)
...
### [IAAS diskler için yedekleme ve DR](storage-backup-and-disaster-recovery-for-azure-iaas-disks.md)
...
### [Veri taşıma](/dotnet/api/microsoft.windowsazure.storage.datamovement)
...
### [Azure Depolama Veri Taşıma Kitaplığı](https://www.nuget.org/packages/Microsoft.Azure.Storage.DataMovement/)
