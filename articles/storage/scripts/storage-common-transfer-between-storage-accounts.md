...
description: "AzCopy kullanarak, bir Azure depolama hesabı içeriğini başka bir konuma kopyalar."
services: storage
...
Bu komut dosyası kaynağı depolama hesabı adı ve anahtar, bir hedef depolama hesap adı ve anahtar ve AzCopy.exe, tam yolu alır. Sonra komut dosyası için hedef depolama hesabı kaynak depolama hesabı, tüm içeriğini kopyalar. Şu anda bu yalnızca Windows üzerinde desteklenir.

[!INCLUDE [sample-powershell-install](../../../includes/sample-powershell-install-no-ssh.md)]

[!INCLUDE [quickstarts-free-trial-note](../../../includes/quickstarts-free-trial-note.md)]

Bu örnek ayrıca gerektirir [AzCopy Windows en son sürümünü](http://aka.ms/downloadazcopy). Varsayılan yükleme dizini`C:\Program Files (x86)\Microsoft SDKs\Azure\AzCopy\`

Bu komut için giriş örneği verilmiştir:
