...
|Azure Backup|Microsoft.RecoveryServices|Yedekleme ve geri yükleme yönetilmeyen disklerin.  [Daha fazla bilgi edinin](https://docs.microsoft.com/azure/backup/backup-introduction-to-azure-backup).|
||||
