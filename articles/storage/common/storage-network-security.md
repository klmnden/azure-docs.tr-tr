...
|:------|:---------------------|:------|
|Azure DevTest Labs|Microsoft.DevTestLab|Özel görüntü oluşturma ve yapı yükleme.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/devtest-lab/devtest-lab-overview).|
|Azure Event Grid|Microsoft.EventGrid|BLOB Storage olay yayımlamayı etkinleştirin.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/event-grid/overview).|
|Azure Event Hubs|Microsoft.EventHub|Olay hub'ları yakalama ile arşiv verileri.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-capture-overview).|
|Azure Hdınsight|Microsoft.HDInsight|Küme hazırlama ve yükleme.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-hadoop-use-blob-storage).|
|Azure Ağı|Microsoft.Networking|Depolama ve ağ trafiği günlüklerini analiz edin.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/network-watcher/network-watcher-packet-capture-overview).|
|Azure SQL Veri Ambarı|Microsoft.Sql|Verileri içeri ve dışarı aktarma.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/sql-data-warehouse/sql-data-warehouse-overview-load#load-from-azure-blob-storage).|
|Azure Backup|Microsoft.RecoveryServices|Yedekleme ve geri yükleme yönetilmeyen disklerin.  [Daha fazla bilgi edinin](https://docs.microsoft.com/en-us/azure/backup/backup-introduction-to-azure-backup).|
||||
