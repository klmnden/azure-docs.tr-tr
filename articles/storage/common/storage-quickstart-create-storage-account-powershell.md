...
Kullanmak istediğiniz konumdan emin değilseniz, kullanılabilir konumları listeleyebilirsiniz. Liste görüntülendikten sonra, kullanmak istediğiniz öğeyi bulun. Bu örnekte **eastus** kullanılır. Bunu bir değişkende depolayın ve tek bir yerde değiştirebilmek için değişkeni kullanın.
...
Dört hizmetin tümü için kullanabileceğiniz bir genel amaçlı standart depolama hesabı oluşturmak için [New-AzureRmStorageAccount](/powershell/module/azurerm.storage/New-AzureRmStorageAccount) kullanın. Depolama hesabını *contosomvcstandard* olarak adlandırın ve Yerel Olarak Yedekli Depolama ve blob şifrelemesi etkin olarak yapılandırın.
