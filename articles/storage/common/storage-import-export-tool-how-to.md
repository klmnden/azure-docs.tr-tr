...
Bu belge en son Azure içeri/dışarı aktarma aracı için sürümüdür. Klasik dağıtım modeli kullanma hakkında daha fazla bilgi için bkz: [Azure içeri/dışarı aktarma aracı v1 kullanarak](storage-import-export-tool-how-to-v1.md).

Aşağıdaki makaleler şunları nasıl yapacağınızı için:  

- Yükleyin ve Azure içeri/dışarı aktarma aracı ayarlamak.
