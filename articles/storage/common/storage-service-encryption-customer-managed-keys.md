...
Bir anahtar kasası yoksa, portaldaki, Powershell veya CLI oluşturabilirsiniz:
...
Var olan bir anahtar kasası kullanıyorsanız, aşağıdaki PowerShell veya Azure CLI komutları yürüterek kasanıza geçici silme ve temizleme değil yapmak etkinleştirmeniz gerekir:
...
Bu anahtar Kasası'nda bir anahtar kasası ve bir anahtar olması gerekir. Anahtar Kasası'ndaki anahtarınız belirtmek için bu adımları izleyin:
