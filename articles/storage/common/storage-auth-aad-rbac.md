---
title: Kapsayıcılar ve kuyrukları RBAC - Azure depolama ile Azure AD erişim haklarını yönetmek için Azure portalını kullanma | Microsoft Docs
...
ms.locfileid: "58368247"
---
# <a name="grant-access-to-azure-containers-and-queues-with-rbac-in-the-azure-portal"></a>Azure kapsayıcıları ve Azure portalında RBAC ile kuyruk için erişim izni ver
...
1. Kapsayıcılar veya sıralara erişim vermek için uygun Azure depolama RBAC rolü atayın. İçin okuma erişimi, atama **Blob verileri okuyucu** veya **kuyruk verileri okuyucu** rol. Okuma, yazma ve silme erişimi atama **Blob verileri katkıda bulunan** veya **kuyruk verileri katkıda bulunan** rol. Ayrıca, özel bir rol atayabilirsiniz.
