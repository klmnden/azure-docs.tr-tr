...
| Desteklenen depolama hesabı türleri                                                                   | GPv1, GPv2, Blob                | GPv1 (PowerShell, Azure CLI veya kaynak sağlayıcısı API) aracılığıyla GPv2                             | GPv1, GPv2, Blob                     | GPv1, GPv2, Blob                     |
