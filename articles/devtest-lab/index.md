        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure DevTest Labs hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Devtest Lab Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure DevTest Labs’i kullanarak VM yapıtları oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure DevTest Labs’i kullanarak eğitim için bir laboratuvar oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/devtest-lab/devtest-lab-use-arm-and-powershell-for-lab-resources">PowerShell: Laboratuvarı otomatik oluşturma veya değiştirme</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Diğer</h3>
                        <p><a href="https://github.com/Azure/azure-devtestlab/tree/master/Samples">Resource Manager şablonları</a></p>
                    </div>
                </div>
            </div>
        </div>
