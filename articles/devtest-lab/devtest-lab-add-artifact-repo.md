...
8. Oluşturulan belirteç kaydedin. Belirteç daha sonra kullanacaksınız.
9. GitHub kapatın.   
...
1. Takım koleksiyonunuz (örneğin, https://contoso-web-team.visualstudio.com) giriş sayfasına gidin ve projenizi seçin.
2. Proje giriş sayfasında seçin **kod**.
3. Projede kopya URL görüntülemek için **kod** sayfasında, **kopya**.
4. URL kaydedin. URL daha sonra kullanacaksınız.
