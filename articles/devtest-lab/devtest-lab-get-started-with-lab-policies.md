...
1. **Yapılandırma ve ilkeleri** dikey belirleyebileceğiniz ayarlar menüsünü içerir. Bu makalede yalnızca ayarlarını kapsar **kullanıcı başına sanal makineler** ve **otomatik kapatma**. Kalan ayarları hakkında bilgi için bkz: [Azure DevTest Labs laboratuvarda yönelik tüm ilkeleri yönetmek](./devtest-lab-set-lab-policy.md). 
