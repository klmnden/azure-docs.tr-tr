...
- [Kalıcı sanal gerçek içeriği](concepts/create-locate-anchors-unity.md#creating-a-cloud-spatial-anchor). Bir uygulamayı sanal bir takvim, kişiler bir telefon uygulaması veya HoloLens cihaz kullanarak görebilir bir Konferans odası nu duvara yansıtabilir, yerleştirin kullanıcı izin verebilirsiniz. Endüstriyel bir ayarda, kullanıcı desteklenen cihaz kamerasına üzerine gelerek bir makine hakkında bağlamsal bilgi alabilir.
