...
- Uygulamanızın sürümünü kullanmalısınız **1.5** (ARCore 1.6 + desteği kullanıma sunulacaktır sonraki bir tarihte) Unity için ARCore SDK'sının.
