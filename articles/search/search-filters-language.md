---
title: Azure Arama'da dil filtreleri | Microsoft Docs
description: Filtre ölçütü kullanıcı güvenlik kimliği, dil, coğrafi konum ya da sorgular, Azure arama, Microsoft Azure üzerinde barındırılan bulut arama hizmeti üzerinde arama sonuçları azaltmak için sayısal değerler.
author: HeidiSteen
manager: cgronlun
services: search
ms.service: search
