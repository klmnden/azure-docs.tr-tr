...
Bir skillset becerileri bir dizi tanımlanır. Her yetenek girdilerinden kaynağı ve üretilen çıkış adını tanımlar. Kullanarak [Skillset REST API'si oluşturma](https://docs.microsoft.com/rest/api/searchservice/create-skillset), önceki diyagrama karşılık gelen bir skillset tanımlayabilirsiniz: 
