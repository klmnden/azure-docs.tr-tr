---
title: İşlem ve Azure Search görüntülerinden metni Ayıkla | Microsoft Docs
...
|--------------------|-----------------------------------------|
| veri               | BASE64 kodlamalı dize JPEG biçiminde bir normalleştirilmiş görüntüsü.   |
