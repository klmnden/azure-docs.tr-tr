...
description: HTTP komutları ve Azure Search'te bir arama sorgusu oluşturmak için REST API kod. Arama sonuçlarını filtrelemek ve sıralamak için arama parametrelerini ekleyin.
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
