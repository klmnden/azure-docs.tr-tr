...
| XLS (uygulama/vnd.ms-excel) |`metadata_content_type`<br/>`metadata_author`<br/>`metadata_creation_date`<br/>`metadata_last_modified` |Ekli belgelerin dahil olmak üzere, metni Ayıkla |
