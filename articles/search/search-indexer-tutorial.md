...
4. Bu adı kopyalayın ve Visual Studio'da ilk girdi olarak **appsettings.json** dosyasına yapıştırın.
  ...
  > [!Note]
  > Hizmet adı, search.windows.net'i içeren uç noktanın bir parçasıdır. Merak ediyorsanız, tam URL'yi Genel Bakış sayfasındaki **Temel Bileşenler**'de görebilirsiniz. URL şu örneğe benzer: https://hizmet-adınız.search.windows.net
