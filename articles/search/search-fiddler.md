<properties
    pageTitle="Azure Search REST API'lerini değerlendirmek ve test etmek için Fiddler'ı kullanma | Microsoft Azure | Barındırılan bulut arama hizmeti"
...
3. **Oluşturucu** sekmesinde, aşağıdaki ekran görüntüsü gibi görünen bir istek düzenleyin.

    ![][1]

2. **PUT**'u seçin.

3. Hizmet URL'sini, istek özniteliklerini ve api sürümünü belirten bir URL girin. Dikkate alınması gereken birkaç işaretçi:
