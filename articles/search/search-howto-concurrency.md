...
Bu kod parçacığı bir synonymMap zaten bir dizine eklenmesi gösterilmektedir. Bu kod dandır [eş anlamlı (Önizleme) C# Azure Search örneğin](https://docs.microsoft.com/azure/search/search-synonyms-example-sdk).
