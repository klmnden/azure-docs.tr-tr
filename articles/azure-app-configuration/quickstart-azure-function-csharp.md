...
Bu hızlı başlangıç yapmak için yükleme [Visual Studio 2019](https://visualstudio.microsoft.com/vs). Emin olun **Azure geliştirme** iş yükü de yüklenir. Ayrıca yükleme [en son Azure işlevleri Araçları](../azure-functions/functions-develop-vs.md#check-your-tools-version).
