...
Bu hızlı başlangıç yapmak için yükleme [Visual Studio 2019](https://visualstudio.microsoft.com/vs) ve [.NET Framework 4.7.1](https://dotnet.microsoft.com/download) veya henüz yapmadıysanız sonraki bir sürümü.
