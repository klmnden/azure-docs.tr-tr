...
| [az appconfig oluşturma](/cli/azure/ext/appconfig/appconfig#ext-appconfig-az-appconfig-create) | Bir uygulama yapılandırma deposu kaynağı oluşturur. |
| [az appconfig anahtar listesi](/cli/azure/ext/appconfig/appconfig/key#ext-appconfig-az-appconfig-key-list) | Bir uygulama yapılandırma deposu içinde depolanan anahtarları listesi. |
