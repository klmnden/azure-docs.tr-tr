...
Bu hızlı başlangıcı tamamlamak için desteklenen bir yükleme [Java Development Kit (JDK)](https://aka.ms/azure-jdks) sürüm 8 ile ve [Apache Maven](http://maven.apache.org/) sürüm 3.0 veya üzeri.
