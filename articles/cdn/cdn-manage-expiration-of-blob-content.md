...
[Azure PowerShell](/powershell/azure/overview) Azure hizmetlerinizi yönetmek için en hızlı ve en güçlü yollarından biridir. Kullanım `Get-AzureStorageBlob` blob başvurusu almak için cmdlet ayarlayın `.ICloudBlob.Properties.CacheControl` özelliği. 
