...
[Azure Portal](http://portal.azure.com)’da oturum açın. Akışınız için CDN yoksa zaten etkinleştirdiğiniz varsa [bir Azure CDN profili ve uç noktası oluşturma](cdn-create-new-endpoint.md) devam etmeden önce.
