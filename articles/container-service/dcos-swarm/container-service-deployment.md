...
* **Hizmet sorumlusu istemci kimliği ve parolası** (yalnızca Kubernetes): Azure Active Directory Hizmet sorumlusu oluşturma hakkında bilgi ve yönergeler için bkz. [Kubernetes kümelerinde hizmet sorumlusu hakkında](../kubernetes/container-service-kubernetes-service-principal.md).
