...
---
# <a name="create-an-azure-container-service-kubernetes-windows-cluster"></a>Bir Azure kapsayıcı hizmeti Kubernetes Windows kümesi oluşturma

Bu örnek Kubernetes için Windows tabanlı kapsayıcıları çalıştıran bir Azure kapsayıcı hizmeti kümesi oluşturur.
...
| [acs az oluşturma](https://docs.microsoft.com/cli/azure/acs#az_acs_create) | Oluşturur ve ACS küme. |
