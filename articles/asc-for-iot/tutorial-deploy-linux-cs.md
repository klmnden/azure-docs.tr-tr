---
title: Yüklemek ve Linux'ı dağıtmak için öğretici C# IOT Önizleme için Azure Güvenlik Merkezi Aracısı | Microsoft Docs
...
ms.locfileid: "58541617"
---
# <a name="tutorial-deploy-asc-for-iot-c-based-security-agent-for-linux"></a>Öğretici: ASC dağıtmak için IOT C#-Linux için aracıyı güvenlik tabanlı

> [!IMPORTANT]
> ASC IOT için şu anda genel Önizleme aşamasındadır.
> Önizleme sürümü bir hizmet düzeyi sözleşmesi olmadan sağlanır ve üretim iş yüklerinde kullanılması önerilmez. Bazı özellikler desteklenmiyor olabileceği gibi özellikleri sınırlandırılmış da olabilir. Daha fazla bilgi için bkz. [Microsoft Azure Önizlemeleri için Ek Kullanım Koşulları](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).

Bu öğreticide, yüklemek ve IOT için ASC dağıtmak açıklanmaktadır C#-Linux güvenlik aracı tabanlı.
