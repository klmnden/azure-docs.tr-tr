...
Edge aracısı ve kenar hub IOT kenar çalışma zamanı yapmak iki modüllerdir. Her modülü gerçekleştirir hangi görevleri hakkında daha fazla bilgi için bkz. [Azure IOT kenar çalışma zamanı ve kendi architecture]](iot-edge-runtime.md) anlayın. 
