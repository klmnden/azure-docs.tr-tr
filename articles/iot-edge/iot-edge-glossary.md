---
title: "Azure IOT kenar terimler sözlüğü | Microsoft Docs"
description: "Kavramlar - Azure IOT kenarına ilgili ortak terimleri içeren sözlük."
services: iot-hub
...
* IOT kenar öğrenin [modülü geliştirme](https://docs.microsoft.com/en-us/azure/iot-edge/iot-edge-modules)
* IOT kenar öğrenin [dağıtımı](https://docs.microsoft.com/en-us/azure/iot-edge/module-deployment-monitoring)
