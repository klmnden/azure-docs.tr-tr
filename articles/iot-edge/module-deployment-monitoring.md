---
title: İçin Azure IOT Edge modüllerini dağıtmak | Microsoft Docs
description: Modülleri nasıl uç cihazlarına dağıtıldığı hakkında bilgi edinin
author: kgremban
manager: timlt
ms.author: kgremban
ms.date: 09/27/2018
...
Bu makalede, yapılandırma ve dağıtım izleme alan her bir bileşeni açıklar. Oluşturma ve dağıtımı güncelleştirme yönergeleri için bkz [dağıtma ve izleme uygun ölçekte IOT Edge modülleri][lnk-howto].
...
* Oluşturmak, güncelleştirmek veya bir dağıtımda silmek için adımlarında yol [dağıtma ve izleme uygun ölçekte IOT Edge modülleri][lnk-howto].
* Gibi diğer IOT Edge kavramları hakkında daha fazla bilgi [IOT Edge çalışma zamanı] [ lnk-runtime] ve [IOT Edge modülleri][lnk-modules].
