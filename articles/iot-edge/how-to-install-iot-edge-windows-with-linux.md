...
Güncelleştirme **workload_uri** ve **management_uri** içinde **bağlanın:** yapılandırma dosyasının. **\<GATEWAY_ADDRESS\>** değerini, kopyaladığınız DockerNAT IP adresiyle değiştirin. 
