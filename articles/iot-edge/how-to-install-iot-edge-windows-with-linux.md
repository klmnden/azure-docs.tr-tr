---
title: Azure IOT Edge üzerinde Windows ile Linux kapsayıcıları yükleyin. | Microsoft Docs
description: Linux kapsayıcıları için yapılandırılmış Windows cihazlarda Azure IOT Edge yükleme yönergeleri
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
