---
title: Hata ayıklama başarısız Azure Data Lake U-SQL işleri için kullanıcı tanımlı C# kodu
description: Bu makalede, Visual Studio için Azure Data Lake Araçları'nı kullanarak U-SQL başarısız köşe hata ayıklama açıklar.
