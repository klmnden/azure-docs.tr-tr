---
title: Azure Data Lake Analytics Belgeleri - Öğreticiler, API Başvurusu
description: Azure Data Lake Analytics ile büyük veri analizi yapmayı öğrenin. Öğreticilerde toplu, gerçek zamanlı ve etkileşimli analiz çalıştırma ve U-SQL sorguları yazma hakkında bilgi sağlanmıştır.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Data Lake Analytics hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Data Lake Analytics Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure portalı kullanarak Azure Data Lake Analytics ile çalışmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="manage-data-lake-analytics"></a>Data Lake Analytics'i yönetme
<table>
    <tr>
        ...
        <td><a href="data-lake-analytics-get-started-python.md">Python SDK'sı</a></td>
    </tr>
</table>
