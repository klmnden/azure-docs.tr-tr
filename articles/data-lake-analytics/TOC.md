...
### U-SQL dili
#### [Temel Bilgiler](data-lake-analytics-u-sql-get-started.md)
#### [Dil başvurusu](https://msdn.microsoft.com/library/azure/mt591959)
#### [Katalog](data-lake-analytics-u-sql-catalog.md)
#### [Kullanıcı tanımlı işleçler](data-lake-analytics-u-sql-develop-user-defined-operators.md)
#### [Python uzantıları](data-lake-analytics-u-sql-python-extensions.md)
#### [R uzantıları](data-lake-analytics-u-sql-r-extensions.md)
...
## [Resource Manager Şablonu](/azure/templates/microsoft.datalakeanalytics/allversions)
