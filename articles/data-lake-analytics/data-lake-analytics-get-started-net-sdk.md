...
6. Uygulamayı çalıştırmak için **F5**'e basın. Çıktı şu şekildedir:
...
7. Çıktı dosyasını denetleyin.  Varsayılan yol ve dosya adı c:\Temp\SearchLog-from-Data-Lake.csv şeklindedir.
