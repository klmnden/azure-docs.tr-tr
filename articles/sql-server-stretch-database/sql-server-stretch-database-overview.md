...
## <a name="what-does-stretch-database-do"></a>Esnetme Veritabanı ne yapar?
...
## <a name="is-stretch-database-for-you"></a>Esnetme Veritabanı sizin için uygun mu?
...
## <a name="what-kind-of-databases-and-tables-are-candidates-for-stretch-database"></a>Ne tür veritabanları ve tablolar Esnetme Veritabanı için aday niteliği taşır?
...
## <a name="test-drive-stretch-database"></a>Esnetme Veritabanı'nda test kullanımı
