...
![Çalışma kitapları için Gezinti bölmesinin ekran görüntüsü](./media/app-insights-usage-workbooks/001-workbooks.png)
...
![Çalışma kitabı galeri görüntüsü](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

İle başlayacağız **varsayılan şablon**, başlığı altında bulunan **Hızlı Başlangıç**.

![Çalışma kitabı galeri görüntüsü](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![Sorgu bölümünde çalışma kitapları](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
Her bölüm ayarlar simgesi erişilebilir kendi Gelişmiş ayarları olan ![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/005-settings.png) sağında bulunan **parametreleri ekleme** düğmesi.

![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/003-active-users.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/004-active-users-trend.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/009-time-range.png)

Bu düzen parametresi menü öğesi başlatılır:

![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Application Insights çalışma kitapları bölümünde düzenleme denetimleri](./media/app-insights-usage-workbooks/011-data-table.png)
...
![Ülke açılan kutusu](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![Ülke açılan kutusu](./media/app-insights-usage-workbooks/013-resource-picker.png)
