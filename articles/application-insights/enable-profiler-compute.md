...
1. [Yeni bir Application Insights kaynağı oluşturma](https://docs.microsoft.com/en-us/azure/application-insights/app-insights-create-new-resource), veya varolan bir tanesini seçin. 
