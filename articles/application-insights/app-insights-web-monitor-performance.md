...
![Daha fazla veri için tıklayın ve bir zaman aralığı seçin](./media/app-insights-web-monitor-performance/appinsights-48metrics.png)

Bir grafik hangi ölçümleri, görüntüler, veya yeni bir grafik ekleyin ve kendi ölçümleri'ni seçin'i seçmek için tıklayın:

![Ölçümler seçmek için bir grafiğe tıklayın](./media/app-insights-web-monitor-performance/appinsights-61perfchoices.png)
...
![Tüm kümesini görmek için tüm ölçümlerin seçimini kaldırın](./media/app-insights-web-monitor-performance/appinsights-62allchoices.png)
...
![GET Customers/Details 7 günde üç süresi ani bir zaman penceresi ile aralığı](./media/app-insights-web-monitor-performance/PerformanceTriageView7DaysZoomedTrend.png)
...
![GET Customers/Details 7 günde üç süresi ani bir zaman penceresi ile aralığı](./media/app-insights-web-monitor-performance/PerformanceTriageView7DaysZoomedTrendZoomed95th99th.png)
...
![GET Customers/Details 7 günde üç süresi ani bir zaman penceresi ile aralığı](./media/app-insights-web-monitor-performance/SlowDependencies95thTrend.png)
...
![GET Customers/Details 7 günde üç süresi ani bir zaman penceresi ile aralığı](./media/app-insights-web-monitor-performance/Performance30DayOveralllnsights.png)
