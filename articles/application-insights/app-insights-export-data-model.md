...
ms.locfileid: "52723457"
---
# <a name="application-insights-export-data-model"></a>Application Insights dışa aktarma veri modeli
Bu tabloda gönderilen telemetri özelliklerinin [Application Insights](app-insights-overview.md) SDK'ları portalı.
Bu özellikler, veri çıkışı görürsünüz [sürekli dışarı aktarma](app-insights-export-telemetry.md).
Ayrıca özellik filtrelerini görünürler [ölçüm Gezgini'nde](app-insights-metrics-explorer.md) ve [tanılama araması](app-insights-diagnostic-search.md).
...
| Yol | Tür | Notlar |
| --- | --- | --- |
| [0] olay sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin, 4 =&gt; % 25. |
...
Raporları [özel durumları](app-insights-asp-net-exceptions.md) sunucunun ve tarayıcı.

| Yol | Tür | Notlar |
| --- | --- | --- |
| basicException [0] derlemesi |dize | |
| [0] basicException sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin, 4 =&gt; % 25. |
...
Tarafından gönderilen [TrackTrace](app-insights-api-custom-events-metrics.md#tracktrace)ve bunun [günlük bağdaştırıcıları](app-insights-asp-net-trace-logs.md).
...
TrackDependency tarafından gönderilir. Rapor performansını ve kullanımını için kullanılan [bağımlılıklara yapılan çağrıları](app-insights-asp-net-dependencies.md) sunucu ve tarayıcıda AJAX çağrıları.
...
| [0] remoteDependency sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin, 4 =&gt; % 25. |
...
Tarafından gönderilen [TrackRequest](app-insights-api-custom-events-metrics.md#trackrequest). Standart modülleri bu sunucuda ölçülen raporları sunucu yanıt süresi için kullanın.

| Yol | Tür | Notlar |
| --- | --- | --- |
| [0] istek sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin: 4 =&gt; % 25. |
...
| Yol | Tür | Notlar |
| --- | --- | --- |
| [0] görüntüleme sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin, 4 =&gt; % 25. |
...
| Kullanılabilirlik [0] sayısı |integer |100 / ([örnekleme](app-insights-sampling.md) oranı). Örneğin, 4 =&gt; % 25. |
...
Önceden toplama ölçümleri yerine kullanabileceğiniz [örnekleme](app-insights-sampling.md) telemetri hacmini azaltmak gerekiyorsa.
