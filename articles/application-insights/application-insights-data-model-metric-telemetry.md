...
ms.locfileid: "35648463"
---
# <a name="metric-telemetry-application-insights-data-model"></a>Ölçüm telemetri: Application Insights veri modeli

Ölçüm telemetri tarafından desteklenen iki tür vardır [Application Insights](app-insights-overview.md): tek bir ölçüm ve önceden toplanmış ölçümü. Yalnızca bir ad ve değer bunun tek ölçümüdür. Önceden toplanmış ölçüm toplama aralığı ve standart sapmasını ölçüm minimum ve maksimum değerini belirtir.
...
- Nasıl kullanacağınızı öğrenin [özel olaylar ve ölçümler için Application Insights API](app-insights-api-custom-events-metrics.md#trackmetric).
