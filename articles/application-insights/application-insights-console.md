...
> [!NOTE]
> Başvuru yönergeleri **Applicationınsights.config** .NET Standard hedeflediğiniz ve .NET Core uygulamaları için geçerli değildir uygulamalar yalnızca geçerlidir. 
