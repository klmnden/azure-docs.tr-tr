...
1. Visual Studio'da web uygulaması projenizin NuGet paketlerini düzenleyin.
    ...
    ![Projeye sağ tıklayın ve Nuget Paketlerini Yönet’i seçin](./media/app-insights-asp-net-manual/03-nuget.png)

2. Web Apps için Application Insights SDK’sı yükleme

    !["Application Insights" araması yapın](./media/app-insights-asp-net-manual/04-ai-nuget.png)
...
![Visual Studio kullanarak uygulamanızı yayımlama](./media/app-insights-asp-net-manual/15-publish.png)
...
## Bağımlılık izleme (ve IIS performans sayaçları) ekleme
...
![Web uygulamanızda Ayarlar, Uzantılar, Ekle, Application Insights](./media/app-insights-asp-net-manual/05-extend.png)
...
![Web uygulamanızda Hızlı Başlangıç’ı açın ve 'Web sayfalarımı izlemeyi sağlayan kodu al' seçeneğine tıklayın](./media/app-insights-asp-net-manual/02-monitor-web-page.png)
...
![ASP.NET projesi oluşturma](./media/app-insights-asp-net-manual/appinsights-01-vsnewp1.png)
...
Projenizde web sayfaları varsa [JavaScript SDK’sını][istemci] da web sayfasına ekler.

#### ... veya mevcut bir projeyse

Çözüm Gezgini'nde projeye sağ tıklayın ve **Application Insights Ekle**’yi seçin.

![Application Insights Ekle’yi seçme](./media/app-insights-asp-net-manual/appinsights-03-addExisting.png)

Visual Studio, Application Insights'ta bir kaynak oluşturur, SDK’yı projenize ekler ve anahtarı `.config` dosyasına yerleştirir.

Bu durumda [JavaScript SDK’sı][istemci] web sayfalarınıza eklenmez; bunu sonraki adımda yapmanız önerilir.
...
![Projenize sağ tıklayıp Azure portalını açın](./media/app-insights-asp-net-manual/appinsights-04-openPortal.png)
...
[istemci]: app-insights-javascript.md
