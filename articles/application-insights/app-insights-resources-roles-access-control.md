...
* **Kaynak** - Microsoft Azure hizmet örneğini bir. Application Insights kaynağınıza toplar, çözümler ve uygulamanızdan gönderilen telemetri verilerini görüntüler.  Diğer Azure kaynak türlerini, web uygulamaları, veritabanları ve VM'ler içerir.
    ...
    ![Azure kaynaklarının listesi](./media/app-insights-resources-roles-access-control/10-browse.png)
...
![Azure portalında erişim ekran denetimi düğmesi](./media/app-insights-resources-roles-access-control/0001-access-control.png)

Seçin **Ekle**

![Ekle düğmesi kırmızı renkte vurgulanmış ekran erişim denetimi menüsü](./media/app-insights-resources-roles-access-control/0002-add.png)
...
![Ekran görüntüsü, erişim denetim kullanıcı rolü listesi](./media/app-insights-resources-roles-access-control/0003-user-roles.png)
