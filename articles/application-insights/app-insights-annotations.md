...
![AT sağ üst köşesinde Azure DevOps hizmetler web sayfası, açık Market. Azure DevOps Services'i seçin ve sonra Azure işlem hatlarını altında daha fazla seçin.](./media/app-insights-annotations/10.png)
...
4. Ayrı bir tarayıcı penceresi açın (veya oluşturun) Azure DevOps Services'den dağıtımlarınızı yöneten sürüm şablonu. 
    ...
    ![Azure DevOps Hizmetleri'nde, yayın açın, bir yayın ardışık düzeni'ni seçin ve Düzenle'yi seçin. Görev Ekle tıklayın ve Application Insights sürüm ek açıklamasının'ı seçin. Application Insights kimliğini yapıştırın](./media/app-insights-annotations/30.png)
...
6. Yayın şablonu yapılandırma sekmesini açın.
    ...
    ![Azure DevOps Hizmetleri penceresinde, yapılandırma sekmesini seçin ve değişken Ekle'a tıklayın. ApiKey ve değerine ayarlayın, yalnızca oluşturulan anahtarı yapıştırın ve kilit simgesine tıklayın.](./media/app-insights-annotations/50.png)
