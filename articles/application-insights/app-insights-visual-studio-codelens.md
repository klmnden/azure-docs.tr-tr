<properties 
    pageTitle="Visual Studio CodeLens’te Application Insights telemetrisi | Microsoft Azure" 
...
> [AZURE.NOTE] CodeLens içinde Application Insights, Visual Studio 2015 Güncelleştirme 3 ve üstü ya da [Developer Analytics Tools uzantısının](https://visualstudiogallery.msdn.microsoft.com/82367b81-3f97-4de1-bbf1-eaf52ddc635a) en sürümleri ile birlikte kullanılabilir. CodeLens, Visual Studio’nun Enterprise ve Professional sürümlerinde kullanılabilir.

## Application Insights verileri nerede bulunur
...
> [AZURE.TIP] Diğer CodeLens göstergelerinin görünmesinden önce Application Insights istek ve özel durum göstergelerinin yüklenmesi birkaç saniye daha sürebilir.

## CodeLens’teki özel durumlar
