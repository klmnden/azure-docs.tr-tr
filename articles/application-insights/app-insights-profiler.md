...
Profiler, şu anda Azure App Service üzerinde çalışan ASP.NET ve ASP.NET Core uygulamaları için çalışır. Temel Hizmet katmanını veya üzeri Profiler'ı kullanmak için gerekli değildir. Linux üzerinde Profiler'ı etkinleştirmek şu anda yalnızca aracılığıyla olası [bu yöntem](app-insights-profiler-aspnetcore-linux.md).
