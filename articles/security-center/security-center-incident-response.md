---
title: Olay Yanıtı için Azure Güvenlik Merkezi’nden Yararlanma | Microsoft Docs
...
1. **Güvenlik Uyarıları** kutucuğuna tıklamış ve **Güvenlik Uyarıları** dikey penceresine erişmiştir.
   ...
   > [!NOTE]
   > Bu senaryoda Meltem, yukarıdaki şekilde görünen Kötü Amaçlı SQL etkinliği uyarısı üzerinde bir değerlendirme yapacaktır. 
   > 
   > 
