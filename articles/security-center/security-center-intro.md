<properties
   pageTitle="Azure Güvenlik Merkezi'ne Giriş | Microsoft Azure"
...
> [AZURE.NOTE] Bu belgedeki bilgiler Azure Güvenlik Merkezi önizleme sürümü için geçerlidir. Bu belge, örnek bir dağıtım kullanarak hizmeti tanıtır.
...
> [AZURE.NOTE] Abonelik düzeyinde veya kaynak grubu düzeyinde bir güvenlik ilkesini değiştirmek için, aboneliğin Sahibi veya Katılımcısı olmanız gerekir.
...
> [AZURE.NOTE] Veri toplama ve her bölge için bir depolama hesabı seçme, abonelik düzeyinde yapılandırılır.
