...
1. Azure Portal'da, IP adresi sınırlamaları eklemek istediğiniz mantıksal uygulama açın
2. Tıklatın **erişim denetimini yapılandırma** menü öğesi altında **ayarları**
3. IP adresi aralıkları için içeriğe erişimi için bir liste belirtin
