...
Her iki işlev aynı şekilde çalışır ancak `decodeDataUri()` tercih edilir.
...
| <*startIndex*> | Evet | Tamsayı | Başlangıç konumu veya dizin değeri olarak kullanmak istediğiniz 0'dan büyük veya eşit pozitif bir sayı |
