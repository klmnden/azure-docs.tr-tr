...
| Yönü | Enum | İleti akış yönünü alma veya gönderme. (Zorunlu) |
...
| isMessageFailed | Boole değeri | Olup olmadığını X12 ileti başarısız oldu. (Zorunlu) |
| isTechnicalAcknowledgmentExpected | Boole değeri | Teknik Bildirim X12 yapılandırılmış olup olmadığı anlaşma. (Zorunlu) |
| isFunctionalAcknowledgmentExpected | Boole değeri | İşlev bildirim X12 yapılandırılmış olup olmadığı anlaşma. (Zorunlu) |
| needAk2LoopForValidMessages | Boole değeri | AK2 döngü için geçerli bir ileti gerekli olup olmadığı. (Zorunlu) |
