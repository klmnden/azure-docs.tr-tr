...
description: Oluşturun ve Visual Studio code'da (VS Code) mantıksal uygulamaları yönetme
services: logic-apps
...
* Mantıksal uygulama hakkında temel bilgilere [iş akışı tanımları](../logic-apps/logic-apps-workflow-definition-language.md) ve JavaScript nesne gösterimi (JSON) kullanır, yapısı
