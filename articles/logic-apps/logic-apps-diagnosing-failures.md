...
description: Logic apps nasıl ve neden başarısız anlama
services: logic-apps
documentationcenter: ''
author: jeffhollan
manager: jeconnoc
...
---
# <a name="troubleshoot-and-diagnose-logic-app-failures"></a>Mantıksal uygulama hatalarını tanılama ve giderme
