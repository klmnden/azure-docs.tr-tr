...
|encodeUriComponent|URL çıkışları geçirilen dize. Örneğin, bu işlevi döndürür `You+Are%3ACool%2FAwesome`: <p>`encodeUriComponent('You Are:Cool/Awesome')` <p> **Numaralı parametre**: 1 <p> **Ad**: dize <p> **Açıklama**: gerekli. URL güvenli olmayan karakterler kaçınmak için dize.|  
|decodeUriComponent|Kaydını URL çıkışları geçirilen dize. Örneğin, bu işlevi döndürür `You Are:Cool/Awesome`: <p>`decodeUriComponent('You+Are%3ACool%2FAwesome')` <p> **Numaralı parametre**: 1 <p> **Ad**: dize <p> **Açıklama**: gerekli. URL güvenli olmayan karakterler çözecek dizesi.|  
