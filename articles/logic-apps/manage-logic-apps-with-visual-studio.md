---
title: Visual Studio - Azure Logic Apps kullanarak mantıksal uygulamaları yönetme
...
1. Bulut Gezgini'nde **hesap yönetimi**. Logic apps ile ilişkili Azure aboneliği seçin ve ardından **Uygula**. Örneğin:

   !["Hesap Yönetimi" seçin](./media/manage-logic-apps-with-visual-studio/account-management-select-Azure-subscription.png)

1. Bağlı olup olmadığını tarafından aramakta olduğunuz üzerinde **kaynak grupları** veya **kaynak türleri**, şu adımları izleyin:
...
1. Mantıksal uygulamanın kısayol menüsünde **Logic App Düzenleyicisi ile açın**.
...
1. Belirli bir çalıştırma ayrıntılarını görüntülemek için bir çift tıklayın. Örneğin:
...
1. Adımları, giriş ve çıkışları gözden geçirmek istediğiniz genişletin. Örneğin:
