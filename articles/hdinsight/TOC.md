...
## [Etkileşimli Sorgu’yu kullanmaya başlama](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Azure PowerShell’i kullanma](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Azure PowerShell’i kullanma](hdinsight-hadoop-use-mapreduce-powershell.md)
#### [Uzak Masaüstü kullanma](hdinsight-hadoop-use-mapreduce-remote-desktop.md)
#### [.NET SDK’yı kullanma](hdinsight-hadoop-use-mapreduce-dotnet-sdk.md)
...
#### [Azure PowerShell’i kullanma](hdinsight-hadoop-use-pig-powershell.md)
...
#### [Java topolojileri ile olayları işleme](https://azure.microsoft.com/resources/samples/hdinsight-java-storm-eventhub/)
...
## Etkileşimli Sorgu’yu kullanma
### [Hive sorguları çalıştırmak için Zeppelin’i kullanma](hdinsight-connect-hive-zeppelin.md)
## Geliştirme
...
### [HDInsight VSCode aracını kullanma](hdinsight-for-vscode.md)
## Büyük verileri çözümleme
### [Power Query kullanarak çözümleme](hdinsight-connect-excel-power-query.md)
### [Power BI’ı Hadoop’a Bağlama](hdinsight-connect-hive-power-bi.md)
...
#### [Azure PowerShell’i kullanarak çalıştırma](hdinsight-hadoop-use-sqoop-powershell.md)
