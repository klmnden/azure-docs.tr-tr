...
3. Tıklayın **Kaydet** yapılandırma değişikliklerini kaydetmek için. Sayfanın üst kısmında etkilenen tüm hizmetleri yeniden başlatmanız istenir. Tıklayın **yeniden**.
