---
title: 'Öğretici: HDInsight’ta Spark makine öğrenimi uygulaması derleme | Microsoft Docs'
...
> [IntelliJ kullanarak Scala Maven uygulaması oluşturma](./apache-spark-create-standalone-application.md)
