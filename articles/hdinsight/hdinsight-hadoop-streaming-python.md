...
[!code-powershell[Ana](../../powershell_scripts/hdinsight/streaming-python/streaming-python.ps1?range=138-140)]

Dosyaları karşıya yükleme, işini çalıştırın ve çıktıyı görüntülemek için aşağıdaki PowerShell betiğini kullanın:

[!code-powershell[Ana](../../powershell_scripts/hdinsight/streaming-python/streaming-python.ps1?range=5-134)]
