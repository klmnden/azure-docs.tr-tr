...
* (İsteğe bağlı) Yerel bir Storm geliştirme ortamı. Yerel bir Storm ortam yalnızca topoloji yerel olarak çalıştırmak istiyorsanız gereklidir. Daha fazla bilgi için bkz: [bir geliştirme ortamını ayarlama](http://storm.apache.org/releases/1.0.1/Setting-up-development-environment.html).
...
* [MapReduce işleri akış için Python kullanma](hdinsight-hadoop-streaming-python.md)
* [Python kullanıcı tanımlı işlevler (UDF), Pig ve Hive kullanma](hdinsight-python.md)
