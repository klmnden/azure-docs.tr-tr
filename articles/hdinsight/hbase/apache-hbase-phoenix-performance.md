...
ms.locfileid: "52308231"
---
# <a name="apache-phoenix-performance-best-practices"></a>Apache Phoenix performansı en iyi uygulamalar

En önemli yönüyle [Apache Phoenix](https://phoenix.apache.org/) performansı, arka plandaki en iyi duruma getirme [Apache HBase](http://hbase.apache.org/). Phoenix, ilişkisel bir veri modeli üzerine taramalar gibi HBase işlemlerini SQL sorguları dönüştürür HBase oluşturur. Tablo şemanızı, seçim ve birincil anahtarınızı ve tüm dizinleri kullanımınız alanların sıralamasını tasarım, Phoenix performansı etkiler.
