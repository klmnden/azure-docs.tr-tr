...
* [Hdınsight'ta Linux tabanlı Hadoop erişim YARN uygulama günlüklerini](hdinsight-hadoop-access-yarn-app-logs-linux.md)
...
* [Azure hdınsight'ta Hadoop bileşenleri için sürüm notları](hdinsight-release-notes.md)
