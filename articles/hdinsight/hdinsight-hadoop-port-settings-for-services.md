...
> [!IMPORTANT]
> Bazı hizmetler, aynı anda yalnızca bir headnode üzerinde çalıştırın. Birincil headnode hizmetine bağlanmak ve bir hata alıyorsunuz çalışırsanız, ikincil headnode kullanarak yeniden deneyin.
