...
| Araçlar | - [Tez işlerinde hata ayıklamak için Ambari görünümleri kullanma](hdinsight-debug-ambari-tez-view.md)<br>- [Hive sorguları en iyi duruma getirme](hdinsight-hadoop-optimize-hive-query.md)<br>- [Hdınsight Intellij aracı](./spark/apache-spark-intellij-tool-plugin.md)<br>- [Hdınsight Eclipse aracı](./spark/apache-spark-eclipse-tool-plugin.md)<br>- [Hdınsight VSCode aracı](hdinsight-for-vscode.md)<br>- [Hdınsight Visual Studio aracı](./hadoop/apache-hadoop-visual-studio-tools-get-started.md) |
