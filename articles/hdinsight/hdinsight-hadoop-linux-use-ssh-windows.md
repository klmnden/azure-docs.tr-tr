---
title: "Windows’da Linux tabanlı kümelerde Hadoop’ta SSH anahtarları kullanma | Microsoft Belgeleri"
...
---
# <a name="use-ssh-with-linuxbased-hadoop-on-hdinsight-from-windows"></a>Windows’da HDInsight’ta Linux tabanlı Hadoop ile SSH kullanma
...
> [!NOTE]
> Bu makaledeki adımlarda Windows tabanlı istemci kullandığınız varsayılır. Linux, Unix ya da OS X kullanıyorsanız, bkz. [Linux, Unix ya da OS X’te HDInsight’ta Linux tabanlı Hadoop ile SSH kullanma](hdinsight-hadoop-linux-use-ssh-unix.md).
> 
