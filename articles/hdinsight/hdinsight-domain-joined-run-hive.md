---
title: "Etki alanına katılmış HDInsight’ta Hive ilkelerini yapılandırma | Microsoft Belgeleri"
description: "Öğrenin ...."
services: hdinsight
documentationcenter: 
author: saurinsh
...
---
# <a name="configure-hive-policies-in-domainjoined-hdinsight-preview"></a>Etki alanına katılmış HDInsight’ta (Önizleme) Hive ilkelerini yapılandırma
...
[Etki alanına katılmış HDInsight kümelerini yapılandırma](hdinsight-domain-joined-configure.md#create-and-configure-azure-ad-ds-for-your-azure-ad) bölümünde hiveruser1 ve hiveuser2 kullanıcılarını oluşturmuştunuz. Bu öğreticide o iki kullanıcı hesabını kullanacaksınız.
...
Talimatlara [Hive ODBC veri kaynağı oluşturma](hdinsight-connect-excel-hive-odbc-driver.md) sayfasından erişebilirsiniz.  
...
* Etki alanına katılmış HDInsight kümelerinde SSH kullanarak Hive sorguları çalıştırmak için bkz. [Linux, Unix ya da OS X’te HDInsight’ta Linux tabanlı Hadoop ile SSH’yi kullanma](hdinsight-hadoop-linux-use-ssh-unix.md#connect-to-a-domain-joined-hdinsight-cluster).
* Hive JDBC kullanarak Hive’a bağlanmak için bkz. [Hive JDBC kullanarak Azure HDInsight üzerindeki Hive’a bağlanma](hdinsight-connect-hive-jdbc-driver.md)
* Hive ODBC kullanarak Excel ile Hadoop arasında bağlantı kurmak için bkz. [Microsoft Hive ODBC sürücüsü kullanarak Excel ile Hadoop arasında bağlantı kurma](hdinsight-connect-excel-hive-odbc-driver.md)
* Power Query kullanarak Excel ile Hadoop arasında bağlantı kurmak için bkz. [Power Query kullanarak Excel ile Hadoop arasında bağlantı kurma](hdinsight-connect-excel-power-query.md)
