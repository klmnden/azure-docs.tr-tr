...
| **R yükleme** |https://hdiconfigactions.blob.core.windows.net/rconfigactionv02/r-installer-v02.ps1. [Yükleme ve kullanma R Hdınsight kümelerinde] bkz [hdınsight r betiklerini]. |
