...
* **Hdınsight kümesi**. Bkz: [Hdınsight'ta Hadoop kullanmaya başlamanıza](hdinsight-hadoop-linux-tutorial-get-started.md) yeni bir Linux tabanlı Hdınsight kümesi oluşturma adımları için.
