...
description: "Azure Blob depolamasında verileri sorgulamayı ve Azure Data Lake Store’da analiz sonuçlarınızı depolamayı öğrenin."
...
### <a name="address-files-in-blob-storage"></a>Blob Storage’da dosyaları adresleme
