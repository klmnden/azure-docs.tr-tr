...
> [!NOTE]
> Aşağıdaki küme türlerinde yalnızca Önizleme'de bu makalede açıklanan yeni özellikler mevcuttur: Hadoop, Spark ve etkileşimli sorgu. Oozie etki alanına katılmış kümelerinde şimdi etkinleştirildi. Web kullanıcı Arabirimi kullanıcılara etkinleştirmelisiniz Oozie erişmek için [tünel](../hdinsight-linux-ambari-ssh-tunnel.md)
