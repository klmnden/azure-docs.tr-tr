...
Özel map/azaltmak bileşenler genellikle Java dilinde yazılır. Hadoop ayrıca C#, F #, Visual Basic, Python ve JavaScript gibi diğer dillerde geliştirilen kullanılacak bileşenler sağlayan bir akış arabirimidir.
