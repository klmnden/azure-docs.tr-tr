---
title: HDInsight için Visual Studio Hadoop araçlarını kullanmayı öğrenme| Microsoft Docs
...
* Aşağıdaki yazılımı içeren bir iş istasyonu:
  ...
  * Visual Studio (aşağıdaki sürümlerinden biri):
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > Şu anda, Visual Studio için HDInsight araçları yalnızca İngilizce sürüm ile birlikte gelir.
    > 
    > 
