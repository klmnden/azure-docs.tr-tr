...
> [!NOTE]
> Bu komut, bir yerel Storm geliştirme ortamını gerektirir. Daha fazla bilgi için bkz: [bir geliştirme ortamını ayarlama](http://storm.apache.org/releases/1.0.6/Setting-up-development-environment.html)
