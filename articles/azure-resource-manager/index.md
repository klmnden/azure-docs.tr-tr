        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Resource Manager hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Resource Manager Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Resource Manager’ı kullanmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Resource Manager şablonlarında bağımlılık oluşturmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Resource Manager'da birden çok kaynak örneğini kullanmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/templates/">Şablon biçimi</a></p>
                        <p><a href="/azure/resource-group-template-functions">Şablon işlevleri</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-functions">UI tanımı işlevleri</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-elements">UI tanımı öğeleri</a></p>
                    </div>
                </div>
            </div>
        </div>
