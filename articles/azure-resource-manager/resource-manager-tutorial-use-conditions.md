...
* [Koşullu olarak kaynak içinde bir Azure Resource Manager şablonu dağıtma](/azure/architecture/building-blocks/extending-templates/conditional-deploy).
