...
Satır içi parametreleri geçirmek için adlı parametre adlarını sağlayan `New-AzureRmResourceGroupDeployment` komutu. Örneğin, bir dize ve dizi için bir şablon geçirmek için kullanın:
