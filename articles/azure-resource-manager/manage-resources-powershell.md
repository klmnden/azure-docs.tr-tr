...
Bir öğreticiyi incelemek için bkz: [Öğreticisi: Azure kaynaklarını başka bir kaynak grubuna veya aboneliğe taşıyın](./resource-manager-tutorial-move-resources.md). 
