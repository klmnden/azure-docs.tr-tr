...
Bir öğreticiyi incelemek için bkz: [Öğreticisi: Azure kaynakları başka bir kaynak grubuna veya aboneliğe taşıma](./resource-manager-tutorial-move-resources.md). 
