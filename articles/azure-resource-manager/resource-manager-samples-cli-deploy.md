...
---
# <a name="azure-resource-manager-template-deployment---azure-cli-script"></a>Azure Resource Manager şablon dağıtımı - Azure CLI komut dosyası
...
| Komut | Notlar |
|---|---|
| [az grubu var.](/cli/azure/group#exists) | Kaynak grubu mevcut olup olmadığını denetler. |
| [az grubu oluşturma](/cli/azure/group#create) | Tüm kaynaklar depolandığı bir kaynak grubu oluşturur. |
| [az grup dağıtımı oluşturma](/cli/azure/group/deployment#create) | Bir dağıtımı başlatın.  |
| [az grubu Sil](/cli/azure/group#delete) | Tüm kaynaklar da dahil olmak üzere bir kaynak grubu siler. |
