...
# Hızlı Başlangıçlar
## [Şablon oluşturma - portal](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Şablon oluşturma - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Şablon oluşturma - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
...
### [Azure portalında](resource-group-portal.md)
...
### [EA abonelikleri oluşturma](programmatically-create-subscription.md)
### [EA abonelikleri oluşturmak için erişim izni verme](grant-access-to-create-subscription.md)
...
#### [Azure portalında](resource-group-create-service-principal-portal.md)
