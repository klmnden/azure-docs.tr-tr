...
> [!NOTE]
> Bu varsayılan NSG güvenli LDAP için kullanılan bağlantı noktasına erişim kilitleme değil. Internet üzerinden güvenli LDAP erişim kilitlemek için bkz: [bu makalede](active-directory-ds-troubleshoot-ldaps.md).
>
