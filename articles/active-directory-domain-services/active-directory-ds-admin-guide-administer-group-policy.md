---
title: 'Azure Active Directory Domain Services: Grup İlkesi, yönetilen etki alanlarını yönetme | Microsoft Docs'
...
Oluşturun veya kendi özel Grup İlkesi nesneleri içeri aktarın. Ayrıca, özel GPO'ları, yönetilen etki alanınızda oluşturduğunuz özel bir OU bağlayabilirsiniz. Özel Kuruluş birimi oluşturma hakkında daha fazla bilgi için bkz. [yönetilen bir etki alanında özel bir OU oluşturma](active-directory-ds-admin-guide-create-ou.md).
