---
title: 'Azure Active Directory Domain Services: Bildirim ayarları | Microsoft Docs'
...
Hemen bir bildirim gönderilir, bir [yeni uyarı](active-directory-ds-troubleshoot-alerts.md) yönetilen etki alanınızda bulunamadı. Uyarı çözümlenemedi, dört her gün bir anımsatıcı bir e-posta bildirimi gönderilir.
