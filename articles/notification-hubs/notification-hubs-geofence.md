...
İkinci olarak, teslimin doğru katılımcılara yapıldığından emin olmaya çalıştığınızdan, onları [etiketleme](notification-hubs-routing-tag-expressions.md) yoluyla hedeflemek isteyebilirsiniz.
