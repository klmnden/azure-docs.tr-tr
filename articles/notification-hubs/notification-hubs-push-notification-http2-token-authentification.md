...
Uygulamanız için bir belirteç oluşturduktan sonra kimlik doğrulama belirteci indirilebilir. Bu belirteci oluşturma hakkında daha fazla bilgi için başvurmak [Apple'nın Geliştirici belgeleri](http://help.apple.com/xcode/mac/current/#/dev11b059073?sub=dev1eb5dfe65).
