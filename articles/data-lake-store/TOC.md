...
# [Data Lake Storage 2. Nesil'e geçiş belgeleri](https://docs.microsoft.com/azure/storage/data-lake-storage/introduction)
...
### [Sanal ağ tümleştirmesi](data-lake-store-network-security.md)
...
## Data Lake Storage Gen1 ile çalışma
...
# Başvuru
## [Kod örnekleri](https://azure.microsoft.com/resources/samples/?service=data-lake-store)
...
## [Python (Hesap Yönetimi)](https://docs.microsoft.com/python/api/azure.mgmt.datalake.store?view=azure-python)
## [Python (Dosya Sistemi Yönetimi)](https://azure-datalake-store.readthedocs.io/en/latest)
## [REST](/rest/api/datalakestore)
## [Resource Manager Şablonu](/azure/templates/microsoft.datalakestore/allversions)
## [Azure CLI](https://docs.microsoft.com/cli/azure/dls)

# Kaynaklar
## [Azure yol haritası](https://azure.microsoft.com/updates/?product=data-lake-store)
...
## [Stack Overflow Forumu](https://stackoverflow.com/questions/tagged/azure-data-lake)
