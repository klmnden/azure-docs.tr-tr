<properties
   pageTitle="Data Lake Store’da Access Control özelliğine genel bakış | Microsoft Azure"
...
>[AZURE.NOTE] Bir üst öğe üzerindeki Varsayılan ACL’nin değiştirilmesi zaten var olan alt öğelerin Erişim ACL’sini veya Varsayılan ACL’sini etkilemez.
...
>[AZURE.NOTE] Yukarıdaki koşullar geçerli oldukça dosyayı silmek için dosya üzerinde yazma izinleri geçerli değildir.
...
>[AZURE.NOTE] Sahip olan kullanıcı başka bir sahibi olunan dosyanın sahibini **değiştiremez**. Bir dosya veya klasörün sahibi olan kullanıcıyı yalnızca süper kullanıcılar değiştirebilir.
...
>[AZURE.NOTE] Yeni bir Data Lake Store hesabı için kök klasörün ("/") Erişim ACL’leri ve Varsayılan ACL için maske varsayılan olarak RWX’tir.
