...
3. ' A tıklayın metin kutusundaki altında **kural adı** ve IP aralığını bağlantı belirtmek için yeni bir güvenlik duvarı kuralı ekleyin. IP aralığınızı girin. **Kaydet**’e tıklayın.
