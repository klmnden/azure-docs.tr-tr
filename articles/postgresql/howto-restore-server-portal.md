...
Azure veritabanı için PostgreSQL kullanırken, veritabanı hizmeti sunucusunun bir yedeği her 5 dakikada bir otomatik olarak yapar. 
...
4. Gerekli bilgileri geri yükleme formu doldurun:
  ...
  - **Geri yükleme noktası**: bir nokta sunucu değiştirilmeden önce oluşan zamanında seçin.
