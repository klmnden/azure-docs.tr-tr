---
title: Oluşturma ve PostgreSQL - Azure CLI kullanarak tek bir sunucu için Azure veritabanı'nda güvenlik duvarı kurallarını yönetme
description: Bu makalede, oluşturmak ve - Azure CLI komut satırını kullanarak tek bir sunucu PostgreSQL için Azure veritabanı'nda güvenlik duvarı kurallarını yönetmek açıklar.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "65067529"
---
# <a name="create-and-manage-firewall-rules-in-azure-database-for-postgresql---single-server-using-azure-cli"></a>Oluşturma ve PostgreSQL - Azure CLI kullanarak tek bir sunucu için Azure veritabanı'nda güvenlik duvarı kurallarını yönetme
