---
title: Azure veritabanı Azure CLI kullanarak PostgreSQL sunucusu için yeniden başlatın.
description: Bu makalede, Azure CLI kullanarak PostgreSQL için Azure veritabanı nasıl yeniden açıklanır.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "58623296"
---
# <a name="restart-azure-database-for-postgresql-server-using-the-azure-cli"></a>Azure veritabanı Azure CLI kullanarak PostgreSQL sunucusu için yeniden başlatın.
