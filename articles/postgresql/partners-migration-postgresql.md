---
title: PostgreSQL geçiş iş ortakları için Azure veritabanı | Microsoft Docs
description: PostgreSQL için Azure veritabanı destekleyen çözümler ile üçüncü taraf geçiş iş ortakları listeler.
services: mysql
author: HJToland3
ms.author: jtoland
manager: craigg
...
ms.locfileid: "39115381"
---
# <a name="azure-database-for-postgresql-migration-partners"></a>PostgreSQL geçiş iş ortakları için Azure veritabanı
Azure veritabanınızı PostgreSQL çözüm problem desteklemek için çok çeşitli sektör lideri iş ortakları ve araçları seçin. Bu makalede, PostgreSQL için Azure veritabanı destekleyen geçiş çözümleri ile Microsoft iş ortağı şirketlerden vurgulanır.
...
| ![Pragmatik çalışır][3] |**Pragmatik çalışır**<br>Pragmatik çalışır, eğitim ve danışmanlık şirketi ile veri yönetimi ve performans, iş zekası, büyük veri, Power BI ve veri iyileştirme üzerinde odaklanma ve SQL Server ve bulut Yönetimi verimliliğini iyileştirme Azure içinde derin bir uzmanlık yüktür.|[Web sitesi][pragmatic-works_website]<br>[Twitter][pragmatic-works_twitter]<br>[YouTube][pragmatic-works_youtube]<br>[İlgili kişi][pragmatic-works_contact] | |
| ![Infosys][4] |**Infosys**<br>Infosys en yeni dijital hizmetlerin küresel bir lider olan ve danışmanlık. Üzerinde üç yıllardır ile genel kuruluşların sistemlerini yönetmeye, Infosys ustalıkla dijital YOLCULUĞUNA istemcileriyle değişiklik yürütme önceliğini yardımcı olmak için yapay ZEKA destekli temel bir kuruluşlarıyla etkinleştirerek steers. Infosys Çevik dijital uygun ölçekte eşsiz düzeyde performans ve müşteri memnun edecek sunmak için işletmeler de sağlar.|[Web sitesi][infosys_website]<br>[Twitter][infosys_twitter]<br>[YouTube][infosys_youtube]<br>[İlgili kişi][infosys_contact] | |
| ![credativ][5] |**credativ**<br>credativ bağımsız danışmanlık ve kapsamlı hizmetler ve işlem iş uygulamaları açık kaynak yazılım ve uygulaması için teknik destek teklifi, 1999 beri Hizmetleri şirket ' dir. Hizmet, kapsamlı stratejik danışma, ses teknik öneri, nitelikli eğitim ve kişiselleştirilmiş destek kadar tüm BT gereken günde 24 saat için bulunur.|[Market][credativ_marketplace]<br>[Web sitesi][credativ_website]<br>[Twitter][credative_twitter]<br>[YouTube][credativ_youtube]<br>[İlgili kişi][credativ_contact] | |
