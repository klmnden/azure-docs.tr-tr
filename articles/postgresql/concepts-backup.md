...
PostgreSQL için Azure veritabanı, en fazla % 100'ünü sağlanan sunucu depolama alanınızın hiçbir ek ücret ödemeden yedekleme depolama alanı olarak sağlar. Genellikle, bu, yedi gün yedekleme bekletme için uygundur. Tüm ek yedek depolama kullanılan GB-ay üzerinden ücretlendirilir.
...
PostgreSQL için Azure veritabanı'nda bir geri yükleme işlemi yeni bir sunucu özgün sunucunun yedeklerden oluşturur.
