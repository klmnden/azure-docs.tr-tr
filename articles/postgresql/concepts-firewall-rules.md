---
title: PostgreSQL sunucusu güvenlik duvarı kuralları için Azure veritabanı
description: Bu makalede, PostgreSQL için Azure veritabanı sunucunuza için güvenlik duvarı kuralları açıklanır.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "60560256"
---
# <a name="azure-database-for-postgresql-server-firewall-rules"></a>PostgreSQL sunucusu güvenlik duvarı kuralları için Azure veritabanı
PostgreSQL sunucusu güvenlik duvarı için azure veritabanı, hangi bilgisayarların izinli olduğunu belirtmenize kadar veritabanı sunucunuza tüm erişimi engeller. Güvenlik Duvarı her isteğin kaynak IP adresi tabanlı sunucu erişim verir.
