...
|Azure SQL veritabanı kaynak grubu|Kaynak grubu|Location|**Kilitli** -şema parametresini kullanır.|
...
|App Service ortamı kaynak grubu|Kaynak grubu|Location|**Kilitli** -şema parametresini kullanır.|
