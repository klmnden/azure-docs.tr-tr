---
title: Azure CLI kullanarak ilk Kaynak Grafiği sorgunuzu çalıştırma
...
Azure Kaynak Grafiği’ni kullanmada ilk adım, [Azure CLI](/cli/azure/) uzantısının yüklenmesini sağlamaktır. Bu hızlı başlangıç, Azure CLI yüklemenize uzantı ekleme işlemini incelemenizi sağlar. Uzantıyı Azure CLI ile, yerel veya [Azure Cloud Shell](https://shell.azure.com) aracılığıyla yüklü olarak kullanabilirsiniz.

Bu işlemin sonunda, uzantıyı seçtiğiniz Azure CLI yüklemesine eklemiş ve ilk Kaynak Grafiği sorgunuzu çalıştırmış olacaksınız.
...
1. En son Azure CLI’sinin (en az **2.0.45** sürümü) yüklü olmasını sağlayın. Henüz yüklü değilse, [bu yönergeleri](/cli/azure/install-azure-cli-windows?view=azure-cli-latest) izleyin.
...
Artık Azure CLI eklentisi seçtiğiniz ortamınıza eklendiğine göre, basit bir Kaynak Grafiği sorgusu denemenin zamanı geldi. Sorgu ilk beş Azure kaynağını, her kaynağın **Adı** ve **Kaynak Türü** ile birlikte döndürür.
