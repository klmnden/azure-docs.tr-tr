...
> [!NOTE]
> Azure PowerShell `Search-AzGraph` cmdlet döndürür bir **PSCustomObject** varsayılan olarak. Aynı Azure CLI tarafından döndürülen olarak ara çıktı elde etmek `ConvertTo-Json` cmdlet'i kullanılır.
