---
title: Azure İlkesi örneği - İzin verilmeyen VM uzantıları
description: Bu örnek ilkesi, belirtilen uzantıların kullanılmasını engeller.
...
ms.locfileid: "46963262"
---
# <a name="not-allowed-vm-extensions"></a>İzin verilmeyen VM uzantıları
