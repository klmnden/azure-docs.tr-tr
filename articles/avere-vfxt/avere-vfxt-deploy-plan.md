...
* Tüm öğeleri Avere vFXT dağıtımı için oluşturulan yeni bir abonelik ile yönetilmelidir. Faydaları şunlardır: 
  ...
  * Kaynak uygun bölümleme kotalar - çok sayıda Avere vFXT istemcileri yalıtarak yüksek performanslı bilgi işlem iş akışınız için kullanılan istemci ayarlama dönüştürürken olası kaynak azaltma diğer kritik iş yüklerini korumak ve küme içindeki bir tek bir abonelik.
