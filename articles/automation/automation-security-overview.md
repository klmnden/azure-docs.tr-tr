<properties
   pageTitle="Azure Otomasyonu Güvenliği | Microsoft Azure"
...
Azure Farklı Çalıştır Hesabı | Azure Resource Manager | [Azure Farklı Çalıştır hesabıyla Kimlik Doğrulaması Runbook’ları](../automation/automation-sec-configure-azure-runas-account.md)
Azure Klasik Farklı Çalıştır Hesabı | Azure Service Management | [Azure Farklı Çalıştır hesabıyla Kimlik Doğrulaması Runbook’ları](../automation/automation-sec-configure-azure-runas-account.md)
