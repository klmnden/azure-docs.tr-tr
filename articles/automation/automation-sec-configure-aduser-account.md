<properties
   pageTitle="Azure AD Kullanıcı Hesabı Yapılandırma | Microsoft Azure"
...
2. **Automation Hesabı Ekle** dikey penceresinde, **Ad** kutusuna, yeni Automation hesabınız için bir ad yazın.
...
3. **Azure Farklı Çalıştır hesabı oluştur** seçeneği için **Hayır** değerini seçin ve **Oluştur** düğmesine tıklayın.  
