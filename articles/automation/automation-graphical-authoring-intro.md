...
Kimliği doğrulanmış farklı çalıştır hesabı kullanmak için Connect-AzureRmAccount, sonraki etkinliği runbook'ta ekler.<br>
![Connect-AzureRmAccount parametre kümesi](media/automation-graphical-authoring-intro/authenticate-conn-to-azure-parameter-set.png)<br>
