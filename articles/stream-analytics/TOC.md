...
## Ölçek
### [Akış birimleri ile ölçeklendirme](stream-analytics-streaming-unit-consumption.md)
### [Sorgu paralelleştirmesiyle ölçeklendirme](stream-analytics-parallelization.md)
#### [Aktarım hızını artırma](stream-analytics-scale-jobs.md)
### [ML işlevleriyle ölçeklendirme](stream-analytics-scale-with-machine-learning-functions.md)

## Otomatikleştirme
### [.NET SDK’yı kullanma](stream-analytics-dotnet-management-sdk.md)
### [Azure PowerShell’i kullanma](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [SELECT INTO deyimi](stream-analytics-select-into.md)
### [Olay Hub'ı alıcıları](stream-analytics-event-hub-consumer-groups.md)

## Makine öğrenimiyle tümleştirme
### [ML modelleriyle yaklaşım analizi](stream-analytics-machine-learning-integration-tutorial.md)
...
## [Videolar](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)
