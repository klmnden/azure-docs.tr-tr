...
Visual Studio için Stream Analytics araçları Azure Data Lake depolama depolama ve blob depolama için şu anda çıkış Önizleme destekler. Sonucu görüntülemek için çift iş diyagramında çıkış düğümünün tıklamanız yeterlidir **iş görünümü** ve uygun kimlik bilgilerini girin.
