...
description: Stream Analytics işlerinde sorgularınızı test etme.
keywords: Bu makalede, test bir Azure Stream Analytics işi, örnek giriş ve örnek verileri karşıya yükleme için Azure portalını kullanmayı açıklar.
