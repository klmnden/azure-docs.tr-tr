---
title: Azure akış analizi Machine Learning uç noktaları kullanma
description: Bu makalede, Azure akış analizi makine dili kullanıcı tanımlı işlevler kullanmayı açıklar.
