        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Anahtar Kasası hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Anahtar Kasası Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Anahtar Kasası’nı kullanmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Web Uygulamasından Anahtar Kasası’nı kullanmaya başlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Anahtar Kasası’nı uçtan uca döndürme ve denetleme ile ayarlama</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Node.js</h3>
                        <p><a href="http://azure.github.io/azure-sdk-for-node/azure-arm-keyvault/latest">Vault yönetimi</a></p>
                        <p><a href="http://azure.github.io/azure-sdk-for-node/azure-arm-keyvault/latest">Vault içeriği yönetimi</a></p>
                    </div>
                </div>
            </div>
        </div>
