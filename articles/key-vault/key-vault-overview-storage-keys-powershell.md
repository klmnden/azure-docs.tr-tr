...
> [!TIP]
> Azure AD ile kayıtlı her uygulama sağlar bir  **[hizmet sorumlusu](/azure/active-directory/develop/developer-glossary#service-principal-object)**, uygulama kimliği olarak görev yapar. Hizmet sorumlusu, rol tabanlı erişim denetimi (RBAC) ile Key Vault gibi diğer Azure kaynakları erişmek için yetkilendirme ardından verilebilir. Key Vault Microsoft uygulama olduğundan, bu uygulama kimliği "cfa8b339-82a2-471a-a3c9-0fc0be7a4093" altındaki tüm Azure AD kiracılarıyla önceden kaydedilir.
...
- [Anahtar kasası PowerShell başvurusu](/powershell/module/azurerm.keyvault/)
