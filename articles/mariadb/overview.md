...
ms.locfileid: "49320926"
---
# <a name="what-is-azure-database-for-mariadb"></a>MariaDB için Azure Veritabanı nedir?

MariaDB için Azure Veritabanı, Microsoft bulutunda sunulan bir ilişkisel veritabanı hizmetidir. MariaDB için Azure Veritabanı, [MariaDB topluluk sürümü](https://mariadb.org/download/) veritabanı altyapısını kullanır. Bu hizmet genel önizleme aşamasındadır. 
