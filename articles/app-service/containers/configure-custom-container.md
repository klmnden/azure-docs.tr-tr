...
İçinde *docker-compose.yml* dosya, harita `volumes` seçeneğini `${WEBAPP_STORAGE_HOME}`. `WEBAPP_STORAGE_HOME`, App Service içinde bulunan ve uygulamanız için kalıcı depolamayla eşlenmiş olan bir ortam değişkenidir. Örneğin:
