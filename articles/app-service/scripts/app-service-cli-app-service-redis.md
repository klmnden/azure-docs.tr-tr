...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az_redis_create) | Yeni bir Redis Önbelleği örneği oluşturur. |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az_redis_list_keys) | Redis önbelleği örneğinin erişim anahtarlarını listeler. |
