...
| [az webapp günlüğünü yapılandırma](https://docs.microsoft.com/cli/azure/webapp/log#az_webapp_log_config) | Azure web uygulaması korunur hangi günlüklerini yapılandırır. |
| [az webapp oturum indirme](https://docs.microsoft.com/cli/azure/webapp/log#az_webapp_log_download) | Günlüklerini indirmeleri yerel makinenize Azure web uygulaması. |
