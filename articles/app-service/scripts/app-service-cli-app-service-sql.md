...
| [`az sql server create`](/cli/azure/sql/server?view=azure-cli-latest#az_sql_server_create) | SQL Veritabanı Sunucusu oluşturur.  |
...
| [`az sql db show-connection-string`](/cli/azure/sql/db?view=azure-cli-latest#az_sql_db_show_connection_string) | Veritabanına bir bağlantı dizesi oluşturur. |
