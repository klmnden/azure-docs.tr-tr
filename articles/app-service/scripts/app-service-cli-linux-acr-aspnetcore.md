---
title: Azure CLI Betik Örneği - Azure Container Registry’den bir Docker kapsayıcısında ASP.NET Core web uygulaması oluşturma | Microsoft Docs
...
| [`az webapp config container set`](/cli/azure/webapp/config/container?view=azure-cli-latest#az_webapp_config_container_set) | Azure web uygulaması için Docker kapsayıcısını ayarlar. |
