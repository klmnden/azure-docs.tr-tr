...
Bu örnek betik bir uygulaması, App Service'te ilgili kaynaklarıyla birlikte oluşturur ve sonra uygulama kodunuzu yerel bir Git deposunda dağıtır.
