...
Öğreticiyi [beş dakika içinde Azure'da ilk ASP.NET web uygulamanızı oluşturma](app-service-web-get-started-dotnet.md) Visual Studio 2017'yi kullanarak bir ASP.NET web uygulamasını App Service'te bir web uygulamasına dağıtma işlemi gösterilmektedir.
...
Azure hızlı başlangıç, uygulamanızın dağıtım yığını ve tercih ettiğiniz yöntemi kullanarak dağıtmanıza yardımcı olması için tasarlanmıştır. Azure portalında Hızlı Başlangıç'ı kullanmak için Git **ayarları** > **uygulama dağıtımı**.
...
*   Git proje kullanırsınız. App Service ile bu depo için dağıtım seçeneklerini kullanarak bağlanın.
