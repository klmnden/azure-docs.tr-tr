...
ms.locfileid: "57456989"
---
# <a name="azure-iot-hub-bindings-for-azure-functions"></a>Azure işlevleri için Azure IOT hub'ı bağlamaları

Bu makalede, Azure işlevleri bağlamaları için IOT Hub ile nasıl çalışılacağı açıklanmaktadır. IOT hub'ı destek dayanır [Azure Event Hubs bağlama](link to event hub doc).
