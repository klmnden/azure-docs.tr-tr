...
description: Pythong işlevleriyle Geliştirme işlemini anlama
services: functions
...
Bir Python işlevi uygulamasını Azure'a dağıtmak için kullanabileceğiniz bir [Travis CI özel betik](https://docs.travis-ci.com/user/deployment/script/) GitHub deponuza ile. Aşağıda bir örnek verilmiştir `.travis.yaml` derleme ve yayımlama işlemi için komut dosyası.
