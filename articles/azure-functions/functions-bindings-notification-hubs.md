...
Bu C# betiği örneği, yerel GCM bildirim göndermek nasıl gösterir. 
...
|**yön** |yok| "Out" ayarlanmalıdır. | 
|**ad** |yok| İşlev kodu bildirim hub'ı iletide kullanılan değişken adı. |
