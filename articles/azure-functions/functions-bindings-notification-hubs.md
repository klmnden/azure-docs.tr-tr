...
|---------|---------|----------------------|
|**Türü** |yok| "NotificationHub" olarak ayarlanmalıdır. |
|**Yönü** |yok| Out"için" olarak ayarlanmalıdır. | 
