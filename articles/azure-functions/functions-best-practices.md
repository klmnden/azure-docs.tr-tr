...
Bu makalede performans ve güvenilirliğini geliştirmek için rehberlik sağlanır, [sunucusuz](https://azure.microsoft.com/overview/serverless-computing/) işlev uygulamaları. 
