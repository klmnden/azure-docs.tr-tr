...
* [Kod ve Azure işlevleri yerel olarak test etme](functions-run-local.md)
* [Azure İşlevleri çalışma zamanı sürümleri nasıl hedeflenir?](set-runtime-version.md)
