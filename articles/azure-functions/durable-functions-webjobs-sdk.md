...
2. Değişiklik `Main` yöntemi kod depolama bağlantı dizesini ve Application Insights izleme anahtarını almak için bir *appsettings.json* dosya, .NET Core yapılandırma çerçevesini kullanarak.  Bir örneği aşağıda verilmiştir:
