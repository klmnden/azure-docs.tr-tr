...
Denetimleri [Application ınsights'ta örnekleme özelliği](functions-monitoring.md#configure-sampling). Sürüm 2.x, bu ayar bir alt öğesi olan [günlüğü](#logging).
