...
Azure işlevleri sağlar, kodunuzda yürütme bir [sunucusuz](https://azure.microsoft.com/overview/serverless-computing/) önce bir VM oluşturun veya bir web uygulaması yayımlamak zorunda kalmadan ortamı. Bu konu başlığında, Azure portalında İşlevler’i kullanarak bir "hello world" işlevi oluşturmayı öğrenebilirsiniz.
