...
![Microsoft Partner Center, müşteri görünümü](media/howto-create-application-csp/image1.png)
...
![Azure IOT Central yönetmek kullanılabilir](media/howto-create-application-csp/image2.png)
...
![CSP'ler için Yöneticisi oluşturma](media/howto-create-application-csp/image3.png)
...
![CSP'ler için uygulama sayfası oluşturma](media/howto-create-application-csp/image4.png)

![CSP'ler için uygulama sayfası oluşturma](media/howto-create-application-csp/image4-1.png)
