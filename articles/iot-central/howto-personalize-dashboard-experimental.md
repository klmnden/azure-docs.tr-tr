...
!["Örnek Contoso" şablonu temel alan uygulamalar için Pano](media/howto-personalize-dashboard-experimental/defaultdashboard.png)
...
![Pano kitaplığı](media/howto-personalize-dashboard-experimental/dashboardeditor.png)
...
!["Cihaz ayrıntıları Yapılandır" form ayarlarına ve özelliklerine ilişkin ayrıntılı](media/howto-personalize-dashboard-experimental/dashboardsetting.png)

Kişisel panonuzu görüntüleyin, ile yeni kutucuğu görmek şimdi **Fan hızı** cihazı için:

![Görüntülenen ayarları ve özellikleri için kutucuğun bulunduğu "Pano" sekmesi](media/howto-personalize-dashboard-experimental/personaldashboard.png)
...
![Anahtar Panosu](media/howto-personalize-dashboard-experimental/switchdashboards.png)

Kişisel panolarınızı düzenleyebilir ve artık ihtiyacınız olanlar Sil:

![Panoyu Sil](media/howto-personalize-dashboard-experimental/managedashboards.png)
...
> [Uygulama tercihlerinizi yönetmeyi öğrenin](howto-manage-preferences.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
