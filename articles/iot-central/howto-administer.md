...
## <a name="utilize-the-azure-sdks-to-do-control-plane-operations"></a>Düzlemi işlemleri denetlemek için Azure SDK'ları kullanma

IOT Central Azure Resource Manager SDK'sı paketleri, düğüm, Python, C#, Ruby, Java ve Git için kullanılabilir. Bu kitaplıklar destek denetim düzlemi işlemleri için IOT Central, oluşturmak, liste, güncelleştirmek veya IOT Central uygulamaları silin etmenize imkan sağlar. Kimlik doğrulaması başa çıkmak için de Yardımcıları sağlanır ve hata işleme, her dil için özeldir. 

Azure Resource Manager SDK'ları kullanma örnekleri bulunabilir [ https://github.com/emgarten/iotcentral-arm-sdk-examples ](https://github.com/emgarten/iotcentral-arm-sdk-examples).

Bilgi edinmek için daha fazla bu paketleri Github'da göz atın.
