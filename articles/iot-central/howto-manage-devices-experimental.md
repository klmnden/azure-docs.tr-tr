...
1. Seçin **Device Explorer** sol gezinti menüsünde. Burada, bir listesini görürsünüz, [cihaz şablonları](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. Sağ bölmede **Device Explorer** sayfasında, cihaz şablondan oluşturulan cihazların bir listesini görürsünüz. Bu cihaz için cihaz ayrıntıları sayfasına görmek için tek bir cihaz seçin:
    ...
    ![Cihaz ayrıntıları sayfasına](./media/howto-manage-devices-experimental/devicelist.png)
...
1. **İçeri Aktar**’a tıklayın.
    ...
    ![Alma eylemi](./media/howto-manage-devices-experimental/BulkImport1.png)
...
1. İçeri aktarma işlemi tamamlandıktan sonra cihaz Kılavuzu'nun bir başarı iletisi gösterilir.
    ...
    ![İçeri aktarma başarılı](./media/howto-manage-devices-experimental/BulkImport3.png)
...
1. Sol panelde seçin **ilişkili değil, cihazları**:
    ...
    ![İlişkilendirilmemiş cihazlar](./media/howto-manage-devices-experimental/UnassociatedDevices1.png)

1. Şablon ile ilişkilendirmek istediğiniz cihazları seçin:

1. Tıklayın **ilişkilendirmek**:

    ![Cihazları İlişkilendir](./media/howto-manage-devices-experimental/UnassociatedDevices2.png)
...
1. Dışarı aktarma ve ardından istediğiniz cihazları seçin **dışarı** eylem.
    ...
    ![Dışarı Aktarma](./media/howto-manage-devices-experimental/Export1.png)
...
1. Tıklayarak **başarılı iletisi** disk üzerindeki yerel bir klasöre dosya indirilemedi.
    ...
    ![Dışarı aktarma başarılı](./media/howto-manage-devices-experimental/Export2.png)
