...
* Bir uzak Linux makinesinde Docker kapsayıcısı içinde Conda Python ortamı. Bir [Azure üzerinde DSVM Ubuntu tabanlı] (örneğin)https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-ads.linux-data-science-vm-ubuntu)
