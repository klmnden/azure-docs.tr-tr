...
Bu makalede, Azure Machine Learning paket bilgisayar işleme (AMLPCV) için bir görüntü sınıflandırma modeli dağıtma eğitin ve test için nasıl kullanılacağını öğrenin. Bu paket ve ayrıntılı başvuru belgelerinde bakış [Burada gördüğünüz](https://aka.ms/aml-packages/vision).
