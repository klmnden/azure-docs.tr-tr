...
>[!Note]
>**Bu makalede kullanım dışı bırakılmıştır.** Bu hizmeti önceki sürümleri için destek artımlı olarak sona erer. [Destek zaman çizelgesini görüntüleyin](../service/overview-what-happened-to-workbench.md#timeline). Okuma [en yeni makale](../service/how-to-export-delete-data.md) bu konuda.
