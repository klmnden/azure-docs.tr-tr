...
* Azure Machine Learning çalışma ekranı. Bkz: [Yükleme Kılavuzu](../service/quickstart-installation.md). Şu anda Azure Machine Learning çalışma ekranı yalnızca aşağıdaki işletim sistemlerinde yüklenebilir: 
