...
Bir proje zaten sahip değilseniz, birinden oluşturabilirsiniz [oluşturma ve yükleme Quickstart](../service/quickstart-installation.md) gelen **proje Panosu**, açabilirsiniz **iris_sklearn.py** (komut dosyası gösterildiği gibi.)
