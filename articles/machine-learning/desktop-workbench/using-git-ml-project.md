...
Bir Machine Learning deneme hesabı oluşturmak ve Azure Machine Learning çalışma ekranı uygulamasını yükleyin. Daha fazla bilgi için bkz: [yükleyin ve hızlı başlangıç oluşturma](../service/quickstart-installation.md).
