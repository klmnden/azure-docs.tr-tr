...
Cortana Intelligence Galerisi'nde PM öğretici için ortak GitHub deposudur ([https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance](https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance)) burada rapor sorunları ve katkı yapın.
...
* [Tahmine dayalı bakım gerçek dünya senaryosu](https://docs.microsoft.com/azure/machine-learning/desktop-workbench/scenario-predictive-maintenance)
