...
- Azure aboneliği. Deneyin [Azure Machine Learning hizmetinin ücretsiz veya Ücretli sürümüne](https://aka.ms/AMLFree) bugün.
...
## <a name="get-the-default-compute-target"></a>Varsayılan işlem hedef alın

Her bir çalışma alanı ile iki gelir, varsayılan işlem hedeflerini: gpu tabanlı işlem hedefi ve cpu tabanlı işlem hedefi. Varsayılan işlem hedefleri, kullandığınız kadar bunlar atanmayacağı anlamına gelir 0 kümesini otomatik ölçeklendirme vardır. Bu örnekte kazanmak için varsayılan GPU işlem hedef kullanın.
