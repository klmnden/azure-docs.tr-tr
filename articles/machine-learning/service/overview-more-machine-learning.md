---
title: Bir machine learning Microsoft teknolojisini seçin
description: Oluşturma, dağıtma ve makine öğrenimi Modellerinizi yönetme seçeneklerini karşılaştırın. Hangi Microsoft ürünleri seçin, çözümünüz için karar verin.
