...
Azure Databricks ortamda [Databricks yükleme adımlarını](how-to-configure-environment.md#azure-databricks
) yerine.
...
1. Ek paketleri yükleyin.  Yüklemediyseniz `azureml-sdk[automl]` yukarıda, bunu şimdi emin olun.
