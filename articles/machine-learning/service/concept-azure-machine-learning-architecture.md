...
1. **Komut Gönderme** ortamında çalıştırmak için yapılandırılmış işlem hedefine. Eğitim sırasında işlem hedef çalışma kayıtlara depolar. bir **veri deposu**. Kayıtlar var. kaydedilir bir **deneme**.
