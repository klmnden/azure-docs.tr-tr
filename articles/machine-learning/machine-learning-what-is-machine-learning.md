<properties
    pageTitle="Azure'da Machine Learning nedir? | Microsoft Azure"
    description="Çözümleri oluşturma, faaliyete sokma ve paraya çevirme için kullanabileceğiniz tam olarak yönetilen bir bulut teknolojisi olan Machine Learning hizmetinin temel kavramlarını açıklar."
...
# Microsoft Azure'da makine öğrenimine giriş

## Machine learning nedir?

Machine learning; gelecekteki davranışları, sonuçları ve eğilimleri öngörmek amacıyla var olan verilerden bilgi alan tahmine dayalı modelleri çalıştırmak için bilgisayarları kullanır.

Machine learning'in bu öngörüleri veya tahminleri, uygulama ve cihazları daha akıllı hale getirir. Çevrimiçi alışveriş yaparken makine öğrenimi önceden satın aldıklarınızı temel alarak beğenebileceğiniz diğer ürünleri önermede yardımcı olur. Kredi kartınız makineden geçirilirken makine öğrenimi, işlemi bir işlemler veritabanıyla karşılaştırır ve sahtekarlığı saptamada bankalara yardımcı olur.

## Microsoft Azure'da Machine Learning nedir?

Azure Machine Learning, tahmine dayalı modelleri analiz çözümleri olarak hızlı bir şekilde oluşturmayı ve dağıtmayı mümkün kılan bulut tabanlı ve güçlü bir tahmine dayalı analiz hizmetidir.

Azure Machine Learning tahmine dayalı analiz modellemeye yönelik araçlar sağlamanın yanı sıra, tahmine dayalı modellerinizi kullanıma hazır web hizmetleri olarak dağıtmada kullanabileceğiniz tam olarak yönetilen bir hizmet de sunar. Azure Machine Learning, tamamlanmış tahmine dayalı analiz çözümlerini bulutta oluşturmak için araçlar sağlar: Tahmine dayalı modelleri hızla oluşturun, test edin, faaliyete geçirin ve yönetin. Herhangi bir donanım satın almanız veya sanal makineleri kendiniz yönetmeniz gerekmez.
...
Tahmine dayalı analiz, gelecekteki olayları öngörmek amacıyla toplanan veya geçerli verilerde düzen ya da eğilim analizi yapmak için bu durumda makine öğrenimi olmak üzere çeşitli istatistik teknikler kullanır.

Azure Machine Learning, tahmine dayalı analiz gerçekleştirmede özellikle güçlü bir yöntemdir: Kullanıma hazır algoritma kitaplığıyla çalışabilir, herhangi bir ek ekipman veya altyapı satın almadan İnternet'e bağlı bir bilgisayarda modelleri oluşturabilir ve tahmine dayalı çözümünüzü hızla dağıtabilirsiniz. [Microsoft Azure Market](https://datamarket.azure.com/browse?query=machine+learning) veya [Cortana Intelligence Galerisi](http://gallery.cortanaintelligence.com/)'nde de kullanıma hazır örnekler ve çözümler bulabilirsiniz.
...
Tarayıcı tabanlı bir araç olan [Machine Learning Studio](machine-learning-what-is-ml-studio.md)'da modülleri sürükleyerek, bırakarak ve bağlayarak tahmine dayalı modelleri oluşturun.
...
* Tahmine dayalı modellerinizi hızla başlatmak için Machine Learning Studio'daki büyük [Machine Learning algoritmaları ve modülleri](https://msdn.microsoft.com/library/azure/f5c746fd-dcea-4929-ba50-2a79c4c067d7) kitaplığını kullanın. Örnek denemeleri, R ve Python paketlerini ve Xbox ve Bing gibi Microsoft işletmelerinden en iyi sınıf algoritmalarını içeren kitaplıktan seçim yapın. Kendi [R](machine-learning-r-quickstart.md) ve [Python](machine-learning-execute-python-scripts.md) betiklerinizle Studio modüllerini genişletin.
* [Cortana Intelligence Galerisi](machine-learning-gallery-how-to-use-contribute-publish.md)'nde başkaları tarafından yazılan analiz çözümlerini deneyebilir veya Machine Learning, HDInsight (Hadoop), Stream Analytics ve Data Lake Analytics dahil olmak üzere kendi Azure hizmetlerinizin yanı sıra büyük Azure veri depoları ve veri yönetimi hizmetlerini kullanarak katkıda bulunabilirsiniz.  Denemeler hakkında topluluğa soru veya yorum gönderin ya da LinkedIn ve Twitter gibi sosyal ağlar aracılığıyla deneme bağlantılarını paylaşın.  
...
## Önemli makine öğrenimi terminolojisi ve kavramları
...
#### Verilerle eğitim
Azure Machine Learning'de bir model, eğitim verilerini ve puanlama modülü gibi işlev modüllerini işleyen bir algoritma modülünden oluşturulur.

Denetimli öğrenmede bir sahtekarlık algılama modelini eğitiyorsanız sahte veya geçerli olarak etiketli bir işlem kümesini kullanırsınız. Verilerinizi rastgele ayırıp bir kısmını modeli eğitmek ve bir kısmı da modeli test etmek veya değerlendirmek için kullanırsınız.
...
* **algoritma**: Veri işleme, hesaplama otomatik mantık aracılığıyla sorunları çözmek için kullanılan kendi içinde bir kural kümesi.
...
* **modül**: Machine Learning Studio'da, küçük veri kümelerini girmeyi ve düzenlemeyi sağlayan Veri Girme modülü gibi işlevsel bir öğedir. Bir algoritma da Machine Learning Studio'da bir modül türüdür.
* **model**: Denetimli öğrenme için bir model; bir eğitim veri kümesi, bir algoritma modülü ve Modeli Puanlama modülü gibi işlevsel modüllerden oluşan bir makine öğrenimi denemesinin ürünüdür.
...
* **tahmin**: Tahmin, makine öğrenimi modeline ilişkin bir değerin veya değerlerin öngörüsüdür. "Tahmin edilen puan" terimini de görebilirsiniz ancak tahmin edilen puanlar bir modelin son çıkışı değildir. Puanın ardından modelin değerlendirmesi gelir.
* **regresyon**: Bir araba fiyatını yılını ve markasını baz alarak tahmin etme gibi bağımsız değişkenlere bağlı sürekli bir değeri tahmin etmeye yönelik bir model.
* **puan**: Machine Learning Studio'daki [Modeli Puanlama modülü](https://msdn.microsoft.com/library/azure/dn905995.aspx) kullanılarak eğitilmiş bir sınıflandırma veya regresyon modelinden oluşturulan tahmin edilen bir değer. Sınıflandırma modelleri, tahmin edilen değerin olasılığı için de bir puan döndürür. Bir modelden puan oluşturduktan sonra, [Modeli Değerlendirme modülünü](https://msdn.microsoft.com/library/azure/dn905915.aspx) kullanarak modelin doğruluğunu değerlendirebilirsiniz.
