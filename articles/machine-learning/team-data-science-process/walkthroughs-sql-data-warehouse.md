---
title: Azure üzerinde T-SQL ve Python kullanarak SQL veri ambarı veri bilimi kılavuzları | Microsoft Docs
...
[Kullanım SQL veri ambarı izlenecek](sqldw-walkthrough.md) oluşturun ve machine Learning'i dağıtma işlemi gösterilmektedir SQL veri ambarı'nı (SQL DW) için genel kullanıma açık bir NYC kullanarak sınıflandırma ve regresyon modellerini taksi seyahat ve taksi veri kümesi.
