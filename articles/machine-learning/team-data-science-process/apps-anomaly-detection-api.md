...
| Yavaş eğilim algılayıcısı |Yavaş eğilim algılayıcısı |Yavaş pozitif eğilim kümesi duyarlılığına göre algılayın |*trenddetector.sensitivity:* algılayıcısı puanı eşiğine (varsayılan: 3,25, 3,25 – 5'tir; buradan seçmek için makul sınırlar Daha yüksek daha az duyarlı) |tscore: eğilim üzerindeki anomali puanı temsil eden kayan sayısı |
| Düzeyi değiştirme algılayıcıları | Çift yönlü düzeyi değişiklik algılayıcısı |Yukarı ve aşağı düzeyi değişiklik kümesi duyarlılığına göre algılayın |*bileveldetector.sensitivity:* algılayıcısı puanı eşiğine (varsayılan: 3,25, 3,25 – 5'tir; buradan seçmek için makul sınırlar Daha yüksek daha az duyarlı) |rpscore: anomali puanı yukarı ve aşağı düzeyi değişiklik gösteren kayan sayı | |
...
| detectors.spikesdips | Olup olmadığının algılanması gerektiğini yalnızca ani, yalnızca Düşüşler veya her ikisi |Her İkisi |Numaralandırılan |Her ikisi de ani artışları, Dıp'lerin |Her İkisi |
