...
## <a name="classify-uci-incomes-in-azure-machine-learning-workbench"></a>Azure Machine Learning çalışma ekranındaki UCI yüksek sınıflandırın

Azure Machine Learning çalışma TDSP proje öğretici gösteren nasıl oluşturmak için bkz: [takım veri bilimi işlemi öğretici: Azure Machine Learning çalışma ekranındaki sınıflandırmak UCI yüksek](../desktop-workbench/scenario-tdsp-classifying-us-incomes.md) 


## <a name="biomedical-entity-recognition-using-natural-language-processing-with-deep-learning"></a>Doğal dil işleme ile derin öğrenme kullanarak biomedical varlık tanıma

Azure Machine Learning çalışma TDSP örneği proje kullanan bir örnek için bkz: [doğal dil işleme ile derin öğrenme kullanarak Biomedical varlık tanıma](../desktop-workbench/scenario-tdsp-biomedical-recognition.md)
