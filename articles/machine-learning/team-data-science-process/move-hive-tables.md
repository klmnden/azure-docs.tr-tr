...
* **&#60; depolama konumu >**: Hive tablolarını verileri kaydetmek için Azure depolama konumu. Belirtmezseniz, *konum &#60; depolama konumu >*, veritabanını ve tabloları depolanır *hive/ambarı/* varsayılan olarak Hive kümenin varsayılan kapsayıcısında dizin. Depolama konumu belirtmek istiyorsanız, depolama konumu tablo ve veritabanı için varsayılan kapsayıcı içinde olması gerekir. Küme biçiminde varsayılan kapsayıcı göreli konumunu olarak başvurulan bu konumuna sahip *' wasb: / / / &#60; 1 dizini > /'* veya *' wasb: / / / &#60; 1 dizini > / &#60; dizin 2 > /'*, vb. Sorgu yürütüldükten sonra göreli dizinleri varsayılan kapsayıcı içinde oluşturulur.
...
* **&#60; blob veri yoluna >**: Hive tablosu karşıya yüklenecek blob dosya Hdınsight Hadoop kümesi varsayılan kapsayıcı ise *&#60; blob veri yoluna >* biçiminde olmalıdır *' wasb: / / / &#60; bu kapsayıcıda dizini > / &#60; blob dosya adı >'*. Blob dosya de Hdınsight Hadoop kümesi ek bir kapsayıcı olabilir. Bu durumda, *&#60; blob veri yoluna >* biçiminde olmalıdır *' wasb: / / &#60; kapsayıcı adı > @&#60; depolama hesabı adı >.blob.core.windows.net/ &#60; blob dosya adı >'*.
...
> [!NOTE]
> Varsa TEXTFILE tablo *&#60; veritabanı adı >. &#60; dış textfile tablo adı >* bölümler, adım 3'te içeren `SELECT * FROM <database name>.<external textfile table name>` komutu döndürülen veri kümesindeki bir alan olarak bölüm değişkeni seçer. İçine ekleme *&#60; veritabanı adı >. &#60; ORC tablo adı >* bu yana başarısız *&#60; veritabanı adı >. &#60; ORC tablo adı >* bölüm değişkeni bir alana sahip değil Tablo şemasını. Bu durumda, özellikle için eklenecek alanları seçmeniz gerekir *&#60; veritabanı adı >. &#60; ORC tablo adı >* gibi:
>
>
...
Bırakma güvenlidir *&#60; dış textfile tablo adı >* olduğunda tüm veri sonra aşağıdaki sorguyu kullanarak ekledi içine *&#60; veritabanı adı >. &#60; ORC tablo adı >*:
