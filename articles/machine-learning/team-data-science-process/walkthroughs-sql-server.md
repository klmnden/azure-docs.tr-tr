---
title: R, Python ve T-SQL kullanarak SQL Server veri bilimi kılavuzları | Microsoft Docs
description: Kullanarak R, Python ve T-SQL ile SQL Server Tahmine dayalı analiz gerçekleştirmede size yol gösteren örnekler.
...
ms.locfileid: "52442072"
---
# <a name="sql-server-data-science-walkthroughs-using-r-python-and-t-sql"></a>R, Python ve T-SQL kullanarak SQL Server veri bilimi kılavuzları
...
[Kullanım SQL Server](sql-walkthrough.md) izlenecek yol, oluşturma ve dağıtma machine learning sınıflandırma gösterir ve SQL Server ve genel kullanıma açık NYC kullanarak, regresyon modelleri, seyahat ve taksi dataset taksi.
...
[Kullanım SQL Server R Services](https://msdn.microsoft.com/library/mt612857.aspx) izlenecek yol, R kodunun, SQL Server verilerini birlikte veri bilimcileri sağlar ve derlemek ve bir R dağıtmak için özel SQL işlevleri için SQL Server modeli. İzlenecek yol, R Services (veritabanında) için R geliştiriciler tanıtmak için tasarlanmıştır.
