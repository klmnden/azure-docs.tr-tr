...
### [Araçlar ve Yardımcı Programlar](machine-learning-data-science-environment-setup.md)
### [Kılavuz](data-science-process-walkthroughs.md)
# Kullanmaya Başlama
## [İlk denemenizi oluşturun](machine-learning-create-experiment.md)
## Kılavuz
### [İlk denemenizi oluşturun](machine-learning-walkthrough-develop-predictive-solution.md)
...
# Nasıl yapılır?
## Kurumsal yaklaşım
### [Senaryoları belirleme](machine-learning-data-science-plan-your-environment.md)
### [Örnek senaryoları görüntüleme](machine-learning-data-science-plan-sample-scenarios.md)
## Araçlar ve Yardımcı Programlar
### [Kurulum ortamları](machine-learning-data-science-environment-setup.md)
### [Sanal makineleri kurma](machine-learning-data-science-virtual-machines.md)
...
#### [Azure VM Kurulumu](machine-learning-data-science-setup-virtual-machine.md)
#### [SQL VM Kurulumu](machine-learning-data-science-setup-sql-server-virtual-machine.md)
...
#### [Çalışma Alanı oluşturma](machine-learning-create-workspace.md)
#### [Çalışma Alanını Yönetme](machine-learning-manage-workspace.md)
...
#### [SQL bölüm tablolarını kullanma](machine-learning-data-science-parallel-load-sql-partitioned-tables.md)
...
#### [TDSP'ye genel bakış](machine-learning-data-science-select-features.md)
...
## [PowerShell’e genel bakış](machine-learning-powershell-module.md)
## [PowerShell kullanarak model oluşturma](machine-learning-create-models-and-endpoints-with-powershell.md)
## [Web hizmeti REST API’si](https://msdn.microsoft.com/library/azure/dn950030.aspx)
