...
>[!NOTE]
> Model yönetim hesabınızı oluşturmuş olsanız da, ortamınız henüz web hizmetlerinin dağıtımı için ayarlanmadı. [Dağıtım ortamınızı](deployment-setup-configuration.md) ayarlamayı öğrenin.
