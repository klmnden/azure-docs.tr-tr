...
* Azure CLI'yi yüklemediyseniz, yönergeleri izleyerek [en son Azure CLI sürümünü yükleyin](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest).
