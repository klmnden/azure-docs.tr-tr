...
3. Varsayılan değerleri değiştirmeyin ve **İleri** düğmesini seçin.  
...
5. **Ölçümler** düğmesini seçin. Histogramları gözlemleyin. Her sütun için eksiksiz bir istatistik hesaplanmıştır. Verileri yeniden görmek için **Veriler** düğmesini de seçebilirsiniz. 

   ![Iris veri görünümü](media/tutorial-classifying-iris/iris_metrics_view.png)

6. **Hazırla** düğmesini seçin. **Hazırla** iletişim kutusu açılır. 
...
7. Şimdi bazı temel veri hazırlıkları yapalım. Sütunları yeniden adlandırın. Üst bilgi metnini düzenlenebilir hale getirmek için her bir sütun başlığını seçin. 
...
8. Farklı değerleri saymak için **Türler** sütununu seçip sağ tıklayın. Açılır menüden **Değer Sayıları**’nı seçin. 
...
9. Null değerleri filtrelemek için grafikten null değerini temsil eden çubuğu seçin. Değeri **(null)** olan bir satır vardır. Bu satırı kaldırmak için eksi işaretini seçin (**-**).
