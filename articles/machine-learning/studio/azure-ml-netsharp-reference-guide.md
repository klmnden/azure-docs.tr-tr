---
title: 'NET # sinir ağları belirtim dili Kılavuzu - Azure Machine Learning | Microsoft Docs'
description: 'Net # kullanarak bir özel sinir ağı modelinin nasıl oluşturulacağını örnekleri ile birlikte belirtim dilinin söz dizimi için Net # sinir ağları'
