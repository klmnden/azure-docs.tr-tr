---
title: Machine Learning için R dili için hızlı başlangıç Öğreticisi | Microsoft Docs
...
5. Çıkışını **zip veri** simgesine **betik paketi** , giriş [R betiği yürütme] [ execute-r-script] modülü.
