...
3. Kullanmak istediğiniz çalışma alanı ve bölgeyi seçin
    ...
    ![Galeriden Jupyter not defteri açın](./media/gallery-jupyter-notebooks/open-notebook-from-gallery.png)
...
3. Farenizi bir not defteri ve Seç'ın üzerine **açık not defteri**
    ...
    ![Açık galeri dizüstü bilgisayarınızı Machine Learning Studio içinde](./media/gallery-jupyter-notebooks/open-notebook-from-studio.png)
