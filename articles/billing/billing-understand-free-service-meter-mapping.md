---
title: Azure ücretsiz hesabı için ölçüm eşleme hizmeti
...
| Yönetilen disk <sup>1</sup>  | Standart yönetilen Disk işlemleri (10,000s) | Standart yönetilen Disk işlemleri (10,000s) - ücretsiz | 82cc6ea4-0abd-43ac-acc0-ec34edf0f14c
...
| Paylaşılan - bant genişliği <sup>2</sup> | Veri Aktarımı Gönderilen (GB) | Veri aktarımı gönderilen (GB) - ücretsiz | 0fc067a1-65d2-46da-b24b-7a9cbe2c69bd

<sup>1</sup> sanal makinenin bir parçası olarak bir Windows sanal makine oluşturun ve yönetilen disk seçin, yönetilen disk ölçüm kullanacaktır.

<sup>2</sup> paylaşılan ölçümleri birden çok hizmeti kullanılabilir. Örneğin, hem sanal makineleri hem de depolama kullanım veri aktarımı Out(GB) ölçüm karşı gösterin.
