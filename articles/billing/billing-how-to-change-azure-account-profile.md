...
description: Azure hesabınızın profil değiştirmek açıklar ve neden, ülke Azure hesap Merkezi'nde değiştiremezsiniz gibi sık sorulan soruları yanıtlar
services: ''
documentationcenter: ''
author: genlin
manager: jlian
...
E-posta adresine hesap yönetici profilinde, abonelik faturalandırma ile ilgili önemli güncelleştirmeler hakkında bilgilendirmek üzere Microsoft tarafından kullanılır. Düzenli olarak denetleyen bir ilgili kişi e-posta adresi belirtmenizi öneririz.

## <a name="how-to-change-your-profile-information"></a>Profil bilgilerini değiştirme
...
### <a name="what-email-address-does-the-azure-billing-alerts-preview-feature-use"></a>Hangi e-posta adresi Azure fatura uyarıları mu Önizleme özellik kullanımı?

Uyarılar için kaydolduğunuzda eklediğiniz uyarı bildirimleri e-posta adresine alırsınız. Uyarılar için kullanılan e-posta adresine Hesap Yöneticisi e-posta adresinden ayrıdır. Daha fazla bilgi için [uyarılar, Microsoft Azure abonelikleri için fatura ayarlama](billing-set-up-alerts.md).
