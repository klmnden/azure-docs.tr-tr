...
1. Oturum [Azure hesap Merkezi](https://account.azure.com/Profile).
1. Seçin **Düzenle ayrıntıları** düğmesine tıklayın ve ardından güncelleştirme **profil** bilgi.

   ![profil](./media/billing-how-to-change-azure-account-profile/profile.png)

## <a name="frequently-asked-questions"></a>Sık sorulan sorular

### <a name="can-notifications-be-sent-to-a-different-email-address-other-than-the-account-administrator-email-address-associated-with-my-account"></a>Bildirimler için farklı bir e-posta adresi hesabımla ilişkilendirilen hesabı yönetici e-posta adresini diğer gönderilebilir?
...
Fatura bilgilerinizi güncelleştirmek öğrenmek için bkz: [Azure aboneliği için ödeme yapmak üzere kullanılan kredi kartı değiştirme](billing-how-to-change-credit-card.md).
