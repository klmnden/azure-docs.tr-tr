...
### <a name="youre-using-services-not-included-for-free-with-your-azure-free-account"></a>Hizmetleri ücretsiz Azure ücretsiz hesabınızla eklenmemiş kullanmakta olduğunuz

Ücretsiz Azure ücretsiz hesabınızla eklenmeyen Hizmetleri kullanılarak için Kullandıkça Öde fiyatları üzerinden ücretlendirilirsiniz. Ücretsiz hesaba dahil hizmetler hakkında bilgi edinmek için bkz. [Azure ücretsiz hesabı nedir](https://azure.microsoft.com/free/free-account-faq/). Azure portalında veya Azure kullanım dosyası aracılığıyla kullandığınız hizmetlere kullanımını kontrol edebilirsiniz. Daha fazla bilgi için bkz. [düzenli olarak Maliyet dağılımı için portalı denetleyin ve yazma hızı](billing-getting-started.md#costs) ve [indirme kullanımı hesap Merkezi'nden](billing-download-azure-invoice-daily-usage-date.md). 

### <a name="youve-reached-the-end-of-your-12-months-free-services"></a>12 aylık Ücretsiz Hizmetler ulaştınız
