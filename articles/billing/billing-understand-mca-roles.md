...
Bu makale, bir faturalama hesabı için bir Microsoft Müşteri sözleşmesi için geçerlidir. [Microsoft Müşteri sözleşmesi erişimi olup olmadığını denetlemek](#check-your-access-to-a-microsoft-customer-agreement).
...
|Rol|Açıklama|
|---|---|
|Faturalama hesabı sahibi|Fatura hesabı için her şeyi yönetme|
...
|Faturalama profili sahibi|Profil fatura için her şeyi yönetme|
|Faturalama profili katılımcısı|Faturalandırma profili izinlerini dışında her şeyi yönetme|
|Faturalama profili okuyucusu|Profil faturalandırma üzerinde salt okunur görünümü her şeyin|
...
|Fatura bölümü katılımcısı|Fatura bölüm izinlerini dışında her şeyi yönetme|
...
|Görev|Faturalama hesabı sahibi|Faturalama hesabı katılımcısı|Faturalama hesabı okuyucusu|
|---|---|---|---|
...
|Görev|Faturalama profili sahibi|Faturalama profili katılımcısı|Faturalama profili okuyucusu|Fatura Yöneticisi|Faturalama hesabı sahibi|Faturalama hesabı katılımcısı|Faturalama hesabı okuyucusu
|---|---|---|---|---|---|---|---|
...
|Görevler|Fatura bölümü sahibi|Fatura bölümü katılımcısı|Fatura bölümü okuyucusu|Azure aboneliği oluşturucusu|
|---|---|---|---|---|
