...
>[!NOTE]
> Çalışma alanınız için yükseltildiyse [yeni günlük analizi sorgu dili](log-analytics-log-search-upgrade.md), sonra yeni panolar oluşturun veya varolan Pano düzenleyin. 
