...
>[!NOTE]
> Bu makalede geçerli sorgu dili günlük analizi kullanarak günlük aramaları açıklanmaktadır.  Çalışma alanınız için yükseltildiyse [yeni günlük analizi sorgu dili](log-analytics-log-search-upgrade.md), için başvurmalıdır sonra [yeni dil için dil başvurusu](https://go.microsoft.com/fwlink/?linkid=856079).
