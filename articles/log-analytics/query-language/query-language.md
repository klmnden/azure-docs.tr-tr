...
- [Azure portalında log Analytics ile çalışmaya başlama](get-started-analytics-portal.md) sorguları yazma ve Azure portalında sonuçları ile çalışmak için bir Ders şu oldu.
...
- [Log Analytics kayıtları standart özelliklerinde](../log-analytics-standard-properties.md) tüm Log Analytics verilerini standart özellikleri açıklar.
- [Log Analytics'te günlük kaynaklar arası aramalar gerçekleştirmek](../log-analytics-cross-workspace-search.md) birden fazla Log Analytics çalışma alanları ve Application Insights uygulamalardan veri kullanan sorguları yazma işlemini açıklamaktadır.
