...
* System Center Operations Manager 2012 SP1 UR7 ile Operations Manager 2012 R2 UR3, Operations Manager 2016 ve Operations Manager sürüm 1801 yönetim grubu ile OMS ile tümleşiktir.  
...
![Operations Manager iletişim OMS diyagramı](./media/log-analytics-oms-gateway/log-analytics-agent-opsmgrconnect.png)
...
|--------|----------------------------------|  
|- CPU: Intel XEON CPU E5-2660 v3 @ 2.6GHz 2 Cores<br> -Bellek: 4 GB<br> -Ağ bant genişliği: 1 GB/sn| 600|  
|- CPU: Intel XEON CPU E5-2660 v3 @ 2.6GHz 4 Cores<br> -Bellek: 8 GB<br> -Ağ bant genişliği: 1 GB/sn| 1000|  
