...
2. Azure portalının sol alt köşesinde bulunan **Diğer hizmetler**'e tıklayın. Kaynak listesinde yazın **sanal makineleri**. Yazmaya başladığınızda liste, girişinize göre filtrelenir. Seçin **sanal makineleri**.
