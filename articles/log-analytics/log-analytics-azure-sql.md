...
Bu uyarı tabanlı sorgular, Azure SQL veritabanı ve esnek havuzlar için belirli eşiklere uyarmak için kullanabilirsiniz. OMS çalışma alanınız için bir uyarı yapılandırmak için:
