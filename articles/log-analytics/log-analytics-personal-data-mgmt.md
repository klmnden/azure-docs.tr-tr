...
* *Özel veri*: Log Analytics, çeşitli yöntemler koleksiyonda sağlar: özel günlükleri ve özel alanları [HTTP veri toplayıcı API'sini](log-analytics-data-collector-api.md) , ve özel veri, sistem olay günlüklerini bir parçası olarak toplanır. Bunların tümü, özel veri içeren açıktır ve herhangi bir veri var olup olmadığını doğrulamak için incelenmelidir.
...
- Log Analytics verilerini nasıl toplanan, işlenen ve güvenliği hakkında daha fazla bilgi için bkz: [Log Analytics veri güvenliği](log-analytics-data-security.md).
