...
5. Uyarıyı aşağıdaki bilgilerle yapılandırın: a. Aşağı açılan **Tetikleyici* listesinden **Metrik ölçüm**'ü seçin.  Bir metrik ölçümü, sorgudaki belirttiğimiz eşiği aşan her nesne için bir uyarı oluşturacaktır.
...
9. Üçüncü ve son adım olarak, bir uyarı tetiklendiğinde aynı eylemlerin yapılmasını sağlayan tanımladığınız her kural için kullanılabilecek bir **Eylem Grubu** belirtin.  Yeni bir eylem grubunu aşağıdaki bilgilerle yapılandırın: a. **Yeni eylem grubu**'nu seçerseniz **Eylem grubu ekle** bölmesi görünür.
   ...
   f. Değişikliklerinizi kaydetmek için **Tamam**’a tıklayın.<br><br> ![Yeni eylem grubu oluşturma](./media/log-analytics-tutorial-response/action-group-properties-01.png)<br>
