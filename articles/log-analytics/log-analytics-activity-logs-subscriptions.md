...
Olay Hub'ı adını ve bağlantı dizesini almak için, [Event Hubs ad alanı izinlerini denetleme ve bağlantı dizesini bulma](../connectors/connectors-create-api-azure-event-hubs.md#connect-to-azure-event-hubs) başlığı altında verilen adımları izleyin.
