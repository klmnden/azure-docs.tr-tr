...
Olay Hub'ı adını ve bağlantı dizesini almak için, [Event Hubs ad alanı izinlerini denetleme ve bağlantı dizesini bulma](../connectors/connectors-create-api-azure-event-hubs.md#check-event-hubs-namespace-permissions-and-find-the-connection-string) başlığı altında verilen adımları izleyin.
