...
- [Benim Panom](log-analytics-dashboards.md) şunun için kullanım [Görünüm Tasarımcısı](log-analytics-view-designer.md) ve [Azure panolar](https://docs.microsoft.com/en-us/azure/azure-portal/azure-portal-dashboards.md).  My panoya eklenen döşeme hala kullanılabildiği ancak salt okunur.
...
Yükseltme tamamlandıktan sonra olacaktır bir **yükseltme Özet** çalışma alanı için ayarları bölümünde.  Görünüm ve yükseltme hakkında bilgi için bu bölümüne bakın
