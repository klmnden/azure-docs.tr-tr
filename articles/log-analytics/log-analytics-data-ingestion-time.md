...
Öğesinden yeni bir özel veri türü oluşturulduğunda bir [özel günlük](../log-analytics/../azure-monitor/platform/data-sources-custom-logs.md) veya [veri toplayıcı API'sini](../log-analytics/log-analytics-data-collector-api.md), sistem bir adanmış depolama kapsayıcısı oluşturur. Bu, bu veri türü yalnızca ilk görünümünü oluşan tek seferlik bir ek yüktür.
