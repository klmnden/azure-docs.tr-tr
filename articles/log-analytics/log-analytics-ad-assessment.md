...
![AD sistem durumu denetimi kutucuk görüntüsü](./media/log-analytics-ad-assessment/ad-healthcheck-summary-tile.png)

![AD sistem durumu denetimi panosunun görüntüsü](./media/log-analytics-ad-assessment/ad-healthcheck-dashboard-01.png)
...
2. Ortamınızdaki bilgisayarları için başarısız olan liste öneriler için aşağıdaki sorguyu kullanın.
    ...
    ```
    Günlük araması sorgusuna gösteren ekran görüntüsü aşağıda verilmiştir:<br><br> ![başarısız önerileri](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
...
* Kullanım [Log Analytics'te günlük aramaları](log-analytics-queries.md) ayrıntılı veri AD sistem durumunu denetleyin ve önerileri çözümleme hakkında bilgi edinmek için.
