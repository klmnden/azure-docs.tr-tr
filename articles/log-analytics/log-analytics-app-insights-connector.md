...
![Application Insights Panosu](./media/log-analytics-app-insights-connector/app-insights-dash01.png)

![Application Insights Panosu](./media/log-analytics-app-insights-connector/app-insights-dash02.png)
...
- Kullanım [günlük araması](log-analytics-queries.md) Application Insights uygulamalarınız için ayrıntılı bilgileri görüntülemek için.
