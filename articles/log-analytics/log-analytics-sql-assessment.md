...
![SQL sistem durumunu denetleme simgesi](./media/log-analytics-sql-assessment/sql-assessment-symbol.png)
...
![SQL sistem durumu denetimi kutucuk görüntüsü](./media/log-analytics-sql-assessment/sql-healthcheck-summary-tile.png)

![SQL sistem durumu denetimi panosunun görüntüsü](./media/log-analytics-sql-assessment/sql-healthcheck-dashboard-01.png)
...
2. Ortamınızdaki bilgisayarları için başarısız olan liste öneriler için aşağıdaki sorguyu kullanın.
    ...
    Günlük araması sorgusuna gösteren ekran görüntüsü aşağıda verilmiştir:<br><br> ![başarısız önerileri](./media/log-analytics-sql-assessment/sql-assess-failed-recommendations.png)<br>
