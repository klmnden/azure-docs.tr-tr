...
Log Analytics aracısını, küçük ayak izine sahip olmak için tasarlanmıştır. Veri hacmi sağlayan çözümlere göre değişir. Veri hacmi hakkındaki ayrıntılı bilgileri bulmak ve çözümde tarafından dökümünü görmek [kullanım](log-analytics-usage.md) sayfası.
...
Ücretsiz fiyatlandırma katmanı sunucuları ve ölçer tipik veri hacmi birkaç yerleşik iyi bir yoludur. Genel kullanım gösterilir [kullanım](log-analytics-usage.md) sayfası.
