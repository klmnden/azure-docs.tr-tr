...
Tüm günlük girişi adlı tek bir özellik içinde saklanan **RawData**.  Her kayıtta depolanan özellikler girişine bilgilerinin farklı parçaları ayırmak büyük olasılıkla isteyeceksiniz.  Bunu yapmak [özel alanlar](log-analytics-custom-fields.md) Log Analytics özelliğidir.

Özel günlük girişi ayrıştırılırken ilişkin ayrıntılı adımlar burada sağlanmaz.  Lütfen [özel alanlar](log-analytics-custom-fields.md) bu bilgi için belgelere bakın.
...
Günlük giriş öğesinin tüm içeriğini adlı tek bir özellik için yazılan **RawData**.  Bu, analiz ve ayrı olarak tanımlayarak Aranan birden fazla özelliklerini içine ayrıştırabilirsiniz [özel alanlar](log-analytics-custom-fields.md) özel günlük oluşturduktan sonra.
...
![Özel alan ile günlük sorgusu](media/log-analytics-data-sources-custom-logs/query-01.png)
...
![Özel alanlarla günlük sorgusu](media/log-analytics-data-sources-custom-logs/query-02.png)
