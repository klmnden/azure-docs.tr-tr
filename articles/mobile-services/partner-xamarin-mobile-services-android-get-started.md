<properties
    pageTitle="Xamarin.Android için Mobile Services’ı Kullanmaya Başlama | Microsoft Azure"
    writer="craigd"
...
4. Uygulamada, _Öğreticiyi tamamla_ gibi anlamlı bir metin yazın ve ardından **Ekle** seçeneğine tıklayın.
