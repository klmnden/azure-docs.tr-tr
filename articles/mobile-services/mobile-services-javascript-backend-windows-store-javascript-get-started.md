<properties
    pageTitle="Windows Mağazası JavaScript uygulamaları için Mobile Services kullanmaya başlama | Azure Mobile Services"
...
>[AZURE.NOTE] Sorgulamak ve default.js dosyasında bulunan verileri eklemek için, mobil hizmetinize erişen kodu gözden geçirebilirsiniz.
