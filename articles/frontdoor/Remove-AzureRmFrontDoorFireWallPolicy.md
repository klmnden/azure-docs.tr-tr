...
## AÇIKLAMA
**Remove-AzureRmFrontDoor** cmdlet'i, geçerli abonelik kapsamında bir WAF ilkesini kaldırır
...
İçinde $resourceGroup $name adlı WAF ilkesini kaldırın.
...
### -ResourceGroupName
WAF ilkenin ait olduğu kaynak grubu.
...
### -ResourceId
Silmek için kaynak kimliğini WAF İlkesi
