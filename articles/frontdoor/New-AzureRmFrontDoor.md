...
ms.locfileid: "47048386"
---
# Yeni AzureRmFrontDoor

Yeni Azure ön kapısı yük dengeleyici oluşturma
...
## AÇIKLAMA
**Yeni AzureRmFrontDoor** cmdlet'i, belirtilen kaynak grubunda geçerli bir abonelik altında yeni bir Azure ön kapısı yük dengeleyici oluşturur

## ÖRNEKLER

### Örnek 1: verilen parametreleriyle dayalı bir ön kapısı oluşturun.
```powershell
...
Parametreleri temel bir ön kapısı oluşturun.
...
### -EnabledState
Ön yük dengeleyicinin EnabledState.
...
### -ResourceGroupName
Ön kapısı oluşturulacağı kaynak grubu adı.
