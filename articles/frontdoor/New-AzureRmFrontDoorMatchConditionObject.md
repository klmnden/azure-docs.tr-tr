...
ms.locfileid: "47048264"
---
# Yeni AzureRmFrontDoorMatchConditionObject
WAF ilke oluştururken MatchCondition nesnesi oluşturma
...
Bir MatchCondition nesnesi oluşturun
...
### -MatchVariable
Değişken eşleştirin.
Olası değerler şunlardır: 'RemoteAddr', 'RequestMethod', 'Sorgu dizesi', 'PostArgs', 'RequestUri', 'RequestHeader', 'Includesearchresults: true'
...
### -NegateCondition
Bu koşul negate olduğu veya varsayılan değer false'tur açıklar
...
Olası değerler şunlardır: 'Any', 'IPMatch', 'GeoMatch', 'Eşittir', 'Contains', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'İle başlıyor', ' EndsWith''
...
### -Seçici
Eşleştirilecek RequestHeader veya ıncludesearchresults: true seçicide adı
