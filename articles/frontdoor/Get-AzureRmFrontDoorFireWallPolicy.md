...
## AÇIKLAMA
**Get-AzureRmFrontDoorFireWallPolicy** cmdletGet geçerli abonelik altında bir kaynak grubundaki WAF ilke alır

## ÖRNEKLER

### Örnek 1: $Name $resourceGroup içinde adlı bir WAF İlke Al
```powershell
...
İçinde $resourceGroup $Name adlı bir WAF İlke Al

### Örnek 2: $resourceGroup tüm WAF ilkesi alma
```powershell
...
$ResourceGroup tüm WAF ilkesini Al
