...
> [!IMPORTANT]
> Ubuntu VM görüntüsü (Ubuntu Server 16.04 LTS Bu örnekte) zaten silinmiş [Azure yığın Market eklenen](asdk-marketplace-item.md) adımları başlamadan önce.
...
> [Gelişmiş değerlendirme görevleri hakkında daha fazla bilgi edinin](asdk-advanced-eval.md)