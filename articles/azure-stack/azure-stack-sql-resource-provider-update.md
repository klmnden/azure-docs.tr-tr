...
Düzenle ve yükseltilmiş bir PowerShell ISE'den aşağıdaki betiği çalıştırın. Ortamınız için gerektiği şekilde parola ve hesap bilgilerini değiştirmeyi unutmayın.
