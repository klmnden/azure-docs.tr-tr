...
5. Araç (Visual Studio) ve Azure yığın portalları yenileme belirteçleri gerektirir. Bu bağlı olan taraf güveni üzerinde tarafından yapılandırılması gerekir. Yükseltilmiş bir Windows PowerShell oturumu açın ve aşağıdaki komutu çalıştırın:
...
> [!Important]  
> AD FS yalnızca etkileşimli oturum açma oturumları destekler. Etkileşimli olmayan oturum açma otomatikleştirilmiş bir senaryo için gerekiyorsa, bir SPN kullanmanız gerekir.
...
[Dış izleme çözümlerini tümleştirmenize](azure-stack-integrate-monitor.md)
