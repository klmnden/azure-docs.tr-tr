...
![Dağıtım çıkışı](media/azure-stack-kv-deploy-vm-with-secret/deployment-output.png)

## <a name="next-steps"></a>Sonraki adımlar

[Key Vault örnek bir uygulamayla dağıtma](azure-stack-kv-sample-app.md)
