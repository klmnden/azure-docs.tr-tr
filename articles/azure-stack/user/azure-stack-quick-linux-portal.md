...
* **Azure yığın Market Linux görüntüde**
   ...
   Azure yığın Market Linux görüntü varsayılan olarak içermiyor. Linux sanal makine oluşturmadan önce bu nedenle, Azure yığın işleci indirdiği olun **Ubuntu Server 16.04 LT** açıklanan adımları kullanarak görüntü [Azure Azure Market öğesi indirin Yığın](../azure-stack-download-azure-marketplace-item.md) konu.
