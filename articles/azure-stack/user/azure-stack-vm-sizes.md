...
|Size - Size\Name |Sanal işlemci     |Bellek | En fazla geçici disk boyutu | Max OS disk verimlilik: (IOPS) | En büyük geçici depolama verimliliğini (IOPS) | En fazla veri diski işleme (IOPS) |
|-----------------|-----|---------|---------|-----|------|-----------|
