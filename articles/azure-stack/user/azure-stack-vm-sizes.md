...
Bu makalede Azure yığını tarafından desteklenen sanal makine (VM) boyutları listeler. 


## <a name="general-purpose"></a>Genel amaçlı

### <a name="basic-a"></a>Temel A
|Size - Size\Name |Sanal işlemci     |Bellek | En fazla geçici disk boyutu | Max OS disk verimlilik: (IOPS) | En büyük geçici depolama verimliliğini (IOPS) | En fazla veri diski işleme (IOPS) | En fazla NIC |    
|-----------------|-----|---------|---------|-----|------|-----------|----|
