...
Aşağıdaki kod, Azure Stack hizmet sorumlusu kimliğini doğrular. Kimliği ve Azure Stack için özel kimlik doğrulaması temel Kiracı tarafından bir belirteç oluşturur:
