...
### <a name="to-run-get-azurestacklog-on-azure-stack-integrated-systems"></a>Tümleşik sistemleri Azure yığında Get-AzureStackLog çalıştırmak için 
...
1. Olarak oturum açın **AzureStack\CloudAdmin** ana bilgisayarda.
