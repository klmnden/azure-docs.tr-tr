...
- **Sabit** - ileti bir sanal makine oluşturduğunuzda *fiyatlandırma görüntülenemiyor* VM boyutu için bir boyut seçerken, artık görünür.
...
*Güncelleştirme 1803 yüklemesi için bilinen herhangi bir sorun vardır.*
