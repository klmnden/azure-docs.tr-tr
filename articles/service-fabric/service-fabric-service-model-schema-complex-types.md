...
#### <a name="mountpoint"></a>Takma noktası
|Öznitelik|Değer|
|---|---|
|ad|Takma noktası|
|type|xs: String|
...
Hizmet Paketi için kapsayıcı ağ ilkelerini de dahil olmak üzere ağ ilkelerini açıklar.
...
#### <a name="nodename"></a>nodeName
Fabric yükseltme için happe olduğu düğüm adıdır
|Öznitelik|Değer|
|---|---|
|ad|nodeName|
|type|xs: String|
