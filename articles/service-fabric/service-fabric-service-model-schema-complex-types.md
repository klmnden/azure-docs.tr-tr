...
Uygulama hata olarak kabul edilmeden önce iyi durumda olmayan dağıtılmış uygulamalar maksimum toleranslı yüzdesini belirtir. Bu, iyi durumda olmayan dağıtılmış uygulamalar uygulamaları şu anda kümede dağıtılan sanal düğüm sayısı üzerinden bölünmesiyle hesaplanır. Az sayıda düğüm üzerinde bir hatasını tolere için hesaplama yukarı yuvarlar. Varsayılan yüzde: 0.
|Öznitelik|Değer|
|---|---|
...
Rsquo Servicemanifestımport bölümünde tanımlanan belirli bir RunAsPolicy sahip bir varsayılan kullanıcı hesabı için tüm hizmet kod paketleri belirtin.
|Öznitelik|Değer|
|---|---|
...
|Öznitelik|Değer|
|---|---|
|content|9 öğeyi/öğeleri, 5 öznitelikleri|
|Tanımlanan|Genel olarak|
...
Kapsayıcı için yalıtım modu. Geçerli değerler şunlardır: varsayılan, işlem veya (yalnızca Windows kapsayıcıları için desteklenir) hyperv üzerinde Windows 10 konaklar, bu nedenle kapsayıcı, yalıtım modu ayarından bağımsız olarak Hyper-V yalıtım modunda çalışıyor yalnızca Hyper-V yalıtım modunda desteklenir.
|Öznitelik|Değer|
|---|---|
|ad|Yalıtım|
|Kullanın|isteğe bağlı|
...
NetworkType. Şu anda yalnızca desteklenen "Açık" türüdür.
|Öznitelik|Değer|
|---|---|
|ad|NetworkType|
|Kullanın|Gerekli|
...
|Öznitelik|Değer|
|---|---|
|content|3 öğeyi/öğeleri, 10 öznitelikleri|
|Tanımlanan|Genel olarak|
...
Bağlantı noktası hizmet bildirimi geçersiz kılınır
|Öznitelik|Değer|
|---|---|
|ad|Bağlantı noktası|
|type|xs: String|
...
Uç noktası için protokol. Uygulama bildiriminde bir EndpointBindingPolicy bildirilen ve HTTPS uç noktaları ayrıca bir EndpointCertificate olması gerekir. Protokol, daha sonra uygulama yükseltmesi olacak şekilde değiştirilemiyor. 
|Öznitelik|Değer|
|---|---|
|ad|Protokol|
|type|xs: String|
...
|Öznitelik|Değer|
|---|---|
|content|18 öğeyi/öğeleri, 0 öznitelikleri|
|Tanımlanan|Genel olarak|
...
|Öznitelik|Değer|
|---|---|
|content|0 öğeyi/öğeleri, 9 öznitelikleri|
|Tanımlanan|Genel olarak|
...
Kaynak türü, hizmet bildiriminde uç nokta veya sertifika tanımlı.
|Öznitelik|Değer|
|---|---|
|ad|ResourceType|
|Kullanın|isteğe bağlı|
...
|Öznitelik|Değer|
|---|---|
|content|8 öğeyi/öğeleri, 4 öznitelikleri|
|Tanımlanan|Genel olarak|
...
Uygulama sistem durumu kötü olarak kabul edilmeden önce iyi durumda olmayan hizmetler toleranslı maksimum yüzdesini belirtir. Varsayılan yüzde: 0.
|Öznitelik|Değer|
|---|---|
...
Bir hizmet sistem durumu kötü olarak kabul edilmeden önce iyi durumda olmayan bölümler toleranslı maksimum yüzdesini belirtir. Varsayılan yüzde: 0.
|Öznitelik|Değer|
|---|---|
...
Bir bölüm sağlıksız olarak kabul edilmeden önce iyi durumda olmayan çoğaltmalar toleranslı maksimum yüzdesini belirtir. Varsayılan yüzde: 0.
|Öznitelik|Değer|
|---|---|
