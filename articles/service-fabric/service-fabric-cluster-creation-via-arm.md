...
* [Azure CLI 2.0 ve üzeri][azure-CLI]
...
Var olan bir anahtar Kasası'nı kullanmak için anahtar kasası olmalıdır [dağıtım için etkin](../key-vault/key-vault-manage-with-cli2.md#bkmk_KVperCLI)) sertifikaları almak ve küme düğümlerine yüklemek işlem kaynak sağlayıcısı izin vermek için.
