---
title: Bir Azure Service Fabric kümesi ekleyerek sanal makine ölçek kümesi tarafından ölçeklendirme | Microsoft Docs
...
> [!WARNING]
> Bir üretim kümesindeki bu yordama başlamadan önce örnek şablonları incelemek ve bir test kümesine göre işlemini doğrulama öneririz. Kümeyi bir süre için de kullanılamaz.
...
## <a name="adding-an-additional-scale-set-to-an-existing-cluster"></a>Mevcut bir kümeye kümesine ek bir ölçek ekleme
Yeni bir NodeType sanal makine ölçek kümesi, var olan bir kümeye ekleme, aynı NodeTypeRef kullanmaz dışında yukarıda sözü edilen birincil düğüm türü,'e yükseltme benzer. Etkin olarak kullanılan tüm sanal makine ölçek kümeleri ve paylaşmıyor, küme kullanılabilirlik kaybetmek devre dışı bırakma açıkça olmayacaktır birincil düğüm türü güncelleştirmez. 
