---
title: Azure Service Fabric hizmet modeli XML Şeması öğesi grupları | Microsoft Docs
description: Service Fabric hizmet modeli XML şema öğesi gruplarını açıklar.
...
Bir hizmet için bölümleme düzenini tanımlar.

|Öznitelik|Değer|
|---|---|
|content|3 öğeyi/öğeleri|
...
Ölçeklendirme mekanizması tanımlar.

|Öznitelik|Değer|
|---|---|
|content|2 öğeyi/öğeleri|
...
Ölçeklendirme tetikleyiciyi tanımlar.
