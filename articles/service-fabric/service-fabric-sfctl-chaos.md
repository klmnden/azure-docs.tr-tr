...
| --end-time-utc   | Windows Chaos rapor oluşturulacak zaman aralığı bitiş saati temsil eden saat dosya. Lütfen bakın [DateTime.ToFileTimeUtc yöntemi](https://msdn.microsoft.com/library/system.datetime.tofiletimeutc(v=vs.110).aspx) Ayrıntılar için.|
