...
Bu makalede, Service Fabric SDK'sıyla yüklü ServiceFabricServiceModel.xsd şema dosyası belgeler.  Şema dosyası varsayılan olarak yüklü *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace bağlamaları

|Alan kodu|Namespace URI'si|
|---|---|
|Xs|https://www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Bileşen özeti 
Aşağıdaki bileşenler ServiceFabricServiceModel.xsd içinde tanımlanmıştır:
...
- [1 simpleType'in](service-fabric-service-model-schema-simple-types.md)
