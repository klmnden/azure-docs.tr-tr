...
Bu makale, Service Fabric SDK ile birlikte yüklenen ServiceFabricServiceModel.xsd şema dosyası içermektedir.  Şema dosyası varsayılan olarak, yüklü *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace bağlamaları
|Alan kodu|Namespace URI|
|---|---|
|Xs|http://www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Bileşen özeti 
Aşağıdaki bileşenler tanımlanan http://schemas.microsoft.com/2011/01/fabric ad alanında ServiceFabricServiceModel.xsd:
- [244 öğeleri](service-fabric-service-model-schema-elements.md)
- [103 Complextype'lar](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 öğesi grupları](service-fabric-service-model-schema-element-groups.md)
- [16 öznitelik grupları](service-fabric-service-model-schema-attribute-groups.md)
