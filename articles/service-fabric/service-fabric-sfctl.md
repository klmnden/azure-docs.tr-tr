...
description: Service Fabric CLI'sını sfctl komutlarını açıklamaktadır.
...
|Alt grubu|Açıklama|
| --- | --- |
| [Uygulama](service-fabric-sfctl-application.md) | Oluşturma, silme ve uygulama ve uygulama türlerini yönetme. |
...
| [Çoğaltma](service-fabric-sfctl-replica.md) | Hizmet bölümlere ait çoğaltmaları yönetin. |
