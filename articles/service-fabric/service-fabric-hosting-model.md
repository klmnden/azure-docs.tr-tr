...
>
> - Word'ün tüm kullanır *çoğaltma* hem bir çoğaltmaya durum bilgisi olan bir hizmet veya statless Hizmeti'nin bir örneğini gösterir.
...
> [!NOTE]
>- **İşlem paylaşılan** barındırma modeli karşılık gelen **ServicePackageAtivationMode** eşit **SharedProcess**. Bu barındırma modeli varsayılandır ve **ServicePackageAtivationMode** hizmet oluşturma sırasında belirtilmesi gerekmez.
>
>- **Özel işlem** barındırma modeli karşılık gelen **ServicePackageAtivationMode** eşit **ExclusiveProcess** ve hizmet oluşturma sırasında açıkça belirtilmesi gerekir. 
>
>- Bir hizmet barındırma modeli bilinir sorgulayarak [hizmet açıklaması] [ p2] ve değeri **ServicePackageAtivationMode**.
>
>
...
>
> - Varsa **ServicePackageActivationId** 'boş string' varsayılan olarak ommited değil. Dağıtılan bir hizmet paketini, altında etkinleştirildi **paylaşılan işlem** modeli varsa, sonra işlemi yapılmalıdır, aksi takdirde işlem başarısız olur.
>
