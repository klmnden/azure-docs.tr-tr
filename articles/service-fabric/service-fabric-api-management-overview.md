...
İzleyin [Hızlı Başlangıç Kılavuzu](service-fabric-api-management-quick-start.md) ilk Service Fabric kümenizle API Management API Management ve akış isteklerini hizmetlerinize ayarlamak için.
