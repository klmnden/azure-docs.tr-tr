...
Hata ayıklayıcı başlatılabilir kapsayıcılar için Overidden giriş noktası.
...
#### <a name="domainuser"></a>Etkialanıkullanıcısı
|Öznitelik|Değer|
|---|---|
|ad|Etkialanıkullanıcısı|
|minOccurs|0|
...
## <a name="servicetypes-element-type-serviceandservicegrouptypestype"></a>ServiceTypes öğesi (ServiceAndServiceGroupTypesType türü) 
