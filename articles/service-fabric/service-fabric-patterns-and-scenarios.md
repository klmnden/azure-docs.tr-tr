...
Artık öğrendiğinize göre Service Fabric modelleri ve senaryoları, nasıl hakkında daha fazla bilgi edinin hakkındaki [oluşturun ve kümelerini Yönet](service-fabric-deploy-anywhere.md), [bulut Hizmetleri uygulamaları için Service Fabric geçirme](service-fabric-cloud-services-migration-worker-role-stateless-service.md), [sürekli teslimat ayarlamak](service-fabric-set-up-continuous-integration.md), ve [kapsayıcıları dağıtın](service-fabric-containers-overview.md).
