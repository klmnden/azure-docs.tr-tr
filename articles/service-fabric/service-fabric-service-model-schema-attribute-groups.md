...
Kullanıcı adı ya da hizmet hesabı adını (örneğin, MyMachine\JohnDoe veya John.Doe@department.contoso.com).
|Öznitelik|Değer|
|---|---|
|ad|Hesap adı|
|type|xs: String|
...
Azure depolama hesabı bağlantı dizesi. Biçimi: DefaultEndpointsProtocol = https; AccountName = []; AccountKey =]
|Öznitelik|Değer|
|---|---|
|ad|connectionString|
|type|xs: String|
...
Hizmet bildirim adı. Adı, hizmet bildirimi ServiceManifest öğesinde bildirilen adıyla eşleşmelidir.
|Öznitelik|Değer|
|---|---|
...
Hizmet bildirimi sürümü. Hizmet bildirimde belirtilen sürümüyle eşleşmelidir.
|Öznitelik|Değer|
|---|---|
