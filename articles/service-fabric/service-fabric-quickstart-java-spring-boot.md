...
description: "Spring Boot Kullanmaya Başlama kılavuzunu kullanarak Azure Service Fabric için bir Spring Boot uygulaması dağıtın."
...
---
# <a name="deploy-a-spring-boot-application"></a>Spring Boot Uygulaması Dağıtma
