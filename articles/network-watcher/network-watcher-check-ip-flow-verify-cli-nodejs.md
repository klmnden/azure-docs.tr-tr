...
Biz cmdlet'i biz çalıştırmak çalıştırmak için gereken bilgileri sahip olduğunuza `network watcher ip-flow-verify` trafiği test etmek için cmdlet. Bu örnekte, ilk IP adresi ilk NIC üzerinde kullanıyoruz
