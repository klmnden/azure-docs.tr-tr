---
title: Azure Ağ İzleyicisi topolojisi - Azure CLI 1.0 görüntülemek | Microsoft Docs
description: Bu makalede, Azure CLI 1.0 ağ topolojinizi sorgulamak için nasıl kullanılacağını anlatmaktadır.
