...
1. Seçin **sonraki** gösterilecek **özeti** ekran ve ardından **Yayımla** bulut hizmeti dağıtmak için.
   ...
   > [!NOTE]
   > Bir web rolü için yapılandırılmış birden fazla örnek varsa, her web rolüyle uygulamanızı yayımlamak için oluşturulan paketi tek örneği sınırlı olduğunu belirten bir uyarı iletisi görüntülenir. Devam etmek için **Tamam**'ı seçin. Gereksinimleri bölümünde belirtildiği gibi her rolün yalnızca bir örneğine ancak birden fazla web rolüne sahip olabilir.
