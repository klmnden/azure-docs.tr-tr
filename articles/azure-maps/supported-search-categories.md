---
title: Azure haritalar arama kategorileri | Microsoft Docs
description: Azure haritalar, arama kategorileri hakkında bilgi edinin
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
| **Kategori kodu** | **Kod eşleşen kategorileri** |
| --- | --- |
| ERİŞİM\_AĞ GEÇİDİ | Havayolu erişim, güvenlik ağ geçidi, istasyon erişim, erişim ağ geçidi |
| YÖNETİM\_BÖLME | bölge, Dördüncü düzey idari bölüm, ilk sırada idari bölüm, geçmiş üçüncü düzey idari bölüm, lisans, lisans bağımlı siyasi bir ikinci sipariş idari bölüm, bir sipariş dördüncü idari bölüm Üçüncü düzey idari bölüm, doldurulmuş yerler, ikinci sipariş idari bölüm, lisans siparişinin ilk-yönetim varlık, doldurulmuş bir yerde bilgisayar lisansı bölme, idari bölüm konumu, geçmiş bölge, geçmiş doldurulur Site, geçmiş doldurulmuş bir yerde, İsrail kapatma, geçmiş Dördüncü düzey idari bölüm, Beşinci düzey idari bölüm, geçmiş ilk sırada idari bölüm, üçüncü düzey idari bölüm, geçmiş siyasi Varlık, geçmiş idari bölüm, kamu siyasi varlık, geçmiş ikinci sipariş idari bölüm, siyasi bir varlığın büyük lisans |
| ADVENTURE\_SPOR\_MEKAN | Adventure Spor Mekan |
| TARIM | horticulture, birincil üretici, Tarım, Grup, Grup village, farmstead, alan, ortak, aquaculture olanağı, grupları, Süt, Balıkçılık alan grazing yerimizle, alanları |
| HAVAALANI | Özel yetkilisi, Askeri yetkilisi, Helikopter pisti, havaalanı kapalı, Orta, büyük Havaalanı, küçük Havaalanı, airfield, seaplane temel, genel yetkilisi, balon bağlantı noktası, havaalanı |
| EĞLENCE\_PARKA | eğlence arcade, eğlence yerde, eğlence parka |
| OTOMOTİV\_DAĞITICI | atv/kar motosikleti, bot, veri yolu, motosiklet, kamyon, van, recreational araçları, araba, otomotiv |
| BANKA | Banka, bankalar, bank(s) |
| PLAJ | Beach, dalışı |
| DERLEME\_NOKTASI | (nokta) oluşturma |
| İŞ\_PARKA | İş park, endüstriyel alanı |
| CAFE\_YAYIMLAMA | internet kafe, Çay house, kafe, internet kafe, kafe, kafe, microbrewery/Bira bahçesi, yayımlama, kafe/pub, kafe/yayımlama |
| KAMPÇILIK\_ÇIĞIR | Toprak kampçılık eğlence, caravan site |
| ARABA\_WASH | araba wash |
| NAKİT\_DAĞITICISI | Otomatik personellerinin makine nakit dağıtıcısı |
| CASINO | Casino |
| SİNEMA | Drive-in sinema, sinema |
| ŞEHİR\_MERKEZİ | Merkezi Yönetim alanında, şehir center Komşuları |
| KULÜBÜ\_İLİŞKİLENDİRME | Plaj kulübü, hockey kulübü kulübü ilişkilendirme |
...
| ASKERİ\_YÜKLEME | Askeri temel Yakası guard istasyon, Askeri yükleme, Denizcilik temel |
