...
### <a name="q-what-source-target-pairs-does-azure-database-migration-service-currently-support"></a>S. Hangi kaynak-hedef çiftlerinin Azure veritabanı geçiş hizmeti şu anda destekliyor mu?
...
### <a name="q-how-does-azure-database-migration-service-compare-to-other-microsoft-database-migration-tools-such-as-the-database-migration-assistant-dma-or-sql-server-migration-assistant-ssma"></a>S. Nasıl Azure veritabanı geçiş hizmeti veritabanı geçiş Yardımcısı (DMA) veya SQL Server Geçiş Yardımcısı (SSMA) gibi diğer Microsoft veritabanı geçiş araçları arasındaki fark nedir?
...
### <a name="q-how-does-azure-database-migration-service-compare-to-the-azure-migrate-offering"></a>S. Nasıl Azure veritabanı geçiş hizmeti, Azure geçişi teklife arasındaki fark nedir?
...
### <a name="q-what-versions-of-sql-server-does-azure-database-migration-service-support-as-a-source"></a>S. SQL Server'ın hangi sürümleri Azure veritabanı geçiş hizmeti, bir kaynak olarak destekliyor mu?

Azure veritabanı geçiş hizmeti, SQL Server'dan Geçiş sırasında SQL Server 2005, SQL Server 2017 ile destekler.

### <a name="q-what-is-a-summary-of-the-steps-required-to-use-azure-database-migration-service-to-perform-a-database-migration"></a>S. Veritabanı geçişi gerçekleştirmek için Azure veritabanı geçiş hizmeti kullanmak için gerekli adımları özetini nedir?
...
### <a name="q-what-are-the-prerequisites-for-using-azure-database-migration-service"></a>S. Azure veritabanı geçiş hizmeti kullanmak için Önkoşullar nelerdir?
...
### <a name="q-how-do-i-find-the-ip-address-for-azure-database-migration-service-so-that-i-can-create-an-allow-list-for-the-firewall-rules-used-to-access-my-source-database-for-migration"></a>S. Böylece geçiş için kaynak Veritabanım erişmek için kullanılan güvenlik duvarı kuralları için bir izin verilenler listesi oluşturmak nasıl IP adresi için Azure veritabanı geçiş hizmeti bulabilirim?
...
### <a name="q-im-setting-up-a-migration-project-in-dms-and-im-having-difficulty-connecting-to-my-source-database-what-should-i-do"></a>S. DMS bir geçiş projesini ayarı ve benim kaynak veritabanı'na bağlanma konusunda sorun yaşıyorum. Ne yapmalıyım?
...
### <a name="q-are-there-any-recommendations-for-optimizing-the-performance-of-azure-database-migration-service"></a>S. Azure veritabanı geçiş Hizmeti performansını iyileştirmek için herhangi bir önerimiz var mı?
...
Görüşlerinizi almak isteriz. Geri bildirimlerinizi gönderin ve / fikirleri sahip kullanıcı sesi aracılığıyla Azure veritabanı geçiş hizmeti hakkında [burada](https://feedback.azure.com/forums/906100-azure-database-migration-service), veya adresinden ekibine başvurarak [isteyin Azure veritabanı geçişlerini](mailto:AskAzureDatabaseMigrations@service.microsoft.com).
