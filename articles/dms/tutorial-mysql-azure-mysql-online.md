...
MySQL çalışanlar örnek veritabanını şirket içi sistemde olduğunu varsayarsak, mysqldump kullanarak şema geçişi yapmak için komut şöyledir:
```
...
Şemanızda yabancı anahtarlar varsa geçişe ilişkin ilk yük ve sürekli eşitleme başarısız olur.  DROP ve ADD yabancı anahtar betiklerini ayıklamak için MySQL Workbench'te şu betiği yürütün.
```
...
> [!IMPORTANT]
> Ayrıca şema geçiş hatası engellemek için herhangi bir DEFINER deyim kaldırdığınızdan emin olun.

Verilerde tetikleyiciniz varsa (ekleme veya güncelleştirme tetikleyicisi) bu, kaynaktan çoğaltılan veriler ile hedef arasında veri bütünlüğü sağlar. Geçiş sırasında tüm tablolardaki tetikleyicileri devre dışı bırakmanız ve geçişin tamamlanmasının ardından etkinleştirmeniz önerilir.
...
5. Fiyatlandırma katmanını seçin.
    ...
    Doğru Azure veritabanı geçiş hizmeti katmanını seçme yardıma gereksinim duyarsanız, Web günlüğü yayınlama önerilere bakın [bir Azure veritabanı geçiş hizmeti (Azure DMS) katmanı seçme](https://go.microsoft.com/fwlink/?linkid=861067). 
