...
1. **Geçiş ayarlarını yapılandırma** ekranında şu bilgileri girin:
    ...
    |**Azure depolama hesabı aboneliği** | Azure Depolama Hesabını içeren aboneliği seçin. |
