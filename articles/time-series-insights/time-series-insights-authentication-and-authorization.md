---
title: Azure Time Series Insights kimlik doğrulama - kimlik doğrulama ve yetkilendirme Azure Time Series Insights API'si tarafından nasıl | Microsoft Docs
