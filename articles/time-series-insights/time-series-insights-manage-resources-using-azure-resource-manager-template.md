...
Time Series Insights, aşağıdaki kaynakları destekler:
   ...
   | Erişim İlkesi | Erişim ilkeleri, veri sorguları gönderme, ortamdaki başvuru verilerini işleme ve kaydedilen sorguları ve Perspektifleri ortamla ilişkilendirilmiş paylaşım izni verin. Daha fazla bilgi için [Azure portalını kullanarak zaman serisi görüşleri ortamına veri erişimi verme](time-series-insights-data-access.md) |
...
1. Şablon ve parametre dosyası oluşturun.
...
Kopyala veya kopyalama [201-timeseriesinsights-ortam-ile-eventhub](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-timeseriesinsights-environment-with-eventhub/azuredeploy.json) github'dan şablon.
