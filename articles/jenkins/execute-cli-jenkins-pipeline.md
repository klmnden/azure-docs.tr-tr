...
[az appservice web config update](/cli/azure/webapp/config#az-appservice-web-config-update) komutunu kullanarak uygulamanız için gerekli Java çalışma zamanı yapılandırmasını ayarlayın.
