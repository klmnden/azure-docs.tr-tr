...
![Mimari](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-azure-hypervsite.png)
...
![Bileşenler](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-onprem-azure-vmm.png)



## <a name="replication-process"></a>Çoğaltma işlemi

![Hyper-V Azure çoğaltma](./media/concepts-hyper-v-to-azure-architecture/arch-hyperv-azure-workflow.png)
...
4. **İşler** sekmesinde işi izleyebilirsiniz.      ![İşler listesi](media/concepts-hyper-v-to-azure-architecture/image1.png) ![Korumayı etkinleştir ayrıntıları](media/concepts-hyper-v-to-azure-architecture/image2.png)
...
3. Varsayılan eşitleme saatleri dışında beklemek istemiyorsanız, bir VM el ile eşitleyebilirsiniz. Örneğin, bir kesinti oluşursa. Bu, Azure portalında yapmak için VM seçin > **eşitlemek**.
    ...
    ![El ile yeniden eşitleme](./media/concepts-hyper-v-to-azure-architecture/image4-site.png)
