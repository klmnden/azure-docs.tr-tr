...
Bu makalede bir VMware vCenter üzerinde gerçekleştirilen çeşitli Site kurtarma işlemleri açıklanır. Doğrulama [Önkoşullar](vmware-physical-azure-support-matrix.md#replicated-machines) başlamadan önce.
