...
Çoğaltma ve Azure sanal makineleri başka bir bölgeye bir bölgesinden kurtarma Bu makalede Azure Site Recovery için Ağ Kılavuzu ayrıntıları verilmektedir. Azure Site Recovery gereksinimleri hakkında daha fazla bilgi için bkz: [Önkoşullar](site-recovery-prereq.md) makalesi.

## <a name="site-recovery-architecture"></a>Site Recovery mimarisi

Site Recovery, böylece birincil bölge kesilme varsa bunlar kurtarılabilir başka bir Azure bölgesine Azure sanal makinelerde çalışan uygulamaların çoğaltmak için basit ve kolay bir yol sağlar. Daha fazla bilgi edinmek [bu senaryo ve Site Recovery mimarisi](site-recovery-azure-to-azure-architecture.md).
