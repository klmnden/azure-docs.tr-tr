...
description: Bildirimleri eupdates & Azure Site Recovery'de kullanılan bileşenlerini yükseltme hakkında genel bir bakış sağlar.
...
Azure Site Recovery destek matrisi ve hata düzeltmeleri varsa yeni özellikler, iyileştirmeler eklenmesi de dahil olmak üzere düzenli aralıklarla - hizmet güncelleştirmeleri yayımlar. Tüm en son özellikler ve geliştirmeler ve hata düzeltmeleri varsa, geçerli Al adavantage kalmak için kullanıcıların her zaman en son Azure SIte Recovery bileşenlerinin sürümüne güncelleştirmeleri önerilir. 
