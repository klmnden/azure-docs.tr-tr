...
4. İçinde **ayarları**, isteğe bağlı olarak hedef site ayarları yapılandırabilirsiniz:
   ...
   - **Önbellek depolama hesapları**: Site Recovery kaynak bölgede önbellek depolama adlı ek bir depolama hesabı gerekir. Kaynak VM üzerinde'olmuyor tüm değişiklikleri izlenir ve bu hedef konuma çoğaltılmadan önce önbellek depolama hesabına gönderilir. Bu depolama hesabı, standart olmalıdır.
   ...
   - **Çoğaltma İlkesi**: Kurtarma noktası bekletme geçmişine ve uygulama tutarlı anlık görüntü sıklığı ayarlarını tanımlar. Varsayılan olarak, Azure Site Recovery, ' 24 saat kurtarma noktası bekletme süresi için varsayılan ayarlarla yeni bir çoğaltma ilkesi oluşturur ve '4 saat' uygulama ile tutarlı anlık görüntü sıklığı.
