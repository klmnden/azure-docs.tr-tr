...
- Çoğaltmak istediğiniz makineleri ile uyumlu olduğundan emin olun [makine desteği çoğaltılan](vmware-physical-secondary-support-matrix.md#replicated-vm-support).
