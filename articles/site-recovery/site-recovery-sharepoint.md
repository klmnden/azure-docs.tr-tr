---
title: Azure Site Recovery kullanarak çok katmanlı bir SharePoint uygulaması çoğaltmak | Microsoft Docs
description: Bu makalede, Azure Site Recovery özelliklerini kullanarak çok katmanlı bir SharePoint uygulaması çoğaltmak açıklar.
...
ms.locfileid: "37916794"
---
# <a name="replicate-a-multi-tier-sharepoint-application-for-disaster-recovery-using-azure-site-recovery"></a>Azure Site Recovery ile olağanüstü durum kurtarma için çok katmanlı bir SharePoint uygulaması çoğaltın
