...
2. Şirket içi [VMware](tutorial-prepare-on-premises-vmware.md) veya Hyper-V sunucularını hazırlayın.

Başlamadan önce olağanüstü durum kurtarma için [VMware](concepts-vmware-to-azure-architecture.md) veya [Hyper-V](concepts-hyper-v-to-azure-architecture.md) mimarilerini gözden geçirmeniz yararlı olabilir.
...
- VMware VM’leri için kaynak ortamı [ayarlayın](tutorial-vmware-to-azure.md#set-up-the-source-environment).
- Fiziksel sunucular için kaynak ortamı [ayarlayın](tutorial-physical-to-azure.md#set-up-the-source-environment).
...
- VMware VM’leri için [çoğaltma ilkesi ayarlayın](tutorial-vmware-to-azure.md#create-a-replication-policy).
- Fiziksel VM’ler için [çoğaltma ilkesi ayarlayın](tutorial-physical-to-azure.md#create-a-replication-policy).
- Hyper-V VM’leri için [çoğaltma ilkesi ayarlayın](hyper-v-azure-tutorial.md#set-up-a-replication-policy).


## <a name="enable-replication"></a>Çoğaltmayı etkinleştirme

- VMware VM’leri için [çoğaltmayı etkinleştirin](tutorial-vmware-to-azure.md#enable-replication).
- Fiziksel sunucular için [çoğaltmayı etkinleştirin](tutorial-physical-to-azure.md#enable-replication).
- Hyper-V VM’leri için [çoğaltmayı etkinleştirin](hyper-v-azure-tutorial.md#enable-replication).
...
> Bir şirket içi siteden geçiş yaptıktan sonra, Azure VM’leri için [olağanüstü durum kurtarmayı ayarlayın](site-recovery-azure-to-azure-after-migration.md).
