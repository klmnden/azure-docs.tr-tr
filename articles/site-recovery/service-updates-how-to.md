...
|---------|---------|---------|---------|--------|
|Güncelleştirme paketi 36 *     |   5.1.4150.0  |  9.24.5211.1   |  5.1.4150.0  | 2.0.9160.0
...
* Sürüm Notları devam ediyor. Site Recovery bileşenlerini yükseltmek için ilgili yükseltme belgelerine başvurun.
