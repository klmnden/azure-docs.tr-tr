...
- Artık tamamladığınıza emin olun bir [olağanüstü durum kurtarma ayrıntıya](azure-to-azure-tutorial-dr-drill.md) her şeyi çalıştığını beklendiği gibi denetlemek için.
