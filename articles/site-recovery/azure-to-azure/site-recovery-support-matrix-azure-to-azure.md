...
>[!NOTE]
>
> - Olağanüstü durum kurtarma senaryoları için başka bir Azure sanal makineleri bir abonelikten çoğaltma desteklenmiyor.
> - Geçirme Azure abonelikleri sanal makinelerde desteklenmiyor.
> - Geçirme Azure sanal makineleri aynı bölge içinde desteklenmiyor.
> - Azure sanal makineleri Klasik dağıtım modelinden manager dağıtım modeli desteklenmiyor kaynağa geçirme.
...
- İş yükleri tarafından korumaya başlamak [Azure Vm'lerini çoğaltma](azure-to-azure-quickstart.md)
