...
![Bileşenler](./media/concepts-physical-to-azure-architecture/arch-enhanced.png)
...
![Çoğaltma işlemi](./media/concepts-physical-to-azure-architecture/v2a-architecture-henry.png)
...
![Yeniden çalışma](./media/concepts-physical-to-azure-architecture/enhanced-failback.png)
