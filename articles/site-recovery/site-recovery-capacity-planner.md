...
Kaynak ortamınız ve iş yükleri, tahmin bant genişliği gereksinimlerini ve sunucu kaynakları için kaynak konumu gerekir ve hedef konumda gereken kaynaklar (sanal makineler ve depolama vb.), analiz etmek için siteyi kurtarma kapasite Planlayıcısı kullanın.
