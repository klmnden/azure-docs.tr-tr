...
1. İndir ve Aç [Site Recovery Capacity Planner](http://aka.ms/asr-capacity-planner-excel). Makrolar çalıştırmanız gerekir. İstendiğinde, düzenlemeyi etkinleştir ve içerik seçim yapın.
