...
### [VMware-Azure arası mimari](site-recovery-architecture-vmware-to-azure.md)
...
#### [2. Adım: Önkoşulları ve sınırlamaları doğrulama](vmware-walkthrough-prerequisites.md)
