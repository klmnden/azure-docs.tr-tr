...
# Kullanmaya Başlama
## [Azure VM’lerini çoğaltma (önizleme)](azure-to-azure-walkthrough-overview.md)
### [1. Adım: Mimariyi gözden geçirme](azure-to-azure-walkthrough-architecture.md)
### [2. Adım: Başlamadan önce](azure-to-azure-walkthrough-prerequisites.md)
### [3. Adım: Ağı planlama](azure-to-azure-walkthrough-network.md)
### [4. Adım: Kasa oluşturma](azure-to-azure-walkthrough-vault.md)
### [5. Adım: Çoğaltmayı etkinleştirme](azure-to-azure-walkthrough-enable-replication.md)
### [6. Adım: Yük devretme testi çalıştırma](azure-to-azure-walkthrough-test-failover.md)
...
## [Hyper-V VM'lerini ikincil bir siteye çoğaltma (VMM ile)](vmm-to-vmm-walkthrough-overview.md)
### [1. Adım: Mimariyi gözden geçirme](vmm-to-vmm-walkthrough-architecture.md)
### [2. Adım: Önkoşulları ve sınırlamaları gözden geçirme](vmm-to-vmm-walkthrough-prerequisites.md)
### [3. Adım: Ağı planlama](vmm-to-vmm-walkthrough-network.md)
### [4. Adım: VMM ve Hyper-V hazırlama](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [5. Adım: Kasa oluşturma](vmm-to-vmm-walkthrough-create-vault.md)
### [6. Adım: Kaynağı ve hedefi ayarlama](vmm-to-vmm-walkthrough-source-target.md)
### [7. Adım: Ağ eşlemesini yapılandırma](vmm-to-vmm-walkthrough-network-mapping.md)
### [8. Adım: Çoğaltma ilkesi oluşturma](vmm-to-vmm-walkthrough-replication.md)
### [9. Adım: Çoğaltmayı etkinleştirme](vmm-to-vmm-walkthrough-enable-replication.md)
### [10. Adım: Yük devretme testi çalıştırma](vmm-to-vmm-walkthrough-test-failover.md)
