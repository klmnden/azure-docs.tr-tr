...
1. İçindeki adımları izleyerek Vm'leri korumalı Sil tüm [bir VMware korumasını devre dışı bırak](site-recovery-manage-registration-and-protection.md#disable-protection-for-a-azure-vm-azure-to-azure).
2. Kasayı silin.
