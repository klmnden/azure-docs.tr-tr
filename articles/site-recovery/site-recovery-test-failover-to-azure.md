...
Bu yordamda, bir kurtarma planı için bir yük devretme testi çalıştırma açıklanmaktadır. 
...
* VMware VM burada aşağıdaki sürücüleri önyükleme sürücüleri değildir:
    ...
    * intelide
    * Atapi
* VMware etkinse, DHCP olmayan VM DHCP veya statik IP adresleri kullanarak rrespective.
