...
Gibi hizmetleri [Mobile Apps](../../app-service-mobile/app-service-mobile-dotnet-how-to-use-client-library.md) ve [Azure Media Services](../../media-services/previous/media-services-dotnet-how-to-use.md) istemci-tarafı SDK'ları olanak sağlayan web ve mobil istemci uygulamaları hizmetlere erişim.
