...
# Önceden yapılandırılmış bağlı fabrika çözümlerini kullanmaya başlama
...
### Hazırlama işleminin tamamlanmasını beklerken
...
* Çözümdeki durumu, konumu ve geçerli üretim yapılandırmasını gösteren bir **fabrika listesi** paneli. Çözümü ilk kez çalıştırdığınızda, bir dizi sanal cihaz bulunur. Üretim hattı benzetimi, üretim hattı başına benzetimi yapılan görevleri gerçekleştiren ve verileri paylaşan üç gerçek OPC UA sunucusundan oluşur. OPC UA hakkında daha fazla bilgi için bkz. [SSS][lnk-faq].
...
* Destek bilgilerini göstermek için yeni tarayıcı penceresinde bir web sayfası yükleme.
* Uyarı nedenini hafifletmek için cihazda OPC UA yöntemini çağırma.
...
## Genel donanım verimliliğini görüntüleme
...
2. Hiyerarşi verilerinin herhangi bir düzeyinde OEE’de daha fazla analiz yapmak için, OEE yüzdesine, kullanılabilirlik yüzdesine, performans yüzdesine veya kalite yüzdesine tıklayın. Son bir saatin, son 24 saatin ve son 7 günün verilerinin gösterildiği, Zaman Serisi Görüşleri ile desteklenen görselleştirmelerle bir bağlam paneli görüntülenir.
...
## Önemli Performans Göstergelerini görüntüleme
...
2. Hiyerarşi verilerinin herhangi bir düzeyinde saat başına birim sayısını ve kullanılan enerji miktarını daha fazla analiz etmek için, **Önemli Performans Göstergeleri** panelinde üretilen birim sayısı veya kullanılan enerji ölçeğine tıklayın. Son bir saatin, son 24 saatin ve son 7 günün verilerini görebilmenizi sağlayan Zaman Serisi Görüşleri ile desteklenen görselleştirmelerle bir bağlam paneli görüntülenir.

<a id="scenario-review" class="xliff"></a>

## Senaryo gözden geçirme
...
Aşağıdaki bölümlerde, önceden yapılandırılmış bağlı fabrika çözümünün önceki senaryonun parçası olarak bahsedilmeyen bazı ek özellikleri açıklanmaktadır.
...
3. İhtiyacınız olan filtreyi seçin; gerekirse, filtre alanlarına serbest metin yazmak da mümkündür.
...
4. Sunucu ağacındaki düğümlerden herhangi birine tıklayarak düğümü genişletin. Yayımlama telemetrisi olan düğümlerin yanında bir onay işareti vardır.
...
*Sanal OPC UA sunucusuna* göz attığınızda, yeni düğümleri yayımlamayı da seçebilirsiniz. Çözümde bu düğümlerden gelen telemetriyi analiz edebilirsiniz. Bu *sanal OPC UA sunucuları* herhangi bir gerçek ve fiziksel cihaza dağıtmaya gerek olmadan önceden yapılandırılmış çözümü denemenizi kolaylaştırır.
