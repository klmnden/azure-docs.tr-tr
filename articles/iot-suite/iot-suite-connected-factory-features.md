...
* [Bağlı Fabrika önceden yapılandırılmış çözümü gözden geçirme](iot-suite-connected-factory-sample-walkthrough.md)
* [Bir ağ geçidi için Fabrika bağlı dağıtma]( iot-suite-connected-factory-gateway-deployment.md)
