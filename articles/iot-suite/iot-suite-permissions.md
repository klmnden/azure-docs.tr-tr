<properties
  pageTitle="Azure IoT Paketi ve Azure Active Directory | Microsoft Azure"
...
7. **Kullanıcılar**’a tıklayın.

8. Rollerini değiştirmek istediğiniz kullanıcıyı seçin.

9. **Ata**’ya tıklayın ve kullanıcıya atamak istediğiniz rolü (**Yönetici** gibi) seçip onay işaretine tıklayın.
