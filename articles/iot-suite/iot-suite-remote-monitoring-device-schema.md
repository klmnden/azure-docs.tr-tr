...
Cihaz davranışını uygulayan JavaScript dosyası hakkında daha fazla bilgi için bkz: [aygıt modeli davranışlarını anlamak](iot-suite-remote-monitoring-device-behavior.md).
...
JSON şeması hakkında öğrendiniz artık, önerilen sonraki adıma edinmektir nasıl [sanal cihazınız davranışını uygulamak](iot-suite-remote-monitoring-device-behavior.md).
