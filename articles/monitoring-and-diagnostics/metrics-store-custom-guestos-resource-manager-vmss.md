...
- Aboneliğiniz ile kaydedilmelidir [Microsoft.Insights](https://docs.microsoft.com/en-us/azure/azure-resource-manager/resource-manager-supported-services#portal). 
...
1. Üzerinde **İzleyici** sayfasında **ölçümleri**. 
   ...
   ![İzleyici - ölçümler sayfası](media/metrics-store-custom-guestos-resource-manager-vmss/metrics.png) 
