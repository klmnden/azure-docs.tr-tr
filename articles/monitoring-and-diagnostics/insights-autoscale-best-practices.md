...
* Tüm otomatik ölçeklendirme hataları, etkinlik günlüğüne kaydedilir. Ardından yapılandırabileceğiniz bir [etkinlik günlüğü Uyarısı](./monitoring-activity-log-alerts.md) böylece bir otomatik ölçeklendirme başarısız olduğunda, e-posta, SMS veya Web kancaları bildirim alabilir.
