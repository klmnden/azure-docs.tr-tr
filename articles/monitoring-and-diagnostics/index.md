        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure İzleyici video merkezi</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>İzleme</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">Desteklenen ölçümlerin listesi</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">Veri izleme kaynakları</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Tanılama</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Azure Tanılama uzantısı sürüm geçmişi</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Azure Tanılama uzantı şeması</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Azure Tanılama uzantı şeması 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Azure Tanılama uzantı şeması 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Azure Tanılama uzantı şeması 1.3’ten 1.7’ye</a></p>
                    </div>
                </div>
            </div>
        </div>
