...
3. Görüntülenen dikey penceresinde, akış olayları ve hizmet veri yolu Namespace bu olayları akış için oluşturulacak bir Event Hub istediğiniz için istediğiniz bölgeleri seçebilirsiniz.
