...
* Bu değişiklik aşağıdaki veri türlerini etkiler:
  ...
  * [Tanılama ayarları tarafından dışarı aktarılan bir azure kaynak ölçümleri](./monitoring-overview-of-diagnostic-logs.md#resource-diagnostic-settings)
