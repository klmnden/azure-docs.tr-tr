...
### [Bir ölçüm uyarısında web kancası yapılandırma](insights-webhooks-alerts.md)
...
## [Azure Tanılama Sürüm Geçmişi](azure-diagnostics-versioning-history.md)
## [Azure Tanılama Şeması](azure-diagnostics-schema.md)
### [Tanılama Şeması 1.0](azure-diagnostics-schema-1dot0.md)
### [Tanılama Şeması 1.2](azure-diagnostics-schema-1dot2.md)
### [Tanılama Şeması 1.3 - 1.7](azure-diagnostics-schema-1dot3-and-later.md)
