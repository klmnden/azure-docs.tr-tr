...
Konusunda bulunan yönergeleri kullanarak Azure Active Directory kiracınızda bir hizmet ilkesi oluşturma [hizmet sorumlusu oluşturma](../active-directory/develop/howto-create-service-principal-portal.md). 
...
2. Özel ölçümler desteklemeyen bir bölge karşı ölçümleri yayma. Bkz: [desteklenen bölgeler](metrics-custom-overview.md#supported-regions). 
