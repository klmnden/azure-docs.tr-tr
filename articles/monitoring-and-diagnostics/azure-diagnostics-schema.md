...
[Tanılama 1.3 ve üzeri yapılandırma şeması](azure-diagnostics-schema-1dot3-and-later.md)  
...
* Tüm performans sayaçlarını uyarı gönderilen Azure İzleyici ile [uyarı deneyimi birleşik](monitoring-overview-alerts.md) Azure İzleyici'de
...
>
> Lütfen şuna başvurun daha fazla ayrıntı için [ayrıntılı tanılama Uzantı Şeması belgeleri.](azure-diagnostics-schema-1dot3-and-later.md)
