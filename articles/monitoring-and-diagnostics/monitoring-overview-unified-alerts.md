...
## <a name="overview"></a>Genel Bakış
 ...
 - **Yazma deneyimini etkinlik günlüğü uyarılar için birleşik** -etkinlik günlüğü uyarıları doğrudan artık oluşturabilirsiniz **İzleyici** > **uyarıları (Önizleme)**. Bunlar daha önce oluşturabilirsiniz yalnızca aracılığıyla **İzleyici** > **etkinlik günlüğü**.
...
| Günlükler  | Etkinlik Günlükleri | Bu kategorideki tüm oluşturma, güncelleştirme, kayıtları içerir ve seçilen hedef (kaynak/kaynak grubu/abonelik) gerçekleştirilen eylemler silin. |
| Günlükler  | Hizmet durumu günlükleri | Uyarıları (Önizleme) deneyimi desteklenmez.   |
