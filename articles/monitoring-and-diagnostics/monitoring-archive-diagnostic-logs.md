...
## <a name="archive-diagnostic-logs-via-the-cross-platform-cli"></a>Platformlar arası CLI aracılığıyla arşiv tanılama günlükleri
```
...
| --- | --- | --- |
| resourceId |Evet |Kaynağın tanılama ayarını ayarlamak istediğiniz kaynak kimliği. |
| storageId |Hayır |Tanılama günlüklerini kaydedilmesi gereken depolama hesabının kaynak kimliği. |
| kategorileri |Hayır |Etkinleştirmek için günlük kategorileri virgülle ayrılmış listesi. |
| Etkin |Evet |Tanılama etkin veya bu kaynağa devre dışı olup olmadığını gösteren bir Boole değeri. |
