...
Azure İzleyici otomatik ölçeklendirme, yalnızca sanal makine ölçek kümeleri (VMSS), bulut Hizmetleri, app service planları ve app service ortamları için geçerlidir. 
