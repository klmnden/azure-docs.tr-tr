---
title: 'Sanal ağ eşlemesi için VPN ağ geçidi aktarımını yapılandırma: Azure Resource Manager | Microsoft Docs'
...
> [!IMPORTANT]
> Ağ geçidi aktarımı şu anda genel sanal ağ eşlemesi ile desteklenmemektedir.
