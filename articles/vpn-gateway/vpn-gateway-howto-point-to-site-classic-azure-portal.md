...
# Azure portalını kullanarak bir sanal ağa Noktadan Siteye bağlantı yapılandırma (klasik)
...
### 1. Kısım - VPN istemcisi yapılandırma paketini oluşturma ve yükleme
...
### 2. Kısım: İstemci sertifikasını yükleme
