---
title: Klasik portalı kullanarak bir Azure Sanal Ağa Noktadan Siteye bir VPN ağ geçidi bağlantısı yapılandırma | Microsoft Docs
...
## <a name="generate"></a>2. Bölüm - Sertifikaları oluşturma ve yükleme
...
### <a name="upload"></a>2. Kısım: Kök sertifika .cer dosyasını Klasik Azure Portalı’na yükleme
