...
>[AZURE.NOTE] Aşağıda listelenen değerler Azure VPN Gateway tarafından desteklenmekle birlikte, şu anda Azure VPN Gateway’de belirli bir birleşim belirtme ya da seçmenin bir yolu yoktur. Tüm kısıtlamaları şirket içi VPN cihazında belirtmeniz gerekir. Ayrıca, MSS’i 1350’de sıkıştırmanız gerekir.
