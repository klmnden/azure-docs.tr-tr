...
Cihazınız doğrulanan VPN cihazları tablosunda görünmüyorsa, bu makaledeki doğrulanmayan VPN cihazları bölümüne bakın. Cihazınızın Azure ile çalışması hala mümkün olabilir. VPN cihaz desteği için lütfen cihaz üreticinize başvurun.
...
- Yüksek Performanslı VPN gateway ve rota tabanlı VPN gateway özellikleri aksi belirtilmedikçe, aynıdır. Örneğin, rota tabanlı VPN gateway’ler ile uyumlu olan VPN cihazları yeni Azure Yüksek Performanslı VPN gateway’ler ile de uyumlu olacaktır. 


## Doğrulanan VPN cihazları 

Cihaz satıcılarıyla işbirliğiyle bir grup standart VPN cihazının doğruladık. Aşağıdaki listede yer alan cihaz ailelerindeki tüm cihazların Azure VPN gateway’ler ile çalışması gerekir. Yapılandırmak istediğiniz çözüme yönelik oluşturmanız gereken ağ geçidi türünü doğrulamak için, bkz. [VPN gateway’ler](vpn-gateway-about-vpngateways.md) makalesi. 
...
| Cisco                           | ASR                                                      | IOS 15.1 (ilke tabanlı), IOS 15.2 (rota tabanlı)                | [Cisco örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Cisco/Current/ASR)                                                                                                                                                                        | [Cisco örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Cisco/Current/ASR)                                                                                                                                 |
| Cisco                           | ISR                                                      | IOS 15.0 (ilke tabanlı), IOS 15.1 (rota tabanlı)               | [Cisco örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Cisco/Current/ISR)                                                                                                                                                                        | [Cisco örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Cisco/Current/ISR)                                                                                                                                |
| Citrix                          | CloudBridge MPX uygulaması veya VPX sanal cihaz       | Yok                                                | [Tümleştirme yönergeleri](https://www.citrix.com/welcome.html?resource=%2Fdownloads%2Fcloudbridge%2Fbetas-and-tech-previews%2Fcloudbridge-azure-integration)                                                                                                                                                                            | Uyumlu değil                                                                                                                                                                                               |
| Dell SonicWALL                  | TZ Serisi, NSA Serisi, SuperMassive Serisi, E-sınıfı NSA Serisi | SonicOS 5.8.x, [SonicOS 5.9.x](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide/supported-platforms?ParentProduct=850), [SonicOS 6.x](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide/supported-platforms?ParentProduct=646 )          | [Yönergeler - SonicOS 6.2](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide?ParentProduct=646) [Yönergeler - SonicOS 5.9](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide?ParentProduct=850)                                                                                                                                   | [Yönergeler - SonicOS 6.2](http://documents.software.dell.com/sonicos/6.2/microsoft-azure-configuration-guide?ParentProduct=646) [Yönergeler - SonicOS 5.9](http://documents.software.dell.com/sonicos/5.9/microsoft-azure-configuration-guide?ParentProduct=850)                                                                                                                                                                                      |
...
| Fortinet                        | FortiGate                                                | FortiOS 5.0.7                                      | [Yapılandırma yönergeleri](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                                                          | [Yapılandırma yönergeleri](http://docs.fortinet.com/fortigate/admin-guides)                                                                                                                                  |
...
| Juniper                         | SRX                                                      | JunOS 10.2 (ilke tabanlı), JunOS 11.4 (rota tabanlı)            | [Juniper örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Juniper/Current/SRX)                                                                                                                                                                      | [Juniper örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Juniper/Current/SRX)                                                                                                                              |
| Juniper                         | J-Serisi                                                 | JunOS 10.4r9 (ilke tabanlı), JunOS 11.4 (rota tabanlı)          | [Juniper örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Juniper/Current/JSeries)                                                                                                                                                                 | [Juniper örnekleri](https://github.com/Azure/Azure-vpn-config-samples/tree/master/Juniper/Current/JSeries)                                                                                                                         |
...
>[AZURE.NOTE] Aşağıda listelenen değerler Azure VPN Gateway tarafından desteklenmekle birlikte, şu anda Azure VPN Gateway’de belirli bir birleşim belirtme ya da seçmenin bir yolu yoktur. Tüm kısıtlamaları şirket içi VPN cihazında belirtmeniz gerekir.
...
| Aşama 1 Güvenlik İlişkisi (SA) Yaşam Süresi (Saat) | 28.800 saniye                 | 10.800 saniye                                                   |
...
Aşağıdaki tabloda, IPsec SA Şifreleme ve Kimlik Doğrulama Teklifleri listelenir. Teklifler, teklifin sunulduğu ya da kabul edildiği tercih sırasına göre listelenmiştir.
...
- Rota tabanlı ve Yüksek Performanslı VPN Gateway’ler ile IPsec ESP NULL şifrelemesini belirtebilirsiniz. Null tabanlı şifreleme aktarımdaki verilere koruma sağlamaz ve yalnızca maksimum performans ve minimum gecikme gerekli olduğunda kullanılmalıdır.  İstemciler bunu VNet - VNet iletişim senaryolarında ya da şifreleme çözümdeki başka bir yere uygulanmakta olduğunda kullanmayı seçebilir.
