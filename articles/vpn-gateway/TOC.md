...
### [Siteden Siteye bağlantı yapılandırma](vpn-gateway-howto-site-to-site-classic-portal.md)
### [Noktadan Siteye bağlantı yapılandırma](vpn-gateway-howto-point-to-site-classic-azure-portal.md)
### [Sanal ağlar arasında bağlantı yapılandırma](vpn-gateway-howto-vnet-vnet-portal-classic.md)
### [Zorlamalı tünel oluşturmayı yapılandırma](vpn-gateway-about-forced-tunneling.md)
### [VPN ağ geçidini silme](vpn-gateway-delete-vnet-gateway-classic-powershell.md)
### [Birden çok S2S bağlantısı yapılandırma](vpn-gateway-multi-site.md)
### [VPN ağ geçidi yapılandırma](vpn-gateway-configure-vpn-gateway-mp.md)
