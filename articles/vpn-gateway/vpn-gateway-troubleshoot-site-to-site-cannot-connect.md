...
### <a name="step-3-verify-the-vpn-peer-ips"></a>Adım 3. VPN eş IP'ler doğrulayın
...
### <a name="step-4-check-udr-and-nsgs-on-the-gateway-subnet"></a>4\. adımı. UDR ve Nsg'ler ağ geçidi alt ağda kontrol edin.
...
### <a name="step-5-check-the-on-premises-vpn-device-external-interface-address"></a>5\. adımı. Şirket içi VPN cihazı dış arabirimi adresi denetleyin
