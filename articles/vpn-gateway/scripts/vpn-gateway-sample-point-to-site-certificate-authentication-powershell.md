...
| [Add-AzureRmVpnClientRootCertificate](/powershell/module/azurerm.network/add-azurermvpnclientrootcertificate) | Kök sertifikanın ortak anahtar bilgilerini VPN Gateway’e yükler.|
...
| [New-SelfSignedCertificate](/powershell/module/azurerm.resources/new-selfsignedcertificate) | Yeni bir otomatik olarak imzalanan kök sertifika oluşturur. |
