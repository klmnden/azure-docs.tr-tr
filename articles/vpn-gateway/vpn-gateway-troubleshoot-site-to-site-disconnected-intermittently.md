...
Yeni veya var olan bir Microsoft Azure noktadan siteye VPN bağlantısı kararlı değilse veya düzenli olarak keser sorunla karşılaşabilirsiniz. Bu makalede, sorun giderme belirlemek ve sorunun nedenini çözümlemenize yardımcı olması için adımlar sağlanmaktadır. 
