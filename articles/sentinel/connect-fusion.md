...
ms.locfileid: "56993310"
---
# <a name="enable-fusion"></a>Fusion etkinleştir
...
4. Kimlik doğrulaması yaptıktan sonra ve ve Azure sürücüsü yapılandırıldığında, aşağıdaki komutları çalıştırın komut isteminde aşağıdakini: 
