        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Service Bus Mesajlaşma hakkında bilgi alın</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Service Bus Mesajlaşma Video Kitaplığı</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>DİĞER</h3>
                        <p><a href="service-bus-messaging-exceptions.md">Özel durumlar</a></p>
                        <p><a href="service-bus-quotas.md">Kotalar</a></p>
                        <p><a href="service-bus-messaging-sql-filter.md">SQLFilter söz dizimi</a></p>
                        <p><a href="service-bus-messaging-sql-rule-action.md">SQLRuleAction söz dizimi</a></p>
                   </div>
                </div>
            </div>
        </div>
