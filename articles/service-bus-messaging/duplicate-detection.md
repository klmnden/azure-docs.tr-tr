...
Bir uygulama karşılaşırsa hemen sonra önemli bir hata ileti gönderir ve yeniden uygulama örneği bu nedenle yanlışlıkla önceki ileti teslimi değil gerçekleştiğinden, sonraki gönderme sistemde görünmesi aynı iletiyi neden olduğunu düşündüğünü iki kez.

Ayrıca ve gönderilen iletiyi kuyruğa istemciye başarıyla kolaylaştırarak değil bildirim ile kaydedilmiş biraz daha önce gerçekleşmesi için istemci veya ağ düzeyinde bir hata için mümkündür. Bu senaryo, gönderme işlemi sonucuyla ilgili şüpheli istemci bırakır.
