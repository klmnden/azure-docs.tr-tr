...
* [Automation PowerShell cmdlet'leri](http://msdn.microsoft.com/library/dn690262.aspx)
* [Otomasyon REST API'si](http://msdn.microsoft.com/library/mt662285.aspx)
* [Topluluk runbook'ları](https://gallery.technet.microsoft.com/scriptcenter/site/search?f%5B0%5D.Type=RootCategory&f%5B0%5D.Value=WindowsAzure&f%5B0%5D.Text=Windows%20Azure)
...
* [Günlük analizi REST API'si](/rest/api/loganalytics)
* [Günlük analizi HTTP veri toplayıcı API](../log-analytics/log-analytics-data-collector-api.md)
* [Günlük arama REST API'si](../log-analytics/log-analytics-log-search-api.md)
* [Uyarı REST API'si](../log-analytics/log-analytics-api-alerts.md)
* [Günlük analizi PowerShell cmdlet'leri](https://msdn.microsoft.com/library/mt188224.aspx)
* [Günlük analizi .NET kitaplığı](https://www.nuget.org/packages/Microsoft.Azure.Management.OperationalInsights/0.16.0-preview)

## <a name="service-map"></a>Hizmet Eşlemesi
* [Hizmet eşlemesi belgeleri](operations-management-suite-service-map.md)
* [Hizmet eşlemesi REST API'si](https://docs.microsoft.com/rest/api/servicemap/)
