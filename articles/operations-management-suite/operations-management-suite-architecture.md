<properties 
   pageTitle="Operations Management Suite (OMS) mimarisi | Microsoft Azure"
...
**VMWare sanal makinelerinin çoğaltılması**
...
**Fiziksel Windows ve Linux sunucularının çoğaltılması** 
