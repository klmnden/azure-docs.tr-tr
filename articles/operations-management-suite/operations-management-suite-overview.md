...
## <a name="automation-controlmediaoperationsmanagementsuiteoverviewiconautomationcontrolpng-automation-control"></a>![Otomasyon ve Denetim](media/operations-management-suite-overview/icon-automation-control.png) Otomasyon ve Denetim
...
## <a name="protection-and-recoverymediaoperationsmanagementsuiteoverviewiconprotectionrecoverypng-protection-and-disaster-recovery"></a>![Koruma ve Kurtarma](media/operations-management-suite-overview/icon-protection-recovery.png) Koruma ve Olağanüstü Durum Kurtarma
...
## <a name="oms-security-and-compliancemediaoperationsmanagementsuiteoverviewiconsecuritycompliancepng-security-and-compliance"></a>![OMS Güvenlik ve Uyumluluk](media/operations-management-suite-overview/icon-security-compliance.png) Güvenlik ve Uyumluluk
