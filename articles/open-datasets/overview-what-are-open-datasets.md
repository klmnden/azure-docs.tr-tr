...
Bir Azure hesabı, açık veri kümeleri kullanılarak kod erişebilir veya arabirimi Azure hizmet. Azure bulut işlem kaynaklarının kullanılmak üzere makine öğrenimi çözüm ile birlikte verilerdir.  
