<properties 
   pageTitle="StorSimple cihazınızı dağıtma (Güncelleştirme 2) | Microsoft Azure"
...
> [AZURE.IMPORTANT] StorSimple Yöneticisi hem ölçülü hem de tam kaynak kullanan birimler oluşturabilir. Ancak kısmen sağlanan birimler oluşturamazsınız. 
