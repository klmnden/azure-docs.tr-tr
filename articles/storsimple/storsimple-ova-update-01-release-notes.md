...
| Özellik | Sorun |
| --- | --- |
| Güncellemeler |Güncelleştirmeleri yüklemek için yerel Web kullanıcı arabirimini kullanmanız gerekiyordu böylece son sürümde, güncelleştirmeleri otomatik olarak Klasik Azure portalında algılanan doğru. Bu sürümde bu sorun düzeltilmiştir. Güncelleştirme 0.2 yükledikten sonra Klasik Azure portalını kullanarak gelecekteki güncelleştirmeleri yükleyebilirsiniz. |
