---
title: StorSimple 8000 serisi cihaz denetleyicisi Değiştir | Microsoft Docs
description: Kaldırdığınızda ve değiştirdiğinizde, StorSimple 8000 serisi Cihazınızda biri veya her ikisi denetleyicisi modülleri açıklanmaktadır.
services: storsimple
documentationcenter: ''
author: alkohli
manager: timlt
...
| 5 |Bir veya iki denetleyicileri başarısız oldu. Cihaz seri konsolu veya Windows PowerShell uzaktan iletişimini erişemez. |[Microsoft Support başvurun](storsimple-8000-contact-microsoft-support.md) el ile denetleyicisi değiştirme yordamı. |
...
> [!IMPORTANT]
> Bir denetleyici değiştirme ve kaldırma gözden önce güvenlik bilgileri [StorSimple donanım bileşeni değiştirme](storsimple-8000-hardware-component-replacement.md).
> 
> 
...
1. Azure portalında StorSimple cihaz Yöneticisi hizmetine gidin, **aygıtları**ve ardından izlemek istediğiniz cihazın adına tıklayın.
2. Git **İzleyici > donanım durumu**. Denetleyici 0 ve denetleyici 1 durumunu hata belirten kırmızı olması gerekir.
...
8. Denetleyici yeniden başlatıldıktan sonra denetleyin **denetleyicisi durumunu** ve **küme durumu** denetleyicisi sağlıklı bir duruma ve bekleme modunda olduğunu doğrulamak için Azure Portalı'nda.
...
5. Değiştirme Azure portalında başarılı olduğunu doğrulamak için aygıtınıza gidin ve ardından gidin **İzleyici** > **donanım durumu**ve denetleyici 0 ve denetleyici 1 sağlıklı olduğundan emin olun (durum yeşil).
...
* [Etkin denetleyicisi belirlemek için Azure portalını kullanın](#use-the-azure-portal-to-identify-the-active-controller)
...
### <a name="use-the-azure-portal-to-identify-the-active-controller"></a>Etkin denetleyicisi belirlemek için Azure portalını kullanın
Azure portalında aygıtınıza gidin ve ardından **İzleyici** > **donanım durumu**ve kaydırma **denetleyicileri** bölümü. Burada, hangi denetleyicisi etkindir doğrulayabilirsiniz.

![Azure Portalı'nda etkin denetleyiciyi belirle](./media/storsimple-controller-replacement/IC752072.png)

**Şekil 6** etkin denetleyicisi gösteren Azure portalı
