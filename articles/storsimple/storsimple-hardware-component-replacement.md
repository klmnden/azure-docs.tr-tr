---
title: "StorSimple donanım bileşeni değiştirme | Microsoft Docs"
...
|:--- |:--- |:--- |:--- |
| Kasa |1 |Hayır |[Kasa, StorSimple Cihazınızda değiştirin](storsimple-chassis-replacement.md) |
| Birincil denetleyicileri |2 |Evet |[Bir denetleyici modülü, StorSimple Cihazınızda değiştirin](storsimple-controller-replacement.md) |
| 764W güç ve soğutma modülleri (PCMs) |2 |Evet |[StorSimple Cihazınızda güç ve soğutma modülü değiştirin](storsimple-power-cooling-module-replacement.md) |
| Yedek pil |2 |Evet |[StorSimple Cihazınızda yedek pil modülü değiştirin](storsimple-battery-replacement.md) |
| Disk sürücüleri |12 |Evet |[StorSimple Cihazınızı disk sürücüsünde değiştirin](storsimple-disk-drive-replacement.md) |
...
|:--- |:--- |:--- |:--- |
| Kasa |1 |Hayır |[Kasa, StorSimple Cihazınızda değiştirin](storsimple-chassis-replacement.md) |
| EBOD denetleyicisi |2 |Evet |[EBOD denetleyicisi, StorSimple Cihazınızda değiştirin](storsimple-ebod-controller-replacement.md) |
| 580W güç ve soğutma modülleri (PCMs) |2 |Evet |[StorSimple Cihazınızda güç ve soğutma modülü değiştirin](storsimple-power-cooling-module-replacement.md) |
| Disk sürücüleri |12 |Evet |[StorSimple Cihazınızı disk sürücüsünde değiştirin](storsimple-disk-drive-replacement.md) |
...
Lütfen [Microsoft Support başvurun](storsimple-contact-microsoft-support.md) bu değiştirme birimleri hiçbirini sıralamak için.
