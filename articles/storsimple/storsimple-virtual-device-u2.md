<properties 
   pageTitle="StorSimple sanal cihazını Güncelleştirme 2 | Microsoft Azure"
...
#### Sanal cihaz modeli karşılaştırması
...
| **Depolama türü**          | Yerel diskler için Azure Standard Storage kullanır.<br></br> [Standart Depolama hesabı oluşturmayı]() öğrenin. | Yerel diskler için Azure Premium Storage kullanır<sup>2</sup> <br></br>[Premium Storage hesabı oluşturmayı](storage-premium-storage.md#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk) öğrenin.                                                               |
...
<sup>2</sup> *Hem 8010 hem de 8020 bulut katmanı için Azure Standard Storage kullanır. Tek fark cihazdaki yerel katmandadır*.

#### 8020 için desteklenen bölgeler
...
## Sanal cihazın fiziksel cihazdan farkı
...
- Sanal cihazla aynı bölgede bir [depolama hesabı](storsimple-manage-storage-accounts.md#add-a-storage-account) kullanın. Farklı bölgelerdeki Depolama hesapları performansın düşmesine neden olabilir. Sanal cihazla Standart veya Premium Storage hesabı kullanabilirsiniz. [Standard Storage hesabı]() ya da [Premium Storage hesabı](storage-premium-storage.md#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk) oluşturma hakkında daha fazla bilgi
...
## Sanal cihaz oluşturma ve yapılandırma
...
### 3. Adım: (İsteğe bağlı) Cihaz yapılandırma ayarlarını değiştirme
...
#### CHAP başlatıcısını yapılandırma
...
#### StorSimple Snapshot Manager parolasını yapılandırma
...
>[AZURE.NOTE] Sanal cihaz için, Windows ana bilgisayarınız bir Azure sanal makinesidir.
...
#### Cihaz yöneticisi parolasını değiştirme 
...
### 1. Adım: Uzaktan yönetimi yapılandırma
...
### 2. Adım: Sanal cihaza uzaktan erişim
...
>[AZURE.WARNING] **Gelişmiş güvenlik için, uç noktalara bağlanırken HTTPS kullanmanızı ve ardından PowerShell uzak oturumunuz tamamladıktan sonra uç noktaları silmenizi öneririz.**
...
## Sanal cihaza doğrudan bağlanma
...
## StorSimple sanal cihazıyla çalışma
...
### StorSimple sanal cihazına bakım yapma
...
### Sanal cihaz için depolama hesapları
...
### StorSimple sanal cihazını devre dışı bırakma
...
### Sanal cihazı başlatma, durdurma ve yeniden başlatma
...
## Sanal cihazı kapatma ya da silme
