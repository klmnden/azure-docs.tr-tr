...
#### <a name="risk-assessment-policy-and-procedures"></a>Risk değerlendirmesi ilke ve yordamlar
...
|||
|---|---|
| **Müşteri** | Müşteri'nin Kurumsal düzeyde risk değerlendirmesi ilke ve yordamlar bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-2a"></a>NIST 800 53 denetim RA-2.a
...
|||
|---|---|
| **Müşteri** | Müşteri, müşteri tarafından dağıtılan kaynakları ve yer alan bilgileri kategorilere ayırmak için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-2b"></a>NIST 800 53 denetim RA-2.b
...
|||
|---|---|
| **Müşteri** | Müşteri RA-02.a tanımlanan güvenlik kategori sonuçlarını belgelemesinden sorumlu değildir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-2c"></a>NIST 800 53 denetim RA-2.c
...
|||
|---|---|
| **Müşteri** | Müşteri, güvenlik kategori kararı gözden geçirdikten ve onaylanan sağlamak için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-3a"></a>NIST 800 53 denetim RA-3.a
...
|||
|---|---|
| **Müşteri** | Müşteri, risk değerlendirmesi yürütmek için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-3b"></a>NIST 800 53 denetim RA-3.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-3c"></a>NIST 800 53 denetim RA-3.c
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-3d"></a>NIST 800 53 denetim RA-3.d
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-3e"></a>NIST 800 53 denetim RA-3.e
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-5a"></a>NIST 800 53 denetim RA-5.a
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-5b"></a>NIST 800 53 denetim RA-5.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ra-5c"></a>NIST 800 53 denetim RA-5.c
...
|||
|---|---|
| **Müşteri** | Müşteri tarama raporları çözümlemek için sorumludur ve güvenlik denetimi değerlendirmeleri sonuçlanır. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-5d"></a>NIST 800 53 denetim RA-5.d
...
|||
|---|---|
| **Müşteri** | Müşteri (uygulamalar, işletim sistemleri, veritabanları ve yazılım dahil etmek için) Müşteri risk değerlendirmesi uygun olarak kaynaklara müşteri tarafından dağıtılan düzelterek güvenlik açıkları için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ra-5e"></a>NIST 800 53 denetim RA-5.e
...
|||
|---|---|
| **Müşteri** | Müşteri, benzer güvenlik açıkları müşteri tarafından dağıtılan kaynaklar arasında ortadan kaldırmanıza yardımcı olmak için işlemi ve güvenlik denetimi değerlendirmeleri tarama açığından alınan bilgi paylaşımı için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ### <a name="nist-800-53-control-ra-5-1"></a>NIST 800 53 denetim RA-5 (1)
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ra-5-2"></a>NIST 800 53 denetim RA-5 (2)

#### <a name="vulnerability-scanning--update-by-frequency--prior-to-new-scan--when-identified"></a>Güvenlik Açığı taraması | Güncelleştirme sıklığı tarafından / önce yeni tarama / tanımlanan olduğunda
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ra-5-3"></a>NIST 800 53 denetim RA-5 (3)

#### <a name="vulnerability-scanning--breadth--depth-of-coverage"></a>Güvenlik Açığı taraması | Avantajlarına / kapsamı derinliği
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ra-5-4"></a>NIST 800 53 denetim RA-5 (4)

#### <a name="vulnerability-scanning--discoverable-information"></a>Güvenlik Açığı taraması | Bulunabilirlik bilgileri
...
|||
|---|---|
| **Müşteri** | Müşteri, bulunabilirlik bilgilere yanıt eylemin gerçekleştirilmesi sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ### <a name="nist-800-53-control-ra-5-5"></a>NIST 800 53 denetim RA-5 (5)
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ra-5-6"></a>NIST 800 53 denetim RA-5 (6)
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ra-5-8"></a>NIST 800 53 denetim RA-5 (8)

#### <a name="vulnerability-scanning--review-historic-audit-logs"></a>Güvenlik Açığı taraması | Geçmiş denetim günlüklerini gözden geçirin
...
|||
|---|---|
| **Müşteri** | Müşteri, geçmiş denetim günlüklerini gözden geçirmek için sorumludur. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ### <a name="nist-800-53-control-ra-5-10"></a>NIST 800 53 denetim RA-5 (10)

#### <a name="vulnerability-scanning--correlate-scanning-information"></a>Güvenlik Açığı taraması | Tarama bilgi ilişkilendirmek
