...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel güvenlik ilkesi ve yordamlar bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-2a"></a>NIST 800 53 denetim PS-2.a

#### <a name="position-risk-designation"></a>Pozisyon Risk unvanı
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde konumu risk belirtimler bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-2b"></a>NIST 800 53 denetim PS-2.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-2c"></a>NIST 800 53 denetim PS-2.c
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-3a"></a>NIST 800 53 denetim PS-3.a
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kurumsal düzey personeline işlem filtreleme bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-3b"></a>NIST 800 53 denetim PS-3.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ps-3-3a"></a>NIST 800 53 PS-3 (3) bir denetim

#### <a name="personnel-screening--information-with-special-protection-measures"></a>Filtreleme personel | Özel koruma önlemlerinin bilgilerle
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ### <a name="nist-800-53-control-ps-3-3b"></a>NIST 800 53 PS-3 (3) .b denetleme
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-4a"></a>NIST 800 53 denetim PS-4.a
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları bilgileri sistem erişim sağlamak için bir işlem derhal sona erdirildi oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-4b"></a>NIST 800 53 denetim PS-4.b
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları Doğrulayıcı/kimlik bilgilerinin sonlandırmak/iptal etmek için bir işlem oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-4c"></a>NIST 800 53 denetim PS-4.c
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları bir çıkış görüşme içerebilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-4d"></a>NIST 800 53 denetim PS-4.d
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları güvenlikle ilgili bilgileri ve özellik sonlandırılan çalışanlardan almak için bir işlem oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-4e"></a>NIST 800 53 denetim PS-4.e
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları bilgi systems erişim sağlamak için bir işlem tutulur oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-4f"></a>NIST 800 53 denetim PS-4.f
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları bir bildirim işlemi içerebilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ### <a name="nist-800-53-control-ps-4-2"></a>NIST 800 53 denetim PS-4 (2)
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel sonlandırma yordamları kuruluş personel veya rolleri için uygun şekilde sonlandırma bildirim sağlamak için bir otomatik mekanizmaları. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-5a"></a>NIST 800 53 denetim PS-5.a
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel aktarımı yordamları mantıksal ve fiziksel erişim yetkilendirme gözden geçirme adresi. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-5b"></a>NIST 800 53 denetim PS-5.b
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel aktarımı yordamları bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-5c"></a>NIST 800 53 denetim PS-5.c
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel aktarımı yordamları erişim kimlik doğrulamalarını gerektiği şekilde değiştirmek için bir işlem oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-5d"></a>NIST 800 53 denetim PS-5.d
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde personel aktarımı yordamları bir bildirim işlemi oluşturabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-6a"></a>NIST 800 53 denetim PS-6.a

#### <a name="access-agreements"></a>Erişim sözleşmeleri
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde erişim anlaşmaları (örneğin, gizlilik anlaşmaları, kabul edilebilir kullanım anlaşmaları) Bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-6b"></a>NIST 800 53 denetim PS-6.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-6c"></a>NIST 800 53 denetim PS-6.c
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-7a"></a>NIST 800 53 denetim PS-7.a
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde üçüncü taraf personel işlem filtreleme bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-7b"></a>NIST 800 53 denetim PS-7.b
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-7c"></a>NIST 800 53 denetim PS-7.c
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-7d"></a>NIST 800 53 denetim PS-7.d
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-7e"></a>NIST 800 53 denetim PS-7.e
...
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |
 ...
 ## <a name="nist-800-53-control-ps-8a"></a>NIST 800 53 denetim PS-8.a

#### <a name="personnel-sanctions"></a>Personel Sanctions
...
|||
|---|---|
| **Müşteri** | Müşteri'nin kuruluş düzeyinde çalışan sanctions işlemi bu denetim gidermek yeterli olabilir. |
| **Sağlayıcı (Microsoft Azure)** | Uygulanamaz |


 ## <a name="nist-800-53-control-ps-8b"></a>NIST 800 53 denetim PS-8.b
