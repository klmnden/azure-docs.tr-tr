...
| **Sağlayıcı&nbsp;(Microsoft&nbsp;Azure)** | Microsoft Azure güvenlik etkin izleme gereksinimleri tanımlanır. Hizmet ekipleri bu gereksinimlere uygun etkin izleme araçları yapılandırın. Etkin izleme araçları Acil eylem gerektiren durumlarda Microsoft Azure güvenliği personeli için gerçek zamanlı uyarılar sağlamak üzere yapılandırılmış İzleme Aracısı (MA) ve System Center Operations Manager (SCOM) içerir. |
...
Bu işlemler gerekmez veya karmaşık açıklama büyük miktarlarda gerektirir, ancak iyi Olay yönetimi, güvenlik, güvenilirlik ve bir hizmet ile ortam sorunlarını kullanıcılara etkisini en aza.
