...
| **SDL aşaması**               | Oluşturma |  
| **İlgili teknolojiler** | Genel |
| **Öznitelikleri**              | StorageType - tablo |
...
| **Öznitelikleri**              | Yok, kimlik sağlayıcısı - AD FS, kimlik sağlayıcısı - Azure AD |
