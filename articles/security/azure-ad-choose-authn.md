...
* **Gelişmiş senaryolar**. Kuruluşlar için seçerseniz, Azure AD kimlik koruması raporlarla kimlikleri ınsights'tan kullanmak mümkündür. Sızan kimlik bilgileri rapor olarak buna bir örnektir. Windows iş için Hello olan diğer seçenek ise [parola karması eşitleme kullandığınızda belirli gereksinimleri](https://docs.microsoft.com/windows/access-protection/hello-for-business/hello-identity-verification). 
...
|Hangi kullanıcı hesabı durumları destekleniyor mu?|Devre dışı bırakılmış hesapları<br>(en fazla 30 dakika Gecikmeli)|Devre dışı bırakılmış hesapları<br><br>Hesap kilitli<br><br>Parolanın süresi dolsun<br><br>Oturum açma saatleri|Devre dışı bırakılmış hesapları<br><br>Hesap kilitli<br><br>Parolanın süresi dolsun<br><br>Oturum açma saatleri|
|Koşullu erişim seçenekleri nelerdir?|[Azure AD koşullu erişim](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)|[Azure AD koşullu erişim](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)|[Azure AD koşullu erişim](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-azure-portal)<br><br>[AD FS talep kuralları](https://adfshelp.microsoft.com/AadTrustClaims/ClaimsGenerator)|
