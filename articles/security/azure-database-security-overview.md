...
-   [Azure VM'de SQL Server ile Azure anahtar kasası](http://blogs.technet.com/b/kv/archive/2015/01/12/using-the-key-vault-for-sql-server-encryption.aspx), donanım güvenlik modülüne veya şifreleme anahtar hiyerarşinin Merkezi Yönetim gerekiyorsa.
