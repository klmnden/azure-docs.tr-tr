...
## <a name="step-1-obtain-a-key"></a>1. adım: bir anahtar alın
...
## <a name="step-2-instrument-your-app-with-the-rum-package-of-mobile-center-sdk"></a>2. adım: uygulamanızı ÇALIŞTIRMA paketi Mobile Center SDK'sı ile izleme
