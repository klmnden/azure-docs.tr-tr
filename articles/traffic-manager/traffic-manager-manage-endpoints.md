...
>[AZURE.NOTE]  Bu makalede, klasik portalın nasıl kullanılacağı açıklanmıştır. Klasik Azure portalı, yalnızca bulut hizmetlerinin ve Web uygulamalarının oluşturulmasını ve uç noktalar olarak atanmasını destekler. Yeni [Azure portal](https://portal.azure.com) tercih edilen arabirimdir.
