<properties
    pageTitle="Bir şirketin İnternet etki alanını Traffic Manager etki alanı adına yönlendirme | Microsoft Azure"
...
>[AZURE.IMPORTANT] *contoso.com* gibi ikinci düzey bir etki alanını Traffic Manager etki alanına yönlendiremezsiniz. DNS protokolü standartları, ikinci düzey etki alanı adları için CNAME kayıtlarına izin vermez.
