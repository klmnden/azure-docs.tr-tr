...
ms.locfileid: "53019266"
---
# <a name="quickstart-use-azure-cache-for-redis-with-a-net-core-app"></a>Hızlı Başlangıç: Azure önbelleği için Redis .NET ile kullanın. Core uygulaması
