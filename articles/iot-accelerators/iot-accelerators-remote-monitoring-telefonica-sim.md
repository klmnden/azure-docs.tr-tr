...
Uzaktan izleme için Cihazınızı bağlamak için bu öğreticileri kullanarak izleyebileceğiniz [C](iot-accelerators-connecting-devices-linux.md) veya [düğümü](iot-accelerators-connecting-devices-node.md). 
...
* [Azure IOT Uzaktan izleme çözümü çalışmayabilir](iot-accelerators-remote-monitoring-explore.md)
