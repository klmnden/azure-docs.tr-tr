...
1. Dağıtma bir **temel** kullanarak Çözüm Hızlandırıcısı örneğini **bilgisayarları** CLI. Dağıtımınız ve sanal makine için sağlanan kimlik bilgileri adını not edin. Daha fazla bilgi için bkz: [CLI kullanarak dağıtmak](iot-accelerators-remote-monitoring-deploy-cli.md).
...
![Değişiklik paneli düzeni](./media/iot-accelerators-remote-monitoring-customize/layout.png)
...
![Güncelleştirilmiş alarmlar paneli](./media/iot-accelerators-remote-monitoring-customize/reorder-columns.png)
