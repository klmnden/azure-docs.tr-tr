...
Uzaktan izleme çözümünde iş tümleştirmesi sıcak depolamaya yerleştirilen alarmlar, nesil sınırlıdır. Çözüm, daha kapsamlı iş tümleştirme senaryolarını uygulamak için Azure Logic Apps ile bağlanın.
