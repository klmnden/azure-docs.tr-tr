...
ms.locfileid: "34725590"
---
# <a name="compare-azure-iot-options"></a>Azure IoT seçeneklerini karşılaştırma

[Azure ve Nesnelerin İnterneti](iot-accelerators-what-is-azure-iot.md) makalesi aşağıdaki katmanlarla tipik bir IoT çözüm mimarisini açıklar:
...
* [Azure IoT çözüm hızlandırıcıları](../active-directory-domain-services/index.yml), özel IoT çözümlerinin geliştirilmesini hızlandırmanızı sağlayan Azure Hizmet Olarak Platform (PaaS) ile tümleşik, [çözüm hızlandırıcılardan](iot-accelerators-what-are-solution-accelerators.md) oluşan, kurumsal düzeyde bir koleksiyondur.
...
* **Azure IoT çözüm hızlandırıcıları**: [Azure IoT çözüm hızlandırıcıları nelerdir?](iot-accelerators-what-are-solution-accelerators.md)
