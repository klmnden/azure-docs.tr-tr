...
[Azure Resource Manager kaynak sağlayıcısı işlemleri](../role-based-access-control/resource-provider-operations.md#microsoftapimanagement) makale API Management düzeyinde verilebilir izinleri listesini içerir.
