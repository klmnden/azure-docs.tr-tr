---
title: "Azure PowerShell Betiği örnek - ölçek hizmet örneği | Microsoft Docs"
description: "Azure PowerShell Betiği örnek - ölçek hizmet örneği"
...
---
# <a name="scale-the-service-instance"></a>Ölçek hizmet örneği

Bu örnek betik ölçeklendirir ve bölge için API Management hizmet örneği ekler.
