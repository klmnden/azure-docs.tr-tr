...
### <a name="functions-limits"></a>İşlevleri sınırları
...
Azure Cosmos DB limitleri için bkz. [sınırları Azure Cosmos DB'de](cosmos-db/concepts-limits.md).
