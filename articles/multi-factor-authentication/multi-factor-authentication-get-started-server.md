...
3. Active Directory sayfasında **Multi-Factor Auth Sağlayıcıları**
    ![Multi-Factor Auth Providers](./media/multi-factor-authentication-get-started-server/authproviders.png) seçeneğine tıklayın
4. Alt kısımdaki **Yönet**’e tıklayın. Yeni bir sayfa açılır.
5. **İndirmeler**’e tıklayın.
6. **Etkinleştirme Kimlik Bilgilerini Oluştur**’un üzerindeki **İndir** bağlantısına tıklayın.
...
8. **Etkinleştirme Kimlik Bilgilerini Oluştur**’un üzerindeki **İndir** bağlantısına tıklayın.
    ![İndir](./media/multi-factor-authentication-get-started-server/download4.png)
