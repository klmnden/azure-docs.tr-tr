...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication Sunucusu’nu kullanmaya başlama
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication Sunucusu’nu indirme
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Azure portaldan Azure Multi-Factor Authentication Sunucusu’nu indirmek için
- - -
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Hizmet ayarları aracılığıyla Azure Multi-Factor Authentication Sunucusu’nu indirmek için
1. Azure Portal’da yönetici olarak oturum açın.
2. Solda, Active Directory'yi seçin.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication Sunucusu’nu Yükleme ve Yapılandırma
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Azure Multi-Factor Authentication Sunucusu güvenlik duvarı gereksinimleri
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication Sunucusu’nu yüklemek ve yapılandırma k için
- - -
...
### <a name="to-import-users-from-active-directory"></a>Kullanıcıları Active Directory'den içeri aktarmak için
- - -
...
### <a name="configuring-email-and-email-templates"></a>E-posta ve e-posta şablonlarını yapılandırma
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Azure Multi-Factor Authentication Sunucusu kullanıcı verileri nasıl işler?
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Gelişmiş Azure Multi-Factor Authentication Sunucusu Yapılandırmaları
