...
7. Değişiklikleri kaydetmek için onay işareti simgesine **tıklayın**.
![Lisans Atama](./media/multi-factor-authentication-get-started-assign-licenses/assign4.png)
8. Kaç tane lisansın atandığını ve kaç tanesinin başarısız olduğunu belirten bir ileti görürsünüz.  **Tamam**’a tıklayın.
