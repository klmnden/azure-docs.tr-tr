---
title: Azure Multi-Factor Authentication ve AD FS ile bulut kaynaklarını güvenli hale getirme
...
1. Kullanıcıların hesabı etkinleştirmesi için [multi-factor authentication’ı açma](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) bölümünde açıklanan adımları kullanın.
