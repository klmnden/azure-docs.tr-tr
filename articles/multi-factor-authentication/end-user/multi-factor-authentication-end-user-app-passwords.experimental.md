...
2. En üstte kullanıcı adınıza tıklayın ve **parola değiştirme**.
3. En üstte düzenleyebileceğinizi sayfasında seçin **uygulama parolaları**.
4. **Oluştur**’u seçin.
5. Uygulama parolası için bir ad girin ve **sonraki**.
