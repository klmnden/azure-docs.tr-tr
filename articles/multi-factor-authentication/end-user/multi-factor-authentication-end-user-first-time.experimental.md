...
Şirket destek, iki aşamalı doğrulamayı kullanmaya başlamak gerektirdiğinde ekran bildiren **yöneticiniz bu hesabı ek güvenlik doğrulaması için ayarlamanızı zorunlu kıldı** görünür:
...
10. Bu noktada, Outlook 2010 gibi eski veya tarayıcı olmayan uygulamalar için uygulama parolaları veya Apple cihazlarda yerel e-posta uygulamasını ayarlamanız istenir. Bu eylem, bazı uygulamalar iki aşamalı doğrulamayı desteklemeyen nedeni. Bu uygulamaları kullanmıyorsanız tıklatın **Bitti** ve geri kalan adımları atlayın.
...
5. Bu noktada, Outlook 2010 gibi eski veya tarayıcı olmayan uygulamalar için uygulama parolaları veya Apple cihazlarda yerel e-posta uygulamasını ayarlamanız istenir. Bu eylem, bazı uygulamalar iki aşamalı doğrulamayı desteklemeyen nedeni. Bu uygulamaları kullanmıyorsanız tıklatın **Bitti** ve kalan adımları atlayın.
