...
BT departmanınız, iki aşamalı doğrulamayı kullanmaya başlamak gerektirdiğinde ekran bildiren **yöneticiniz bu hesabı ek güvenlik doğrulaması için ayarlamanızı zorunlu kıldı** görünür:
