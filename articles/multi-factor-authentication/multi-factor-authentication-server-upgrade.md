...
1. Konusundaki yönergeleri kullanın [Azure multi-Factor Authentication Sunucusu'nu indirmek](multi-factor-authentication-get-started-server.md#download-the-mfa-server) Azure MFA sunucusu en son sürümünü almak için.
