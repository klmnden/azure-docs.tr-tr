...
| **Kanberra** | CDC |
| **Kanberra2** | CDC |
| **Cape Town** |Internet Solutions - Cloud Connect, Liquid Telecom, Teraco |
...
| **Silikon Vadisi** |Aryaka Networks, AT&T NetBond, British Telecom, CenturyLink Cloud Connect, Comcast, Coresite, Equinix, IXReach, PacketFabric, Level 3 Communications, Megaport, Orange, Sprint, Tata Communications, Verizon, Zayo Group |
