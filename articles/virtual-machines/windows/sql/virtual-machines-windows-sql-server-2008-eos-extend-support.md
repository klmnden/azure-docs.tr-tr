...
- **SQL Server yedeklemeleri**: SQL Server Yedekleme, SQL Server bölgesel durumunda veya bölge hataları kurtarmak için kullanılabilir. Yönetilen yedekleme özelliğini EOS SQL Server için desteklenmediğinden, müşterilerin yedeklemeleri el ile gerçekleştirilecek gerekir.
