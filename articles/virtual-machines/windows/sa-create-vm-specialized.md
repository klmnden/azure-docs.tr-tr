...
* [Mevcut bir Azure VM'i VHD'yi kopyalayın](create-vm-specialized.md#option-2-copy-an-existing-azure-vm)
...
1. Genel IP oluşturun. Bu örnekte, ortak IP adresi adı ayarlamak **myIP**.
    ...
    ```       
2. NIC oluşturun Bu örnekte, NIC adı ayarlamak **myNicName**.
