---
title: Windows sanal makineleri üzerinde Azure Resource Manager dağıtımında depolama kaynak silme hatalarında sorun giderme | Microsoft Docs
...
Azure Vm'lerinde kullanılan VHD'ler, sayfa bloblarını Azure standart veya premium storage hesabında depolanan .vhd dosyalarıdır. Azure diskleri hakkında daha fazla bilgi için bkz: [yönetilmeyen ve Microsoft Azure Windows VM'ler için disk depolama yönetilen hakkında](about-disks-and-vhds.md). 
