---
title: Azure Resource Manager'a geçiş için Klasik sırasında sık karşılaşılan | Microsoft Docs
description: Bu makalede, Azure Hizmet Yönetimi Iaas kaynakları Azure Resource Manager yığınına geçiş sırasında yaygın hataları ve risk azaltma işlemleri kataloglar.
