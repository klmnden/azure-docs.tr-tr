...
description: Azure Vm'leri için Windows Server çalıştıran SPECint işlem Kıyaslama puanlarını karşılaştırın.
...
ms.locfileid: "64866296"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Windows Vm'leri için Kıyaslama puanlarını hesaplama
Aşağıdaki SPECInt Kıyaslama puanları, Windows Server çalıştıran Azure Vm'leri seçmek için işlem performans gösterir. Kıyaslama puanlarını hesaplama için kullanılabilir ayrıca [Linux Vm'leri](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="av2---general-compute"></a>Av2 - genel işlem
| Boyut | vCPU sayısı | NUMA düğümleri | CPU | Çalıştırmalar | Ortalama taban fiyatı | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
| Boyut | vCPU sayısı | NUMA düğümleri | CPU | Çalıştırmalar | Ortalama taban fiyatı | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_F2s_v2 | 2 | 1 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 46 | 56.5 | 2.4 | 
| Standard_F4s_v2 | 4 | 1 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 60 | 110.2 | 4.7 | 
| Standard_F8s_v2 | 8 | 1 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 36 | 215.2 | 5.3 | 
| Standard_F16s_v2 | 16 | 1 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 36 | 409.3 | 15.5 | 
| Standard_F32s_v2 | 32 | 1 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 31 | 760.9 | 16.9 | 
| Standard_F64s_v2 | 64 | 2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 33 | 1440.9 | 26.0 | 
| Standard_F72s_v2 | 72 | 2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 29 | 1372.1 | 8.2 | 
...
| Standart_h16mr | 16 | 2 | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 18 | 563.6 | 3.7 | 
| Standart_h16r | 16 | 2 | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 17 | 562.2 | 4.2 | 
...
| İşler için standart_m64s | 64 | 2 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 12 | 1012.5 | 4,5 | 
...
| İşler için standart_m128ms | 128 | 4 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 15 | 1780.7 | 18.3 | 
| İşler için standart_m128s | 128 | 4 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 12 | 1775.8 | 11.6 | 
| İşler için Standard_M16ms | 16 | 1 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 20 | 293.1 | 11.8 | 
...
| İşler için standart_m64ls | 64 | 2 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 13 | 1015.2 | 10.0 | 
| İşler için Standard_M8ms | 8 | 1 | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 13 | 158.2 | 5.5 | 
...
| İşler için standart_nc24r | 24 | 2 | Intel(R) Xeon(R) CPU E5-2690 v3 @ 2.60GHz | 27 | 752.9 | 3.4 | 
...
Windows numaraları hesaplanan çalıştırarak [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) Windows Server'da. SPECint vCPU başına bir kopya ile taban fiyat seçeneği (yayımlanan SPECint_rate2006) kullanılarak çalıştırıldı. SPECint 12 ayrı testleri, her üç kez çalıştırın, her test ORTANCA değerini alma ve bunları bir bileşik puanı oluşturmak üzere Ağırlıklandırma oluşur. Bu test, sonra gösterilen ortalama puanları sağlamak için birden çok VM arasında çalıştırılamadı.

## <a name="next-steps"></a>Sonraki adımlar
* Depolama kapasitesi, disk ayrıntıları ve VM boyutları seçim ek hususlar için bkz. [sanal makine boyutları](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
