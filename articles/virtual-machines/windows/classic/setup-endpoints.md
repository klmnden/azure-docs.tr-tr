...
* Resource Manager dağıtım modelinde bir sanal makine oluşturduysanız, Azure PowerShell kullanabileceğiniz [ağ güvenlik grupları oluşturma](../../../virtual-network/virtual-networks-create-nsg-arm-ps.md) VM denetim trafiği için.
