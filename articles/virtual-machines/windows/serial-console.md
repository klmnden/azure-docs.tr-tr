...
Yalnızca sistem durumu bilgileri, bir Windows VM'ye bağlanırken gösterilir.| [Windows sistem durumu sinyali](https://github.com/Microsoft/azserialconsole/blob/master/Known_Issues/Windows_Health_Info.md)
