...
1.  Etkinleştirmek veya güvenlik duvarı kurallarını devre dışı bırakmak için başvurmak [etkinleştirmek veya devre dışı bir güvenlik duvarı kuralı Azure VM konuk işletim sisteminde](enable-disable-firewall-rule-guest-os.md).
