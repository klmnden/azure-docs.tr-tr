---
title: Uzak Masaüstü lisans sunucusu kullanılabilir değil, Azure VM'sine bağlandığınızda | Microsoft Docs
...
ms.locfileid: "50088888"
---
# <a name="remote-desktop-license-server-is-not-available-when-you-connect-to-azure-vm"></a>Azure VM'ye bağlanın, Uzak Masaüstü lisans sunucusu kullanılamıyor
