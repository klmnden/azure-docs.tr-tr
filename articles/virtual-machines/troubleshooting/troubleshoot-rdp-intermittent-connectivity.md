...
Bu sorun, RDP dinleyicisi yanlış yapılandırılmış ortaya çıkabilir. Genellikle, bu sorun kullanan bir VM üzerinde oluşur bir özel bir görüntü.
...
16. RDP oturumu boşta kalma süresi denetimi ayarlama: ' HKLM\BROKENSYSTEM\ControlSet001\control\Terminal Server\Winstations\RDP Tcp "/v 'fInheritMaxIdleTime' /t REG_DWORD /d 1 /f REG ADD 
