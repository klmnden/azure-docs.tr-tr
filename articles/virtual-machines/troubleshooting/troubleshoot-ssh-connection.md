...
* [Azure CLI](#use-the-azure-cli) - komut satırında zaten varsa hızlı bir şekilde SSH yapılandırması veya kimlik bilgilerini sıfırlama. Ayrıca [Azure CLI](#use-the-azure-classic-cli)
