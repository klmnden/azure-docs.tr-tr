...
- SSH 
    - [ SSH hakkındaki sorunları giderme  ](troubleshoot-ssh-connection.md)
    - [ SSH hakkındaki sorunları gidermeyle ilgili ayrıntılar  ](detailed-troubleshoot-ssh-connection.md)
