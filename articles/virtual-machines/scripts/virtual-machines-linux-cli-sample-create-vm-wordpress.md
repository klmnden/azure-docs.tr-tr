...
| [az vm uzantısı kümesi](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Özel betik uzantısının WordPress yüklemek için bir komut dosyası çağırır sanal makine için ekleyin. |
