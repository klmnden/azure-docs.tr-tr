---
title: "Azure PowerShell Betiği örnek - WordPress | Microsoft Docs"
...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | Özel betik uzantısının WordPress yüklemek için bir komut dosyası çağırır sanal makine için ekleyin. |
