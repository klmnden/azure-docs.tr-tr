---
title: "Azure CLI betik örnek - Windows Server 2016 VM DSC kullanarak IIS ile oluşturun. | Microsoft Docs"
...
Bu komut dosyasını bir sanal makine oluşturur ve IIS yüklemesi ve yapılandırması için Azure sanal makine DSC özel betik uzantısı kullanır. 
...
| [az vm uzantısı kümesi](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Özel betik uzantısının IIS yüklemek için bir komut dosyası çağıran sanal makineye ekleyin. |
