---
title: Azure CLI örneği - Azure Log Analytics izleme çalıştıran VM oluşturma | Microsoft Docs
description: Azure CLI örneği - Windows Server 2016 VM ve Log Analytics izleme çalıştıran bir Azure VM oluşturma.
