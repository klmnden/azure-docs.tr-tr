---
title: "Azure Hızlı Başlangıç - VM PowerShell oluşturma | Microsoft Belgeleri"
...
Azure PowerShell modülü, PowerShell komut satırından veya betik içinden Azure kaynakları oluşturmak ve yönetmek için kullanılır. Bu kılavuzda PowerShell kullanarak Ubuntu 14.04 LTS çalıştıran bir Azure sanal makinesi oluşturma işleminin ayrıntıları verilmektedir.

Başlamadan önce, Windows kullanıcı profilinizin `.ssh` dizininde `id_rsa.pub` adlı bir ortak SSH anahtarının depolanması gerekir. Azure için SSH anahtarları oluşturma hakkında ayrıntılı bilgi için bkz. [Azure için SSH anahtarları oluşturma](./virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
Bir ağ güvenliği grubu ve bir ağ güvenliği grup kuralı oluşturun. Ağ güvenliği grubu, gelen ve giden kuralları kullanarak sanal makinenin güvenliğini sağlar. Bu durumda, bağlantı noktası 22 için gelen SSH bağlantılarına izin veren bir gelen kuralı oluşturulur.
...
[VM dağıtımı PowerShell örneklerini keşfedin](./virtual-machines-linux-powershell-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
