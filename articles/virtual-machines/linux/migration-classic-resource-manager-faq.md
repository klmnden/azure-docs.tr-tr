---
title: Azure Resource Manager'a geçiş için Klasik hakkında sık sorulan sorular | Microsoft Docs
description: Azure Resource Manager'a geçiş için Klasik hakkında sık sorulan sorular
