...
| Ubuntu Server | Ubuntu 14.04 LTS, Ubuntu Server 16.04, Ubuntu Server 17.10 ve Ubuntu Server 18.04 |
...
Azure AD kimlik bilgilerinizi kullanarak Azure Linux sanal makinesinde oturum açın. `-l` Parametresi kendi Azure AD hesabı adresini belirtmenize olanak sağlar. Önceki komutun çıkışında olarak sanal makinenizin genel IP adresini belirtin:
...
SSH isteminiz aşağıdaki hatayı görürseniz, gördüğünüzden emin olun [yapılandırılmış RBAC ilkelerini](#configure-rbac-policy-for-the-virtual-machine) ya da kullanıcı veren bir VM için *Sanal Makine Yöneticisi oturum açma* veya *sanal Makine kullanıcı oturum açma* rolü:
...
Azure Active Directory hakkında daha fazla bilgi için bkz. [Azure Active Directory nedir](../../active-directory/fundamentals/active-directory-whatis.md) ve [nasıl Azure Active Directory ile çalışmaya başlama](../../active-directory/fundamentals/get-started-azure-ad.md)
