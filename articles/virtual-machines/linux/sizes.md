...
| [Bellek için iyileştirilmiş](sizes-memory.md)         | Esv3, Ev3, M, DSv2, Dv2  | Yüksek bellek CPU oranı. İlişkisel veritabanı sunucuları, orta veya büyük boyutlu önbellekler ve bellek içi analiz için idealdir.                 |
