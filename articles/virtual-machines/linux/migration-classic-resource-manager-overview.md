---
title: Iaas kaynaklarının Klasik modelden Azure Resource Manager'a platform destekli geçişe genel bakış | Microsoft Docs
description: Bu makalede kaynakları platform destekli geçiş Klasik modelden Azure Resource Manager'a gösterilmektedir.
