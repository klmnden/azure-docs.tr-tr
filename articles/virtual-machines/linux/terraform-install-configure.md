...
Kiracı kimliği, abonelik kimliği, istemci kimliği ve istemci hizmet asıl gizli Azure kaynakları oluşturulurken kullanılacak Terraform yapılandırın. Tarafından otomatik olarak kullanılan aşağıdaki ortam değişkenlerini ayarlama [Azure Terraform modülleri](https://registry.terraform.io/modules/Azure).
