...
Evet. Mevcut bir Klasik VM'yi bir yeni veya var olan kullanılabilirlik kümesine ekleyebilirsiniz. Daha fazla bilgi için bkz: [var olan bir sanal makine bir kullanılabilirlik kümesine ekleme](../windows/classic/configure-availability.md#addmachine).
