...
VM’nizin genel IP adresini bilmiyorsanız, [az network public-ip list](/cli/azure/network/public-ip#az_network_public_ip_list) komutunu çalıştırın:
