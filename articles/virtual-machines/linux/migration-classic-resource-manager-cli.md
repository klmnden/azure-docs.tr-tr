...
## <a name="step-2-set-your-subscription-and-register-the-provider"></a>2. adım: aboneliğinizi ayarlama ve sağlayıcısını Kaydet
...
Azure Resource Manager'da sahip Vcpu geçerli sayısını denetlemek için aşağıdaki CLI komutunu kullanabilirsiniz. VCPU kotaları hakkında daha fazla bilgi için bkz: [sınırlarını ve Azure Resource Manager](../../azure-subscription-service-limits.md#limits-and-the-azure-resource-manager)
...
## <a name="step-4-option-2----migrate-virtual-machines-in-a-virtual-network"></a>4. adım: 2. seçenek - bir sanal ağdaki sanal makinelerin geçişini gerçekleştirin
