---
title: Azure Linux VM'ler için Kıyaslama puanları işlem | Microsoft Docs
description: CoreMark işlem Kıyaslama puanları Azure Linux çalıştıran VM'ler için karşılaştırın.
...
| Standard_A8m_v2 | Intel(r) Xeon(R) CPU E5-2673 v4 2.30GHz @ | 8 | 1 | 64.4 | 48,494 | 501 | 1,03 koyun % | 49 |
...
| Standard_A1 | AMD Opteron(tm) işlemci 4171. | 1 | 1 | 1.7 | 6,862 | 169 | %2.47 | 42 |
...
| Standard_A2 | AMD Opteron(tm) işlemci 4171. | 2 | 1 | 3.4 | 13,950 | 415 | %2.98 | 35 |
...
| Standard_A3 | AMD Opteron(tm) işlemci 4171. | 4 | 1 | 6.9 | 28,069 | 679 | %2.42 | 28 |
...
| Standard_A4 | AMD Opteron(tm) işlemci 4171. | 8 | 2 | 14.0 | 56,604 | 305 | %0.54 | 7 |
...
| Standard_A5 | AMD Opteron(tm) işlemci 4171. | 2 | 1 | 14.0 | 14,164 | 273 | %1.93 | 21 |
...
| Standard_A6 | AMD Opteron(tm) işlemci 4171. | 4 | 1 | 28,1 | 28,272 | 392 | %1.39 | 28 |
...
(3/23/2018 7:28:44 PM pbı 2050259)
...
(3/23/2018 7:32:37 PM pbı 2050259)
...
(3/23/2018 19:31:01: 00 pbı 2050259)
...
(3/23/2018 7:29:35 PM pbı 2050259)
...
## <a name="dsv2---storage-optimized"></a>DSv2 - en iyi duruma getirilmiş depolama
(3/23/2018 19:30:03: 00 pbı 2050259)
...
| Standard_DS14_v2 | Intel(r) Xeon(R) CPU E5-2673 v4 2.30GHz @ | 16 | 1 | 112.8 | 224,791 | 4,363 | in %1,94 | 77 |
...
| İçin Standard_D15_v2 | Intel(r) Xeon(R) CPU E5-2673 v3 2,40 GHz @ | 20 | 2 | 141.0 | 275,417 | 6,457 | %2.34 | 154 |
...
## <a name="ds---storage-optimized"></a>DS - en iyi duruma getirilmiş depolama
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 - işlem + depolama en iyi duruma getirilmiş
(3/23/2018 19:33:11: 00 pbı 2050259)

| VM Boyutu | CPU | vCPU sayısı | NUMA düğümleri | Memory(GiB) | Ortalama puanı | StdDev | StdDev % | #Runs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_F2s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 2 | 1 | 3.9 | 25,392 | 157 | %0.62 | 49 |
| Standard_F4s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 4 | 1 | 8.0 | 48,065 | 656 | %1.36 | 42 |
| Standard_F8s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 8 | 1 | 16.0 | 95,026 | 1,205 | %1.27 | 49 |
| Standard_F16s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 16 | 1 | 32.1 | 187,039 | 2,681 | %1.43 | 42 |
| Standard_F32s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 32 | 1 | 64.4 | 375,828 | 5,180 | %1.38 | 70 |
| Standard_F64s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 64 | 2 | 128.9 | 741,859 | 5,954 | %0,80 | 49 |
| Standard_F72s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 72 | 2 | 145.0 | 831,616 | 4,867 | %0.59 | 42 |

## <a name="f---compute-optimized"></a>F - işlem en iyi duruma getirilmiş
...
## <a name="fs---compute-and-storage-optimized"></a>FS - işlem ve depolama en iyi duruma getirilmiş
(3/23/2018 19:30:14: 00 pbı 2050259)
...
## <a name="g---compute-optimized"></a>G - işlem en iyi duruma getirilmiş
(3/23/2018 7:27:25 PM pbı 2050259)
...
## <a name="gs---storage-optimized"></a>GS - en iyi duruma getirilmiş depolama
(3/23/2018 19:25:12: 00 pbı 2050259)
...
## <a name="h---high-performance-compute-hpc"></a>Y - yüksek performanslı bilgi işlem (HPC)
(3/23/2018 7:27:16 PM pbı 2050259)
...
| Standart_h16mr | Intel(r) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 225.7 | 272,683 | 6,484 | %2.38 | 70 |
| Standart_h16r | Intel(r) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 112.8 | 271,822 | 6,126 | %2,25 | 98 |

## <a name="hpc---a8-11"></a>HPC - A8-11
(3/23/2018 19:35:10: 00 pbı 2050259)
...
## <a name="ls---storage-optimized"></a>Ls - depolama en iyi duruma getirilmiş
(3/23/2018 7:58:51 PM pbı 2050259)

| VM Boyutu | CPU | vCPU sayısı | NUMA düğümleri | Memory(GiB) | Ortalama puanı | StdDev | StdDev % | #Runs |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standart_L4s | Intel(r) Xeon(R) CPU E5-2698B v3 2.00GHz @ | 4 | 1 | 32.1 | 55,962 | 3,567 | %6.37 | 154 |
| Standart_L8s | Intel(r) Xeon(R) CPU E5-2698B v3 2.00GHz @ | 8 | 1 | 64.4 | 106,482 | 3,178 | %2.98 | 168 |
| Standart_L16s | Intel(r) Xeon(R) CPU E5-2698B v3 2.00GHz @ | 16 | 1 | 128.9 | 197,906 | 12,605 | %6.37 | 168 |
| Standart_L32s | Intel(r) Xeon(R) CPU E5-2698B v3 2.00GHz @ | 32 | 2 | 257.9 | 388,652 | 6,274 | %1.61 | 126 |

## <a name="m---memory-optimized"></a>M - bellek için iyileştirilmiş
(3/23/2018 8:57:07 PM pbı 2050259)
