...
| VM Boyutu | CPU | Vcpu | NUMA düğümleri | Memory(GiB) | Ortalama puanı | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
## <a name="b---burstable"></a>B - seri aktarıma uygun
(3/15/2019 12:27:08: 00 pbı 3897709)
...
(3/12/2019 6:52: 03'te pbı 3897709)
...
(3/12/2019 6:54:27 PM pbı 3897709)
...
(3/15/2019 12:53:13: 00 pbı 3897709)
...
(3/12/2019 18:53:48: 00 pbı 3897709)
...
(3/12/2019 7:17:33 PM pbı 3897709)
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eısv3 - bellek Opt + Premium depolama (yalıtılmış)
(4/11/2019 10:07:29 PM pbı 3897709)
...
(3/12/2019 6:52:13 PM pbı 3897709)
...
## <a name="eiv3---memory-optimized-isolated"></a>Eıv3 - bellek için optimize edilmiş (yalıtılmış)
(3/12/2019 6:57:51 PM pbı 3897709)
...
(3/12/2019 6:51:35 PM pbı 3897709)

| VM Boyutu | CPU | Vcpu | NUMA düğümleri | Memory(GiB) | Ortalama puanı | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 2 | 1 | 3.9 | 28,219 | 1,843 | 6.53% | 700 |
| Standard_F4s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 4 | 1 | 7.8 | 53,911 | 1,002 | 1.86% | 707 |
| Standard_F8s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 8 | 1 | 15.7 | 106,467 | 1,101 | 1.03% | 707 |
| Standard_F16s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 16 | 1 | 31.4 | 211,311 | 1,724 | 0.82% | 707 |
| Standard_F32s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 32 | 1 | 62.9 | 423,175 | 4,346 | 1.03% | 707 |
| Standard_F64s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 64 | 2 | 125.9 | 829,537 | 21,574 | 2.60% | 707 |
| Standard_F72s_v2 | Intel(r) Xeon(R) 2,70 GHz @ Platinum 8168 CPU | 72 | 2 | 141.7 | 933,800 | 26,783 | 2.87% | 707 |
...
(3/12/2019 6:53:59 PM pbı 3897709)
...
(3/12/2019 10:22:33 PM pbı 3897709)
...
(3/12/2019 10:23:51 PM pbı 3897709)
...
## <a name="h---high-performance-compute-hpc"></a>H - yüksek performanslı bilgi işlem (HPC)
(3/12/2019 10:50:51 PM pbı 3897709)
...
| Standart_h16mr | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 220.4 | 282,167 | 6,889 | 2.44% | 84 |
| Standart_h16r | Intel(R) Xeon(R) CPU E5-2667 v3 @ 3.20GHz | 16 | 2 | 110.2 | 280,837 | 6,587 | 2.35% | 84 |

## <a name="lv2---storage-optimized"></a>Lv2 - depolama için iyileştirilmiş
(3/14/2019-17:49:04 pbı 3897709)

| VM Boyutu | CPU | Vcpu | NUMA düğümleri | Memory(GiB) | Ortalama puanı | StdDev | StdDev % | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 çekirdekli işlemci | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 çekirdekli işlemci | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 çekirdekli işlemci | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 çekirdekli işlemci | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 çekirdekli işlemci | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - depolama için iyileştirilmiş
(3/12/2019 10:22:29 PM pbı 3897709)
...
## <a name="m---memory-optimized"></a>M - bellek için iyileştirilmiş
(4/11/2019 7:30:39 PM pbı 3897709)
...
| İşler için standart_m64s | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 64 | 2 | 1,007.9 | 674,785 | 15,983 | 2.37% | 42 |
...
| İşler için standart_m128ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 128 | 4 | 3,831.1 | 1,329,151 | 24,295 | 1.83% | 42 |
| İşler için standart_m128s | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 128 | 4 | 2,015.9 | 1,329,923 | 20,117 | 1.51% | 42 |
| İşler için Standard_M16ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 16 | 1 | 430.6 | 174,686 | 2,704 | 1.55% | 35 |
...
| İşler için standart_m64ls | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 64 | 2 | 503.9 | 676,026 | 18,078 | 2.67% | 42 |
| İşler için Standard_M8ms | Intel(R) Xeon(R) CPU E7-8890 v3 @ 2.50GHz | 8 | 1 | 215.2 | 88,066 | 1,391 | 1.58% | 42 |

## <a name="ncsv3---gpu-enabled"></a>NCSv3 - GPU etkin
(3/21/2019 5:48:37 PM pbı 3897709)
...
(3/12/2019 11:19:19 PM pbı 3897709)
...
(3/12/2019 23:08:03: 00 pbı 3897709)
...
| İşler için standart_nc24r | Intel(R) Xeon(R) CPU E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>NDs GPU etkin
(3/12/2019 11:19:10 PM pbı 3897709)
...
(3/12/2019 23:08:13: 00 pbı 3897709)
...
* Linux Vm'lerinde CoreMark betikleri çalıştırmak için [CoreMark betik paketi](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).
