...
bir [dağıtım grubuna](https://docs.microsoft.com/en-us/azure/devops/pipelines/release/deployment-groups/index?view=vsts) dağıtmak için Azure DevOps kullanın. Aşağıdakileri nasıl yapacağınızı öğrenirsiniz:
