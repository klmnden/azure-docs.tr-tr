...
Ayarları şunları yapabilirsiniz ya da bağlantı tanımlamak için önerilen yapılandırma komutunu çalıştırın (`eval $(docker-machine env myvmdocker)`), ya da ortam değişkenleri el ile ayarlayabilirsiniz. 
