...
- **Linux veya Linux sanal makinesine erişim** - Linux makineniz yoksa [Linux sanal makinesi](/virtual-machines/linux/quick-create-cli.md) oluşturun.
