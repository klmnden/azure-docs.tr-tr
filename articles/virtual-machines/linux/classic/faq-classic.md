---
title: Klasik Linux VM'ler için sık sorulan sorular | Microsoft Docs
description: Klasik dağıtım modeliyle oluşturulan Azure Linux sanal makineleri hakkında bazı sık sorulan soruları yanıtlar.
...
ms.locfileid: "30840898"
---
# <a name="frequently-asked-question-about-azure-linux-virtual-machines-created-with-the-classic-deployment-model"></a>Sık sorulan soruya hakkında Azure Linux Klasik dağıtım modeliyle oluşturulan sanal makineler
> [!IMPORTANT] 
> Azure oluşturmak ve kaynaklarla çalışmak için iki farklı dağıtım modeli vardır: [Resource Manager ve klasik](../../../resource-manager-deployment-model.md). Bu makalede, Klasik dağıtım modeli kullanarak yer almaktadır. Microsoft, yeni dağıtımların çoğunun Resource Manager modelini kullanmasını önerir. Resource Manager modeli kullanılırken SSS bkz [burada](../faq.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
