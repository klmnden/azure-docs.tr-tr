...
Yönetilmeyen bir disk: Azure depolama hesabı, olası bir tek hata noktası olduğundan, en az iki sanal makine dağıtılır, en az iki Azure depolama hesabınızın olması önemlidir. İdeal bir Kurulum, SAP iletişim örneği çalıştıran her sanal makinenin diskleri farklı depolama hesabında dağıtılabilir.
