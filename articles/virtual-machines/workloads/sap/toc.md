...
## Genel Bakış
### [Azure üzerinde SAP HANA (Büyük Örnekler) nedir?](hana-overview-architecture.md)
### [Terimleri öğrenin](hana-know-terms.md)
### [Sertifika](hana-certification.md)
### [HLI için kullanılabilen SKU’lar](hana-available-skus.md)
### [Boyutlandırma](hana-sizing.md)
### [Katılım gereksinimleri](hana-onboarding-requirements.md)
### [SAP HANA veri katmanlama ve uzantı düğümleri](hana-data-tiering-extension-nodes.md)
### [İşlem modeli ve sorumluluklar](hana-operations-model.md)
## Mimari
### [Genel mimari](hana-architecture.md)
...
#### [SAP NetWeaver için Red Hat Enterprise Linux’taki Azure VM’leri üzerinde GLusterFS](high-availability-guide-rhel-glusterfs.md)
#### [SLES üzerinde Pacemaker](high-availability-guide-suse-pacemaker.md)
#### [RHEL üzerinde Pacemaker](high-availability-guide-rhel-pacemaker.md)
### SAP Yüklemesi
