...
[az network nic create](/cli/azure/network/nic#az_network_nic_create) ile iki ağ arabirimi oluşturun ve bunları özel IP adresi ile ilişkilendirin. 
