---
title: "Resource Manager’da Azure CLI kullanarak iç yük dengeleyici oluşturma | Microsoft Belgeleri"
...
> [!NOTE]
> Azure’da kaynak oluşturmak ve bunlarla çalışmak için iki farklı dağıtım modeli vardır:  [Resource Manager ve klasik](../resource-manager-deployment-model.md).  Bu makale, Microsoft’un çoğu yeni dağıtım için [klasik dağıtım modeli](load-balancer-get-started-ilb-classic-cli.md) yerine önerdiği Resource Manager dağıtım modelini açıklamaktadır.
