---
title: Azure için birden çok ön uç yük dengeleyici | Microsoft Docs
...
## <a name="rule-type-1-no-backend-port-reuse"></a>Kural türü #1: arka uç bağlantı noktası yeniden yok
