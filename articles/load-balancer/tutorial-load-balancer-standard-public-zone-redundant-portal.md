...
Trafiği VM’lere dağıtmak için, bir arka uç adres havuzunda yük dengeleyiciye bağlı sanal NIC’lerin IP adresleri barındırılır. Arka uç adres havuzu oluşturma *myBackendPool* içerecek şekilde *VM1* ve *VM2*.
