...
İle Vm'leri oluşturabilirsiniz artık [New-AzVM](/powershell/module/az.compute/new-azvm). Aşağıdaki örnek, iki VM ve mevcut değilse gerekli olan sanal ağ bileşenlerini oluşturur:
