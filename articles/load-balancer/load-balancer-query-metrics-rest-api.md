---
title: REST API'si ile Azure Load Balancer ölçümleri alma | Microsoft Docs
...
Eksiksiz başvuru belgelerine ve REST API için ek örneklerini bulunan [Azure İzleyici REST başvurusu](/rest/api/monitor). 

## <a name="build-the-request"></a>Derleme isteği

Aşağıdaki GET isteği toplamak için kullan [ByteCount ölçüm](/azure/load-balancer/load-balancer-standard-diagnostics#a-name--multidimensionalmetricsamulti-dimensional-metrics) bir standart yük dengeleyiciden. 
