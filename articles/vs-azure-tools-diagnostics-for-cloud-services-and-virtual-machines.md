...
Bir Azure bulut hizmeti veya sanal makine sorunlarını gidermek, ihtiyacınız olduğunda, Visual Studio, daha kolay Azure Tanılama'yı ayarlamak için kullanabilirsiniz. Tanılama sistemi veri ve sanal makineler ve bulut hizmetinizi çalıştıran sanal makine örneği günlük verilerini yakalar. Tanılama verileri, seçtiğiniz bir depolama hesabına aktarılır. Azure'da günlüğe kaydetme Tanılama hakkında daha fazla bilgi için bkz [Azure App Service'te Web uygulamaları için tanılama günlüğünü etkinleştirme](app-service/web-sites-enable-diagnostic-log.md).
...
Uygulama günlükleri hakkında daha fazla bilgi için bkz. [Azure App Service'te Web uygulamaları için tanılama günlüğünü etkinleştirme](app-service/web-sites-enable-diagnostic-log.md).
...
Azure'da günlüğe kaydetme Tanılama hakkında daha fazla bilgi için bkz: [Azure bulut Hizmetleri ve sanal makineler'de tanılamayı etkinleştirme](cloud-services/cloud-services-dotnet-diagnostics.md) ve [Azure App Service'te Web uygulamaları için tanılama günlüğünü etkinleştirme](app-service/web-sites-enable-diagnostic-log.md).
