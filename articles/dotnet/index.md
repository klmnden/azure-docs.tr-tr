---
title: ".NET Framework ve .NET Core için Azure Kitaplıkları | Microsoft Docs"
description: ".NET Framework ve .NET Core için tüm Azure kitaplıkları ve NuGet paketlerinin bir listesidir."
keywords: "Azure .NET, SDK, Azure .NET API Başvurusu, Azure .NET sınıf kitaplığı, Azure NuGet, Azure Core"
author: camsoper
manager: douge
ms.author: casoper
ms.date: 04/06/2016
...
# <a name="azure-libraries-for-net"></a>.NET İçin Azure Kitaplıkları

Uygulamanızdaki Azure hizmetlerini yönetmek ve kullanmak için Azure için .NET SDK’sındaki kitaplıkları kullanın.

## <a name="packages"></a>Paketler

> [!TIP]
> [Fluent kitaplıkları](https://azure.microsoft.com/blog/simpler-azure-management-libraries-for-net/) (**\*.Fluent** ile biter) okunabilirlik ve yazılabilirlik için en iyi duruma getirilmiş daha yüksek düzeyli, nesne yönelimli bir API sağlayarak geliştirici deneyimini iyileştirir. Bunlar nelerin gerekli, isteğe bağlı veya değiştirilemez olduğunu açıklar. Bu kitaplıklar fluent olmayan kitaplıklar ile yan yana çalıştırılabilir. Bu nedenle bu söz dizimini tercih ediyorsanız fluent paketleri kullanın. [Microsoft.Azure.Management.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.Fluent) tüm fluent yönetim kitaplıklarını içeren bir pakettir.

Hizmet | Hizmet ile etkileşimde bulunma | Hizmet kaynaklarını yönetme
--------|---------------------------|-------------------------
...
[Yetkilendirme](/rest/api/authorization) | | [Microsoft.Azure.Management.Authorization](https://www.nuget.org/packages/Microsoft.Azure.Management.Authorization)
[Otomasyon](/azure/automation/) | | [Microsoft.Azure.Management.Automation](https://www.nuget.org/packages/Microsoft.Azure.Management.Automation)
...
[Faturalandırma](/azure/billing/) | | [Microsoft.Azure.Management.Billing](https://www.nuget.org/packages/Microsoft.Azure.Management.Billing)
...
[Bilişsel Hizmetler](/azure/cognitive-services/) | | [Microsoft.Azure.Management.CognitiveServices](https://www.nuget.org/packages/Microsoft.Azure.Management.CognitiveServices)
[Ticaret](/azure/billing/billing-usage-rate-card-overview) | | [Microsoft.Azure.Commerce.UsageAggregates](https://www.nuget.org/packages/Microsoft.Azure.Commerce.UsageAggregates)
...
[IoT Hub’ı](/azure/iot-hub) | [Microsoft.Azure.Devices](https://www.nuget.org/packages/Microsoft.Azure.Devices)&nbsp;<b>&#42;</b><br/>[Microsoft.Azure.Devices.Client](https://www.nuget.org/packages/Microsoft.Azure.Devices.Client)&nbsp;<b>&#42;</b>
[Anahtar Kasası](/azure/key-vault/) | [Microsoft.Azure.KeyVault](https://www.nuget.org/packages/Microsoft.Azure.KeyVault) | [Microsoft.Azure.Management.KeyVault.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.KeyVault.Fluent)<br/>[Microsoft.Azure.Management.KeyVault](https://www.nuget.org/packages/Microsoft.Azure.Management.KeyVault)
...
[İzleme](/azure/monitoring-and-diagnostics/) | | [Microsoft.Azure.Insights](https://www.nuget.org/packages/Microsoft.Azure.Insights)
...
[Kurtarma Hizmetleri](/azure/site-recovery/) | | [Microsoft.Azure.Management.RecoveryServices](https://www.nuget.org/packages/Microsoft.Azure.Management.RecoveryServices)
[Redis Önbelleği](/azure/redis-cache/) | [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis/) | [Microsoft.Azure.Management.Redis.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.Redis.Fluent)<br/>[Microsoft.Azure.Management.Redis](https://www.nuget.org/packages/Microsoft.Azure.Management.Redis)
...
[Akış Analizi](/azure/stream-analytics/) | | [Microsoft.Azure.Management.StreamAnalytics](https://www.nuget.org/packages/Microsoft.Azure.Management.StreamAnalytics)
...
[Sanal Makineler](/azure/virtual-machines/) | | [Microsoft.Azure.Management.Compute.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.Compute.Fluent)<br/>[Microsoft.Azure.Management.Compute](https://www.nuget.org/packages/Microsoft.Azure.Management.Compute)
[Sanal Ağ](/azure/virtual-network/) | | [Microsoft.Azure.Management.Network.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.Network.Fluent)<br/>[Microsoft.Azure.Management.Network](https://www.nuget.org/packages/Microsoft.Azure.Management.Network)
...
\* *- Paketin şu anda .NET Core ile uyumsuz olduğunu gösterir.*

## <a name="installation"></a>Yükleme

### <a name="visual-studio"></a>Visual Studio

Visual Studio kullanıyorsanız, paketi projenize aktarmak için **NuGet Paket Yöneticisi Konsolu**’nu kullanın.

1. Visual Studio çözümünüz açıkken, **Araçlar**’a ve ardından **NuGet Paketleyici Yöneticisi**’ne tıklayarak ve daha sonra **Paket Yöneticisi Konsolu**’na tıklayarak konsolu başlatın.  

    ![Paket Yöneticisi Konsolu](media/index/package-manager.png)

2. Konsol penceresinde, **Install-Package** cmdlet’ini kullanarak NuGet paketini indirin ve yükleyin.  Örneğin, .NET için [Azure Kaynak Yönetimi Kitaplığı](http://www.nuget.org/packages/Microsoft.Azure.Management.ResourceManager)’nın son sürümünü eklemek için:

    ```powershell
    Install-Package Microsoft.Azure.Management.ResourceManager -Pre 
    ``` 
    Belirli bir sürümü kullanmak için aşağıdaki gibi sürüm numarasını ekleyin:

    ```powershell
    Install-Package Microsoft.Azure.Management.ResourceMananger -Version 1.4.0-preview
    ``` 

### <a name="other-editors"></a>Diğer düzenleyiciler

Visual Studio Code (veya başka bir düzenleyici) ile .NET Core kullanıyorsanız, csproj dosyanızı düzenleyerek **PackageReference** öğesini ekleyin.  Bu örnek en iyi uygulama olan belirli bir **Microsoft.Azure.Management.ResourceManager** sürümünü kullanır ancak NuGet [kayan sürümleri](/nuget/consume-packages/package-references-in-project-files#floating-versions) de desteklenir.
...
> [!TIP]
> Önceki .NET Core sürümleri csproj yerine project.json kullanıyordu.  project.json’yi csproj’a eşleme hakkında bilgi edinmek için [bu belgeye bakın](/dotnet/articles/core/tools/project-json-to-csproj).
