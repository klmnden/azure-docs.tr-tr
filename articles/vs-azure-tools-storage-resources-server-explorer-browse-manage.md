...
**Blobları** düğümü kapsayıcılar için seçilen depolama hesabına bir listesini görüntüler. BLOB kapsayıcıları blob dosyaları içerir ve bu bloblar klasörlere ve alt düzenleyebilirsiniz. Daha fazla bilgi için [net'ten Blob storage kullanma](storage/blobs/storage-dotnet-how-to-use-blobs.md).
