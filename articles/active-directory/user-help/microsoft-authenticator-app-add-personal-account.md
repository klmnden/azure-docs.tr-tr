...
2. Sayfanın alt kısmında **güvenlik temel kavramları** sayfasında **daha fazla güvenlik seçeneği** bağlantı.
    ...
    ![Vurgulanmış "daha fazla güvenlik seçenekleri" bağlantısını içeren güvenlik temel bilgileri sayfası](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Seçin **Hesap Ekle** gelen **özelleştirme ve Denetim** sağ üst köşedeki bir simge.
    ...
    ![Hesaplar sayfasında, vurgulanan özelleştirme ve denetim simgesi](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
...
- Hesaplarınız için uygulamayı ekledikten sonra kimlik doğrulayıcı uygulamasını Cihazınızda kullanarak oturum açabilirsiniz. Daha fazla bilgi için [uygulamayı kullanarak oturum](microsoft-authenticator-app-phone-signin-faq.md).

- İOS çalıştıran cihazlar için hesap kimlik bilgilerinizi da yedekleyebilirsiniz ve hesaplarınızı sırası gibi uygulama ayarlarını bulutla ilgili. Daha fazla bilgi için [yedekleme ve Kurtarma Microsoft Authenticator uygulaması ile](microsoft-authenticator-app-backup-and-recovery.md).
