...
4. QR kodu taraması için cihazınızın kamerasının kullanın **mobil uygulama yapılandırma** PC'NİZDE ekran ve ardından **Bitti**.
    ...
    >[!Note]
    >Kameranız QR kodunu yakalamak üzere yapamıyorsa, hesap bilgilerinizi iki adımlı doğrulama için Microsoft Authenticator uygulamasını el ile ekleyebilirsiniz. Daha fazla bilgi ve bunu nasıl için bkz: [el ile hesabınızı eklemek](microsoft-authenticator-app-add-account-manual.md).
