...
- Kimlik doğrulama kişi bilgilerinizi en fazla tarih ve erişiminizi engellemediğini olup olmadığını denetleyin. Denetleme [burada](https://docs.microsoft.com/en-us/azure/multi-factor-authentication/end-user/multi-factor-authentication-end-user) kimlik bilgilerinizi ayarlama hakkında daha fazla bilgi.
...
## <a name="i-am-having-trouble-installing-the-my-apps-portal-browser-extension"></a>My uygulamaları portal tarayıcı uzantısı yükleme sorun yaşıyorum
...
- Uzantı için tarayıcı gereksinimleri şunlardır:
    - Internet Explorer 8, 9, 10, Windows 7 veya sonraki sürümlerde 11
...
1. Grupları uygulama kutucuğuna tıklayın. 
2. I kendi, gruplar altında bir grup oluşturmak için Grup Oluştur'a tıklayın ve ardından yönergeleri izleyin.
3. Grupları, ben altında bir gruba katılması için gruba Katıl tıklayın ve ardından yönergeleri izleyin.
