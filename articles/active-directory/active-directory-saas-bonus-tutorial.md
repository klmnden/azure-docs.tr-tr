...
4. Arama kutusuna **Bonusly**seçin **Bonusly** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde bonusly](./media/active-directory-saas-bonus-tutorial/tutorial_bonusly_addfromgallery.png)
...
4. Üzerinde **SAML imzalama sertifikası** bölümünde, kopyalama **parmak İZİ** sertifika değeri.
    ...
    ![Sertifika indirme bağlantısı](./media/active-directory-saas-bonus-tutorial/tutorial_bonusly_certificate.png) 
...
1. İçinde **Azure portal**, sol gezinti bölmesinde tıklatın **Azure Active Directory** simgesi.
    ...
    ![Azure Active Directory düğmesi](./media/active-directory-saas-bonus-tutorial/create_aaduser_01.png) 

2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar** tıklatıp **tüm kullanıcılar**.
    
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/active-directory-saas-bonus-tutorial/create_aaduser_02.png) 

3. Açmak için **kullanıcı** iletişim kutusunda, tıklatın **Ekle** iletişim kutusunun üst kısmında.
 
    ![Ekle düğmesi](./media/active-directory-saas-bonus-tutorial/create_aaduser_03.png) 

4. Üzerinde **kullanıcı** iletişim sayfasında, aşağıdaki adımları gerçekleştirin:
 
    ![Kullanıcı iletişim kutusu](./media/active-directory-saas-bonus-tutorial/create_aaduser_04.png) 
...
2. Uygulamalar listesinde **Bonusly**.
    ...
    ![Bonusly bağlantı uygulamalar listesinde](./media/active-directory-saas-bonus-tutorial/tutorial_bonusly_app.png) 
