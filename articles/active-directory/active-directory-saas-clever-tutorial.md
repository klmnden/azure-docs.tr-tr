...
4. Üzerinde **SAML imzalama sertifikası** 'yi tıklatın **meta veri XML** ve meta veri dosyası, bilgisayarınıza kaydedin.
    ...
    ![Sertifika indirme bağlantısı](./media/active-directory-saas-clever-tutorial/tutorial_clever_certificate.png)
...
8. Oluşturulacak **meta veri** url, aşağıdaki adımları gerçekleştirin:
    ...
    d. Şimdi özellik sayfasına gidin **Clever** ve kopyalama **uygulama kimliği** kullanarak **kopyalama** düğmesine tıklayın ve Not Defteri'ne yapıştırın.
...
9. Farklı web tarayıcısı penceresinde Akıllı şirket sitenizin bir yönetici olarak oturum açın.

10. Araç çubuğunda **anlık oturum açma**.

    ![Hızlı oturum açma](./media/active-directory-saas-clever-tutorial/ic798984.png "anlık oturum açma")

11. Üzerinde **anlık oturum açma** sayfasında, aşağıdaki adımları gerçekleştirin:
      ...
      c. Tür **meta veri URL'sini** içinde **meta veri URL'sini** metin kutusu.
