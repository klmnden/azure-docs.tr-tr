...
İzleme ve programlara düzenleyerek farklı amaçlar için erişim incelemeler toplamak nasıl basitleştirebilirsiniz. Her erişim gözden geçirme bir programa bağlanabilir. Raporlar için bir denetçi hazırlarken, yalnızca erişim incelemeler belirli girişimi kapsamında görünür değildir.
