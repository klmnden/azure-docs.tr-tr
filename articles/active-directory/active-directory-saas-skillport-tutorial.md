...
3. Üzerinde **Skillport etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek yanıt URL'si ve oturum açma URL'si ile güncelleştirin. Kişi [Skillport istemci destek ekibi](https://www.skillsoft.com/contact.asp) bu değerleri almak için.
