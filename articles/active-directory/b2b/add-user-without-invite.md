...
> [!NOTE]
> Şimdi, Konuk kullanıcılar artık davet e-posta dışında bazı özel durumlarda gerekir. Daha fazla bilgi için bkz: [B2B işbirliği davet kullanım](redemption-experience.md).  
...
2. Konak kuruluşunuzdaki Yönetim [ilkeleri oluşturur](delegate-invitations.md) tanımlamak ve iş ortağı kuruluştan (Lıtware) diğer kullanıcıları eklemek Sam izin verin.
