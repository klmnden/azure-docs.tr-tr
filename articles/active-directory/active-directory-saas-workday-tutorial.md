...
10. İçinde **yönlendirme URL'lerini** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    >-Workday kiracısı URL'si etki alanı adı ile impl örneğin başlayıp başlamadığını: *https://impl.workday.com/\<tenant\>/login-saml2.htmld*), **ortam** uygulamasına özniteliği ayarlanmalıdır.  
