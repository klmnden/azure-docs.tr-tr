...
4. Arama kutusuna yazın **SAML SSO GmbH çözünürlüğün Bambu için**seçin **SAML SSO GmbH çözünürlüğün Bambu için** sonuç panelinden ardından **Ekle** eklemek için düğmeyi uygulama.
    ...
    ![Sonuçlar listesinde GmbH çözünürlüğün Bambu SAML SSO](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addfromgallery.png)
...
2. Üzerinde **çoklu oturum açma** iletişim kutusunda **modu** olarak **SAML tabanlı oturum açma** çoklu oturum açmayı etkinleştirmek için.
    ...
    ![Çoklu oturum açma iletişim kutusu](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_samlbase.png)
...
3. Üzerinde **GmbH etki alanı çözünürlüğün Bambu ve URL'ler için SAML SSO** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![SAML SSO Bambu çözünürlüğün GmbH etki alanı için ve oturum açma URL'leri tek bilgileri](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![SAML SSO Bambu çözünürlüğün GmbH etki alanı için ve oturum açma URL'leri tek bilgileri](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url1.png)
...
5. Üzerinde **SAML imzalama sertifikası** 'yi tıklatın **meta veri XML** ve meta veri dosyası, bilgisayarınıza kaydedin.
    ...
    ![Sertifika indirme bağlantısı](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_certificate.png) 

6. Tıklatın **kaydetmek** düğmesi.

    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/active-directory-saas-bamboo-tutorial/tutorial_general_400.png)
...
8. Ana araç çubuğunun sağ tarafta tıklatın **ayarları** > **eklentileri**.
    ...
    ![Ayarları](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_setings.png)
...
10. Üzerinde **SAML SIngleSignOn eklentisi yapılandırma sayfası**, tıklatın **IDP eklemek**. 
    ...
    ![IDP ekleme](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addidp.png)

11. Üzerinde **SAML kimlik sağlayıcısı seçin** sayfasında, aşağıdaki adımları gerçekleştirin:

    ![Kimlik sağlayıcısı](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityprovider.png)
...
12. Üzerinde **kimlik sağlayıcı Yapılandırması** sayfasında **sonraki**.
    ...
    ![Kimlik yapılandırma](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityconfig.png)
...
13.  Üzerinde **meta verileri içeri aktarma SAML IDP** sayfasında, tıklatın **yükleme dosyası** karşıya yüklemek için **meta veri XML** Azure Portalı'ndan indirilen dosya.
    ...
    ![İdpmetadata](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_idpmetadata.png)

14. **İleri**’ye tıklayın.

15. Tıklatın **ayarlarını kaydetmek**.

    ![Kaydetme](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_save.png)
...
1. Sol bölmede, Azure portal'ı tıklatın **Azure Active Directory** düğmesi.
    ...
    ![Azure Active Directory düğmesi](./media/active-directory-saas-bamboo-tutorial/create_aaduser_01.png)

2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.

    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/active-directory-saas-bamboo-tutorial/create_aaduser_02.png)

3. Açmak için **kullanıcı** iletişim kutusu, tıklatın **Ekle** en üstündeki **tüm kullanıcılar** iletişim kutusu.

    ![Ekle düğmesi](./media/active-directory-saas-bamboo-tutorial/create_aaduser_03.png)

4. İçinde **kullanıcı** iletişim kutusunda, aşağıdaki adımları gerçekleştirin:

    ![Kullanıcı iletişim kutusu](./media/active-directory-saas-bamboo-tutorial/create_aaduser_04.png)
...
2. Uygulamalar listesinde **SAML SSO GmbH çözünürlüğün Bambu için**.
    ...
    ![Uygulamalar listesinde çözümleme GmbH bağlantısıyla Bambu SAML SSO](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_app.png)  
