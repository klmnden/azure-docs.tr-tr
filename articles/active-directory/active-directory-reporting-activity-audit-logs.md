...
Örneğin, **Etkinlik Türü** olarak **Grup** seçeneğini belirlediyseniz aşağıdaki **Etkinlik Kaynaklarına** göre filtreleme yapmanızı sağlayan ek bir filtreleme seçeneği sunulur:
