...
![Ekran görüntüsü, Azure AD Connect Health e-posta bildirimi ayarları](./media/active-directory-aadconnect-health/email_noti_discover.png)
...
1. Gelen **yapılandırma** bölümünde **kullanıcılar**.<br>
   ![Ekran görüntüsü, Azure AD Connect Health kaynak kenar çubuğu](./media/active-directory-aadconnect-health/startRBAC.png)
2. **Add (Ekle)** seçeneğini belirleyin.
3. İçinde **bir rol seçin** bölmesinde, bir rol seçin (örneğin, **sahibi**).<br>
   ![Ekran Azure AD Health RBAC kullanıcıların bağlanmasına penceresi](./media/active-directory-aadconnect-health/RBAC_add.png)
4. Adına veya tanımlayıcısına hedeflenen kullanıcı veya grubun yazın. Aynı anda bir veya daha fazla kullanıcılar veya gruplar seçebilirsiniz. **Seç**'e tıklayın.
   ![Ekran Azure AD Health RBAC kullanıcıların bağlanmasına penceresi](./media/active-directory-aadconnect-health/RBAC_select_users.png)
5. **Tamam**’ı seçin.<br>
6. Rol ataması tamamlandıktan sonra kullanıcıları ve grupları listesinde görünür.<br>
   ![Vurgulanmış yeni kullanıcılarla ekran Azure AD Health RBAC kullanıcıların bağlanmasına penceresi](./media/active-directory-aadconnect-health/RBAC_user_list.png)
...
#### <a name="step-3-share-the-blade-location-with-users-or-groups"></a>3. adım: dikey konumu, kullanıcılar veya gruplar ile paylaşın.
...
2. Dikey penceresinde kullanıcı, dikey ya da farklı bölümlerini, panoya sabitleyebilirsiniz. Tıklamanız yeterlidir **panoya Sabitle** simgesi.<br>
   ![PIN simgesinin vurgulandığı ekran görüntüsü, Azure AD Connect Health RBAC PIN dikey](./media/active-directory-aadconnect-health/RBAC_pin_blade.png)
...
![Ekran görüntüsü, Azure AD Health RBAC kullanıcıların bağlanmasına penceresinin vurgulanmış Kaldır](./media/active-directory-aadconnect-health/RBAC_remove.png)
