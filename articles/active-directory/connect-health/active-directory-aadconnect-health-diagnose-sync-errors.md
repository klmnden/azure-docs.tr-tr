...
Azure AD hakkında daha fazla bilgi için bkz. [kimlik eşitleme ve yinelenen öznitelik dayanıklılığı](https://aka.ms/dupattributeresdocs).
...
![Eşitleme hatası yaygın bir senaryo tanılayın](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixCommonCase.png)
...
![Eşitleme hatası yalnız bırakılmış nesneye senaryosu tanılayın](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Eşitleme hata tanılama adımları](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![Eşitleme hatası yalnız bırakılmış nesneye tanılama * kullanıcısı mevcut * senaryosu](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Eşitleme hatası yalnız bırakılmış nesneye tanılama * aynı kullanıcı * senaryosu](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Eşitleme hatası düzeltme tanılayın](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixAfterFix.png)
