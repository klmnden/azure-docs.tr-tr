...
![Otomasyon betiği Azure kaynakları için yönetilen kimlikleri dışarı aktarma hatası](../managed-service-identity/media/msi-known-issues/automation-script-export-error.png)
