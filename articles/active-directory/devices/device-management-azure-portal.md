...
- **Kullanıcılar cihazları Azure AD'ye Katıl** -Bu ayar için kullanıcıları seçmenizi sağlar [katılın cihazları](overview.md#azure-ad-joined-devices) Azure AD'ye. Varsayılan değer **tüm**.
