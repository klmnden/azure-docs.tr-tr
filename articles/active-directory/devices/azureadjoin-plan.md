...
* [Cihaz kaydı oluşturma](device-management-azure-portal.md)

### <a name="user-tasks"></a>Kullanıcı görevleri
* [Kurulum sırasında Azure AD ile yeni bir Windows 10 cihazı ayarlama](azuread-joined-devices-frx.md)
* [Ayarlar'dan Azure AD ile bir Windows 10 cihazı ayarlama](../user-help/device-management-azuread-registered-devices-windows10-setup.md)
* [Kişisel bir Windows 10 cihazı kuruluşunuza katma](../user-help/device-management-azuread-joined-devices-setup.md)
