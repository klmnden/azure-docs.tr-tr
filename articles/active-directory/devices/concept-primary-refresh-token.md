...
Azure AD kayıtlı cihaz senaryolarda, Azure AD WAM eklentisi PRT birincil yetkilisini olduğu Windows oturum açma, bu Azure AD hesabıyla oluyor değil.
