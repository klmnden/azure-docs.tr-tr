...
1. Yerel güvenlik yetkilisi (LSA) hizmeti, cihaz üzerinden Kerberos kimlik doğrulamasını etkinleştirir.
...
1. Şirket içi bulunduğu DC'ye kimliği doğrulanmış kullanıcı almak için etki alanı bilgilerini ve kullanıcı kimlik bilgilerini gönderir.
1. Bir Kerberos alır [bilet sağlayan bilet (TGT)](https://docs.microsoft.com/windows/desktop/secauthn/ticket-granting-tickets) AD alanına katılmış kaynaklara erişmek için kullanılır.
