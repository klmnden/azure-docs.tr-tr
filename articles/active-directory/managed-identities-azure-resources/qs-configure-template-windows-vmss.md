...
### <a name="assign-a-user-assigned-managed-identity-to-a-virutal-machine-scale-set"></a>Bir sanal makine ölçek kümesi için bir kullanıcı tarafından atanan bir yönetilen kimlik atama
