...
Bir Azure kaynağı üzerinde gibi MSI etkinleştirdikten sonra bir [Azure VM](msi-qs-configure-portal-windows-vm.md) veya [Azure VMSS](msi-qs-configure-portal-windows-vmss.md):
...
- Bir Azure sanal makinede MSI etkinleştirmek için bkz: [bir Azure VM yönetilen hizmet kimliği (Azure Portalı'nı kullanarak MSI) yapılandırma](msi-qs-configure-portal-windows-vm.md).
