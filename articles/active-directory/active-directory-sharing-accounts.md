...
* [Grup ataması](users-groups-roles/groups-self-service-management.md)
...
* Kullanım [grup tabanlı atama](users-groups-roles/groups-saasapps.md) ve paylaşılan bir kimlik bilgisi girin seçeneğini belirleyin
