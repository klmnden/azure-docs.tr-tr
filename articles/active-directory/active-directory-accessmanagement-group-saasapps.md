...
> [!IMPORTANT]
> Yalnızca bir Azure AD Premium deneme sürümünü başlatın veya Azure AD Premium veya Azure AD temel lisans satın sonra bu özelliği kullanabilirsiniz. Grup tabanlı atama yalnızca güvenlik grupları için desteklenir. Şu anda uygulamalara grup tabanlı atama yapmak için iç içe geçmiş grup üyelikleri desteklenmiyor.
