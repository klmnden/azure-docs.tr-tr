...
![Uygulama Kimliği](./media/application-proxy-wildcard/22.png)


Yapılandırırken bir **dış URL**, aşağıdaki biçimi kullanmanız gerekir: `https://*.<custom domain>` 

![Uygulama Kimliği](./media/application-proxy-wildcard/21.png)
...
![Uygulama Kimliği](./media/application-proxy-wildcard/01.png)
...
- İç URL:
    ...
    ![İç URL](./media/application-proxy-wildcard/42.png)


- Dış URL:

    ![Dış URL](./media/application-proxy-wildcard/43.png)

 
- İç uygulama SPN'si: 

    ![SPN yapılandırma](./media/application-proxy-wildcard/44.png)
...
![Uygulama Kimliği](./media/application-proxy-wildcard/05.png)
...
- İçinde **İç URL**, ayarladığınız **Finans** yerine bir joker karakter. 
    ...
    ![İç URL](./media/application-proxy-wildcard/52.png)

- İçinde **dış URL**, ayarladığınız **Finans** yerine bir joker karakter. 

    ![Dış URL](./media/application-proxy-wildcard/53.png)

- Ayarladığınız iç uygulama SPN'si **Finans** yerine bir joker karakter.

    ![SPN yapılandırma](./media/application-proxy-wildcard/54.png)


Bu yapılandırma aşağıdaki senaryoyu uygular:

![Senaryo](./media/application-proxy-wildcard/09.png)
