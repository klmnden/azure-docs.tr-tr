...
Başvurulan içerik dahil, ancak yine de daha derin bir bağlantıyı yolunda güden kullanıcılara gerekir, yolunu değiştirirseniz, blog gönderisine bakın [Azure AD uygulama proxy'si uygulamalarda paneli ve Office 365 uygulama Başlatıcıerişmekiçindoğrubağlantıayarı](https://blogs.technet.microsoft.com/applicationproxyblog/2016/04/06/setting-the-right-link-for-application-proxy-applications-in-the-azure-ad-access-panel-and-office-365-app-launcher/).
