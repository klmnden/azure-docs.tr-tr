...
Aşağıdaki tabloda her önceki uygulama türleri tarafından desteklenen farklı tek oturum açma ve sağlama modları açıklanmaktadır. Bu tablo, belirli bir amaca desteklemek için eklemeniz gereken hangi uygulamanın anlamanıza yardımcı olması için kullanabilirsiniz.
  ...
  ![Tablo: Farklı SSO ve her bir uygulama türü tarafından desteklenen modları sağlama](./media/choose-application-type/table1.png)
...
Oturum açma uygulamanın tek modu ayarlamak için bu yönergeleri izleyin:
...
1. tıklayın **kurumsal uygulamalar** Azure Active Directory sol taraftaki gezinti menüsünde.
...
1. Sağlama yapılandırmak istediğiniz uygulamayı seçin.
1. Uygulama yüklendikten sonra tıklayın **sağlama** uygulamanın sol taraftaki gezinti menüsünde.
