...
description: Parola çoklu oturum açma için yapılandırılmış Azure AD galeri uygulamaları için oturum açma ile ilgili sorunları gidermek için rehberlik sorunlu alanları açıklar.
