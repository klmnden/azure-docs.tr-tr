...
![Kısıtlamaları trafiği akışı Kiracı - diyagram](./media/tenant-restrictions/traffic-flow.png)
...
![Sayfa kiracılar izin olmayan kullanıcılar için erişim reddedildi](./media/tenant-restrictions/end-user-denied.png)
...
![Kısıtlı oturum açma denemeleri görüntülemek için Azure portalını kullanma](./media/tenant-restrictions/portal-report.png)
