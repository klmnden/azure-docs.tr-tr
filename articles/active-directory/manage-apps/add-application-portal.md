...
6. Uygulama aramak için **Galeriden ekle** bölümüne eklemek istediğiniz uygulamanın adını girin. Sonuçların arasından istediğiniz uygulamayı seçin ve **Ekle**’ye tıklayın. Aşağıdaki örnekte GitHub.com araması yaptıktan sonra görünen **Uygulama ekle** formu gösterilmektedir.
...
Bu hızlı başlangıçta Azure AD kiracınıza galeri uygulaması eklemeyi öğrendiniz. Ayrıca bir uygulamanın özelliklerini düzenlemeyi de öğrendiniz. 
