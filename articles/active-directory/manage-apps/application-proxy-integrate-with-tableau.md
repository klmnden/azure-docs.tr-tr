...
- Bir [uygulama ara sunucusu Bağlayıcısı](application-proxy-enable.md) yüklü. 
...
Uygulamayı kullanmak hazır olduğunuzda, bir onay iletisi. Yapılandırmaları için onay beklenirken bitirebilirsiniz.
...
Azure AD uygulama proxy'si hakkında daha fazla bilgi için bkz: [güvenli uzaktan erişim sağlamak şirket içi uygulamalar](application-proxy.md).
