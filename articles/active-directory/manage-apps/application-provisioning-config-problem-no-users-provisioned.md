...
---
Başlık: Azure AD galeri uygulaması için hiçbir kullanıcı sağlanmıyor | Microsoft Docs açıklaması: yaygın sorunlarını giderme konusunda karşılaştığı görüntülenmesini kullanıcılar görmüyorsanız, bir Azure ad galeri Azure AD Hizmetleri ile kullanıcı sağlama için yapılandırdığınız uygulama: active directory documentationcenter: '' author: barbkess manager: mtillman

MS.assetid: ms.service: active directory ms.component: uygulama-mgmt ms.workload: kimlik ms.tgt_pltfrm: na ms.devlang: na ms.topic: kavramsal ms.date: 05/04/2017 ms.author: barbkess ms.reviewer: asteen
...
## <a name="next-steps"></a>Sonraki adımlar
[Azure AD Connect eşitleme: anlama, bildirim temelli sağlama](../connect/active-directory-aadconnectsync-understanding-declarative-provisioning.md)
