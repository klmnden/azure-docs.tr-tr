...
6. **Kaydet**’i seçin.
    ...
    ![Çoklu oturum açma düğmesi kaydetme yapılandırın](./media/active-directory-saas-cisco-webex-tutorial/tutorial_general_400.png)
...
10. İçinde **Federe Web SSO Yapılandırması** bölümünde, aşağıdaki adımları uygulayın:
    ...
    ı. İçinde **müşteri SSO hizmet oturum kapatma URL'si** kutusunda, yapıştırma **Sign-Out URL**, hangi Azure portalından kopyalanır.
