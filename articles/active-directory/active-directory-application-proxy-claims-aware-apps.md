...
1. Uygulamanızı bölümünde açıklanan yönergeleri göre yayımlamak [uygulama proxy'si ile uygulama yayımlama](manage-apps/application-proxy-publish-azure-portal.md).
...
* [Çoklu oturum açmayı etkinleştir](manage-apps/application-proxy-single-sign-on.md) talep kullanan olmayan uygulamalar için
