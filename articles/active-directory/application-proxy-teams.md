...
- Bilgi edinmek için nasıl [şirket içi SharePoint siteleri yayımlamak](manage-apps/application-proxy-integrate-with-sharepoint-server.md) uygulama proxy'si ile.
