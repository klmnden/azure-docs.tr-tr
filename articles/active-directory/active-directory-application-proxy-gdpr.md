...
Azure AD uygulama ara sunucusuna genel bakış için bkz: [güvenli uzaktan erişim sağlamak şirket içi uygulamalar](active-directory-application-proxy-get-started.md).
