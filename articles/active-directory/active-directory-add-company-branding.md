...
> [!IMPORTANT]
> Yammer, kullanıcı oturum açtıktan sonra Azure AD işaretli oturum açma sayfasını göstermez. Kullanıcı önce genel Office 365 oturum açma sayfasını ve ardından işaretli sayfayı görür.   
