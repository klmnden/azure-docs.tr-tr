...
7. Farklı web tarayıcısı penceresinde JIRA şirket içi sunucunuza yönetici olarak oturum açın.
...
2. Dişlisine üzerine gelin ve tıklatın **kullanıcı yönetimi**.
    ...
    ![Çalışanı ekleyin](./media/kantegassoforjira-tutorial/user1.png) 

3. Altında **kullanıcı yönetimi** bölüm sekmesini tıklatın, **kullanıcı oluşturma**.

    ![Çalışanı ekleyin](./media/kantegassoforjira-tutorial/user2.png) 

4. Üzerinde **"Yeni kullanıcı oluştur"** iletişim sayfasında, aşağıdaki adımları gerçekleştirin:

    ![Çalışanı ekleyin](./media/kantegassoforjira-tutorial/user3.png) 
