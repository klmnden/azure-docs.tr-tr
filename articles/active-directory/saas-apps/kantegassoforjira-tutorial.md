...
* Azure AD hesaplarına otomatik olarak Kantega SSO (çoklu oturum açma) JIRA için oturum, kullanıcıların etkinleştirebilirsiniz.
...
* JIRA desteklediği için Kantega SSO **SP ve IDP** tarafından başlatılan
...
4. Arama kutusuna **Kantega SSO için JIRA**seçin **Kantega SSO için JIRA** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

    ![Sonuç listesinde JIRA için Kantega SSO](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Kantega SSO ile JIRA adlı bir test kullanıcı tabanlı için test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Kantega SSO JIRA için ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[Kantega SSO JIRA çoklu oturum açma için yapılandırma](#configure-kantega-sso-for-jira-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[JIRA test kullanıcısı için Kantega SSO oluşturma](#create-kantega-sso-for-jira-test-user)**  - Kantega SSO için kullanıcı Azure AD gösterimini bağlı JIRA Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Kantega SSO için JIRA** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu, aşağıdaki adımları gerçekleştirin:
    ...
    ![JIRA etki alanı ve URL'ler tek oturum açma bilgileri için Kantega SSO](common/idp-intiated.png)
...
5. Tıklayın **ek URL'lerini ayarlayın** ve uygulamada yapılandırmak istiyorsanız, aşağıdaki adımı uygulayın **SP** başlatılan modu:
    ...
    ![JIRA etki alanı ve URL'ler tek oturum açma bilgileri için Kantega SSO](common/metadata-upload-additional-signon.png)
...
7. Üzerinde **Kantega SSO için JIRA ayarlama** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
### <a name="configure-kantega-sso-for-jira-single-sign-on"></a>Kantega SSO JIRA çoklu oturum açma için yapılandırma
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Kantega SSO için JIRA**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Kantega SSO için JIRA**.

    ![Uygulamalar listesinde JIRA bağlantısının Kantega SSO](common/all-applications.png)
...
### <a name="create-kantega-sso-for-jira-test-user"></a>Kantega SSO için JIRA test kullanıcısı oluşturma
...
Kantega SSO erişim panelinde JIRA kutucuğa tıkladığınızda, otomatik olarak için SSO'yu ayarlama JIRA Kantega SSO için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
