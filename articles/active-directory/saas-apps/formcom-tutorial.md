...
4. Arama kutusuna **Form.com**seçin **Form.com** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde form.com](./media/formcom-tutorial/tutorial_form.com_addfromgallery.png)
...
3. Üzerinde **Form.com etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Form.com etki alanı ve URL'leri tek oturum açma bilgileri](./media/formcom-tutorial/tutorial_form.com_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/formcom-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/formcom-tutorial/create_aaduser_02.png)
