...
4. Arama kutusuna **Netsuite**.
    ...
    ![Bir Azure AD test kullanıcısı oluşturma](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. Sonuçlar panelinde seçin **Netsuite**ve ardından **Ekle** uygulama eklemek için düğmesi.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. Üzerinde **SAML Kurulumu** sayfasında, aşağıdaki adımları gerçekleştirin:
    ...
    ![Çoklu oturum açmayı yapılandırın](./media/netsuite-tutorial/ns-sso-setup.png)
...
* [Kullanıcı sağlamayı Yapılandır](netsuite-provisioning-tutorial.md)
