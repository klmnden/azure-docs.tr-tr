...
3. **[Muhasebesi test kullanıcısı oluşturma](#creating-a-netsuite-test-user)**  - kullanıcı Azure AD gösterimini bağlı muhasebesi Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **muhasebesi etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **muhasebesi yapılandırma** bölümünde **yapılandırma muhasebesi** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/tutorial_NetSuite_configure.png)

7. Tarayıcınızda yeni bir sekme açın ve muhasebesi şirketinizin sitesi yönetici olarak oturum açın.

8. Sayfanın üst kısmındaki araç çubuğunda **Kurulum**, ardından gidin **şirket** tıklatıp **özellikleri etkinleştirmek**.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-setupsaml.png)

9. Sayfanın ortasında, araç çubuğunda **SuiteCloud**.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-suitecloud.png)

10. Altında **yönetme kimlik doğrulaması** bölümünden **SAML çoklu oturum açma** muhasebesi SAML çoklu oturum açma seçeneği etkinleştirme.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-ticksaml.png)

11. Sayfanın üst kısmındaki araç çubuğunda **Kurulum**.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-setup.png)

12. Gelen **Kurulum görevleri** listesinde **tümleştirme**.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-integration.png)

13. İçinde **yönetme kimlik doğrulaması** bölümünde **SAML çoklu oturum açma**.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-saml.png)

14. Üzerinde **SAML Kurulumu** sayfasındaki **muhasebesi yapılandırma** bölümünde aşağıdaki adımları gerçekleştirin:
...
15. Azure AD'de tıklayarak **görünümü ve diğer tüm kullanıcı özniteliklerini düzenleyin** onay kutusu ve öznitelik ekleyin.

    ![Çoklu oturum açmayı yapılandırın](./media/NetSuite-tutorial/ns-attributes.png)

16. İçin **öznitelik adı** yazın, alan `account`. İçin **öznitelik değeri** alanında, muhasebesi hesabı kimliğinizi yazın Bu, sabit ve değişiklik hesabıyla değerdir. Hesap Kimliğinizi bulmak yönergeler aşağıda verilmiştir:
...
17. Kullanıcılara çoklu oturum açma muhasebesi gerçekleştirmeden önce muhasebesi için uygun izinler önce atanmalıdır. Bu izinleri atamak için aşağıdaki yönergeleri izleyin.
...
2. Uygulamalar listesinde **muhasebesi**.
