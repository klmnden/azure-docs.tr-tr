...
4. **[Muhasebesi test kullanıcısı oluşturma](#create-netsuite-test-user)**  - kullanıcı Azure AD gösterimini bağlı muhasebesi Britta simon'un bir karşılığı vardır.
