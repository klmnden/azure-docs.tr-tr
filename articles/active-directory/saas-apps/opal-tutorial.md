...
3. **[Bir Opal test kullanıcısı oluşturma](#create-an-opal-test-user)**  - kullanıcı Azure AD gösterimini bağlı Opal Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Opal etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
4. Opal uygulama belirli bir biçimde SAML onaylamalarını bekler. Bu uygulama için aşağıdaki talepleri yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz **kullanıcı öznitelikleri** uygulama tümleştirme sayfasında bölümü. Aşağıdaki ekran görüntüsü bunun bir örneği gösterilmektedir.
...
8. Çoklu oturum açmayı yapılandırma **Opal** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Opal Destek ekibine](mailto:support@workwithopal.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
