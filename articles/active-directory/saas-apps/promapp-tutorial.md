...
* Otomatik olarak (çoklu oturum açma) Promapp için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Promapp destekler **SP** ve **IDP** tarafından başlatılan

* Promapp destekler **zamanında** kullanıcı sağlama
...
4. Arama kutusuna **Promapp**seçin **Promapp** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

     ![Sonuç listesinde Promapp](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Promapp adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Promapp ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[Promapp çoklu oturum açmayı yapılandırma](#configure-promapp-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Promapp test kullanıcısı oluşturma](#create-promapp-test-user)**  - kullanıcı Azure AD gösterimini bağlı Promapp Britta simon'un bir karşılığı vardır.
...
4. Üzerinde **temel SAML yapılandırma** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu, aşağıdaki adımları gerçekleştirin:
    ...
    ![Promapp etki alanı ve URL'ler tek oturum açma bilgileri](common/idp-intiated.png)
...
5. Tıklayın **ek URL'lerini ayarlayın** ve uygulamada yapılandırmak istiyorsanız, aşağıdaki adımı uygulayın **SP** başlatılan modu:
    ...
    İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın:  `https://<DOMAINNAME>.promapp.com/TENANTNAME/saml/authenticate`

    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerler gerçek tanımlayıcısı, yanıt URL'si ve oturum açma URL'si ile güncelleştirin. İlgili kişi [Promapp istemci Destek ekibine](https://www.promapp.com/about-us/contact-us/) bu değerleri almak için. Gösterilen desenleri de başvurabilirsiniz **temel SAML yapılandırma** bölümünde Azure portalında.
...
7. Üzerinde **Promapp kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
### <a name="configure-promapp-single-sign-on"></a>Promapp tek oturum açmayı yapılandırın

1. Promapp şirketinizin sitesi için yönetici olarak oturum açın. 
...
4. Üzerinde **güvenlik** iletişim kutusunda, aşağıdaki adımları gerçekleştirin:
   
    ![Azure AD çoklu oturum açma][14]
    
    a. Yapıştırma **oturum açma URL'si**, hangi Azure portaldan kopyaladığınız **SSO oturum açma URL'si** metin.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Promapp**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Promapp**.

    ![Uygulamalar listesinde Promapp bağlantı](common/all-applications.png)
...
### <a name="create-promapp-test-user"></a>Promapp test kullanıcısı oluşturma

Bu bölümde, Britta Simon adlı bir kullanıcı Promapp oluşturulur. Promapp just-ın-time kullanıcı hazırlama, varsayılan olarak etkin olduğu destekler. Bu bölümde, hiçbir eylem öğesini yoktur. Bir kullanıcı Promapp içinde zaten mevcut değilse yeni bir kimlik doğrulamasından sonra oluşturulur.

### <a name="test-single-sign-on"></a>Çoklu oturum açma testi 

Bu bölümde, erişim panelini kullanarak Azure AD çoklu oturum açma yapılandırmanızı test edin.

Erişim paneli Promapp kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama Promapp için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
