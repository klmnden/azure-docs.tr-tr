...
* Otomatik olarak (çoklu oturum açma) Edcor için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Abonelik Edcor çoklu oturum açma etkin
...
* Edcor destekler **IDP** tarafından başlatılan
...
Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Edcor adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Edcor ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
5. **[Edcor test kullanıcısı oluşturma](#create-edcor-test-user)**  - kullanıcı Azure AD gösterimini bağlı Edcor Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Edcor** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Edcor etki alanı ve URL'ler tek oturum açma bilgileri](common/idp-identifier.png)

    İçinde **tanımlayıcı** metin kutusuna bir URL yazın:  `https://sso.edcor.com/sp/ACS.saml2`

5. Üzerinde **yukarı çoklu oturum açma SAML ile ayarlanmış** sayfasında **SAML imzalama sertifikası** bölümünde **indirme** indirmek için **Federasyon meta veri XML**  bilgisayarınızdaki belirli seçenekler ihtiyacınıza göre ve kaydedin.

    ![Sertifika indirme bağlantısı](common/metadataxml.png)

6. Üzerinde **Edcor kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Edcor**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Edcor**.

    ![Uygulamalar listesinde Edcor bağlantı](common/all-applications.png)
...
Erişim paneli Edcor kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama Edcor için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
