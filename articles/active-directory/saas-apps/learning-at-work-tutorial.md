...
1. Arama kutusuna **İşte öğrenme**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/learning-at-work-tutorial/tutorial_learningatwork_search.png)

1. Sonuçlar panelinde seçin **İşte öğrenme**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Bir öğrenme iş test kullanıcısı oluşturma](#creating-a-learning-at-work-test-user)**  - Learning kullanıcı Azure AD gösterimini bağlantılı iş yerinde bir karşılığı Britta simon'un sağlamak için.
...
1. Üzerinde **iş etki alanı ve URL'ler öğrenme** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **iş yapılandırmasını öğrenme** bölümünde **yapılandırma öğrenme iş** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/learning-at-work-tutorial/tutorial_learningatwork_configure.png) 

1. Çoklu oturum açmayı yapılandırma **İşte öğrenme** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML**, **SAML varlık kimliği**, **SAML çoklu oturum açma hizmeti URL**, ve **oturum kapatma URL'si** için [iş Destek'te öğrenme](https://www.learninga-z.com/site/contact/support).
...
1. Uygulamalar listesinde **İşte öğrenme**.
