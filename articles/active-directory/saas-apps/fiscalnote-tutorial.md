...
4. Arama kutusuna **FiscalNote**seçin **FiscalNote** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde FiscalNote](./media/fiscalnote-tutorial/tutorial_fiscalnote_addfromgallery.png)
...
3. Üzerinde **FiscalNote etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![FiscalNote etki alanı ve URL'leri tek oturum açma bilgileri](./media/fiscalnote-tutorial/tutorial_fiscalnote_url.png)
...
7. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/fiscalnote-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/fiscalnote-tutorial/create_aaduser_02.png)
