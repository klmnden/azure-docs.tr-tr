...
4. Arama kutusuna **FileCloud**seçin **FileCloud** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde FileCloud](./media/filecloud-tutorial/tutorial_filecloud_addfromgallery.png)
...
3. Üzerinde **FileCloud etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![FileCloud etki alanı ve URL'leri tek oturum açma bilgileri](./media/filecloud-tutorial/tutorial_filecloud_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/filecloud-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/filecloud-tutorial/create_aaduser_02.png)
