...
5. Sonuçlar panelinde seçin **dönüm OnDemand**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Bir dönüm OnDemand test kullanıcısı oluşturma](#creating-a-cornerstone-ondemand-test-user)**  - kullanıcı Azure AD gösterimini bağlı dönüm OnDemand Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **dönüm OnDemand etki alanı ve URL'ler** bölümünde, aşağıdaki adımı uygulayın:
...
6. Üzerinde **dönüm OnDemand yapılandırma** bölümünde **yapılandırma temel taşıdır OnDemand** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
