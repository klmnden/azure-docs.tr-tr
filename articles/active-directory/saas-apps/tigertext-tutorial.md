...
1. Arama kutusuna **TigerText güvenli Messenger**seçin **TigerText güvenli Messenger** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[TigerText güvenli Messenger test kullanıcısı oluşturma](#create-a-tigertext-secure-messenger-test-user)**  - TigerText güvenli Messenger kullanıcı Azure AD gösterimini bağlı Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **TigerText güvenli Messenger etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu uygulama için yapılandırılmış oturum almak için iletişime geçin [TigerText güvenli Messenger Destek ekibine](mailTo:prosupport@tigertext.com) ve sağlayacağını **yüklenen meta verileri**.
