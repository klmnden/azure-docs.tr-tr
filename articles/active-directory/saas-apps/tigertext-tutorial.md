...
4. Arama kutusuna **TigerText güvenli Messenger**seçin **TigerText güvenli Messenger** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Galerisi'nden ekleme](./media/tigertext-tutorial/tutorial_tigertext_addfromgallery.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar** tıklatıp **tüm kullanıcılar**.
    ...
    ![Kullanıcıların ve grupların tüm kullanıcılar ->](./media/tigertext-tutorial/create_aaduser_02.png) 
...
2. Uygulamalar listesinde **TigerText güvenli Messenger**.
    ...
    ![TigerText güvenli Messenger'da uygulama listesi](./media/tigertext-tutorial/tutorial_tigertext_app.png) 
