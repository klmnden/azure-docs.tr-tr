...
4. Arama kutusuna yazın **IMPAC riski yönetici**seçin **IMPAC riski yönetici** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde IMPAC Risk Yöneticisi](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_addfromgallery.png)
...
3. Üzerinde **IMPAC riski yönetici etki alanı ve URL'leri** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![IMPAC riski yönetici etki alanı ve URL'leri tek oturum açma bilgileri](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_url_new.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![IMPAC riski yönetici etki alanı ve URL'leri tek oturum açma bilgileri](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_url1_new.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/impacriskmanager-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/impacriskmanager-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **IMPAC riski yönetici**.
    ...
    ![Uygulamalar listesinde IMPAC riski yönetici bağlantı](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_app.png)  
