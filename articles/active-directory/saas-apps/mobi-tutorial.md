---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle MOBI | Microsoft Docs'
...
ms.locfileid: "39040502"
---
# <a name="tutorial-azure-active-directory-integration-with-mobi"></a>Öğretici: Azure Active Directory MOBI ile tümleştirme
...
3. **[MOBI test kullanıcısı oluşturma](#create-a-mobi-test-user)**  - kullanıcı Azure AD gösterimini bağlı MOBI Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **MOBI etki alanı ve URL'ler** bölümünde, IDP tarafından başlatılan modunda uygulama yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
...
7. Çoklu oturum açmayı yapılandırma **MOBI** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [MOBI Destek ekibine](mailto:sso@mobiwm.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
