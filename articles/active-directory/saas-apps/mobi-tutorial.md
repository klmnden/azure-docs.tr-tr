...
4. Arama kutusuna **MOBI**seçin **MOBI** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde MOBI](./media/mobi-tutorial/tutorial_mobi_addfromgallery.png)
...
3. Üzerinde **MOBI etki alanı ve URL'leri** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![MOBI etki alanı ve URL'leri tek oturum açma bilgileri](./media/mobi-tutorial/tutorial_mobi_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![MOBI etki alanı ve URL'leri tek oturum açma bilgileri](./media/mobi-tutorial/tutorial_mobi_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/mobi-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/mobi-tutorial/create_aaduser_02.png)
