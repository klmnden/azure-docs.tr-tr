...
4. **[SAP HANA test kullanıcısı oluşturma](#create-sap-hana-test-user)**  - kullanıcı Azure AD gösterimini bağlı SAP hana Britta simon'un bir karşılığı vardır.
