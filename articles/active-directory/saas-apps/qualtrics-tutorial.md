---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Qualtrics | Microsoft Docs'
...
ms.locfileid: "39046218"
---
# <a name="tutorial-azure-active-directory-integration-with-qualtrics"></a>Öğretici: Azure Active Directory Qualtrics ile tümleştirme
...
3. **[Qualtrics test kullanıcısı oluşturma](#create-a-qualtrics-test-user)**  - kullanıcı Azure AD gösterimini bağlı Qualtrics Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Qualtrics etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **Qualtrics** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Qualtrics Destek ekibine](https://www.qualtrics.com/support/). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
