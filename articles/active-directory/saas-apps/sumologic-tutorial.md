...
2. Git **yönetmek \> kullanıcılar**.
    ...
    ![Kullanıcıların](./media/sumologic-tutorial/ic778561.png "kullanıcılar")

3. **Ekle**'ye tıklayın.
   
    ![Kullanıcıların](./media/sumologic-tutorial/ic778562.png "kullanıcılar")
