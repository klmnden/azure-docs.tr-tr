...
3. Zscaler eklemek için tıklatın **yeni uygulama** iletişim kutusunun üst kısmındaki düğmesi.

    ![Yeni Uygulama düğmesi][3]

4. Arama kutusuna **Zscaler**.

    ![Zscaler sağlama](./media/zscaler-provisioning-tutorial/app-search.png)

5. Sonuçlar panelinde seçin **Zscaler**ve ardından **Ekle** düğmesini Zscaler SaaS uygulamaları listenize ekleyin.

    ![Zscaler sağlama](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Zscaler sağlama](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. Zscaler SaaS uygulamaları listesinden seçin.

    ![Zscaler sağlama](./media/zscaler-provisioning-tutorial/app-instance-search.png)
