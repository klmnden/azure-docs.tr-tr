...
3. **[TurboRater test kullanıcısı oluşturma](#create-a-turborater-test-user)**  - kullanıcı Azure AD gösterimini bağlı TurboRater Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **TurboRater etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
7. Çoklu oturum açmayı yapılandırma **TurboRater** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [TurboRater Destek ekibine](https://www.getitc.com/support). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
