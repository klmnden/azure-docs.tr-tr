...
4. Arama kutusuna **Zscaler**seçin **Zscaler** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
    ...
    ![Sonuç listesinde Zscaler](./media/zscaler-tutorial/tutorial_zscaler_addfromgallery.png)
...
3. **[Zscaler test kullanıcısı oluşturma](#creating-a-zscaler-test-user)**  - kullanıcı Azure AD gösterimini bağlı Zscaler Britta simon'un bir karşılığı vardır.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Zscaler etki alanı ve URL'ler tek oturum açma bilgileri](./media/zscaler-tutorial/tutorial_zscaler_url.png)

    İçinde **oturum açma URL'si** metin kutusuna bir URL şu biçimi kullanarak: `https://<companyname>.zscaler.net`
...
7. Üzerinde **SAML imzalama sertifikası** sayfasında **SAML imzalama sertifikası** bölümünde **indirme** indirmek için **sertifika (Base64)** ve bilgisayarınızdaki sertifika dosyasını kaydedin.
    ...
    ![Sertifika indirme bağlantısı](./media/zscaler-tutorial/tutorial_zscaler_certificate.png) 

8. Üzerinde **Zscaler kümesi** bölümünde, ihtiyacınıza göre uygun URL'yi kopyalayın.
    ...
    ![Zscaler yapılandırma](common/configuresection.png)

9. Farklı bir web tarayıcı penceresinde ZScaler şirketinizin sitesi için bir yönetici olarak oturum açın.
...
Bu bölümün amacı Zscaler Britta Simon adlı bir kullanıcı oluşturmaktır. Zscaler tam zamanında sağlama, varsayılan olarak etkin olan destekler. Bu bölümde, hiçbir eylem öğesini yoktur. Yeni bir kullanıcı, henüz yoksa Zscaler erişme denemesi sırasında oluşturulur.
>[!Note]
