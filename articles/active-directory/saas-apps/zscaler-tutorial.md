...
9. Altında **yönetmesine & rolleri**, tıklatın **kullanıcıları yönetme & kimlik doğrulama**.   
    ...
    ![Kullanıcıların & kimlik doğrulaması Yönet](./media/zscaler-tutorial/ic800207.png "kullanıcılar & kimlik doğrulaması Yönet")

10. İçinde **, kuruluşunuz için kimlik doğrulama seçeneklerini seçin** bölümünde, aşağıdaki adımları gerçekleştirin:   
                
    ![Kimlik doğrulama](./media/zscaler-tutorial/ic800208.png "kimlik doğrulaması")
...
3. Tıklatın **kullanıcı yönetimi**.   
     ...
     ![Ekleme](./media/zscaler-tutorial/ic781036.png "ekleme")

4. İçinde **kullanıcılar** sekmesini tıklatın, **Ekle**.
      
    ![Ekleme](./media/zscaler-tutorial/ic781037.png "ekleme")
