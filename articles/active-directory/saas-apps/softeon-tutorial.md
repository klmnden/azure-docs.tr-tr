---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Softeon WMS | Microsoft Docs'
...
ms.locfileid: "39041322"
---
# <a name="tutorial-azure-active-directory-integration-with-softeon-wms"></a>Öğretici: Azure Active Directory Softeon WMS ile tümleştirme
...
5. Sonuçlar panelinde seçin **Softeon WMS**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Softeon WMS test kullanıcısı oluşturma](#creating-a-softeon-wms-test-user)**  - kullanıcı Azure AD gösterimini bağlı Softeon WMS Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Softeon WMS etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Softeon WMS yapılandırma** bölümünde **yapılandırma Softeon WMS** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
