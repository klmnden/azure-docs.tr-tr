...
4. **[SharePoint şirket içi test kullanıcısı için erişim verin](#grant-access-to-sharepoint-on-premises-test-user)**  - kullanıcı Azure AD gösterimini bağlantılı bir karşılığı Britta simon'un SharePoint şirket içi sağlamak için.
