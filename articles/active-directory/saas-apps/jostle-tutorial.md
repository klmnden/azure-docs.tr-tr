---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Jostle | Microsoft Docs'
...
ms.locfileid: "37866296"
---
# <a name="tutorial-azure-active-directory-integration-with-jostle"></a>Öğretici: Azure Active Directory Jostle ile tümleştirme
...
3. Tıklayın **Ekle** pencerenin üst kısmındaki.

    ![add_01](./media/jostle-tutorial/add_01.png)

4. Arama kutusuna altında **uygulama ekleme** türü **Jostle**.

    ![add_02](./media/jostle-tutorial/add_02.png)

5. Sonuçlar panelinde seçin **Jostle**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Jostle test kullanıcısı oluşturma](#creating-a-jostle-test-user)**  - kullanıcı Azure AD gösterimini bağlı Jostle Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Jostle etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
4. Üzerinde **kullanıcı öznitelikleri** bölüm için **kullanıcı tanımlayıcısı** girin: `user.userprincipalname`

    ![url_02](./media/jostle-tutorial/url_02.png)

5. Tıklayın **Kaydet** pencerenin üst kısmındaki.

6. Git **SAML imzalama sertifikası** ve ayarlanmış olduğunu doğrulayın **etkin**. Ardından **meta veri XML** meta veri dosyası indirilemedi.

    ![url_03](./media/jostle-tutorial/url_03.png)

7. Çoklu oturum açma Jostle'nın tarafında yapılandırmak için indirilen meta verileri XML göndermek gereken şekilde [Jostle Destek ekibine](mailto:support@jostle.me). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
