---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Sciforma | Microsoft Docs'
...
ms.locfileid: "39042070"
---
# <a name="tutorial-azure-active-directory-integration-with-sciforma"></a>Öğretici: Azure Active Directory Sciforma ile tümleştirme
...
5. Sonuçlar panelinde seçin **Sciforma**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Sciforma test kullanıcısı oluşturma](#creating-a-sciforma-test-user)**  - kullanıcı Azure AD gösterimini bağlı Sciforma Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Sciforma etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL'si ve tanımlayıcı ile güncelleştirin. İlgili kişi [Sciforma istemci Destek ekibine](http://www.sciforma.com/company/contact_us) bu değerleri almak için. 
...
6. Çoklu oturum açmayı yapılandırma **Sciforma** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Sciforma Destek ekibine](http://www.sciforma.com/company/contact_us).
