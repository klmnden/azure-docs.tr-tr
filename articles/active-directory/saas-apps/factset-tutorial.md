...
4. Arama kutusuna **FactSet**seçin **FactSet** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde FactSet](./media/factset-tutorial/tutorial_factset_addfromgallery.png)
...
3. Üzerinde **FactSet etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![FactSet etki alanı ve URL'leri tek oturum açma bilgileri](./media/factset-tutorial/tutorial_factset_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/factset-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/factset-tutorial/create_aaduser_02.png)
