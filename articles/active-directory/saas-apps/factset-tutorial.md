---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle FactSet | Microsoft Docs'
...
ms.locfileid: "39043821"
---
# <a name="tutorial-azure-active-directory-integration-with-factset"></a>Öğretici: Azure Active Directory FactSet ile tümleştirme
...
3. **[FactSet test kullanıcısı oluşturma](#create-a-factset-test-user)**  - kullanıcı Azure AD gösterimini bağlı FactSet Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **FactSet etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **FactSet** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [FactSet Destek ekibine](mailto:support@factset.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
