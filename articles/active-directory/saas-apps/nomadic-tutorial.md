---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Nomadic | Microsoft Docs'
...
ms.locfileid: "39046388"
---
# <a name="tutorial-azure-active-directory-integration-with-nomadic"></a>Öğretici: Azure Active Directory Nomadic ile tümleştirme
...
3. **[Nomadic test kullanıcısı oluşturma](#create-a-nomadic-test-user)**  - kullanıcı Azure AD gösterimini bağlı Nomadic Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Nomadic etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6.  Uygulamanız için yapılandırılmış SSO almak için iletişime geçin [Nomadic Destek ekibine](mailto:help@nomadic.fm) ve indirilen sağlayacağını **meta verileri**.
