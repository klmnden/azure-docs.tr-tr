...
1. Arama kutusuna **Sprinklr**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/sprinklr-tutorial/tutorial_sprinklr_search.png)

1. Sonuçlar panelinde seçin **Sprinklr**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Sprinklr test kullanıcısı oluşturma](#creating-a-sprinklr-test-user)**  - kullanıcı Azure AD gösterimini bağlı Sprinklr Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Sprinklr etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **Sprinklr yapılandırma** bölümünde **yapılandırma Sprinklr** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. Uygulamalar listesinde **Sprinklr**.
