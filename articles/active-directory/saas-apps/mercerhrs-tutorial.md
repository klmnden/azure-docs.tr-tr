---
title: 'Öğretici: Azure Active Directory Tümleştirme ile Mercer BenefitsCentral (MBC) | Microsoft Docs'
...
3. **[Mercer BenefitsCentral (MBC) test kullanıcısı oluşturma](#create-a-mercer-benefitscentral-mbc-test-user)**  - içinde Mercer BenefitsCentral (kullanıcı Azure AD gösterimini bağlı MBC) Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Mercer BenefitsCentral (MBC) etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Mercer BenefitsCentral (MBC) yapılandırma** bölümünde **yapılandırma Mercer BenefitsCentral (MBC)** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
