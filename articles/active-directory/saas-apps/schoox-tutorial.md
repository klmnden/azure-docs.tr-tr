...
4. Arama kutusuna **Schoox**seçin **Schoox** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Schoox](./media/schoox-tutorial/tutorial_schoox_addfromgallery.png)
...
3. Üzerinde **Schoox etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Schoox etki alanı ve URL'leri tek oturum açma bilgileri](./media/schoox-tutorial/tutorial_schoox_url.png)

    İçinde **tanımlayıcısı** metin kutusuna, bir URL yazın: `https://saml.schoox.com/saml/adfsmetadata`

4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:

    ![Schoox etki alanı ve URL'leri tek oturum açma bilgileri](./media/schoox-tutorial/tutorial_schoox_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/schoox-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/schoox-tutorial/create_aaduser_02.png)
