---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Workstars | Microsoft Docs'
...
ms.locfileid: "39055549"
---
# <a name="tutorial-azure-active-directory-integration-with-workstars"></a>Öğretici: Azure Active Directory Workstars ile tümleştirme
...
3. **[Workstars test kullanıcısı oluşturma](#create-a-workstars-test-user)**  - kullanıcı Azure AD gösterimini bağlı Workstars Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Workstars etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Workstars yapılandırma** bölümünde **yapılandırma Workstars** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Workstars yapılandırma](./media/workstars-tutorial/tutorial_workstars_configure.png) 

7. Başka bir tarayıcı penceresinde Workstars şirketinizin sitesi için bir yönetici olarak oturum açın.
