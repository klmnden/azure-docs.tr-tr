---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Halosys | Microsoft Docs'
...
ms.locfileid: "39053188"
---
# <a name="tutorial-azure-active-directory-integration-with-halosys"></a>Öğretici: Azure Active Directory Halosys ile tümleştirme
...
3. **[Halosys test kullanıcısı oluşturma](#create-a-halosys-test-user)**  - kullanıcı Azure AD gösterimini bağlı Halosys Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Halosys etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek tanımlayıcısı ve yanıt URL'si ile güncelleştirin. İlgili kişi [Halosys Destek ekibine](http://halosys.com/halosys#contact) bu değerleri almak için.
...
6. Üzerinde **Halosys yapılandırma** bölümünde **yapılandırma Halosys** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Halosys yapılandırma](./media/halosys-tutorial/tutorial_halosys_configure.png) 

7. Çoklu oturum açmayı yapılandırma **Halosys** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** ve **SAML çoklu oturum açma hizmeti URL'si** için [Halosys desteği Takım](http://halosys.com/halosys#contact). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
Bu bölümde, Britta Simon Halosys içinde adlı bir kullanıcı oluşturun. Çalışmak [Halosys Destek ekibine](http://halosys.com/halosys#contact) Halosys platform kullanıcıları eklemek için. Kullanıcı oluşturulmalı ve çoklu oturum açma kullanmadan önce etkinleştirildi
