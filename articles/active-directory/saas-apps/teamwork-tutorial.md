...
1. Arama kutusuna **Teamwork.com**seçin **Teamwork.com** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Teamwork.com test kullanıcısı oluşturma](#create-a-teamworkcom-test-user)**  - kullanıcı Azure AD gösterimini bağlı Teamwork.com Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Teamwork.com etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu oturum açmayı yapılandırma **Teamwork.com** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Teamwork.com Destek ekibine](mailto:support@teamwork.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Uygulamalar listesinde **Teamwork.com**.
