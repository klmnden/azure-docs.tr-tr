...
4. Arama kutusuna **Sequr**seçin **Sequr** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Sequr](./media/sequr-tutorial/tutorial_sequr_addfromgallery.png)
...
3. Üzerinde **Sequr etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Sequr etki alanı ve URL'leri tek oturum açma bilgileri](./media/sequr-tutorial/tutorial_sequr_url.png)

    İçinde **tanımlayıcısı** metin kutusuna, URL'yi yazın: `https://login.sequr.io`

4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:

    ![Sequr etki alanı ve URL'leri tek oturum açma bilgileri](./media/sequr-tutorial/tutorial_sequr_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/sequr-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/sequr-tutorial/create_aaduser_02.png)
