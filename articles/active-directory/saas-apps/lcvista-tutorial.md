---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle LCVista | Microsoft Docs'
...
ms.locfileid: "39046813"
---
# <a name="tutorial-azure-active-directory-integration-with-lcvista"></a>Öğretici: Azure Active Directory LCVista ile tümleştirme
...
5. Sonuçlar panelinde seçin **LCVista**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[LCVista test kullanıcısı oluşturma](#creating-a-lcvista-test-user)**  - kullanıcı Azure AD gösterimini bağlı LCVista Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **LCVista etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **LCVista yapılandırma** bölümünde **yapılandırma LCVista** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği** ve **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

7.  LCVista uygulamanıza yönetici olarak oturum açın.

8. İçinde **SAML yapılandırma** bölümünde onay **etkinleştirme SAML oturum açma** görüntü belirtildiği gibi ayrıntılarını girin. 
