...
1. Arama kutusuna **SmarterU**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/smarteru-tutorial/tutorial_smarteru_search.png)

1. Sonuçlar panelinde seçin **SmarterU**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[SmarterU test kullanıcısı oluşturma](#creating-a-smarteru-test-user)**  - kullanıcı Azure AD gösterimini bağlı SmarterU Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **SmarterU etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin: 
...
1. Uygulamalar listesinde **SmarterU**.
