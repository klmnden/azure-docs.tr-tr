...
3. **[LoginRadius test kullanıcısı oluşturma](#create-a-loginradius-test-user)**  - kullanıcı Azure AD gösterimini bağlı LoginRadius Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **LoginRadius etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
7. Çoklu oturum açmayı yapılandırma **LoginRadius** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [LoginRadius Destek ekibine](mailto:support@loginradius.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
