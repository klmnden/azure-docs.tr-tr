...
4. Arama kutusuna **LoginRadius**seçin **LoginRadius** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde LoginRadius](./media/lr-tutorial/tutorial_LoginRadius_addfromgallery.png)
...
3. Üzerinde **LoginRadius etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![LoginRadius etki alanı ve URL'leri tek oturum açma bilgileri](./media/lr-tutorial/tutorial_LoginRadius_url.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/lr-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/lr-tutorial/create_aaduser_02.png)
