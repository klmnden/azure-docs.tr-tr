...
4. **[LinkedIn Learning test kullanıcısı oluşturma](#create-linkedin-learning-test-user)**  - kullanıcı Azure AD gösterimini bağlı LinkedIn Learning Britta simon'un bir karşılığı vardır.
