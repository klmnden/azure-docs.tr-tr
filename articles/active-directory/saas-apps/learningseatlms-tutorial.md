...
1. **[Learning Seat LMS test kullanıcısı oluşturma](#creating-a-learnconnect-test-user)**  - kullanıcı Azure AD gösterimini bağlı Learning Seat LMS Britta simon'un bir karşılığı vardır.
