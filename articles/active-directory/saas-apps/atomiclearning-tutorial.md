...
ms.locfileid: "39053956"
---
# <a name="tutorial-azure-active-directory-integration-with-atomic-learning"></a>Öğretici: Azure Active Directory tümleştirmesiyle atomik öğrenme
...
5. Sonuçlar panelinde seçin **atomik öğrenme**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Bir atomik öğrenme test kullanıcısı oluşturma](#creating-an-atomic-learning-test-user)**  - kullanıcı Azure AD gösterimini bağlı atomik learning'de Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **atomik öğrenme etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **atomik öğrenme** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [atomik öğrenme Destek ekibine](mailto:cs@atomiclearning.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
