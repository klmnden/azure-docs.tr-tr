---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Supermood | Microsoft Docs'
...
ms.locfileid: "39041033"
---
# <a name="tutorial-azure-active-directory-integration-with-supermood"></a>Öğretici: Azure Active Directory Supermood ile tümleştirme
...
3. **[Supermood test kullanıcısı oluşturma](#create-a-supermood-test-user)**  - kullanıcı Azure AD gösterimini bağlı Supermood Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Supermood etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
4. Supermood uygulama belirli bir biçimde SAML onaylamalarını bekler. Bu uygulama için aşağıdaki talepleri yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz **kullanıcı öznitelikleri** uygulama tümleştirme sayfasında bölümü. Aşağıdaki ekran görüntüsü bunun bir örneği gösterilmektedir.
...
6. Üzerinde **SAML imzalama sertifikası** bölümünde, kopyalamak için Kopyala düğmesine **uygulama Federasyon meta verileri URL'sini** kopyalayıp Not Defteri'ne yapıştırın.
...
9. Tıklayarak **Hesabımı** (alt sol) ve **çoklu oturum açma (SSO)**.

    ![Tek bir sertifika](./media/supermood-tutorial/tutorial_supermood_single.png)
10. Üzerinde **bilgisayarınızı SAML 2.0 yapılandırmaları**, tıklayın **e-posta etki alanı için bir SAML 2.0 Yapılandırması Ekle**.

    ![Sertifika Ekle](./media/supermood-tutorial/tutorial_supermood_add.png)

11. Üzerinde **e-posta etki alanı için bir SAML 2.0 Yapılandırması Ekle**. bölümünde, aşağıdaki adımları gerçekleştirin:
