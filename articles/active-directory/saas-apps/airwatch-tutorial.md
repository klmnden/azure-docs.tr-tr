...
12. Aşağıdaki adımları gerçekleştirin:
    ...
    ![Karşıya yükleme](./media/airwatch-tutorial/ic791924.png "karşıya yükle")   
...
13. İçinde **isteği** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![İstek](./media/airwatch-tutorial/ic791925.png "isteği")  
...
2. Sol taraftaki gezinti bölmesinde tıklayın **hesapları**ve ardından **kullanıcılar**.
   ...
   ![Kullanıcıların](./media/airwatch-tutorial/ic791929.png "kullanıcılar")
