...
4. Arama kutusuna **AwardSpring**seçin **AwardSpring** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde AwardSpring](./media/awardspring-tutorial/tutorial_awardspring_addfromgallery.png)
...
3. Üzerinde **AwardSpring etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![AwardSpring etki alanı ve URL'leri tek oturum açma bilgileri](./media/awardspring-tutorial/tutorial_awardspring_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![AwardSpring etki alanı ve URL'leri tek oturum açma bilgileri](./media/awardspring-tutorial/tutorial_awardspring_url1.png)
...
8. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/awardspring-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/awardspring-tutorial/create_aaduser_02.png)
