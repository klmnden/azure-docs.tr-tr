...
* Azure AD hesaplarına otomatik olarak Procore SSO (çoklu oturum açma) oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Procore SSO'yu destekler **IDP** tarafından başlatılan
...
4. Arama kutusuna **Procore SSO**seçin **Procore SSO** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
    ...
    ![Sonuç listesinde procore SSO](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Procore adlı bir test kullanıcı tabanlı SSO ile test etme **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Procore SSO ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
5. **[Procore SSO test kullanıcısı oluşturma](#create-procore-sso-test-user)**  - kullanıcı Azure AD gösterimini bağlı Procore SSO Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Procore SSO** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde kullanıcısının clonedatabase'i uygulama zaten Azure ile önceden tümleşik olarak herhangi bir adımı gerçekleştirmek.
    ...
    ![Çoklu oturum açma bilgileri procore SSO etki alanı ve URL'ler](common/preintegrated.png)

5. Üzerinde **yukarı çoklu oturum açma SAML ile ayarlanmış** sayfasında **SAML imzalama sertifikası** bölümünde **indirme** indirmek için **Federasyon meta veri XML**  bilgisayarınızdaki belirli seçenekler ihtiyacınıza göre ve kaydedin.

    ![Sertifika indirme bağlantısı](common/metadataxml.png)

6. Üzerinde **Procore SSO'yu ayarlama** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
### <a name="configure-procore-sso-single-sign-on"></a>Procore SSO çoklu oturum açmayı yapılandırın

1. Çoklu oturum açmayı yapılandırma **Procore SSO** yan, procore şirket sitenize yönetici olarak oturum açın.

2. Araç kutusu açılan listeden, aşağı, tıklayarak **yönetici** SSO ayarlar sayfasını açın.
...
5. Bu ayarlar sonra göndermesi gerekiyor. **etki alanı adı** (ör. **contoso.com**) için Procore içine, oturum açtığınız aracılığıyla [Procore Destek ekibine](https://support.procore.com/) ve bunlar etki alanı Federasyon SSO'yu etkinleştirin.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Procore SSO**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Procore SSO**.

    ![Uygulamalar listesinde Procore SSO bağlantı](common/all-applications.png)
...
Lütfen izleyin Procore SSO tarafında Procore test kullanıcısı oluşturmak için aşağıdaki adımları.

1. Procore şirketinizin sitesi için bir yönetici olarak oturum açın.    
...
Erişim paneli Procore SSO kutucuğa tıkladığınızda, size otomatik olarak Procore SSO'yu ayarlama SSO için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
