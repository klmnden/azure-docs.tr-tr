...
1. Arama kutusuna **Oneteam**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/oneteam-tutorial/tutorial_oneteam_search.png)

1. Sonuçlar panelinde seçin **Oneteam**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Oneteam test kullanıcısı oluşturma](#creating-a-oneteam-test-user)**  - kullanıcı Azure AD gösterimini bağlı Oneteam Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Oneteam etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu:
...
1. Uygulamanız için yapılandırılmış SSO almak için destek bileti gönderebilirsiniz [Oneteam Destek ekibine](https://support.one-team.com/hc/requests/new) ve indirilen sağlayacağını **meta verileri**. 
...
1. Uygulamalar listesinde **Oneteam**.
