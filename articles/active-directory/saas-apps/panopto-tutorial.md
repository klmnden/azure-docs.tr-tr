...
5. Sonuçlar panelinde seçin **Panopto**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Panopto test kullanıcısı oluşturma](#creating-a-panopto-test-user)**  - kullanıcı Azure AD gösterimini bağlı Panopto Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Panopto etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Panopto yapılandırma** bölümünde **yapılandırma Panopto** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/panopto-tutorial/tutorial_panopto_configure.png) 

7. Farklı bir web tarayıcı penceresinde Panopto şirketinizin sitesi için bir yönetici olarak oturum açın.
