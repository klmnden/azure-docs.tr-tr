...
2. Üstteki menüde tıklatın **Yönet**ve ardından **kullanıcılar**.
  ...
  ![Kullanıcıların](./media/panorama9-tutorial/ic790027.png "kullanıcılar")

3. Kullanıcılar bölümünde tıklatın **+** yeni kullanıcı eklemek için.

 ![Kullanıcıların](./media/panorama9-tutorial/ic790028.png "kullanıcılar")
