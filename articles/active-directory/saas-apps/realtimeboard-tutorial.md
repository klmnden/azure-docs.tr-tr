...
4. Arama kutusuna **RealtimeBoard**seçin **RealtimeBoard** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde RealtimeBoard](./media/realtimeboard-tutorial/tutorial_realtimeboard_addfromgallery.png)
...
3. Üzerinde **RealtimeBoard etki alanı ve URL'leri** uygulamada yapılandırmak istiyorsanız, bölüm **IDP** modu tarafından başlatılan:
    ...
    ![RealtimeBoard etki alanı ve URL'leri tek oturum açma bilgileri](./media/realtimeboard-tutorial/tutorial_realtimeboard_url.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/realtimeboard-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/realtimeboard-tutorial/create_aaduser_02.png)
