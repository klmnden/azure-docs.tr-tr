...
1. Arama kutusuna **becerileri Manager**seçin **becerileri Manager** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Beceriler Manager test kullanıcısı oluşturma](#create-a-skills-manager-test-user)**  - kullanıcı Azure AD gösterimini bağlı becerileri Yöneticisi'nde Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **becerileri yöneticisi etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **becerileri Manager yapılandırması** bölümünde **becerileri Yapılandırma Yöneticisi'ni** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. Uygulamalar listesinde **becerileri Manager**.
