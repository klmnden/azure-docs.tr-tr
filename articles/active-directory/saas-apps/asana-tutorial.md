...
3. Üzerinde **Asana etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Asana etki alanı ve URL'leri tek oturum açma bilgileri](./media/asana-tutorial/tutorial_asana_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/asana-tutorial/tutorial_general_400.png)
...
9. **Kaydet**’e tıklayın. Git [SSO'yu ayarlamak için Asana Kılavuzu](https://asana.com/guide/help/premium/authentication#gl-saml) daha fazla yardıma ihtiyacınız varsa.
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar** tıklatıp **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/asana-tutorial/create_aaduser_02.png)
...
Bu bölümün amacı Britta Simon içinde Asana adlı bir kullanıcı oluşturmaktır. Asana otomatik kullanıcı hazırlama, varsayılan olarak etkin olduğu destekler. Daha fazla ayrıntı bulabilirsiniz [burada](asana-provisioning-tutorial.md) otomatik kullanıcı sağlamayı yapılandırma.
...
* [Kullanıcı sağlamayı Yapılandır](asana-provisioning-tutorial.md)
