...
4. Arama kutusuna **Proofpoint isteğe bağlı**seçin **Proofpoint isteğe bağlı** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde isteğe bağlı Proofpoint](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)
...
3. Üzerinde **Proofpoint isteğe bağlı etki alanı ve URL'ler hakkında** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![İsteğe bağlı etki alanı ve URL'leri tek oturum açma bilgileri Proofpoint](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/proofpoint-ondemand-tutorial/tutorial_general_400.png)
...
7. Üzerinde **isteğe bağlı yapılandırma Proofpoint** 'yi tıklatın **isteğe bağlı yapılandırma Proofpoint** açmak için **yapılandırma oturum açma** penceresi. Kopya **Sign-Out URL, SAML varlık kimliği ve SAML çoklu oturum açma hizmet URL'si** gelen **hızlı başvuru bölümü.**
    ...
    ![İsteğe bağlı yapılandırma Proofpoint](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_configure.png) 
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/proofpoint-ondemand-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **Proofpoint isteğe bağlı**.
    ...
    ![İsteğe bağlı bağlantıyı uygulamalar listesinde Proofpoint](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
