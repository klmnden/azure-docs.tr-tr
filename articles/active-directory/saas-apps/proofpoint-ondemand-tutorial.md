...
3. **[İsteğe bağlı test kullanıcısı üzerinde bir Proofpoint oluşturma](#create-a-proofpoint-on-demand-test-user)**  - Proofpoint kullanıcı Azure AD gösterimini bağlı isteğe bağlı bir karşılığı Britta simon'un sağlamak için.
...
3. Üzerinde **isteğe bağlı etki alanı ve URL'ler hakkında Proofpoint** bölümünde, aşağıdaki adımları gerçekleştirin:
...
7. Üzerinde **isteğe bağlı yapılandırma Proofpoint** bölümünde **isteğe bağlı yapılandırma Proofpoint** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
