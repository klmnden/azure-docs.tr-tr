---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle DATABASICS | Microsoft Docs'
...
ms.locfileid: "39047969"
---
# <a name="tutorial-azure-active-directory-integration-with-databasics"></a>Öğretici: Azure Active Directory DATABASICS ile tümleştirme
...
3. **[DATABASICS test kullanıcısı oluşturma](#create-a-databasics-test-user)**  - kullanıcı Azure AD gösterimini bağlı DATABASICS Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **DATABASICS etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açma DATABASICS tarafında yapılandırmak için lütfen aşağıdaki URL'yi kullanarak formu doldurun. Form gönderildikten sonra [DATABASICS istemci Destek ekibine](https://www.data-basics.com/support/) sizinle iletişime geçecektir.
