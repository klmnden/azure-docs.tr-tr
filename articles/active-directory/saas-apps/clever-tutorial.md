...
4. Arama kutusuna **Clever**seçin **Clever** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde akıllı](./media/clever-tutorial/tutorial_clever_addfromgallery.png)
...
3. Üzerinde **akıllı etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Akıllı etki alanı ve URL'leri tek oturum açma bilgileri](./media/clever-tutorial/tutorial_clever_url.png)
...
7. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/clever-tutorial/tutorial_general_400.png)
...
9. Araç çubuğunda **anlık oturum açma**.
    ...
    ![Hızlı oturum açma](./media/clever-tutorial/ic798984.png "anlık oturum açma")
...
10. Üzerinde **anlık oturum açma** sayfasında, aşağıdaki adımları gerçekleştirin:
      ...
      ![Hızlı oturum açma](./media/clever-tutorial/ic798985.png "anlık oturum açma")
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/clever-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **Clever**.
    ...
    ![Clever bağlantı uygulamalar listesinde](./media/clever-tutorial/tutorial_clever_app.png)
