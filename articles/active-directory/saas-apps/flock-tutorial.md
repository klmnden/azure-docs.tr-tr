---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Flock | Microsoft Docs'
...
ms.locfileid: "39053113"
---
# <a name="tutorial-azure-active-directory-integration-with-flock"></a>Öğretici: Azure Active Directory Flock ile tümleştirme
...
3. **[Flock test kullanıcısı oluşturma](#create-a-flock-test-user)**  - kullanıcı Azure AD gösterimini bağlı Flock Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Flock etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Flock yapılandırma** bölümünde **yapılandırma Flock** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Flock yapılandırma](./media/flock-tutorial/tutorial_flock_configure.png) 

7. Farklı bir web tarayıcı penceresinde Flock şirketinizin sitesi için bir yönetici olarak oturum açın.

8. Seçin **kimlik doğrulaması** sol gezinti panelinde sekmesini seçip **SAML kimlik doğrulaması**.
