...
* Otomatik olarak (çoklu oturum açma) ZenQMS için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* ZenQMS tek oturum açma etkin abonelik

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, yapılandırma ve Azure AD çoklu oturum açma bir test ortamında test edin.

* ZenQMS destekler **SP** ve **IDP** tarafından başlatılan
...
4. Arama kutusuna **ZenQMS**seçin **ZenQMS** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
     ...
     ![Sonuç listesinde ZenQMS](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma ZenQMS adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının ZenQMS ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[ZenQMS çoklu oturum açmayı yapılandırma](#configure-zenqms-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[ZenQMS test kullanıcısı oluşturma](#create-zenqms-test-user)**  - kullanıcı Azure AD gösterimini bağlı ZenQMS Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **ZenQMS** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu, aşağıdaki adımları gerçekleştirin:
    ...
    a. İçinde **tanımlayıcı** metin kutusuna şu biçimi kullanarak bir URL yazın: `urn:zenqms:<INSTANCE>`

    b. İçinde **yanıt URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<INSTANCE>.zenqms.com/SAML/AssertionConsumerService`
...
5. Tıklayın **ek URL'lerini ayarlayın** ve uygulamada yapılandırmak istiyorsanız, aşağıdaki adımı uygulayın **SP** başlatılan modu:
    ...
    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerler gerçek tanımlayıcısı, yanıt URL'si ve oturum açma URL'si ile güncelleştirin. İlgili kişi [ZenQMS istemci Destek ekibine](mailto:help@zenqms.com) bu değerleri almak için. Gösterilen desenleri de başvurabilirsiniz **temel SAML yapılandırma** bölümünde Azure portalında.
...
### <a name="configure-zenqms-single-sign-on"></a>ZenQMS tek oturum açmayı yapılandırın

Çoklu oturum açmayı yapılandırma **ZenQMS** tarafını göndermek için ihtiyacınız **uygulama Federasyon meta verileri URL'sini** için [ZenQMS Destek ekibine](mailto:help@zenqms.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **ZenQMS**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **ZenQMS**.

    ![Uygulamalar listesinde ZenQMS bağlantı](common/all-applications.png)
...
Erişim paneli ZenQMS kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama ZenQMS için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
