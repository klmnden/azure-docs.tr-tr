...
3. **[Trello test kullanıcısı oluşturma](#create-a-trello-test-user)**  - kullanıcı Azure AD gösterimini bağlı trello'daki Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Trello etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP tarafından başlatılan modu**, aşağıdaki adımları gerçekleştirin:
...
5. Trello uygulama SAML onaylamalarını belirli öznitelikleri içermesini bekliyor. Aşağıdaki öznitelikler bu uygulama için yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz **"Kullanıcı öznitelikleri"** uygulama. Aşağıdaki ekran görüntüsü bunun bir örneği gösterilmektedir.
...
7. Üzerinde **SAML imzalama sertifikası** bölümünde **sertifika (Base64)** ve bilgisayarınızda meta veri dosyasını kaydedin.
...
9. Üzerinde **Trello yapılandırma** bölümünde **yapılandırma Trello** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
