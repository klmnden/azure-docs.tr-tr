...
5. **[AuditBoard test kullanıcısı oluşturma](#create-auditboard-test-user)**  - kullanıcı Azure AD gösterimini bağlı AuditBoard Britta simon'un bir karşılığı vardır.
