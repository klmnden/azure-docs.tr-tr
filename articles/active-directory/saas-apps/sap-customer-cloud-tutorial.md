...
4. **[Müşteri test kullanıcısı için SAP Cloud oluşturma](#create-sap-cloud-for-customer-test-user)**  - kullanıcı Azure AD gösterimini bağlı müşteri için SAP bulutta Britta simon'un bir karşılığı vardır.
