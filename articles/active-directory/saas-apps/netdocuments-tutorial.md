...
9. Tıklatın **Gelişmiş kimlik doğrulama Seçenekleri Yapılandır**.
    ...
    ![Gelişmiş kimlik doğrulama Seçenekleri Yapılandır](./media/netdocuments-tutorial/ic795048.png "Gelişmiş kimlik doğrulama seçeneklerini yapılandırma")
