...
* Otomatik olarak (çoklu oturum açma) Wingspan eTMF için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Abonelik wingspan eTMF çoklu oturum açma etkin

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, yapılandırma ve Azure AD çoklu oturum açma bir test ortamında test edin.

* Wingspan eTMF destekler **SP** tarafından başlatılan
...
4. Arama kutusuna **Wingspan eTMF**seçin **Wingspan eTMF** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

     ![Sonuç listesinde wingspan eTMF](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Wingspan eTMF adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Wingspan eTMF ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[Çoklu oturum açma Wingspan eTMF yapılandırma](#configure-wingspan-etmf-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Wingspan eTMF test kullanıcısı oluşturma](#create-wingspan-etmf-test-user)**  - Britta Simon kullanıcı Azure AD gösterimini bağlı Wingspan eTMF içinde bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Wingspan eTMF** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Wingspan eTMF etki alanı ve URL'ler tek oturum açma bilgileri](common/sp-identifier-reply.png)

    a. İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<customer name>.<instance name>.mywingspan.com/saml`

    b. İçinde **tanımlayıcı** kutusuna şu biçimi kullanarak bir URL yazın: `http://saml.<instance name>.wingspan.com/shibboleth`
...
6. Üzerinde **Wingspan eTMF kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Wingspan eTMF**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Wingspan eTMF**.

    ![Uygulamalar listesinde Wingspan eTMF bağlantı](common/all-applications.png)
...
Erişim paneli Wingspan eTMF kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama Wingspan eTMF için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
