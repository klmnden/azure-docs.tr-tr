---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Wingspan eTMF | Microsoft Docs'
...
ms.locfileid: "39041798"
---
# <a name="tutorial-azure-active-directory-integration-with-wingspan-etmf"></a>Öğretici: Azure Active Directory Wingspan eTMF ile tümleştirme
...
5. Sonuçlar panelinde seçin **Wingspan eTMF**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Wingspan eTMF test kullanıcısı oluşturma](#creating-a-wingspan-etmf-test-user)**  - Britta Simon kullanıcı Azure AD gösterimini bağlı Wingspan eTMF içinde bir karşılığı vardır.
...
3. Üzerinde **Wingspan eTMF etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **Wingspan eTMF** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Wingspan eTMF Destek](http://www.wingspan.com/contact-us/). Bunlar bu iki tarafı da düzgün ayarlandığından SAML SSO bağlantısı ayarlayın.
