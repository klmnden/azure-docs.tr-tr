...
4. Arama kutusuna **Getabstract**seçin **Getabstract** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Getabstract](./media/getabstract-tutorial/tutorial_getabstract_addfromgallery.png)
...
3. Üzerinde **Getabstract etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Getabstract etki alanı ve URL'leri tek oturum açma bilgileri](./media/getabstract-tutorial/tutorial_getabstract_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Getabstract etki alanı ve URL'leri tek oturum açma bilgileri](./media/getabstract-tutorial/tutorial_getabstract_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/getabstract-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/getabstract-tutorial/create_aaduser_02.png)
