...
1. Arama kutusuna **ITRP**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/itrp-tutorial/tutorial_itrp_search.png)

1. Sonuçlar panelinde seçin **ITRP**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Bir ITRP oluşturma, kullanıcı test](#creating-an-itrp-test-user)**  - kullanıcı Azure AD gösterimini bağlı ITRP Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **ITRP etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **ITRP yapılandırma** bölümünde **yapılandırma ITRP** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmet URL'si ve oturum kapatma URL'si** gelen **hızlı başvuru bölümü.**
