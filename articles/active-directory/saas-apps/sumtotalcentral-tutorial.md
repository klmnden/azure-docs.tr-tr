...
1. Arama kutusuna **SumTotalCentral**seçin **SumTotalCentral** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[SumTotalCentral test kullanıcısı oluşturma](#create-a-sumtotalcentral-test-user)**  - kullanıcı Azure AD gösterimini bağlı SumTotalCentral Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **SumTotalCentral etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu oturum açmayı yapılandırma **SumTotalCentral** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [SumTotalCentral Destek ekibine](http://www.sumtotalsystems.com/support/). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Uygulamalar listesinde **SumTotalCentral**.
