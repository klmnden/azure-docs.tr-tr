...
4. Arama kutusuna **SumTotalCentral**seçin **SumTotalCentral** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde SumTotalCentral](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_addfromgallery.png)
...
3. Üzerinde **SumTotalCentral etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![SumTotalCentral etki alanı ve URL'leri tek oturum açma bilgileri](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/sumtotalcentral-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/sumtotalcentral-tutorial/create_aaduser_02.png)
