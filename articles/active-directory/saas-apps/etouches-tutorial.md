...
4. Arama kutusuna **etouches**seçin **etouches** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde etouches](./media/etouches-tutorial/tutorial_etouches_addfromgallery.png)
...
3. Üzerinde **etouches etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![etouches etki alanı ve URL'leri tek oturum açma bilgileri](./media/etouches-tutorial/tutorial_etouches_url.png)
...
5. İçinde **kullanıcı öznitelikleri** bölümünde **çoklu oturum açma** iletişim kutusunda, SAML belirteci özniteliği görüntüde gösterildiği gibi yapılandırın ve aşağıdaki adımları gerçekleştirin:
    ...
    ![Öznitelik iletişim ekleyin](./media/etouches-tutorial/tutorial_attribute_05.png)
...
7. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/etouches-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar** tıklatıp **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/etouches-tutorial/create_aaduser_02.png) 
