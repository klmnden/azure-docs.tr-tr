...
4. Arama kutusuna **Reflektive**seçin **Reflektive** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Reflektive](./media/reflektive-tutorial/tutorial_reflektive_addfromgallery.png)
...
3. Üzerinde **Reflektive etki alanı ve URL'leri** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![Reflektive etki alanı ve URL'leri tek oturum açma bilgileri](./media/reflektive-tutorial/tutorial_reflektive_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Reflektive etki alanı ve URL'leri tek oturum açma bilgileri](./media/reflektive-tutorial/tutorial_reflektive_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/reflektive-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/reflektive-tutorial/create_aaduser_02.png)
