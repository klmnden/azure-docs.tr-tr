...
5. Sonuçlar panelinde seçin **BenefitHub**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[BenefitHub test kullanıcısı oluşturma](#creating-a-benefithub-test-user)**  - kullanıcı Azure AD gösterimini bağlı BenefitHub Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **BenefitHub etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
4. BenefitHub uygulama, özel öznitelik eşlemelerini SAML belirteci öznitelikleri yapılandırmanıza ekleyin gerektiren belirli bir biçimde SAML onaylamalarını bekler. Bu uygulama için aşağıdaki talepleri yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz "**kullanıcı öznitelikleri**" uygulama tümleştirme sayfasında bölümü. 
...
8. Çoklu oturum açmayı yapılandırma **BenefitHub** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [BenefitHub Destek ekibine](https://www.benefithub.com/Home/ContactUs). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
