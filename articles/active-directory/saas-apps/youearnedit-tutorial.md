...
1. Arama kutusuna **YouEarnedt**seçin **YouEarnedt** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[YouEarnedIt test kullanıcısı oluşturma](#create-a-youearnedit-test-user)**  - kullanıcı Azure AD gösterimini bağlı YouEarnedIt Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **YouEarnedIt etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL'si ve tanımlayıcı ile güncelleştirin. İlgili kişi [YouEarnedIt istemci Destek ekibine](https://youearnedit.freshdesk.com/support/tickets/new) bu değerleri almak için. 
...
1. Üzerinde **YouEarnedIt yapılandırma** bölümünde **yapılandırma YouEarnedIt** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![YouEarnedIt yapılandırma](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Çoklu oturum açmayı yapılandırma **YouEarnedIt** tarafı, indirilen göndermek için ihtiyacınız **Certificate(Base64)** ve **SAML çoklu oturum açma hizmeti URL'si** için [ YouEarnedIt Destek ekibine](https://youearnedit.freshdesk.com/support/tickets/new). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
Bu bölümde, Britta Simon YouEarnedIt içinde adlı bir kullanıcı oluşturun. Lütfen YouEarnedIt platform kullanıcıları eklemek için YouEarnedIt destek ekibi ile çalışın.
...
1. Uygulamalar listesinde **YouEarnedIt**.
