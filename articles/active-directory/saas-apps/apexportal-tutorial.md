...
4. Arama kutusuna yazın **tepesindeki Portal**seçin **tepesindeki Portal** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde tepesindeki portalı](./media/apexportal-tutorial/tutorial_apexonline_addfromgallery.png)
...
3. Üzerinde **tepesindeki Portal etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Tepesindeki Portal etki alanı ve URL'leri tek oturum açma bilgileri](./media/apexportal-tutorial/tutorial_apexonline_url.png)
...
7. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/apexportal-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/apexportal-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **tepesindeki Portal**.
    ...
    ![Uygulamalar listesinde tepesindeki Portal bağlantısı](./media/apexportal-tutorial/tutorial_apexonline_app.png)  
