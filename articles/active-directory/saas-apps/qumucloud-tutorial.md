---
title: 'Öğretici: Azure Active Directory Qumu bulut ile tümleştirme | Microsoft Docs'
...
ms.locfileid: "39051641"
---
# <a name="tutorial-azure-active-directory-integration-with-qumu-cloud"></a>Öğretici: Azure Active Directory Qumu bulut ile tümleştirme
...
3. **[Test kullanıcısı Qumu bulut oluşturma](#create-a-qumu-cloud-test-user)**  - kullanıcı Azure AD gösterimini bağlı Qumu bulutta Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Qumu bulut etki alanı ve URL'ler** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** başlatılan modu:
...
4. Qumu bulut uygulaması, belirli bir biçimde SAML onaylamalarını bekliyor. Lütfen bu uygulama için aşağıdaki talepleri yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz "**kullanıcı öznitelikleri**" uygulama tümleştirme sayfasında bölümü. Aşağıdaki ekran görüntüsü bunun bir örneği gösterilmektedir.
...
7. Çoklu oturum açmayı yapılandırma **Qumu bulut** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Qumu bulut Destek ekibine](mailto:support@qumu.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
