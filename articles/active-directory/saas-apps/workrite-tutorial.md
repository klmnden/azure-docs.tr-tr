...
4. Arama kutusuna **Workrite**seçin **Workrite** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Workrite](./media/workrite-tutorial/tutorial_workrite_addfromgallery.png)
...
3. Üzerinde **Workrite etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Workrite etki alanı ve URL'leri tek oturum açma bilgileri](./media/workrite-tutorial/tutorial_workrite_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/workrite-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/workrite-tutorial/create_aaduser_02.png)
