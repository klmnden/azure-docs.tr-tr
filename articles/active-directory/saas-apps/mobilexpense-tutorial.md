...
3. **[Mobil Xpense test kullanıcısı oluşturma](#create-a-mobile-xpense-test-user)**  - kullanıcı Azure AD gösterimini bağlı mobil Xpense Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **mobil Xpense etki alanı ve URL'ler** bölümünde, IDP tarafından başlatılan modunda uygulama yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
...
7. Çoklu oturum açmayı yapılandırma **mobil Xpense** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [mobil Xpense Destek ekibine](http://www.mobilexpense.net/contact). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
