...
1. Arama kutusuna **Eli ekleme**seçin **Eli ekleme** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Bir Eli ekleme test kullanıcısı oluşturma](#create-an-eli-onboarding-test-user)**  - kullanıcı Azure AD gösterimini bağlı Eli ekleme Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Eli ekleme etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu oturum açmayı yapılandırma **Eli ekleme** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Eli Onboarding destek ekibi](mailto:support@geteli.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Uygulamalar listesinde **Eli ekleme**.
