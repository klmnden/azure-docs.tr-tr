...
4. Arama kutusuna **IBM OpenPages**seçin **IBM OpenPages** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde IBM OpenPages](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_addfromgallery.png)
...
3. Üzerinde **IBM OpenPages etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![IBM OpenPages etki alanı ve URL'leri tek oturum açma bilgileri](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/ibmopenpages-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/ibmopenpages-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **IBM OpenPages**.
    ...
    ![Uygulamalar listesinde IBM OpenPages bağlantı](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_app.png)  
