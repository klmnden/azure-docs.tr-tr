...
3. **[Bir IBM OpenPages test kullanıcısı oluşturma](#create-an-ibm-openpages-test-user)**  - kullanıcı Azure AD gösterimini bağlı IBM OpenPages Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **IBM OpenPages etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
7. Çoklu oturum açmayı yapılandırma **IBM OpenPages** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [IBM OpenPages Destek ekibine](https://www.ibm.com/support/home/). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
