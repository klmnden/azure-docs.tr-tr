...
3. Zscaler bir eklemek için tıklatın **yeni uygulama** iletişim kutusunun üst kısmındaki düğmesi.

    ![Yeni Uygulama düğmesi][3]

4. Arama kutusuna **Zscaler bir**.

    ![Zscaler bir sağlama](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. Sonuçlar panelinde seçin **Zscaler bir**ve ardından **Ekle** düğmesini Zscaler bir SaaS uygulamasına listenize ekleyin.

    ![Zscaler bir sağlama](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Zscaler bir sağlama](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Zscaler bir SaaS uygulamaları listesinden seçin.

    ![Zscaler bir sağlama](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
