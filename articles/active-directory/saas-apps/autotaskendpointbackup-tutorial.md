...
3. **[Uç nokta yedekleme Autotask test kullanıcısı oluşturma](#create-a-autotask-endpoint-backup-test-user)**  - kullanıcı Azure AD gösterimini bağlı Autotask uç nokta yedekleme Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Autotask uç nokta yedekleme etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
