...
3. **[PatentSQUARE test kullanıcısı oluşturma](#create-a-patentsquare-test-user)**  - kullanıcı Azure AD gösterimini bağlı PatentSQUARE Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **PatentSQUARE etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **PatentSQUARE** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [PatentSQUARE Destek ekibine](https://www.panasonic.com/jp/business/its/patentsquare.html). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
