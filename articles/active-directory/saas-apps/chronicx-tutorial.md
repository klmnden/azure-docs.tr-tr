...
4. Arama kutusuna **ChronicX®**seçin **ChronicX®** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde ChronicX®](./media/chronicx-tutorial/tutorial_chronicx_addfromgallery.png)
...
3. Üzerinde **ChronicX® etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![ChronicX® etki alanı ve URL'leri tek oturum açma bilgileri](./media/chronicx-tutorial/tutorial_chronicx_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/chronicx-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/chronicx-tutorial/create_aaduser_02.png)
