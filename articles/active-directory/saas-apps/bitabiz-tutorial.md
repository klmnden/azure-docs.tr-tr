...
4. Arama kutusuna **BitaBIZ**seçin **BitaBIZ** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde BitaBIZ](./media/bitabiz-tutorial/tutorial_bitabiz_addfromgallery.png)
...
3. Üzerinde **BitaBIZ etki alanı ve URL'leri** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![BitaBIZ etki alanı ve URL'leri tek oturum açma bilgileri](./media/bitabiz-tutorial/tutorial_bitabiz_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![BitaBIZ etki alanı ve URL'leri tek oturum açma bilgileri](./media/bitabiz-tutorial/tutorial_bitabiz_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/bitabiz-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/bitabiz-tutorial/create_aaduser_02.png)
...
2. Tıklayın **Kurulum yönetici**.
    ...
    ![BitaBIZ kullanıcı ekleme](./media/bitabiz-tutorial/settings1.png)

3. Tıklayın **kullanıcıları eklemek** altında **kuruluş** bölümü.

    ![BitaBIZ kullanıcı ekleme](./media/bitabiz-tutorial/user1.png)

4. Tıklatın **Ekle yeni çalışan**.

    ![BitaBIZ kullanıcı ekleme](./media/bitabiz-tutorial/user2.png)

5. Üzerinde **"Yeni çalışan Ekle"** iletişim sayfasında, aşağıdaki adımları gerçekleştirin:

    ![BitaBIZ kullanıcı ekleme](./media/bitabiz-tutorial/user3.png)
