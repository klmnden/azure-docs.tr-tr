...
4. Arama kutusuna **Bpm'online**seçin **Bpm'online** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Bpm'online](./media/bpmonline-tutorial/tutorial_bpmonline_addfromgallery.png)
...
3. Üzerinde **Bpm'online etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Bpm'online etki alanı ve URL'leri tek oturum açma bilgileri](./media/bpmonline-tutorial/tutorial_bpmonline_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Bpm'online etki alanı ve URL'leri tek oturum açma bilgileri](./media/bpmonline-tutorial/tutorial_bpmonline_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/bpmonline-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/bpmonline-tutorial/create_aaduser_02.png)
