...
1. Arama kutusuna **doğrudan**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/direct-tutorial/tutorial_direct_search.png)

1. Sonuçlar panelinde seçin **doğrudan**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Doğrudan test kullanıcısı oluşturma](#creating-a-direct-test-user)**  - kullanıcı Azure AD gösterimini bağlı doğrudan Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **doğrudan etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu:
...
1. Çoklu oturum açmayı yapılandırma **doğrudan** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [doğrudan Destek ekibine](https://direct4b.com/ja/support.html#inquiry). 
...
1. Uygulamalar listesinde **doğrudan**.
...
1. Test istiyorsanız **SP tarafından başlatılan modu**:
