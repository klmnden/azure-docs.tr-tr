...
4. Arama kutusuna yazın **Mimecast Yönetici Konsolu**seçin **Mimecast Yönetici Konsolu** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Mimecast Yönetim Konsolu](./media/mimecast-admin-console-tutorial/tutorial_mimecastadminconsole_addfromgallery.png)
...
3. Üzerinde **Mimecast Yönetici Konsolu etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Mimecast Yönetici Konsolu etki alanı ve URL'leri tek oturum açma bilgileri](./media/mimecast-admin-console-tutorial/tutorial_mimecastadminconsole_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/mimecast-admin-console-tutorial/tutorial_general_400.png)
...
9. Tıklatın **kimlik doğrulaması profilleri**.
    ...
    ![Kimlik doğrulama profilleri](./media/mimecast-admin-console-tutorial/ic794999.png "kimlik doğrulaması profilleri")
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/mimecast-admin-console-tutorial/create_aaduser_02.png)
...
3. Tıklatın **kayıt yeni bir etki alanı**.
   ...
   ![Yeni etki alanı kayıt](./media/mimecast-admin-console-tutorial/ic795004.png "kayıt yeni bir etki alanı")
4. Yeni etki alanınızın oluşturulduktan sonra tıklatın **yeni adresi**.
   
   ![Yeni bir adres](./media/mimecast-admin-console-tutorial/ic795005.png "yeni adresi")
...
2. Uygulamalar listesinde **Mimecast Yönetici Konsolu**.
    ...
    ![Uygulamalar listesinde Mimecast yönetici konsolunu bağlantısı](./media/mimecast-admin-console-tutorial/tutorial_mimecastadminconsole_app.png)  
