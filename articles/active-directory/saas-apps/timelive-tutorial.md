...
4. Arama kutusuna **TimeLive**seçin **TimeLive** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde TimeLive](./media/timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
3. Üzerinde **TimeLive etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![TimeLive etki alanı ve URL'leri tek oturum açma bilgileri](./media/timelive-tutorial/tutorial_timelive_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/timelive-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/timelive-tutorial/create_aaduser_02.png)
