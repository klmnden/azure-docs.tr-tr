---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle RightAnswers | Microsoft Docs'
...
ms.locfileid: "39045580"
---
# <a name="tutorial-azure-active-directory-integration-with-rightanswers"></a>Öğretici: Azure Active Directory RightAnswers ile tümleştirme
...
5. Sonuçlar panelinde seçin **RightAnswers**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[RightAnswers test kullanıcısı oluşturma](#creating-a-rightanswers-test-user)**  - kullanıcı Azure AD gösterimini bağlı RightAnswers Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **RightAnswers etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **RightAnswers** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [RightAnswers Destek ekibine](https://www.rightanswers.com/contact-us/).
