...
4. Arama kutusuna **Greenhouse**seçin **Greenhouse** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde greenhouse](./media/greenhouse-tutorial/tutorial_greenhouse_addfromgallery.png)
...
3. Üzerinde **Greenhouse etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Greenhouse etki alanı ve URL'leri tek oturum açma bilgileri](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/greenhouse-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/greenhouse-tutorial/create_aaduser_02.png)
...
2. Üstteki menüde tıklatın **yapılandırma**ve ardından **kullanıcılar**.
   ...
   ![Kullanıcıların](./media/greenhouse-tutorial/ic790791.png "kullanıcılar")
