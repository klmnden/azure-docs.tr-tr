...
* Otomatik olarak (çoklu oturum açma) Greenhouse için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Greenhouse destekler **SP** tarafından başlatılan
...
4. Arama kutusuna **Greenhouse**seçin **Greenhouse** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
     ...
     ![Sonuç listesinde greenhouse](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Greenhouse adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının Greenhouse ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[Greenhouse çoklu oturum açmayı yapılandırma](#configure-greenhouse-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Greenhouse test kullanıcısı oluşturma](#create-greenhouse-test-user)**  - kullanıcı Azure AD gösterimini bağlı Greenhouse Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Greenhouse** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Greenhouse etki alanı ve URL'ler tek oturum açma bilgileri](common/sp-identifier.png)

    a. İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<companyname>.greenhouse.io`

    b. İçinde **tanımlayıcı (varlık kimliği)** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<companyname>.greenhouse.io`

    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL ve tanımlayıcıdır ile güncelleştirin. İlgili kişi [Greenhouse istemci Destek ekibine](https://www.greenhouse.io/contact) bu değerleri almak için. Gösterilen desenleri de başvurabilirsiniz **temel SAML yapılandırma** bölümünde Azure portalında.
...
6. Üzerinde **Greenhouse kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
### <a name="configure-greenhouse-single-sign-on"></a>Greenhouse çoklu oturum açmayı yapılandırın

Çoklu oturum açmayı yapılandırma **Greenhouse** tarafı, indirilen göndermek için ihtiyacınız **Federasyon meta verileri XML** ve uygun Azure portalına kopyalanan URL'lerden [Greenhouse Destek ekibine](https://www.greenhouse.io/contact). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Greenhouse**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Greenhouse**.

    ![Uygulamalar listesinde Greenhouse bağlantı](common/all-applications.png)
...
### <a name="create-greenhouse-test-user"></a>Greenhouse test kullanıcısı oluşturma
...
Erişim paneli Greenhouse kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama Greenhouse için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
