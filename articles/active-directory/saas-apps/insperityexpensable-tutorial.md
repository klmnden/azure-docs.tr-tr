...
* Azure AD hesaplarına otomatik olarak Insperity ExpensAble için (çoklu oturum açma) oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Abonelik Insperity ExpensAble çoklu oturum açma etkin

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, yapılandırma ve Azure AD çoklu oturum açma bir test ortamında test edin.

* Insperity ExpensAble destekler **SP** tarafından başlatılan
...
4. Arama kutusuna **Insperity ExpensAble**seçin **Insperity ExpensAble** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

     ![Sonuç listesinde Insperity ExpensAble](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Insperity adlı bir test kullanıcı tabanlı ExpensAble ile test etme **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısı ile ilgili kullanıcı Insperity ExpensAble arasında bir bağlantı ilişki kurulması gerekir.
...
2. **[Insperity ExpensAble çoklu oturum açmayı yapılandırma](#configure-insperity-expensable-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Insperity ExpensAble test kullanıcısı oluşturma](#create-insperity-expensable-test-user)**  - Insperity kullanıcı Azure AD gösterimini bağlı ExpensAble Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Insperity ExpensAble** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Insperity ExpensAble etki alanı ve URL'ler tek oturum açma bilgileri](common/sp-signonurl.png)
...
6. Üzerinde **Insperity ExpensAble kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Insperity ExpensAble**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Insperity ExpensAble**.

    ![Uygulamalar listesinde Insperity ExpensAble bağlantı](common/all-applications.png)
...
Erişim panelinde Insperity ExpensAble kutucuğa tıkladığınızda, otomatik olarak Insperity SSO'yu ayarlama ExpensAble için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
