---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle OnTrack | Microsoft Docs'
...
ms.locfileid: "39051392"
---
# <a name="tutorial-azure-active-directory-integration-with-ontrack"></a>Öğretici: Azure Active Directory OnTrack ile tümleştirme
...
3. **[Bir OnTrack test kullanıcısı oluşturma](#create-an-ontrack-test-user)**  - kullanıcı Azure AD gösterimini bağlı OnTrack Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **OnTrack etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
8. Çoklu oturum açmayı yapılandırma **OnTrack** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [OnTrack Destek ekibine](mailto:CustomerService@insigniagroup.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
