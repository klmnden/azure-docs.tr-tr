...
1. Arama kutusuna **ThirdLight**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/thirdlight-tutorial/tutorial_thirdlight_search.png)

1. Sonuçlar panelinde seçin **ThirdLight**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[ThirdLight test kullanıcısı oluşturma](#creating-a-thirdlight-test-user)**  - kullanıcı Azure AD gösterimini bağlı ThirdLight Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **ThirdLight etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Uygulamalar listesinde **ThirdLight**.
