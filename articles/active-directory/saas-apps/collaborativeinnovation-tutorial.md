---
title: 'Öğretici: Azure Active Directory Tümleştirme ile işbirliğine dayalı yenilik | Microsoft Docs'
...
ms.locfileid: "39042435"
---
# <a name="tutorial-azure-active-directory-integration-with-collaborative-innovation"></a>Öğretici: Azure Active Directory Tümleştirme ile işbirliğine dayalı yenilik
...
4. Arama kutusuna **işbirliğine dayalı yenilik**.
...
5. Sonuçlar panelinde seçin **işbirliğine dayalı yenilik**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[İşbirliğine dayalı yenilik test kullanıcısı oluşturma](#creating-a-collaborative-innovation-test-user)**  - kullanıcı Azure AD gösterimini bağlı işbirliğine dayalı yenilik Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **işbirliğine dayalı yenilik etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
8. Çoklu oturum açmayı yapılandırma **işbirliğine dayalı yenilik** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [işbirliğine dayalı yenilik Destek ekibine](https://www.unilever.com/contact/). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
