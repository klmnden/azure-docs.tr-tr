...
4. Arama kutusuna **mindWireless**seçin **mindWireless** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde mindWireless](./media/mindwireless-tutorial/tutorial_mindwireless_addfromgallery.png)
...
3. Üzerinde **mindWireless etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![mindWireless etki alanı ve URL'leri tek oturum açma bilgileri](./media/mindwireless-tutorial/tutorial_mindwireless_url.png)
...
8. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/mindwireless-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/mindwireless-tutorial/create_aaduser_02.png)
