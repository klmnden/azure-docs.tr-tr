...
3. **[Predictix Sınıflama planlama test kullanıcısı oluşturma](#create-a-predictix-assortment-planning-test-user)**  - Predictix Sınıflama kullanıcı Azure AD gösterimini bağlı planlama Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Predictix Sınıflama planlama etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Predictix Sınıflama yapılandırmasını planlama** bölümünde **yapılandırma Predictix Sınıflama planlama** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
