---
title: 'Öğretici: Azure Active Directory Tümleştirmesi ile Yazı tahtası öğrenin | Microsoft Docs'
...
ms.openlocfilehash: 2dbd047d8fdef98d579586175da740617496b73e
ms.sourcegitcommit: 7e772d8802f1bc9b5eb20860ae2df96d31908a32
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 03/06/2019
ms.locfileid: "57440634"
---
...
* Kimlerin erişebildiğini Yazı tahtası öğrenmek için Azure AD'de kontrol edebilirsiniz.
* Azure AD hesaplarına otomatik olarak (çoklu oturum açma) Yazı tahtası öğrenmek için oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Abonelik Yazı tahtası öğrenin çoklu oturum açma etkin

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, yapılandırma ve Azure AD çoklu oturum açma bir test ortamında test edin.

* Yazı tahtası öğrenin destekler **SP** tarafından başlatılan
* Yazı tahtası öğrenin destekler **zamanında** kullanıcı sağlama
...
4. Arama kutusuna **Yazı tahtası öğrenin**seçin **Yazı tahtası öğrenin** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

     ![Sonuç listesinde Yazı tahtası öğrenin](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma adlı bir test kullanıcı tabanlı Yazı tahtası bilgi ile test etme **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısı ile ilgili bilgi Yazı tahtası kullanıcı arasında bir bağlantı ilişki kurulması gerekir.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **Yazı tahtası öğrenin** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Yazı tahtası öğrenin etki alanı ve URL'ler tek oturum açma bilgileri](common/sp-identifier.png)

    a. İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<subdomain>.blackboard.com/`

    b. İçinde **tanımlayıcı (varlık kimliği)** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<subdomain>.blackboard.com/auth-saml/saml/SSO/entity-id/SAML_AD`

    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL ve tanımlayıcıdır ile güncelleştirin. İlgili kişi [Yazı tahtası öğrenin istemci Destek ekibine](https://www.blackboard.com/support/index.aspx) bu değerleri almak için. Gösterilen desenleri de başvurabilirsiniz **temel SAML yapılandırma** bölümünde Azure portalında.
...
### <a name="configure-blackboard-learn-single-sign-on"></a>Yazı tahtası yapılandırma çoklu oturum açmayı öğrenin

Çoklu oturum açmayı yapılandırma **Yazı tahtası öğrenin** tarafı, indirilen göndermek için ihtiyacınız **Federasyon meta verileri XML** ve **Azure Ad tanımlayıcısı** için [ Yazı tahtası öğrenin Destek](https://www.blackboard.com/support/index.aspx).
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Yazı tahtası öğrenin**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Yazı tahtası öğrenin**.

    ![Uygulamalar listesinde Yazı tahtası bilgi bağlantısı](common/all-applications.png)
