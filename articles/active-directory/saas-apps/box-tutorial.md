...
2. İçinde **çoklu oturum açma** penceresi, **tek oturum açma modu** kutusunda **SAML tabanlı oturum açma**.
    ...
    !["Çoklu oturum açmayı" penceresi](./media/box-tutorial/tutorial_box_samlbase.png)

3. Altında **kutusunu etki alanı ve URL'leri**, aşağıdakileri yapın:

    !["Etki alanı ve URL'ler kutusuna" tek oturum açma bilgileri](./media/box-tutorial/url3.png)
...
5. **Kaydet**’i seçin.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/box-tutorial/tutorial_general_400.png)
...
2. Geçerli kullanıcıların bir listesini görüntülemek için seçin **kullanıcılar ve gruplar** > **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/box-tutorial/create_aaduser_02.png)
...
* [Kullanıcı sağlamayı Yapılandır](box-userprovisioning-tutorial.md)
