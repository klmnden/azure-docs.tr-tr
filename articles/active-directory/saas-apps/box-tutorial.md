...
5. **[Kutusunu test kullanıcısı oluşturma](#create-box-test-user)**  - kullanıcı Azure AD gösterimini bağlı kutusunda Britta simon'un bir karşılığı vardır.
