...
4. Arama kutusuna yazın **SciQuest harcamanız Director**seçin **SciQuest harcamanız Director** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde SciQuest harcamanız Director](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
3. Üzerinde **SciQuest harcamanız Director etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![SciQuest harcadığı Director etki alanı ve URL'leri tek oturum açma bilgileri](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/sciquest-spend-director-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **SciQuest harcamanız Director**.
    ...
    ![Uygulamalar listesini SciQuest Director harcamanızı bağlantıyı](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
