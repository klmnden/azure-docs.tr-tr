...
1. Arama kutusuna **Datahug**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/datahug-tutorial/tutorial_datahug_search.png)

1. Sonuçlar panelinde seçin **Datahug**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Datahug test kullanıcısı oluşturma](#creating-a-datahug-test-user)**  - kullanıcı Azure AD gösterimini bağlı Datahug Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Datahug etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu:
...
1.  Denetleme **"Show gelişmiş sertifika imzalama ayarlarını"** ve aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **Datahug yapılandırma** bölümünde **yapılandırma Datahug** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği** ve **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. Üzerine **dişli** sağ üst köşedeki tıklayıp **ayarları**
   
   ![Çalışan Ekle](./media/datahug-tutorial/1.png)

1. Seçin **kişiler** tıklatıp **Add Users** sekmesi

    ![Çalışan Ekle](./media/datahug-tutorial/2.png)

1. İçin bir hesap oluşturup ve istediğiniz kişinin e-postasını yazmalı **Ekle**.
...
1. Uygulamalar listesinde **Datahug**.
