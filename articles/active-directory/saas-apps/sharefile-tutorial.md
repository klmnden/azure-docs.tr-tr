...
1. Arama kutusuna **Citrix ShareFile**seçin **Citrix ShareFile** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Citrix ShareFile test kullanıcısı oluşturma](#create-a-citrix-sharefile-test-user)**  - bir karşılığı Britta simon'un kullanıcı Azure AD gösterimini bağlı Citrix ShareFile sağlamak için.
...
1. Üzerinde **Citrix ShareFile etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **Citrix ShareFile Yapılandırması** bölümünde **yapılandırma Citrix ShareFile** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. Üst araç çubuğunda tıklatın **yönetici**.

1. Sol gezinti bölmesinde seçin **yapılandırma çoklu oturum açma**.
   
    ![Hesap Yönetimi](./media/sharefile-tutorial/ic773627.png "hesap yönetimi")

1. Üzerinde **çoklu oturum açma / SAML 2.0 Yapılandırması** iletişim sayfanın altında **temel ayarları**, aşağıdaki adımları gerçekleştirin:
...
1. Tıklayın **Kaydet** Citrix ShareFile Yönetim Portalı'nda.
...
1. Tıklayın **kullanıcıları yönetme \> kullanıcıların giriş yönetme \> + çalışan Oluştur**.
   
   ![Çalışan oluşturma](./media/sharefile-tutorial/IC781050.png "çalışan oluşturun")

1. Üzerinde **temel bilgileri** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Uygulamalar listesinde **Citrix ShareFile**.
