---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Synergi | Microsoft Docs'
...
ms.locfileid: "39041437"
---
# <a name="tutorial-azure-active-directory-integration-with-synergi"></a>Öğretici: Azure Active Directory Synergi ile tümleştirme
...
3. **[Synergi test kullanıcısı oluşturma](#create-a-synergi-test-user)**  - kullanıcı Azure AD gösterimini bağlı Synergi Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Synergi etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Synergi yapılandırma** bölümünde **yapılandırma Synergi** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si ve SAML varlık kimliği** gelen **hızlı başvuru bölümü.**

    ![Synergi yapılandırma](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Çoklu oturum açmayı yapılandırma **Synergi** tarafı, indirilen göndermek için ihtiyacınız **Certificate(Base64), oturum kapatma URL'si ve SAML varlık kimliği** için [Synergi Destek ekibine](https://www.irmsecurity.com/contact/).
