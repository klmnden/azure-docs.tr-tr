...
4. Arama kutusuna **Zoho**seçin **Zoho** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Zoho](./media/zoho-mail-tutorial/tutorial_zoho_addfromgallery.png)
...
3. Üzerinde **Zoho etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Zoho etki alanı ve URL'leri tek oturum açma bilgileri](./media/zoho-mail-tutorial/tutorial_zoho_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/zoho-mail-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/zoho-mail-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **Zoho**.
    ...
    ![Uygulamalar listesinde Zoho bağlantı](./media/zoho-mail-tutorial/tutorial_zoho_app.png)  
