...
9. Hesap Yapılandırma sayfasında, aşağıdaki adımları gerçekleştirin:
    ...
    ![Çoklu oturum açma yapılandırma](./media/bime-tutorial/ic775559.png "çoklu oturum açmayı yapılandırın")
...
3. İçinde **kullanıcılar listesi**, tıklatın **yeni kullanıcı Ekle** ("+").
    ...
    ![Kullanıcıların](./media/bime-tutorial/ic775562.png "kullanıcılar")
