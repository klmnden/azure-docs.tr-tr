...
Azure AD ile Bersin tümleştirme ile aşağıdaki avantajları sağlar:

- Bersin erişimi, Azure AD'de kontrol edebilirsiniz.
- Otomatik olarak imzalanan için Bersin (çoklu oturum açma) ile Azure AD hesaplarına açma, kullanıcılarınızın etkinleştirebilirsiniz.
...
4. Arama kutusuna **Bersin**seçin **Bersin** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

    ![Sonuç listesinde Bersin](./media/bersin-tutorial/tutorial_bersin_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırın ve Azure AD çoklu oturum açma "Britta Simon" adlı bir test kullanıcı tabanlı Bersin sınayın.

Tek iş için oturum açma için Azure AD ne Bersin karşılığı kullanıcı için bir kullanıcı Azure AD'de olduğunu bilmeniz gerekir. Diğer bir deyişle, bir Azure AD kullanıcısının Bersin ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.

Yapılandırma ve Azure AD çoklu oturum açma Bersin ile test etmek için aşağıdaki yapı taşlarını tamamlanması gerekir:

1. **[Azure AD çoklu oturum açmayı yapılandırmayı](#configure-azure-ad-single-sign-on)**  - bu özelliği kullanmak, kullanıcılarınızın etkinleştirmek için.
2. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
3. **[Bersin test kullanıcısı oluşturma](#create-a-bersin-test-user)**  - kullanıcı Azure AD gösterimini bağlı Bersin Britta simon'un bir karşılığı vardır.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Çoklu oturum açmayı test](#test-single-sign-on)**  - yapılandırma çalışıp çalışmadığını doğrulayın.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD çoklu oturum açmayı yapılandırın

Bu bölümde, Azure AD çoklu oturum açma Azure portalında etkinleştirin ve Bersin uygulamanızda çoklu oturum açmayı yapılandırın.
...
3. Üzerinde **Bersin etki alanı ve URL'ler** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** başlatılan modu:

    ![Bersin etki alanı ve URL'ler tek oturum açma bilgileri](./media/bersin-tutorial/tutorial_bersin_url.png)

    a. İçinde **tanımlayıcı** metin kutusuna bir URL: `https://www.bersin.com/shibboleth`

    b. Denetleme **Gelişmiş URL ayarlarını göster** ve **geçiş durumu** metin kutusuna bir URL: `https://www.bersin.com/secure/`

4. Uygulamada yapılandırmak istiyorsanız **SP** modunda başlatılan aşağıdaki adımı uygulayın:

    ![Bersin etki alanı ve URL'ler tek oturum açma bilgileri](./media/bersin-tutorial/tutorial_bersin_url1.png)

    İçinde **oturum açma URL'si** metin kutusuna bir URL: `https://www.bersin.com/Login.aspx`
...
6. Tıklayın **Kaydet** düğmesi.
    ...
    ![Çoklu oturum açma Kaydet düğmesi yapılandırın](./media/bersin-tutorial/tutorial_general_400.png)
    
7. Çoklu oturum açmayı yapılandırma **Bersin** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Bersin Destek ekibine](mailto:USBersinServiceClient@deloitte.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
2. Kullanıcıların listesini görüntülemek için Git **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantıları](./media/bersin-tutorial/create_aaduser_02.png)
...
Bu bölümde, Azure çoklu oturum açma kullanmak için Bersin erişim vererek Britta Simon etkinleştirin.

![Kullanıcı rolü atayın][200] 

**Britta Simon Bersin için atamak için aşağıdaki adımları gerçekleştirin:**
...
Erişim panelinde Bersin kutucuğa tıkladığınızda, otomatik olarak Bersin uygulamanıza açan.
