...
ms.openlocfilehash: b53731cb4f5624144aa76d833b69416d12d18860
ms.sourcegitcommit: 7e772d8802f1bc9b5eb20860ae2df96d31908a32
ms.translationtype: MT
ms.contentlocale: tr-TR
ms.lasthandoff: 03/06/2019
ms.locfileid: "57433867"
---
...
* Otomatik olarak (çoklu oturum açma) Bersin için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Bersin destekler **SP ve IDP** tarafından başlatılan
...
Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma Bersin adlı bir test kullanıcı tabanlı test **Britta Simon** tek çalışmak için oturum açma için bir Azure AD kullanıcısının Bersin ilgili kullanıcı arasında bir bağlantı ilişkisi olması gerekir kurdu.
...
2. **[Bersin çoklu oturum açmayı yapılandırma](#configure-bersin-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Bersin test kullanıcısı oluşturma](#create-bersin-test-user)**  - kullanıcı Azure AD gösterimini bağlı Bersin Britta simon'un bir karşılığı vardır.
...
4. Üzerinde **temel SAML yapılandırma** uygulamada yapılandırmak isterseniz, bölümü **IDP** modunda başlatılan aşağıdaki adımı uygulayın:
    ...
    ![Bersin etki alanı ve URL'ler tek oturum açma bilgileri](common/idp-identifier-relay.png)

    a. İçinde **tanımlayıcı** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://www.bersin.com/shibboleth`
...
5. Tıklayın **ek URL'lerini ayarlayın** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **SP** başlatılan modu:
    ...
    İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın:  `https://www.bersin.com/Login.aspx`
...
7. Üzerinde **Bersin kümesi** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **Bersin**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **Bersin**.

    ![Uygulamalar listesinde Bersin bağlantı](common/all-applications.png)
...
Erişim paneli Bersin kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama Bersin için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
