...
1. Arama kutusuna **Bersin**seçin **Bersin** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Bersin test kullanıcısı oluşturma](#create-a-bersin-test-user)**  - kullanıcı Azure AD gösterimini bağlı Bersin Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Bersin etki alanı ve URL'ler** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** başlatılan modu:
...
1. Uygulamada yapılandırmak istiyorsanız **SP** modunda başlatılan aşağıdaki adımı uygulayın:
...
1. Uygulamalar listesinde **Bersin**.
