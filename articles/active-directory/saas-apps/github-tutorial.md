...
1. Arama kutusuna **GitHub**seçin **GitHub** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[GitHub test kullanıcısı oluşturma](#create-a-github-test-user)**  - kullanıcı Azure AD gösterimini bağlı github'da Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **GitHub etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **kullanıcı öznitelikleri** bölümünden **kullanıcı tanımlayıcısı** user.mail olarak.
...
1. Üzerinde **GitHub yapılandırma** bölümünde **GitHub yapılandırma** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. Gidin **ayarları** tıklatıp **güvenlik**

    ![Ayarlar](./media/github-tutorial/tutorial_github_config_github_03.png)

1. Kontrol **etkinleştirme SAML kimlik doğrulaması** kutusu, çoklu oturum açmayı yapılandırma alanları açıklayacak. Ardından, çoklu oturum açma URL'si Azure AD yapılandırmasını güncelleştirmek için tek oturum açma URL değeri kullanın.
...
1. Tıklayarak **Test SAML yapılandırma** onaylamak için hiçbir doğrulama hataları veya SSO sırasında hata.
...
1. Uygulamalar listesinde **GitHub**.
