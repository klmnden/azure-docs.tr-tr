...
1. Arama kutusuna **Klue**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/klue-tutorial/tutorial_klue_search.png)

1. Sonuçlar panelinde seçin **Klue**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Klue test kullanıcısı oluşturma](#creating-a-klue-test-user)**  - kullanıcı Azure AD gösterimini bağlı Klue Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Klue etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu:
...
1. Klue uygulama, özel öznitelik eşlemelerini SAML belirteci öznitelikleri yapılandırmanıza ekleyin gerektiren belirli bir biçimde SAML onaylamalarını bekler. Bu öznitelikleri değerlerini yönetebilirsiniz "**kullanıcı öznitelikleri**" uygulama tümleştirme sayfasında bölümü. 
...
1. Üzerinde **Klue yapılandırma** bölümünde **yapılandırma Klue** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/klue-tutorial/tutorial_klue_configure.png) 

1. Çoklu oturum açmayı yapılandırma **Klue** tarafı, indirilen göndermek için ihtiyacınız **Certificate(Base64), SAML çoklu oturum açma hizmet URL'si ve SAML varlık kimliği** için [Klue Destek ekibine](mailto:support@klue.com).
