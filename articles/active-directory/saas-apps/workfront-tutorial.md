---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Workfront | Microsoft Docs'
...
ms.locfileid: "39050716"
---
# <a name="tutorial-azure-active-directory-integration-with-workfront"></a>Öğretici: Azure Active Directory Workfront ile tümleştirme
...
5. Sonuçlar panelinde seçin **Workfront**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Workfront test kullanıcısı oluşturma](#creating-a-workfront-test-user)**  - kullanıcı Azure AD gösterimini bağlı Workfront Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Workfront etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL'si ve tanımlayıcı ile güncelleştirin. İlgili kişi [Workfront istemci Destek ekibine](https://www.workfront.com/contact-us/) bu değerleri almak için. 
...
6. Üzerinde **Workfront yapılandırma** bölümünde **yapılandırma Workfront** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/workfront-tutorial/tutorial_workfront_configure.png) 

7. Workfront şirketinizin sitesi için yönetici olarak oturum.

8. Git **çoklu oturum açma yapılandırması**.

9. Üzerinde **çoklu oturum açma** iletişim kutusunda, aşağıdaki adımları gerçekleştirin
