...
1. Arama kutusuna **Manabi Pocket**seçin **Manabi Pocket** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Manabi Pocket test kullanıcısı oluşturma](#create-a-manabi-pocket-test-user)**  - kullanıcı Azure AD gösterimini bağlı Manabi Pocket Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Manabi Pocket etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu oturum açmayı yapılandırma **Manabi Pocket** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Manabi Pocket Destek ekibine](mailto:info-ed-cl@ntt.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Uygulamalar listesinde **Manabi Pocket**.
