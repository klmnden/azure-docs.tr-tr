---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle HappyFox | Microsoft Docs'
...
ms.locfileid: "39042376"
---
# <a name="tutorial-azure-active-directory-integration-with-happyfox"></a>Öğretici: Azure Active Directory HappyFox ile tümleştirme
...
5. Sonuçlar panelinde seçin **HappyFox**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[HappyFox test kullanıcısı oluşturma](#creating-a-happyfox-test-user)**  - kullanıcı Azure AD gösterimini bağlı HappyFox Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **HappyFox etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **HappyFox yapılandırma** bölümünde **yapılandırma HappyFox** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümüne**.

    ![Çoklu oturum açmayı yapılandırın](./media/happyfox-tutorial/tutorial_happyfox_configure.png) 

7. HappyFox personeli portalınızda oturum açın ve gidin **Yönet**, tıklayarak **tümleştirmeler** sekmesi.
...
9. SAML yapılandırma bölümü içinde yapıştırın **SAML çoklu oturum açma hizmeti URL'si** Azure portaldan kopyaladığınız **SSO hedef URL** metin.

    ![Çoklu oturum açmayı yapılandırın](./media/happyfox-tutorial/targeturl.png)

10. Not Defteri'nde Azure portalından indirilen sertifikasını açın ve içeriğini yapıştırın **IDP imza** bölümü.
 
    ![Çoklu oturum açmayı yapılandırın](./media/happyfox-tutorial/cert.png)

11. Tıklayın **Ayarları Kaydet** düğmesi.
