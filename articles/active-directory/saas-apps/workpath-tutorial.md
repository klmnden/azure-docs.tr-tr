---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Workpath | Microsoft Docs'
...
ms.locfileid: "39055568"
---
# <a name="tutorial-azure-active-directory-integration-with-workpath"></a>Öğretici: Azure Active Directory Workpath ile tümleştirme
...
5. Sonuçlar panelinde seçin **Workpath**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Workpath test kullanıcısı oluşturma](#creating-a-workpath-test-user)**  - kullanıcı Azure AD gösterimini bağlı Workpath Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Workpath etki alanı ve URL'ler** uygulamada yapılandırmak isterseniz, bölümü **IDP** başlatılan modu, aşağıdaki adımları gerçekleştirin:
...
4. Denetleme **Gelişmiş URL ayarlarını göster**. Uygulamada yapılandırmak istiyorsanız **SP** başlatılan modu, aşağıdaki adımları gerçekleştirin:
...
9. Üzerinde **Workpath yapılandırma** bölümünde **yapılandırma Workpath** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/workpath-tutorial/tutorial_workpath_configure.png) 

10. Çoklu oturum açmayı yapılandırma **Workpath** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML**, **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** için [Workpath Destek ekibine](https://help.workpath.com). 
