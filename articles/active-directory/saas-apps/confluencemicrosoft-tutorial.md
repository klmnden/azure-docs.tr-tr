...
10. Yapılandırma sayfasında şu adımları gerçekleştirin:
    ...
    > [!NOTE]
    > Yükleme ve sorun giderme hakkında daha fazla bilgi için ziyaret [MS Confluence SSO Bağlayıcısı Yönetici Kılavuzu](../ms-confluence-jira-plugin-adminguide.md) ayrıca [SSS](../ms-confluence-jira-plugin-faq.md) , Yardım almak için
...
2. Dişlisine üzerine gelin ve tıklatın **kullanıcı yönetimi**.
    ...
    ![Çalışanı ekleyin](./media/confluencemicrosoft-tutorial/user1.png) 
...
3. Kullanıcılar bölümü altında tıklatın **kullanıcıları eklemek** sekmesi. Üzerinde **kullanıcı ekleme** iletişim sayfasında, aşağıdaki adımları gerçekleştirin:
    ...
    ![Çalışanı ekleyin](./media/confluencemicrosoft-tutorial/user2.png) 
