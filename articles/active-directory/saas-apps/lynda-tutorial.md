...
1. Arama kutusuna **Lynda.com**.

    ![Bir Azure AD test kullanıcısı oluşturma](./media/lynda-tutorial/tutorial_lynda.com_search.png)

1. Sonuçlar panelinde seçin **Lynda.com**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Lynda.com test kullanıcısı oluşturma](#creating-a-lyndacom-test-user)**  - kullanıcı Azure AD gösterimini bağlı Lynda.com Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Lynda.com etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Çoklu oturum açmayı yapılandırma **Lynda.com** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** [Lynda.com Destek](https://www.linkedin.com/help/lynda/ask).
...
1. Uygulamalar listesinde **Lynda.com**.
