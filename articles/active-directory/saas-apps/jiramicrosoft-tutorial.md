...
*   JIRA 5.2 de destekler. Daha fazla ayrıntı için tıklatın [Microsoft Azure Active Directory çoklu oturum açma JIRA 5.2 için](jira52microsoft-tutorial.md)
...
4. Arama kutusuna **JIRA SAML SSO Microsoft tarafından**seçin **JIRA SAML SSO Microsoft tarafından** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Microsoft tarafından JIRA SAML SSO](./media/jiramicrosoft-tutorial/tutorial_singlesign-onforjira_addfromgallery.png)
...
3. Üzerinde **JIRA SAML SSO Microsoft Domain ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![JIRA SAML SSO Microsoft Domain ve URL'ler tek oturum açma bilgileri](./media/jiramicrosoft-tutorial/tutorial_singlesign-onforjira_url.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/jiramicrosoft-tutorial/create_aaduser_02.png)
