...
4. Arama kutusuna **etmek perakende – bilgi yönetimi**seçin **etmek perakende – bilgi yönetimi** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Böl perakende – sonuçlar listesinde bilgi yönetimi](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
3. Üzerinde **etmek perakende – bilgi yönetim etki alanı ve URL'leri** bölümünde, uygulama tarafından başlatılan IDP modunda yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin:
    ...
    ![Böl perakende – bilgi yönetim etki alanı ve URL'ler tek oturum açma bilgileri IDP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Böl perakende – bilgi yönetim etki alanı ve URL'leri tek oturum açma bilgileri SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/inforretailinformationmanagement-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **etmek perakende – bilgi yönetimi**.
    ...
    ![Böl perakende – uygulamalar listesinde bilgi yönetimi bağlantı](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  
