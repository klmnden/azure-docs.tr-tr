---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle myPolicies | Microsoft Docs'
...
ms.locfileid: "39046235"
---
# <a name="tutorial-azure-active-directory-integration-with-mypolicies"></a>Öğretici: Azure Active Directory myPolicies ile tümleştirme
...
5. Sonuçlar panelinde seçin **myPolicies**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[MyPolicies test kullanıcısı oluşturma](#creating-a-mypolicies-test-user)**  - Britta Simon kullanıcı Azure AD gösterimini bağlı myPolicies içinde bir karşılığı vardır.
...
3. Üzerinde **myPolicies etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
8. Üzerinde **myPolicies yapılandırma** bölümünde **myPolicies yapılandırma** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/mypolicies-tutorial/tutorial_mypolicies_configure.png) 

9. Çoklu oturum açmayı yapılandırma **myPolicies** tarafı, indirilen göndermek için ihtiyacınız **Certificate(Base64)** ve **SAML çoklu oturum açma hizmeti URL'si** için [ myPolicies Destek ekibine](mailto:support@mypolicies.com). 
