...
* Azure AD hesaplarına otomatik olarak fon portalına (çoklu oturum açma) oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Abonelik portalı fon çoklu oturum açma etkin

## <a name="scenario-description"></a>Senaryo açıklaması

Bu öğreticide, yapılandırma ve Azure AD çoklu oturum açma bir test ortamında test edin.

* Fon Portal destekler **SP** tarafından başlatılan
...
4. Arama kutusuna **fon portalı**seçin **fon portalı** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.

     ![Sonuç listesinde fon portalı](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırma ve fon adlı bir test kullanıcı tabanlı Portal ile Azure AD çoklu oturum açmayı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısı ve ilgili kullanıcı portalında fon arasında bir bağlantı ilişki kurulması gerekir.
...
2. **[Fon portalı çoklu oturum açmayı yapılandırma](#configure-the-funding-portal-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Fon portalı test kullanıcısı oluşturma](#create-the-funding-portal-test-user)**  - fon kullanıcı Azure AD gösterimini bağlı portalında Britta simon'un bir karşılığı vardır.
...
1. İçinde [Azure portalında](https://portal.azure.com/), **fon portalı** uygulama tümleştirme sayfasında **çoklu oturum açma**.
...
4. Üzerinde **temel SAML yapılandırma** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Fon portalı etki alanı ve URL'ler tek oturum açma bilgileri](common/sp-identifier.png)

    a. İçinde **oturum açma URL'si** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<subdomain>.regenteducation.net/`

    b. İçinde **tanımlayıcı (varlık kimliği)** metin kutusuna şu biçimi kullanarak bir URL yazın: `https://<subdomain>.regenteducation.net`

    > [!NOTE]
    > Bu değerler gerçek değildir. Bu değerler gerçek oturum açma URL ve tanımlayıcıdır ile güncelleştirin. İlgili kişi [fon portalı istemcisi Destek ekibine](mailto:info@regenteducation.com) bu değerleri almak için. Gösterilen desenleri de başvurabilirsiniz **temel SAML yapılandırma** bölümünde Azure portalında.

5. Fon Portalı Uygulama SAML onaylamalarını "externalId1" adlı bir öznitelik içermesini bekliyor. "ExternalId1" değeri, tanınan bir studentID olmalıdır. Bu uygulama için "externalId1" talep yapılandırın. Bu öznitelikleri değerlerini yönetebilirsiniz **kullanıcı öznitelikleri** uygulama. Aşağıdaki ekran görüntüsü bunun bir örneği gösterilmektedir.
...
8. Üzerinde **fon Portal'ı ayarlama** bölümünde, ihtiyacınıza göre uygun URL'lerini kopyalayın.
...
### <a name="configure-the-funding-portal-single-sign-on"></a>Fon Portal çoklu oturum açmayı yapılandırın

Çoklu oturum açmayı yapılandırma **fon portalı** tarafı, indirilen göndermek için ihtiyacınız **Federasyon meta verileri XML** ve uygun Azure portalına kopyalanan URL'lerden [fon portalı Destek](mailto:info@regenteducation.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **fon portalı**.
