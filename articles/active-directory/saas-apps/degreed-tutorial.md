---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Degreed | Microsoft Docs'
...
ms.locfileid: "39047935"
---
# <a name="tutorial-azure-active-directory-integration-with-degreed"></a>Öğretici: Azure Active Directory Degreed ile tümleştirme
...
5. Sonuçlar panelinde seçin **Degreed**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Degreed test kullanıcısı oluşturma](#creating-a-degreed-test-user)**  - kullanıcı Azure AD gösterimini bağlı Degreed Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Degreed etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **Degreed** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Degreed Destek ekibine](mailTo:admin@degreed.com). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
