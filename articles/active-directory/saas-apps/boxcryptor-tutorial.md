...
3. **[Boxcryptor test kullanıcısı oluşturma](#create-a-boxcryptor-test-user)**  - kullanıcı Azure AD gösterimini bağlı Boxcryptor Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Boxcryptor etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Boxcryptor yapılandırma** bölümünde **yapılandırma Boxcryptor** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML çoklu oturum açma hizmeti URL'si** ve **SAML varlık kimliği** gelen **hızlı başvuru bölümü.**
