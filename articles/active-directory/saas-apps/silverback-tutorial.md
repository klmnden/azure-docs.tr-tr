---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Silverback | Microsoft Docs'
...
- Otomatik olarak imzalanan için Silverback (çoklu oturum açma) ile Azure AD hesaplarına açma, kullanıcılarınızın etkinleştirebilirsiniz.
...
4. Arama kutusuna **Silverback**seçin **Silverback** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
    ...
    ![Sonuç listesinde silverback](./media/silverback-tutorial/tutorial_silverback_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Yapılandırma ve Azure AD çoklu oturum açmayı test etme

Bu bölümde, yapılandırın ve Azure AD çoklu oturum açma "Britta Simon" adlı bir test kullanıcı tabanlı Silverback sınayın.

Tek iş için oturum açma için Azure AD ne Silverback karşılığı kullanıcı için bir kullanıcı Azure AD'de olduğunu bilmeniz gerekir. Diğer bir deyişle, bir Azure AD kullanıcısının Silverback ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
3. **[Silverback test kullanıcısı oluşturma](#create-a-silverback-test-user)**  - kullanıcı Azure AD gösterimini bağlı Silverback Britta simon'un bir karşılığı vardır.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Çoklu oturum açmayı test](#test-single-sign-on)**  - yapılandırma çalışıp çalışmadığını doğrulayın.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD çoklu oturum açmayı yapılandırın

Bu bölümde, Azure AD çoklu oturum açma Azure portalında etkinleştirin ve Silverback uygulamanızda çoklu oturum açmayı yapılandırın.

**Azure AD çoklu oturum açma ile Silverback yapılandırmak için aşağıdaki adımları gerçekleştirin:**

1. Azure portalında, üzerinde **Silverback** uygulama tümleştirme sayfasını tıklatın **çoklu oturum açma**.

    ![Çoklu oturum açma bağlantısı yapılandırma][4]

2. Üzerinde **çoklu oturum açma** iletişim kutusunda **modu** olarak **SAML tabanlı oturum açma** çoklu oturum açmayı etkinleştirmek için.
 
    ![Çoklu oturum açma iletişim kutusu](./media/silverback-tutorial/tutorial_silverback_samlbase.png)

3. Üzerinde **Silverback etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
4. Üzerinde **SAML imzalama sertifikası** bölümünde, kopyalamak için Kopyala düğmesine **uygulama Federasyon meta verileri URL'sini** kopyalayıp Not Defteri'ne yapıştırın.
    ...
    ![Sertifika indirme bağlantısı](./media/silverback-tutorial/tutorial_silverback_certificate.png) 
...
1. Azure portalında, sol bölmede, tıklayın **Azure Active Directory** düğmesi.
    ...
    ![Azure Active Directory düğmesi](./media/silverback-tutorial/create_aaduser_01.png)

2. Kullanıcıların listesini görüntülemek için Git **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.

    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantıları](./media/silverback-tutorial/create_aaduser_02.png)

3. Açmak için **kullanıcı** iletişim kutusu, tıklayın **Ekle** en üstündeki **tüm kullanıcılar** iletişim kutusu.

    ![Ekle düğmesi](./media/silverback-tutorial/create_aaduser_03.png)

4. İçinde **kullanıcı** iletişim kutusunda, aşağıdaki adımları gerçekleştirin:

    ![Kullanıcı iletişim kutusu](./media/silverback-tutorial/create_aaduser_04.png)
...
**Britta Simon Silverback için atamak için aşağıdaki adımları gerçekleştirin:**
...
2. Uygulamalar listesinde **Silverback**.
    ...
    ![Uygulamalar listesinde Silverback bağlantı](./media/silverback-tutorial/tutorial_silverback_app.png)  
...
Erişim panelinde Silverback kutucuğa tıkladığınızda, otomatik olarak Silverback uygulamanıza açan.
