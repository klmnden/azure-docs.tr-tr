...
1. Arama kutusuna **Salesforce korumalı alan**seçin **Salesforce korumalı alan** sonucu panelinden ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
1. **[Salesforce korumalı alan test kullanıcısı oluşturma](#create-a-salesforce-sandbox-test-user)**  - kullanıcı Azure AD gösterimini bağlı Salesforce korumalı Britta simon'un bir karşılığı vardır.
...
1. Üzerinde **Salesforce korumalı alan etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
1. Üzerinde **Salesforce korumalı alan yapılandırma** bölümünde **yapılandırma Salesforce korumalı alan** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
...
1. SAML çoklu oturum açma ayarları bölümünde aşağıdaki adımları gerçekleştirin:
...
1. İçinde **kimlik doğrulama Yapılandırması** bölümünde **Düzenle**, sonra **kimlik doğrulama hizmeti**, oturum açma SAML tek ayarının adı önceki seçin bölüm ve son olarak tıklayın **Kaydet**.
...
1. Uygulamalar listesinde **Salesforce korumalı alan**.
