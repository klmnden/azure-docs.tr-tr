---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Igloo yazılım | Microsoft Docs'
...
ms.locfileid: "39042432"
---
# <a name="tutorial-azure-active-directory-integration-with-igloo-software"></a>Öğretici: Azure Active Directory Igloo yazılım ile tümleştirme
...
5. Sonuçlar panelinde seçin **Igloo yazılım**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Bir Igloo yazılım test kullanıcısı oluşturma](#creating-an-igloo-software-test-user)**  - kullanıcı Azure AD gösterimini bağlı Igloo yazılım Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Igloo yazılım etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Igloo yazılım yapılandırma** bölümünde **Igloo yazılımı Yapılandır** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/igloo-software-tutorial/tutorial_igloosoftware_configure.png) 

7. Farklı bir web tarayıcı penceresinde Igloo yazılım şirketinizin sitesi için bir yönetici olarak oturum açın.

8. Git **Denetim Masası**.
   
     ![Denetim Masası](./media/igloo-software-tutorial/ic799949.png "Denetim Masası")

9. İçinde **üyelik** sekmesinde **oturum ayarları**.
   
    ![Oturum açma ayarları](./media/igloo-software-tutorial/ic783968.png "oturum açma ayarları")

10. SAML yapılandırma bölümünde tıklayın **SAML kimlik doğrulamasını yapılandırma**.
