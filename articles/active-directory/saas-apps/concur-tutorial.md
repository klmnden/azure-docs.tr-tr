...
5. Sonuçlar panelinde seçin **Concur**ve ardından **Ekle** uygulama eklemek için Ekle düğmesine.
...
3. **[Concur test kullanıcısı oluşturma](#creating-a-concur-test-user)**  - kullanıcı Azure AD gösterimini bağlı Concur Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Concur etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **Concur** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** Concur desteği. Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
