...
3. **[Pluralsight test kullanıcısı oluşturma](#create-a-pluralsight-test-user)**  - kullanıcı Azure AD gösterimini bağlı Pluralsight Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Pluralsight etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
5. Bu bölümün amacı, Azure AD çoklu oturum açma Azure portalındaki etkinleştirmek ve Pluralsight uygulamada SSO yapılandırmak için ' dir.
...
8. Uygulamanız için yapılandırılmış SSO almak için iletişime geçin [Pluralsight Profesyonel Hizmetler](mailTo:professionalservices@pluralsight.com) takım ve indirilen meta veri dosyası sağlayın.
