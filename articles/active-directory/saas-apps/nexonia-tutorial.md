...
3. **[Nexonia test kullanıcısı oluşturma](#create-a-nexonia-test-user)**  - kullanıcı Azure AD gösterimini bağlı Nexonia Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Nexonia etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **Nexonia yapılandırma** bölümünde **yapılandırma Nexonia** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
