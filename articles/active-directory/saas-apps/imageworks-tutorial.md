...
3. **[Görüntü WORKS test kullanıcısı oluşturma](#create-a-image-works-test-user)**  - kullanıcı Azure AD gösterimini bağlantılı görüntü geliştirilme Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **görüntü ÇALIŞTIĞI etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Üzerinde **görüntü WORKS Yapılandırması** bölümünde **yapılandırma görüntü WORKS** açmak için **yapılandırma oturum açma** penceresi. Kopyalama **oturum kapatma URL'si, SAML varlık kimliği ve SAML çoklu oturum açma hizmeti URL'si** gelen **hızlı başvuru bölümü.**
