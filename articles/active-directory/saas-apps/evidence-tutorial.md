...
2. **[Evidence.com çoklu oturum açmayı yapılandırma](#configure-evidence.com-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Evidence.com test kullanıcısı oluşturma](#create-evidence.com-test-user)**  - kullanıcı Azure AD gösterimini bağlı Evidence.com Britta simon'un bir karşılığı vardır.
