...
9. Tıklatın **genel ayarları**.
    ...
    ![Kullanıcılar, şirketler ve izinleri](./media/jitbit-helpdesk-tutorial/ic777680.png "kullanıcıları, şirketler ve izinleri")

10. İçinde **kimlik doğrulama ayarlarını** yapılandırma bölümünde, aşağıdaki adımları gerçekleştirin:
   
    ![Kimlik doğrulama ayarlarını](./media/jitbit-helpdesk-tutorial/ic777683.png "kimlik doğrulama ayarları")
...
3. Tıklatın **kullanıcıları, şirketler ve izinleri**.
    ...
    ![Kullanıcılar, şirketler ve izinleri](./media/jitbit-helpdesk-tutorial/ic777682.png "kullanıcıları, şirketler ve izinleri")
