---
title: 'Öğretici: Azure Active Directory tümleştirmesiyle Sedgwick CMS | Microsoft Docs'
...
3. **[Sedgwick CMS test kullanıcısı oluşturma](#create-a-sedgwick-cms-test-user)**  - kullanıcı Azure AD gösterimini bağlı Sedgwick CMS Britta simon'un bir karşılığı vardır.
...
3. Üzerinde **Sedgwick CMS etki alanı ve URL'ler** bölümünde, aşağıdaki adımları gerçekleştirin:
...
6. Çoklu oturum açmayı yapılandırma **Sedgwick CMS** tarafı, indirilen göndermek için ihtiyacınız **meta veri XML** için [Sedgwick CMS Destek ekibine](https://www.sedgwick.com/contact/Pages/contactform.aspx). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
