...
4. Arama kutusuna **Sedgwick CMS**seçin **Sedgwick CMS** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Sedgwick CMS](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_addfromgallery.png)
...
3. Üzerinde **Sedgwick CMS etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Sedgwick CMS etki alanı ve URL'leri tek oturum açma bilgileri](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_url.png)
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerler gerçek tanımlayıcısı ve yanıt URL'si ile güncelleştirin. Kişi [Sedgwick CMS destek ekibi](https://www.sedgwick.com/help) bu değerleri almak için.
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/sedgwickcms-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/sedgwickcms-tutorial/create_aaduser_02.png)
