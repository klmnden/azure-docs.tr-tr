...
10. İçinde **güvenlik** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![Çoklu oturum açmayı](./media/freshservice-tutorial/ic790816.png "çoklu oturum açmayı")
...
4. Tıklatın **yeni istek**.
    ...
    ![Yeni sahiplerini](./media/freshservice-tutorial/ic790819.png "yeni sahiplerini")

5. İçinde **yeni istek** bölümünde, aşağıdaki adımları gerçekleştirin:
   
    ![Yeni İstek](./media/freshservice-tutorial/ic790820.png "yeni istek")   
