...
4. Arama kutusuna **Genliğidir**seçin **Genliğidir** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde genliğidir](./media/amplitude-tutorial/tutorial_amplitude_addfromgallery.png)
...
3. Üzerinde **Genliğidir etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Genliğidir etki alanı ve URL'leri tek oturum açma bilgileri](./media/amplitude-tutorial/tutorial_amplitude_url.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Genliğidir etki alanı ve URL'leri tek oturum açma bilgileri](./media/amplitude-tutorial/tutorial_amplitude_url1.png)
...
6. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/amplitude-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/amplitude-tutorial/create_aaduser_02.png)
...
2. Uygulamalar listesinde **Genliğidir**.
    ...
    ![Uygulamalar listesinde Genliğidir bağlantı](./media/amplitude-tutorial/tutorial_amplitude_app.png)  
