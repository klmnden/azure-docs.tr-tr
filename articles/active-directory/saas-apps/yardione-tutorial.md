...
4. Arama kutusuna **YardiOne**seçin **YardiOne** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde YardiOne](./media/yardione-tutorial/tutorial_yardione_addfromgallery.png)
...
3. Üzerinde **YardiOne etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:
    ...
    ![YardiOne etki alanı ve URL'leri tek oturum açma bilgileri](./media/yardione-tutorial/tutorial_yardione_url.png)
...
5. Tıklatın **kaydetmek** düğmesi.
    ...
    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/yardione-tutorial/tutorial_general_400.png)
...
2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.
    ...
    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/yardione-tutorial/create_aaduser_02.png)
