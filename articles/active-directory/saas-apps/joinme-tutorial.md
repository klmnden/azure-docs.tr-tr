...
* Otomatik olarak (çoklu oturum açma) join.me için kendi Azure AD hesapları ile oturum açmış, kullanıcıların etkinleştirebilirsiniz.
...
* Join.Me destekler **IDP** tarafından başlatılan
...
Bu bölümde, yapılandırma ve Azure AD çoklu oturum açma join.me adlı bir test kullanıcı tabanlı test **Britta Simon**.
Tek iş için oturum açma için bir Azure AD kullanıcısının join.me ilgili kullanıcı arasında bir bağlantı ilişkisi kurulması gerekir.
...
2. **[Çoklu oturum açma join.Me yapılandırma](#configure-joinme-single-sign-on)**  - uygulama tarafında çoklu oturum açma ayarlarını yapılandırmak için.
3. **[Bir Azure AD test kullanıcısı oluşturma](#create-an-azure-ad-test-user)**  - Azure AD çoklu oturum açma Britta Simon ile test etmek için.
4. **[Azure AD test kullanıcı atama](#assign-the-azure-ad-test-user)**  - Azure AD çoklu oturum açmayı kullanmak Britta Simon etkinleştirmek için.
5. **[Join.Me test kullanıcısı oluşturma](#create-joinme-test-user)**  - Britta Simon kullanıcı Azure AD gösterimini bağlı join.me içinde bir karşılığı vardır.
...
### <a name="configure-joinme-single-sign-on"></a>Join.Me çoklu oturum açmayı yapılandırın

Çoklu oturum açmayı yapılandırma **join.me** tarafını göndermek için ihtiyacınız **uygulama Federasyon meta verileri URL'sini** için [join.me Destek ekibine](https://help.join.me/s/?language). Bunlar, her iki kenarı da düzgün ayarlandığından SAML SSO bağlantı sağlamak için bu ayarı ayarlayın.
...
1. Azure portalında **kurumsal uygulamalar**seçin **tüm uygulamaları**, ardından **join.me**.

    ![Kurumsal uygulamalar dikey penceresi](common/enterprise-applications.png)

2. Uygulamalar listesinde **join.me**.

    ![Uygulamalar listesinde join.me bağlantı](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Join.Me test kullanıcısı oluşturma
...
Erişim paneli join.me kutucuğa tıkladığınızda, size otomatik olarak SSO'yu ayarlama join.me için oturum açmanız. Erişim paneli hakkında daha fazla bilgi için bkz: [erişim Paneli'ne giriş](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
