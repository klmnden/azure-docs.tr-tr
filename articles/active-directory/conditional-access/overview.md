...
Bu sorular ve yanıtları, Azure AD koşullu erişim özelliğinin yaygın erişim senaryolarını oluşturmaktadır.
Azure Active Directory'nin koşullu erişim özelliği, senaryoları ilke tabanlı bir yaklaşımla ele almanızı sağlar.
...
Koşullu erişim ilkeleri [federe kimlik doğrulaması](../../security/azure-ad-choose-authn.md#federated-authentication) ile sorunsuz bir şekilde çalışır. Desteklenen tüm koşullar ve denetimleri ve ilke etkin kullanıcı oturum açma kullanarak işlemleri için nasıl uygulanacağını içine görünürlük bu desteğiyle [Azure AD raporlama](../reports-monitoring/concept-sign-ins.md).
