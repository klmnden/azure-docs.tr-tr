...
|Koşullu erişim [indirilebilir planı](https://aka.ms/CADPDownload) veya [çevrimiçi planı](https://aka.ms/caonlineplan)|Koşullu erişimle bulut uygulamalarınıza erişim sağlamak üzere koşullara bağlı otomatik erişim denetimi kararlarını uygulamaya alabilirsiniz.|
