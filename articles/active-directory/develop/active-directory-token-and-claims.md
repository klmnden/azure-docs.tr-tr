...
.NET ile nasıl yapılacağı hakkında daha fazla bilgi için bkz: [Azure AD'den taşıyıcı belirteçlerini kullanarak bir Web API korumak](active-directory-devquickstarts-webapi-dotnet.md).
