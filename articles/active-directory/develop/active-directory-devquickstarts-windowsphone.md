...
* DirectorySearcher projeyi açın `MainPage.xaml.cs`.  Değerleri değiştirin `Config Values` Azure portalına giriş değerleri yansıtacak şekilde bölge.  ADAL kullandığında kodunuzu bu değerleri başvurur.
