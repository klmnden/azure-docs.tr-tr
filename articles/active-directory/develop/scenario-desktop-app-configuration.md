...
Yukarıda görüldüğü gibi etkileşimli kimlik doğrulaması veya cihaz kod akışı, kullanmayı düşünüyorsanız, kullanmak istediğiniz `.WithRedirectUri` değiştiricisi:
