---
title: "Azure Active Directory Node.js Başlarken | Microsoft Docs"
...
---
# <a name="secure-nodejs-web-api-with-azure-active-directory"></a>Node.js Web API'si Azure Active Directory ile güvenli
...
Uygulamayı yapılandırma başlamak için Azure CLI edinebilirsiniz birkaç hesaba özel değer vardır. CLI ile çalışmaya başlamak için en kolay yolu, Azure bulut kabuğunu kullanmaktır.
