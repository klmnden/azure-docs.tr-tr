...
| ------------------------------------ | ---------- | ---------- |
| Microsoft logosu  | ![Microsoft logosu PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![SVG Microsoft logosu](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![Microsoft'ta oturum redlines](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)

Uygulamanızda resmi resimleri indirmek için bilgisayarınıza kaydedin ve kullanmak istediğiniz bir sağ tıklayın.

| Varlık                                | PNG biçimi | SVG biçimi |
| ------------------------------------ | ---------- | ---------- |
| Microsoft'ta (Koyu tema) oturum açın  | ![Düğme koyu tema PNG oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Microsoft düğme koyu tema oturum SVG oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Microsoft'ta (açık tema) oturum açın | ![Düğme açık tema PNG oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Microsoft düğme açık tema oturum SVG oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| (Koyu tema) oturum açın                 | ![Düğme koyu tema PNG kısa oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Düğme koyu tema SVG kısa oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| (Açık tema) oturum açın                | ![Düğme açık tema PNG kısa oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Düğme açık tema SVG kısa oturum](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
