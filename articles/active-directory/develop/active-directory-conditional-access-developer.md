...
Bilgi [tek](quickstart-v1-integrate-apps-with-azure-ad.md) ve [çok kiracılı](active-directory-devhowto-multi-tenant-overview.md) uygulamalar ve [ortak kimlik doğrulaması desenleri](authentication-scenarios.md) varsayılır.
...
![Uygulama üzerinde temsili Akış Diyagramı gerçekleştirme](media/active-directory-conditional-access-developer/app-performing-on-behalf-of-scenario.png)
...
![Uygulama yeni bir belirteç isteğinde birden çok hizmetlerine erişme](media/active-directory-conditional-access-developer/app-accessing-multiple-services-new-token.png)
...
![ADAL akış diyagramı kullanarak tek sayfalı uygulama](media/active-directory-conditional-access-developer/spa-using-adal-scenario.png)
...
* Çok kiracılı senaryolarda hakkında daha fazla bilgi için bkz: [çok kiracılı desenini kullanarak, kullanıcıların oturum açma](active-directory-devhowto-multi-tenant-overview.md).
