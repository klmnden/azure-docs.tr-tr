...
Azure Active Directory (Azure AD), uygulamanızın güvenli ve bir hizmet korumak için çeşitli yollar sunar. Bu benzersiz özellikleri koşullu erişim biridir. Geliştiricilerin ve kurumsal müşteriler dahil olmak üzere çok sayıda hizmetlerini korumak koşullu erişim sağlar:
