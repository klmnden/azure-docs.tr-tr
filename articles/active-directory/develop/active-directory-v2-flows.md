...
Bu senaryoyu çalışırken görmek için bizim v2.0 web uygulama oturum açma kodu örneklerinden birini deneyin [Başlarken](active-directory-appmodel-v2-overview.md#getting-started) bölümü.
