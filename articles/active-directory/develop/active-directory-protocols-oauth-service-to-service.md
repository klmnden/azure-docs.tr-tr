...
![OAuth2.0 istemci kimlik bilgileri yetki akışı](media/active-directory-protocols-oauth-service-to-service/active-directory-protocols-oauth-client-credentials-grant-flow.jpg)
...
* [Azure AD'nin OAuth 2.0](active-directory-protocols-oauth-code.md)
