...
Azure Active Directory (Azure AD), geliştiricilerin Microsoft iş veya okul hesabına sahip kullanıcılara güvenli bir şekilde oturum açtırmasını sağlayan bir bulut kimlik hizmetidir. Bu belgeler, sektör standardı protokolleri olan OAuth ve OpenID Connect’i kullanarak Azure AD desteğini uygulamanıza nasıl ekleyeceğinizi göstermektedir.
