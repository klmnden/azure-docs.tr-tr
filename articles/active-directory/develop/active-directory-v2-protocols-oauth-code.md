...
![OAuth yetkilendirme kod akışı](../../media/active-directory-v2-flows/convergence_scenarios_native.png)
...
| scope                 | gerekli    | Boşlukla ayrılmış bir listesini [kapsamları](active-directory-v2-scopes.md) onay kullanıcıya istiyor.           |
...
> [!TIP]
> Postman içinde bu isteğin yürütülmesi deneyin! (Değiştirmeyi unutmayın `code`) [ ![Postman içinde çalıştırın](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Postman içinde bu isteğin yürütülmesi! (Değiştir `Authorization` üstbilgi ilk) [ ![Postman içinde çalıştırın](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Postman içinde bu isteğin yürütülmesi deneyin! (Değiştirmeyi unutmayın `refresh_token`) [ ![Postman içinde çalıştırın](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
