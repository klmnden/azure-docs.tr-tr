---
title: Azure AD v2.0 JavaScript tek sayfalı uygulama (SPA) destekli Kurulum | Microsoft Docs
description: JavaScript SPA'ya uygulamaları Azure Active Directory v2.0 uç noktası tarafından erişim belirteçlerini gerektiren bir API çağrısı nasıl
