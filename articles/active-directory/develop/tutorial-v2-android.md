---
title: Azure Active Directory v2.0 Android kullanmaya başlama | Microsoft Docs
description: Nasıl bir Android uygulamasına erişim belirteci almak ve Microsoft Graph API'si veya bir Azure Active Directory v2.0 uç noktasından erişim belirteçlerini gerektiren API çağrısı.
