---
title: Azure AD v2 iOS kullanmaya başlama | Microsoft Docs
description: Nasıl iOS (Swift) uygulamaları Azure Active Directory v2 uç noktası tarafından erişim belirteçlerini gerektiren bir API çağrısı
