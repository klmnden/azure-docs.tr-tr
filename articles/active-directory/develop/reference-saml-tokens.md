...
| Anında kimlik doğrulaması | |Kimlik doğrulaması oluştuğu saat ve tarihi kaydeder. | `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | 
...
|Ad | `unique_name` |Belirtecin konu tanımlayan bir insan tarafından okunabilir değer sağlar. Bu değer, bir kiracıda benzersiz olması garanti edilmez ve yalnızca görüntüleme amaçları için kullanılmak üzere tasarlanmıştır. | `<Attribute Name=”http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name”>`<br>`<AttributeValue>frankm@contoso.com<AttributeValue>`|
