...
> [!NOTE]
> Yeni uygulama mı kaydediyorsunuz? Azure portalında **Uygulama kayıtları (Önizleme)** deneyimini kullanın. Başlamak için bkz. [Uygulama kaydetme (Önizleme)](quickstart-register-app.md).
