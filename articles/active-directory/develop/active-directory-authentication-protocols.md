...
* [Desteklenen belirteç ve talep türleri](active-directory-token-and-claims.md) -Azure AD verdiği belirteçlere talep hakkında bilgi edinin.
* [Federasyon meta verileri](active-directory-federation-metadata.md) -bulun ve Azure AD oluşturan meta veri belgelerini yorumlama hakkında bilgi edinin.
* [OAuth 2.0, Azure AD'de](active-directory-protocols-oauth-code.md) -OAuth 2.0, Azure AD'de uygulama hakkında bilgi edinin.
...
* [İstemci kimlik bilgileri ile hizmetten hizmete çağrılar](active-directory-protocols-oauth-service-to-service.md) -hizmet çağrıları için OAuth 2.0 istemci kimlik bilgileri verme akışı kullanmayı öğrenin.
* [Hizmetten hizmete çağrılar On-Behalf-Of Flow ile](active-directory-protocols-oauth-on-behalf-of.md) -hizmet çağrıları için OAuth 2.0 On-Behalf-Of akış'ı kullanmayı öğrenin.
