...
7. Son olarak, altında **seçin** açılır listede, Windows sanal makine seçin ve ardından **kaydetmek**. 
    ...
    ![Alt görüntü metin](~/articles/active-directory/media/msi-tutorial-linux-vm-access-storage/msi-storage-role.png)
...
- Depolama SAS kimlik bilgilerini kullanarak bu öğreticiyi yapmak öğrenmek için bkz: [bir SAS kimlik bilgisi Azure depolama erişmek için bir Windows VM yönetilen hizmet kimliği kullanın](msi-tutorial-windows-vm-access-storage-sas.md)
