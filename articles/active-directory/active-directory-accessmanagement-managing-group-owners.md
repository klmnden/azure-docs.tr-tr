...
## <a name="add-an-owner-to-a-group"></a>Bir sahip gruba ekleme

1. İçinde [Azure AD Yönetim Merkezi](https://aad.portal.azure.com)seçin **kullanıcılar ve gruplar**.
...
## <a name="remove-an-owner-from-a-group"></a>Bir sahip bir gruptan kaldırma
