...
Kullanmanıza gerek kiracınızda tüm uygulamaları görmek için **filtre** göstermek için Denetim **tüm uygulamaları** altında **tüm uygulamaları** listesi. Bunu yapmak için aşağıdaki adımları izleyin:
...
7.  Üzerinde **filtre** dikey penceresinde ayarlamak **Göster** için seçenek **tüm uygulamaları.**
...
1.  Herhangi bir uygulama uygulama Galerisi'nden eklediğinizde dahil olmak üzere:
   ...
   4. **Galeri olmayan uygulamaları** – kendi uygulamalarınızı Getir! İstediğiniz herhangi bir web bağlantıyı ya da bir kullanıcı adı ve parola alanı işleyen herhangi bir uygulama SAML veya Openıd Connect protokollerini destekler veya çoklu oturum açma için Azure AD ile tümleştirmek istediğiniz SCIM'yi destekler.
...
10. Kiracınızda verileri depolamak belirli hizmetleri etkinleştirdiğinizde. Bunun bir örneği parola parolanızı depolamak için bir hizmet sorumlusu İlkesi sıfırlama olarak hangi modellenir, güvenli bir şekilde sıfırlanır.
