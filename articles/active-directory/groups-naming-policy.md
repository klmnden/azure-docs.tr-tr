...
* [Office 365 gruplarının süre sonu ilkesi](users-groups-roles/groups-lifecycle.md)
...
* [Gruptaki kullanıcılar için dinamik kurallarını yönetme](users-groups-roles/groups-dynamic-membership.md)
