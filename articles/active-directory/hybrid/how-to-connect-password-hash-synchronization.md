...
Daha ayrıntılı bilgi için bkz. [Şirket içi kimliklerinizi Azure Active Directory ile tümleştirme](whatis-hybrid-identity.md).
...
![Ayrıntılı parola akış](./media/how-to-connect-password-hash-synchronization/arch3.png)
...
Azure AD Connect yükleme sırasında özel ayarları kullanırsanız, parola karması eşitleme, kullanıcı oturum açma sayfasında kullanılabilir. Daha fazla ayrıntı için [Azure AD Connect özel yüklemesi](how-to-connect-install-custom.md).
