...
![Dağıtım tasarımı](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Sanal ağ oluşturma](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Alt ağ](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)

![Alt ağ DMZ](./media/how-to-connect-fed-azure-adfs/deploynetwork3.png)
...
![NSG oluşturma](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![NSG başlatma](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![NSG yapılandırma](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![NSG’den sonra alt ağlar](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Depolama hesabı oluşturma](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Kullanılabilirlik kümeleri](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Dağıtılmış Sanal Makineler](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Yük dengeleyiciye göz atma](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![İç yük dengeleyici](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)

Oluştur’a tıklayıp ILB’yi dağıttıktan sonra yük dengeleyiciler listesinde ILB’yi görmeniz gerekir:

![ILB’den sonra yük dengeleyiciler](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![ILB arka uç havuzunu yapılandırma](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![ILB araştırmasını yapılandırma](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![ILB dengeleme kurallarını yapılandırma](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![İnternet'e yönelik yük dengeleyici](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Dağıtımdan sonra yük dengeleyici, Yük dengeleyiciler listesinde görünür.

![Yük dengeleyici listesi](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![İnternet'e yönelik yük dengeleyiciyi yapılandırma](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![İnternet'e yönelik yük dengeleyiciyi yapılandırma (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![İnternet’e Yönelik Yük Dengeleyicinin arka uç havuzunu yapılandırma](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![İnternet'e Yönelik Yük Dengeleyici araştırmasını yapılandırma](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![İnternet’e Yönelik Yük Dengeleyicinin dengeleme kurallarını yapılandırma](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![Oturum açma sayfasını test etme](./media/how-to-connect-fed-azure-adfs/test1.png)

Oturum açma başarılı olduğunda aşağıdaki gibi bir başarı iletisi gösterilir:

![Test başarılı](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Azure AD Connect kullanarak AD FS’yi yapılandırma ve yönetme](how-to-connect-fed-whatis.md)
