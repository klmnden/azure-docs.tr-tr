...
Kullanım dışı bırakılmıştır iki kimlik eşitleme Araçları tek orman müşteriler (DirSync) için sunulan ve birden çok orman ile diğer ileri düzey müşterilerin (Azure AD Sync). Bu eski araçların tüm senaryolar için kullanılabilir olan tek bir çözüm ile değiştirilmiş olabilir: Azure AD Connect. Yeni işlevsellik ve özellik geliştirmeleri yeni senaryolar için destek sunar. Şirket içi kimlik verilerinizi Azure AD'ye eşitlemeye devam edebilmek için ve Office 365 önemle tavsiye ederiz Azure AD Connect'e yükseltme. Microsoft, 31 Aralık 2017'den sonra çalışması için bu eski sürümleri garanti etmez.
...
## <a name="faq"></a>SSS
**S: bir e-posta bildirimi Azure ekibi ve/veya Office 365 ileti merkezi gelen iletiyi aldım, ancak Connect kullanarak.**  
...
**S: olacak DirSync/Azure AD eşitleme 13 Nisan 2017'de çalışan işlemi durdurulsun mu?**  
...
**S: hangi DirSync sürümlerinin miyim yükseltebilir miyim?**  
Şu anda kullanılan DirSync sürümünden yükseltmek için desteklenir. 

**S: Azure AD Bağlayıcısı için FIM/MIM?**  
