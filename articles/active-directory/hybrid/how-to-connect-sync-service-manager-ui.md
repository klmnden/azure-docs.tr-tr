---
title: 'Azure AD Connect eşitleme: Eşitleme Hizmeti Yöneticisi kullanıcı Arabirimi | Microsoft Docs'
description: İçin Azure AD Connect Eşitleme Hizmeti Yöneticisi anlayın.
...
![Eşitleme Hizmeti Yöneticisi](./media/how-to-connect-sync-service-manager-ui/ssmui.png)

**Eşitleme Hizmeti Yöneticisi** kullanıcı Arabirimi, eşitleme altyapısı daha gelişmiş özelliklerini yapılandırın ve hizmeti işletimsel yönlerini görmek için kullanılır.
