...
Konuk kullanıcı dizinine eklendikten sonra bilgi çalışanı ya da Konuk kullanıcı doğrudan bir bağlantı için paylaşılan bir uygulama gönderebilir veya Konuk kullanıcı davet e-posta kullanım URL'de tıklatabilirsiniz. Alma işlemi hakkında daha fazla bilgi için bkz: [B2B işbirliği davet kullanım](active-directory-b2b-redemption-experience.md).
