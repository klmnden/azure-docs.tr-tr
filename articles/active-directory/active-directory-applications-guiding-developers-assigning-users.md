...
## <a name="assigning-users-to-an-application"></a>Kullanıcılar için uygulama atama
...
7. Uygulamaya atamak istediğiniz kullanıcıları seçin.
8. Tıklatın **ATAMAK**.
9. Tıklatın **Evet** istendiğinde.
