...
Lisansları yönetirken [Azure portalı](https://portal.azure.com/#blade/Microsoft_AAD_IAM/LicensesMenuBlade/Products) veya Office 365 portalı şunun gibi görünmesi ürün adlarını görmenizi *Office 365 Kurumsal E3*. PowerShell v1.0 cmdlet'leri kullandığınızda, aynı ürünün belirli ama daha kolay bir ad kullanılarak tanımlanır: *ENTERPRISEPACK*. PowerShell v2.0 cmdlet'lerini veya Microsoft Graph kullanırken, aynı ürünün bir GUID değeri kullanılarak tanımlanır: *6fd2c87f-b296-42f0-b197-1e91e994b900*. Aşağıdaki tabloda, en yaygın olarak kullanılan Microsoft çevrimiçi hizmet ürünleri listeler ve çeşitli kimliği değerlerine sağlar:
...
- **Hizmet planları dahil**: dize kimliği ve GUID karşılık gelen hizmet planları üründeki listesi
...
| EXCHANGE SUNUCUSU İÇİN EXCHANGE ONLINE ARŞİVLEME | EXCHANGEARCHIVE   | 90b5e015-709a-4b8b-b08e-3200f994494c  | EXCHANGE_S_ARCHIVE (da040e0a-b393-4bea-bb76-928b3fa1cf5a)
...
| MS AKADEMİ DÜŞÜNÜN    | IT_ACADEMY_AD | ba9a34de-4489-469d-879c-0f0f145321cd  | IT_ACADEMY_AD (d736def0-1fde-43f0-a5be-e3f8b2de6e41)
...
| ONEDRIVE İŞ'İ (PLAN 1)    | WACONEDRIVESTANDARD   | e6778190-713e-4e4f-9119-8b8238de25df  | FORMS_PLAN_E1 (159f4cd6-e380-449f-a816-af1a9ef76344)<br/>ONEDRIVESTANDARD (13696edf-5a08-49f6-8134-03083ed8ba30)<br/>SHAREPOINTWAC (e95bec33-7c88-4a70-8e19-b10bd9d0c014)<br/>SWAY (a23b959c-7ce8-4e57-9140-b90eb88a9e97)
| ONEDRIVE İŞ'İ (PLAN 2)    | WACONEDRIVEENTERPRISE | ed01faf2-1d88-4947-ae91-45ca18703a96  | ONEDRIVEENTERPRISE (afcafa6a-d966-4462-918c-ec0b4e0fe642)<br/>SHAREPOINTWAC (e95bec33-7c88-4a70-8e19-b10bd9d0c014)
| OFFICE 365 EKLENTİSİ İÇİN POWER BI    | POWER_BI_ADDON    | 45bc2c81-6072-436a-9b0b-3b12eefbc402  | BI_AZURE_P1 (2125cfd7-2110-4567-83c4-c1cd5275163d)<br/>SQL_IS_SSIM (fc0a60aa-feee-4746-a0e3-aecfe81a38dd)
...
| İŞ BULUT PBX SKYPE  | MCOEV | e43b5b99-8dfb-405f-9987-dc307f34bcbd  | MCOEV (4828c8ec-dc2e-4779-b502-87ac9ce28ab7)
| SKYPE KURUMSAL ÇEVRİMİÇİ (PLANI İÇİN 1)    | MCOIMP    | b8b749f8-a4ef-4887-9539-c95b1eaa5db7  | MCOIMP (afc06cb0-b4f4-4473-8286-d644f70d8faf)
| SKYPE KURUMSAL ÇEVRİMİÇİ (PLANI İÇİN 2)    | MCOSTANDARD   | d42c793f-6c78-4f43-92ca-e8f6a02b035f  | MCOSTANDARD (0feaeb32-d00e-4d66-bd5a-43b5b83db82c)
| SKYPE FOR BUSINESS PSTN KONFERANS  | MCOMEETADV    | 0c266dff-15dd-4B49-8397-2bb16070ed52  | MCOMEETADV (3e26ee1f-8a5f-4d52-aee2-b81ce45c8f40)
| SKYPE KURUMSAL PSTN YURTİÇİ VE ULUSLARARASI ARAMALAR İÇİN    | MCOPSTN2  | d3b4fe1f-9992-4930-8acb-ca6ec609365e  | MCOPSTN2 (5a10155d-f5c1-411a-a8ec-e99aae125390)
| SKYPE FOR BUSINESS PSTN YURTİÇİ ARAMA  | MCOPSTN1  | 0dab259f-bf13-4952-b7f8-7db8f131b28d  | MCOPSTN1 (4ed3ff63-69d7-4fb7-b984-5aec7f605ca8)
...
## <a name="service-plans-that-cannot-be-assigned-at-the-same-time"></a>Aynı anda atanamaz hizmet planları

Bazı ürünler aynı kullanıcı için aynı anda atanamaz hizmet planları içerir. Örneğin, *Office 365 Kurumsal E1* ve *Office 365 Kurumsal E3* , kiracınızda ve aynı kullanıcı her iki lisansları atamak deneyin, işlemi başarısız olur. E3 ürün E1 dekiler ile çakışan şu hizmet planlarını içerdiğinden bu.
...
Grup tabanlı lisans kullanırken karşılaştığınız [bu hata koşulu](active-directory-licensing-group-problem-resolution-azure-portal.md#conflicting-service-plans). PowerShell kullanırken, gördüğünüz *MutuallyExclusiveViolation* hata.

Bu bölümde, hizmet türüne göre gruplandırılmış birbirini dışlayan en yaygın hizmet planları listelenir. Lisans dağıtımınızı planlama ve atama hataları önlemek için bu bilgileri kullanın.

### <a name="service-azure-active-directory"></a>Hizmet: *Azure Active Directory*

>[!NOTE]
>Azure Active Directory ile ilgili tüm hizmet planları şimdi birlikte, aynı kullanıcıya atanabilir. Bu kullanıcılar için Azure AD Premium P1 Azure AD temel taşıma gibi belirli lisans yönetim senaryolarını kolaylaştırır.
