...
4. Arama kutusuna **Flock**seçin **Flock** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde flock](./media/active-directory-saas-flock-tutorial/tutorial_flock_addfromgallery.png)
...
2. Üzerinde **çoklu oturum açma** iletişim kutusunda **modu** olarak **SAML tabanlı oturum açma** çoklu oturum açmayı etkinleştirmek için.
    ...
    ![Çoklu oturum açma iletişim kutusu](./media/active-directory-saas-flock-tutorial/tutorial_flock_samlbase.png)

3. Üzerinde **Flock etki alanı ve URL'leri** bölümünde, aşağıdaki adımları gerçekleştirin:

    ![Flock etki alanı ve URL'leri tek oturum açma bilgileri](./media/active-directory-saas-flock-tutorial/tutorial_flock_url.png)
...
4. Üzerinde **SAML imzalama sertifikası** 'yi tıklatın **Certificate(Base64)** ve sertifika dosyayı bilgisayarınıza kaydedin.
    ...
    ![Sertifika indirme bağlantısı](./media/active-directory-saas-flock-tutorial/tutorial_flock_certificate.png)

5. Tıklatın **kaydetmek** düğmesi.

    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/active-directory-saas-flock-tutorial/tutorial_general_400.png)
...
6. Üzerinde **Flock yapılandırma** 'yi tıklatın **yapılandırma Flock** açmak için **yapılandırma oturum açma** penceresi. Kopya **SAML varlık kimliği ve SAML çoklu oturum açma hizmet URL'si** gelen **hızlı başvuru bölümü.**
    ...
    ![Flock yapılandırma](./media/active-directory-saas-flock-tutorial/tutorial_flock_configure.png) 
...
8. Seçin **kimlik doğrulaması** sol gezinti panelinden sekmesini ve ardından **SAML kimlik doğrulaması**.
    ...
    ![Flock yapılandırma](./media/active-directory-saas-flock-tutorial/configure1.png)

9. İçinde **SAML kimlik doğrulaması** bölümünde, aşağıdaki adımları gerçekleştirin:

    ![Flock yapılandırma](./media/active-directory-saas-flock-tutorial/configure2.png)
...
1. Sol bölmede, Azure portal'ı tıklatın **Azure Active Directory** düğmesi.
    ...
    ![Azure Active Directory düğmesi](./media/active-directory-saas-flock-tutorial/create_aaduser_01.png)

2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.

    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/active-directory-saas-flock-tutorial/create_aaduser_02.png)

3. Açmak için **kullanıcı** iletişim kutusu, tıklatın **Ekle** en üstündeki **tüm kullanıcılar** iletişim kutusu.

    ![Ekle düğmesi](./media/active-directory-saas-flock-tutorial/create_aaduser_03.png)

4. İçinde **kullanıcı** iletişim kutusunda, aşağıdaki adımları gerçekleştirin:

    ![Kullanıcı iletişim kutusu](./media/active-directory-saas-flock-tutorial/create_aaduser_04.png)
...
2. Tıklatın **yönetmek takım** sol gezinti panelinden.
    ...
    ![Çalışanı ekleyin](./media/active-directory-saas-flock-tutorial/user1.png)

3. Tıklatın **Üye Ekle** sekmesini ve ardından **ekip üyelerinin**.

    ![Çalışanı ekleyin](./media/active-directory-saas-flock-tutorial/user2.png)

4. Bir kullanıcı gibi e-posta adresini girin **Brittasimon@contoso.com** ve ardından **Kullanıcı Ekle**.

    ![Çalışanı ekleyin](./media/active-directory-saas-flock-tutorial/user3.png)
...
2. Uygulamalar listesinde **Flock**.
    ...
    ![Uygulamalar listesinde Flock bağlantı](./media/active-directory-saas-flock-tutorial/tutorial_flock_app.png)
