...
## <a name="im-having-problems-configuring-user-provisioning-to-an-application"></a>Kullanıcı bir uygulama sağlama yapılandırma ilgili sorunlar yaşıyorum
  ...
  * [Yönetici kimlik bilgilerinin Azure Active Directory Galerisi uygulamaya kullanıcı sağlamayı yapılandırılırken kaydedilirken sorun](https://docs.microsoft.com/azure/active-directory/application-provisioning-config-problem-storage-limit/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
