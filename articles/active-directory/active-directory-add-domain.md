...
Kuruluşunuzun iş amaçlı kullandığı bir veya daha fazla etki alanı adı var ve kullanıcılarınız şirket ağınızda sizin şirket etki alanı adınızı kullanarak oturum açıyor. Artık Azure Active Directory'yi (Azure AD) kullandığınıza göre şirket etki alanı adınızı da Azure AD'ye ekleyebilirsiniz. Böylece dizinde kullanıcılarınızın aşina olduğu kullanıcı adları (‘alice@contoso.com.’ gibi) atayabilirsiniz. Bu işlem basittir:
