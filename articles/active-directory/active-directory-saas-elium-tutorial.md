...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    > [!NOTE] 
    > Bu değerler gerçek değildir. Bu değerleri alırsınız **SP meta veri dosyası** adresindeki indirilebilir `https://<platform-domain>.elium.com/login/saml2/metadata`, bu öğreticinin ilerleyen bölümlerinde açıklanmıştır.
