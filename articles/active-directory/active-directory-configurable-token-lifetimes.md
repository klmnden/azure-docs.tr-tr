...
Aşağıdaki örneklerde, oluşturma, güncelleştirme, bağlantı ve uygulamaları, hizmet sorumluları ve kuruluşunuzun genel ilkeleri silin. Azure AD'ye yeni başladıysanız, hakkında bilgi edinin öneririz [bir Azure AD kiracısı edinme](develop/quickstart-create-new-tenant.md) bu örnekleri ile devam etmeden önce.  
