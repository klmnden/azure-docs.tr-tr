...
Öznitelik dizininde bir veya daha fazla nesnelerde yapılandırılmışsa (4. adım) Çözümleme sırasında sihirbazın özniteliği başka bir uygulama tarafından kullanılıyor ve aşağıdaki çizimde gösterildiği gibi bir hata döndürür sonlanır. Öznitelik mevcut uygulamalar tarafından kullanılmadığından eminseniz, hatayı bastırmak hakkında bilgi için desteğe başvurun gerekir.
