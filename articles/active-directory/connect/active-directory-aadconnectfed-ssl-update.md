...
![Üç adım](./media/active-directory-aadconnectfed-ssl-update/threesteps.png)
...
![SSL görevi güncelleştir](./media/active-directory-aadconnectfed-ssl-update/updatessltask.png)
