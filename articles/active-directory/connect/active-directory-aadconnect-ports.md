...
Uç noktalar listesi için bkz. [Azure AD Connect Health aracısı için gereksinimler bölümüne](../connect-health/active-directory-aadconnect-health-agent-install.md#requirements).
