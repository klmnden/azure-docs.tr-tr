...
4. **Cihaz kapsayıcı** sayfasında iki kullanılabilir seçeneklerden birini kullanarak active directory hazırlama bir seçenek sağlar:
    ...
    ![Etkin Dizin ormanı hazırlamak](./media/active-directory-aadconnect-feature-device-writeback/devicecontainercreds.png)
...
2. RegisteredDevices, Federasyon etki alanı içinde genişletin.
   ...
   ![Active Directory Yönetim Merkezi kayıtlı cihazlar](./media/active-directory-aadconnect-feature-device-writeback/devicewriteback5.png)

3. Geçerli kayıtlı cihazlar burada listelenir.

   ![Active Directory Yönetim Merkezi kayıtlı cihazlar listesi](./media/active-directory-aadconnect-feature-device-writeback/devicewriteback6.png)
...
![Sorun giderme, yapılandırma ad alanında DeviceRegistrationService](./media/active-directory-aadconnect-feature-device-writeback/troubleshoot1.png)
...
![Sorun giderme, kapsayıcı üzerindeki izinleri doğrulayın](./media/active-directory-aadconnect-feature-device-writeback/troubleshoot5.png)
