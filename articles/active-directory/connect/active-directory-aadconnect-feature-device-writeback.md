...
2. Active Directory PowerShell Modülü yüklü değilse, uzak sunucu yönetim AD PowerShell modülü ve komut dosyasını çalıştırmak için gerekli olan dsacls.exe içeren araçları yükleyin.  Şu komutu çalıştırın:
...
![Cihaz geri yazma özelliğini etkinleştirmek için Powershell](./media/active-directory-aadconnect-feature-device-writeback/powershell.png) d
