...
Başlangıç [Eşitleme Hizmeti Yöneticisi](active-directory-aadconnectsync-service-manager-ui.md) adımları başlamadan önce.
...
Üst kısmında kronolojik sırayla tüm çalıştırmalar gösterir. Varsayılan olarak, son yedi gün saklar bilgilerini işlemleri günlüğe, ancak bu ayar değiştirilebilir [Zamanlayıcı](active-directory-aadconnectsync-feature-scheduler.md). Başarı durumunu göstermez her çalıştırma için görünmesini istediğiniz. Başlıklarını tıklatarak sıralama değiştirebilirsiniz.
...
Nesne bulamazsanız, aradığınız ve ardından onu ile filtre uygulanmış [etki alanı tabanlı filtreleme](active-directory-aadconnectsync-configure-filtering.md#domain-based-filtering) veya [OU tabanlı filtreleme](active-directory-aadconnectsync-configure-filtering.md#organizational-unitbased-filtering). Okuma [süzme](active-directory-aadconnectsync-configure-filtering.md) filtreleme beklendiği gibi yapılandırıldığını doğrulamak için konu.
...
![CS kökenini](./media/active-directory-aadconnectsync-troubleshoot-object-not-syncing/cslineage.png)  
...
### <a name="log"></a>Günlük
Parola Eşitleme durumunu ve geçmişini görmek için günlüğü sayfasında kullanılır. Daha fazla bilgi için [parola karması eşitleme sorunlarını giderme](active-directory-aadconnectsync-troubleshoot-password-hash-synchronization.md).
...
İçinde **Eşitleme Hizmeti Yöneticisi**, tıklayın **meta veri deposu arama**. Kullanıcı bulur bildiğiniz bir sorgu oluşturun. AccountName (sAMAccountName) ve userPrincipalName gibi ortak öznitelikleri için arama yapabilirsiniz. Daha fazla bilgi için [meta veri deposu arama](active-directory-aadconnectsync-service-manager-ui-mvsearch.md).
...
- Öznitelik **cloudFiltered** sunmak ve kümesine **true**? Bunun ardından adımlarda göre uygulanmış [öznitelik tabanlı filtreleme](active-directory-aadconnectsync-configure-filtering.md#attribute-based-filtering).
