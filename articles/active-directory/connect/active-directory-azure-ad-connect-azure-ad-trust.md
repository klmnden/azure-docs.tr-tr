...
![Mevcut Azure AD güven yedekleme hakkında daha fazla Azure AD Connect sayfası gösterme iletisi](media/active-directory-azure-ad-connect-azure-ad-trust/backup2.png)
...
![Örneğin bir sanpshot Azure AD güvenini yedekleme](media/active-directory-azure-ad-connect-azure-ad-trust/backup.png)
...
* [Azure AD Connect kullanarak Active Directory Federasyon Hizmetleri özelleştirme ve yönetme](active-directory-aadconnect-federation-management.md)