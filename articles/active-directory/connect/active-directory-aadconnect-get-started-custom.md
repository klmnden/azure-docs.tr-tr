...
### <a name="user-signin"></a>Kullanıcı oturumu açma
...
### <a name="azure-ad-signin-configuration"></a>Azure AD oturum açma yapılandırması
...
### <a name="ad-fs-configuration-prerequisites"></a>AD FS yapılandırması önkoşulları
