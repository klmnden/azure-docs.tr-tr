...
5.  İstendiğinde Azure AD Kiracı Kimliğinizi girin ve **İleri**'ye tıklayın.
    ...
    > [!TIP] 
    > Office 365/Azure AD kiracınızın kimliğini hızlıca bulmak için Azure AD Portalında oturum açın, dizine gidin ve şu URL'deki kimliği kopyalayın: https://manage.windowsazure.com/woodgroveonline.com#Workspaces/ActiveDirectoryExtension/Directory/<tenantid>/directoryQuickStart
