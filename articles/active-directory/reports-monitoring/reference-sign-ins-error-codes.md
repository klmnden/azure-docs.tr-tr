...
Oturum açma verilerine erişmek için Azure portalını kullanmaya alternatif olarak [raporlama API'sini](concept-reporting-api.md) de kullanabilirsiniz.
...
Daha fazla bilgi için bkz. [Azure Active Directory portalındaki oturum açma etkinlik raporları](concept-sign-ins.md).
