...
4. Arama kutusuna **Zendesk**.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk6.png)

5. Sonuçlar panelinde seçin **Zendesk**ve ardından **Ekle** Zendesk SaaS uygulamaları listenize eklemek için düğmeyi.

    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk7.png)

    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk20.png)
...
> [!TIP]
> Ayrıca aktarmızı SAML tabanlı çoklu oturum açma için Zendesk etkinleştirmek, yönergeleri izleyerek sağlanan [oturum açma Zendesk tek Öğreticisi](active-directory-saas-zendesk-tutorial.md). Bu iki özellik birbirine tamamlayıcı rağmen otomatik kullanıcı sağlamayı bağımsız olarak, çoklu oturum açma yapılandırılabilir.
...
2. Zendesk SaaS uygulamaları listesinden seçin.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk3.png)

3. Seçin **sağlama** sekmesi.
    
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk16.png)
...
6. **Gizli belirteci** hesabının bulunduğu için Zendesk **yönetici > API > ayarlarını**. 
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk4.png) ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk2.png)
...
7. Adım 5'te gösterilen alanları doldurma sırasında tıklatın **Bağlantıyı Sına** Azure emin olmak için AD için Zendesk bağlanabilir. Bağlantı başarısız olursa, Zendesk hesabınıza yönetici izinlerine sahip olduğundan emin olun ve yeniden deneyin.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk19.png)
...
8. İçinde **bildirim e-posta** alan, bir kişi veya grubun ve sağlama hata bildirimleri almak - onay e-posta adresini girin **birhataoluşursa,bire-postabildirimigönder**.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk9.png)

9. **Kaydet**’e tıklayın.

10. Altında **eşlemeleri** bölümünde, select **eşitleme Azure Active Directory Kullanıcıları Zendesk**.

    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk10.png)
...
11. Azure AD içinde Zendesk eşitlenir kullanıcı öznitelikleri gözden **eşleme özniteliği** bölümü. Seçilen öznitelikler **eşleşen** özellikleri Zendesk kullanıcı hesaplarında güncelleştirme işlemleri için eşleştirmek için kullanılır. Seçin **kaydetmek** düğmesi değişiklikleri uygulayın.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk11.png)

12. Altında **eşlemeleri** bölümünde, select **eşitleme Azure Active Directory gruplarına ZenDesk**.

    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk12.png)
...
13. Azure AD içinde Zendesk eşitlenir grup öznitelikleri gözden **eşleme özniteliği** bölümü. Seçilen öznitelikler **eşleşen** özellikleri Zendesk gruplara güncelleştirme işlemleri için eşleştirmek için kullanılır. Seçin **kaydetmek** düğmesi değişiklikleri uygulayın.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk13.png)
...
15. Zendesk hizmet sağlama Azure AD etkinleştirmek için değiştirmek **sağlama durumu** için **üzerinde** içinde **ayarları** bölümü.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk14.png)
...
16. Kullanıcılara ve/veya istediğiniz grupları Zendesk sağlamak için istenen değerleri seçerek tanımlamak **kapsam** içinde **ayarları** bölümü.
    ...
    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk15.png)

17. Sağlamak için hazır olduğunuzda tıklatın **kaydetmek**.

    ![Zendesk sağlama](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk18.png)
