---
title: VPN ağ ilkesi sunucusu uzantısı kullanılarak Azure MFA ile tümleştirin. | Microsoft Docs
...
13. İçinde **Tamamlanıyor yeni çevirmeli ya da sanal özel ağ bağlantıları ve RADIUS istemcileri** penceresinde **son**.
    ...
    !["Tamamlama yeni çevirmeli ya da sanal özel ağ bağlantıları ve RADIUS istemcileri" penceresi](./media/howto-mfa-nps-extension-vpn/image10.png)
...
![Hesabı doğrula](./media/howto-mfa-nps-extension-vpn/image43.png)
...
Başarılı oturum açma olaylarını Windows Olay Görüntüleyicisi günlükleri görüntülemek için sorgu Windows Güvenlik oturum NPS sunucusunda aşağıdaki PowerShell komutunu girerek:
...
![Ağ İlkesi Sunucusu günlüğü](./media/howto-mfa-nps-extension-vpn/image45.png)
...
![Olay Görüntüleyicisi "Olay sayısı" bölmesi](./media/howto-mfa-nps-extension-vpn/image46.png)
...
![Microsoft ileti Çözümleyicisi](./media/howto-mfa-nps-extension-vpn/image50.png)
