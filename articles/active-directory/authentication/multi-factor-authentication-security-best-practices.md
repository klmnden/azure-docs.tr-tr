---
title: MFA için Güvenlik Kılavuzu | Microsoft Docs
...
* [İki aşamalı doğrulama kayıt deneyimi](../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-first-time.md)
