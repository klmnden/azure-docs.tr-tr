...
* **Destekler parola sıfırlamaları kullanan kullanıcılar için** [parola karması eşitlemesi](./../connect/active-directory-aadconnectsync-implement-password-hash-synchronization.md): parola sıfırlama hizmeti eşitlenmiş kullanıcı hesabının parola karma eşitlemesi için etkin olduğunu algıladığında, biz hem bu sıfırlama hesabın şirket içi ve bulut parola aynı anda. Parola geri yazma özelliğini parola karma eşitlemesini bağlı değildir.
...
Lisanslama hakkında daha fazla bilgi için bkz: [lisansları parola geri yazma için gereken](concept-sspr-licensing.md) veya aşağıdaki siteleri:
...
[Writeback]: ./media/howto-sspr-writeback/enablepasswordwriteback.png "Azure AD CONNECT'te parola geri yazma etkinleştir"
