...
Lisanslama hakkında daha fazla bilgi için bkz: [lisansları parola geri yazma için gereken](concept-sspr-licensing.md#licenses-required-for-password-writeback) veya aşağıdaki siteleri:
