...
description: Çok faktörlü kimlik doğrulaması istemci farklı yöntemler ve kullanılabilir sürümlerini hakkında bilgiler.
...
> [!NOTE]
> Bu karşılaştırma tablosu, çok faktörlü kimlik doğrulaması her sürümü parçası olan özellikler açıklanmaktadır. Tam Azure çok faktörlü kimlik doğrulama hizmeti varsa, bazı özellikler bağlı olarak kullanıp kullanılamayabilir [bulutta MFA veya MFA şirket içi](concept-mfa-whichversion.md).
