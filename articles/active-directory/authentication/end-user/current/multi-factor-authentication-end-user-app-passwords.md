...
- Denemenin [Microsoft Authenticator uygulaması](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) oturum açma işlemleri metinleri veya aramaları almasını yerine uygulama bildirimleri ile doğrulayın.
