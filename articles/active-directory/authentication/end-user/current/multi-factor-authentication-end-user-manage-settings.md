---
title: İki aşamalı doğrulama ayarları - Azure AD yönetme | Microsoft Docs
...
**Ek güvenlik doğrulama sayfasına git**

- https://aka.ms/MFASetup kısmına gidin.

    ![Proofup](./media/multi-factor-authentication-end-user-manage-settings/proofup.png)

Bu bağlantıyı tıklatarak sizin için işe yaramazsa, ayrıca için alabilirsiniz **ek güvenlik doğrulaması** aşağıdaki adımları izleyerek sayfa:
...
1. Üzerinde **ek güvenlik doğrulaması** sayfasında, geçerli telefon numaranızı metin kutusunu seçin ve yeni telefon numaranızı ile düzenleyin.  
2. **Kaydet**’i seçin.  
3. Bu telefon numarası için tercih edilen doğrulama seçeneğini kullanın sayı ise, kaydedebilmek için öncelikle yeni numarasını doğrulamanız gerekir.  
