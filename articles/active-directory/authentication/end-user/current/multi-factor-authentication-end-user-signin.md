...
İçin öğrenin [Microsoft Authenticator uygulaması ile çalışmaya başlama](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) böylece bildirimleri, telefon aramaları ve metinler yerine imzalamak için kullanabilirsiniz.
