---
title: Cep telefonları - Azure AD için Microsoft Authenticator uygulaması | Microsoft Docs
...
2. Yanındaki kutuyu işaretleyin **Doğrulayıcı uygulama** seçip **yapılandırma**.
    ...
    ![QR kodu sağlar ekranı](./media/microsoft-authenticator-app-how-to/barcode2.png)
...
5. Uygulama hesap adınızı ile bunun altındaki altı rakamlı bir kod gösterdiğinde bitirdiniz.
    ...
    ![Hesapları ekranı](./media/microsoft-authenticator-app-how-to/accounts.png)
...
2. Seçin **yapılandırma**.
    ...
    ![QR kodu ve URL sağlayan ekran](./media/microsoft-authenticator-app-how-to/barcode2.png)
3. Microsoft Kimlik Doğrulayıcı uygulamasını açın. Üzerinde **hesapları** ekran, select **+** ve ardından iş veya Okul hesabı eklemek istediğinizi belirtin.

4. Tarayıcıda seçin **kodu el ile girmeniz**.

    ![QR kodu taraması için ekran](./media/microsoft-authenticator-app-how-to/scan2.png)
5. Uygun kutulara uygulama kodu ve URL'yi girin ve ardından **son**.

    ![Kod ve URL girme ekran](./media/microsoft-authenticator-app-how-to/manual.png)
...
![Touch ID kurulumunun doğrulama](./media/microsoft-authenticator-app-how-to/touchid1.png)
