...
2. Git **şirket yönetmek**.
    ...
    ![Şirket yönetmek](./media/active-directory-saas-15five-tutorial/IC784675.png "şirket yönetme")

3. Git **kişiler \> kişileri ekleyin**.
   
    ![Kişiler](./media/active-directory-saas-15five-tutorial/IC784676.png "kişiler")

4. Yeni bir kişiye eklemek bölümünde, aşağıdaki adımları gerçekleştirin:
   
    ![Yeni bir kişiye eklemek](./media/active-directory-saas-15five-tutorial/IC784677.png "yeni bir kişiye ekleme")
