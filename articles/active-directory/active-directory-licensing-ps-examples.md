...
* [Azure Active Directory'deki bir gruba lisans atama](users-groups-roles/licensing-groups-assign.md)
* [Azure Active Directory'de bir grup için lisans sorunlarını belirleme ve çözme](users-groups-roles/licensing-groups-resolve-problems.md)
* [Azure Active Directory'de Grup tabanlı lisanslama için tek tek lisanslı kullanıcıları geçirme](users-groups-roles/licensing-groups-migrate-users.md)
* [Azure Active Directory grup tabanlı lisanslama ek senaryoları](users-groups-roles/licensing-group-advanced.md)
