---
title: Self Servis veya deneme kaydı - Azure Active Directory aracılığıyla kullanıcılar ekleyin | Microsoft Docs
...
* Henüz yoksa bir davet etmek için farklı bir dizinden B2B işbirliği kullandığınız (userdoesnotexist@contoso.com) constoso.com giriş dizininde
...
![Self Servis kaydolma denetimleri](./media/directory-self-service-signup/SelfServiceSignUpControls.png)
