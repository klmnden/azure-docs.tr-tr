...
4. Arama kutusuna **Vidyard**seçin **Vidyard** sonuç panelinden ardından **Ekle** uygulama eklemek için düğmeyi.
    ...
    ![Sonuçlar listesinde Vidyard](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_addfromgallery.png)
...
2. Üzerinde **çoklu oturum açma** iletişim kutusunda **modu** olarak **SAML tabanlı oturum açma** çoklu oturum açmayı etkinleştirmek için.
    ...
    ![Çoklu oturum açma iletişim kutusu](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_samlbase.png)
...
3. Üzerinde **Vidyard etki alanı ve URL'leri** bölümünde, uygulamada yapılandırmak istiyorsanız aşağıdaki adımları gerçekleştirin **IDP** modu tarafından başlatılan:
    ...
    ![Vidyard etki alanı ve URL'leri tek oturum açma bilgileri](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_url2.png)
...
4. Denetleme **Göster Gelişmiş URL ayarları** ve uygulamada yapılandırmak istiyorsanız aşağıdaki adımı gerçekleştirin **SP** modunda başlatılan:
    ...
    ![Vidyard etki alanı ve URL'leri tek oturum açma bilgileri](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_url1.png)
...
1. Üzerinde **SAML imzalama sertifikası** 'yi tıklatın **Certificate(Base64)** ve sertifika dosyayı bilgisayarınıza kaydedin.
    ...
    ![Sertifika indirme bağlantısı](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_certificate.png) 

6. Tıklatın **kaydetmek** düğmesi.

    ![Oturum açma tek Kaydet düğmesi yapılandırın](./media/active-directory-saas-vidyard-tutorial/tutorial_general_400.png)
...
7. Üzerinde **Vidyard yapılandırma** 'yi tıklatın **yapılandırma Vidyard** açmak için **yapılandırma oturum açma** penceresi. Kopya **SAML çoklu oturum açma hizmet URL'si** gelen **hızlı başvuru bölümü.**
    ...
    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_configure.png)
...
9. Vidyard panodan seçin **grup** > **güvenlik**
    ...
    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure1.png)

1. Tıklatın **yeni bir profil** sekmesi.

    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure2.png)

11. İçinde **SAML Yapılandırması** bölümünde, aşağıdaki adımları gerçekleştirin:

    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure3.png)
...
12. Çoklu oturum açma sekmesinden seçin **atamak** bir profil yanındaki
    ...
    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure4.png)
...
13. Görünür kuruluş grubunuzu seçin **bölgeyle atanacak**.
    ...
    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure5.png)

14. Atanan gruplar altında görebilirsiniz **şu anda atanmış grup**. Kuruluş ve tıklatın göredir grup için bir rol seçin **Onayla**.

    ![Vidyard yapılandırma](./media/active-directory-saas-vidyard-tutorial/configure6.png)
...
1. Sol bölmede, Azure portal'ı tıklatın **Azure Active Directory** düğmesi.
    ...
    ![Azure Active Directory düğmesi](./media/active-directory-saas-vidyard-tutorial/create_aaduser_01.png)

2. Kullanıcıların listesini görüntülemek için şu adrese gidin **kullanıcılar ve gruplar**ve ardından **tüm kullanıcılar**.

    !["Kullanıcılar ve Gruplar" ve "Tüm kullanıcılar" bağlantılar](./media/active-directory-saas-vidyard-tutorial/create_aaduser_02.png)

3. Açmak için **kullanıcı** iletişim kutusu, tıklatın **Ekle** en üstündeki **tüm kullanıcılar** iletişim kutusu.

    ![Ekle düğmesi](./media/active-directory-saas-vidyard-tutorial/create_aaduser_03.png)

4. İçinde **kullanıcı** iletişim kutusunda, aşağıdaki adımları gerçekleştirin:

    ![Kullanıcı iletişim kutusu](./media/active-directory-saas-vidyard-tutorial/create_aaduser_04.png)
...
2. Uygulamalar listesinde **Vidyard**.
    ...
    ![Uygulamalar listesinde Vidyard bağlantı](./media/active-directory-saas-vidyard-tutorial/tutorial_vidyard_app.png)  
