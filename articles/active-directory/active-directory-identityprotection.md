...
Azure Active Directory kimlik koruması yapılandırmanızı analiz eder ve kullanıcılarınızın kimliklerini üzerinde bir etkisi olan güvenlik açıklarını algılar. Daha fazla ayrıntı için [Azure Active Directory kimlik koruması tarafından algılanan güvenlik açıklarını](active-directory-identityprotection-vulnerabilities.md).
...
Araştırma etkinliklerinizi bağlayabilirsiniz [bildirimleri](active-directory-identityprotection-notifications.md) Azure Active Directory koruması e-posta gönderir.
...
* [Riskli oturum açma kurtarma](active-directory-identityprotection-flows.md#risky-sign-in-recovery)
* [Riskli engellenen oturum açma](active-directory-identityprotection-flows.md#risky-sign-in-blocked)  
* [Azure AD kimlik koruması ile oturum açma deneyimleri](active-directory-identityprotection-flows.md)  
...
* [Engellenen hesap akış tehlikeye](active-directory-identityprotection-flows.md#compromised-account-blocked).  
...
* [Çok faktörlü kimlik doğrulaması kayıt akışını](active-directory-identityprotection-flows.md#multi-factor-authentication-registration).  
...
* [Azure Active Directory kimlik Koruması'nı etkinleştirme](active-directory-identityprotection-enable.md)

* [Azure Active Directory kimlik koruması tarafından algılanan güvenlik açıklarını](active-directory-identityprotection-vulnerabilities.md)
...
* [Azure Active Directory kimlik koruması - kullanıcı engellemesini kaldırma](active-directory-identityprotection-unblock-howto.md)

* [Microsoft Graph ve Azure Active Directory kimlik koruması ile çalışmaya başlama](active-directory-identityprotection-graph-getting-started.md)
