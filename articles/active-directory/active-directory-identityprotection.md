...
Azure Active Directory kimlik koruması yapılandırmanızı analiz eder ve kullanıcılarınızın kimliklerini üzerinde bir etkisi olan güvenlik açıklarını algılar. Daha fazla ayrıntı için [Azure Active Directory kimlik koruması tarafından algılanan güvenlik açıklarını](identity-protection/vulnerabilities.md).
...
Araştırma etkinliklerinizi bağlayabilirsiniz [bildirimleri](identity-protection/notifications.md) Azure Active Directory koruması e-posta gönderir.
...
![Oturum açma riski İlkesi](./media/active-directory-identityprotection/1014.png "oturum açma riski İlkesi")
...
* Kullanıcıları ve grupları ilkenin uygulanacağı ayarlayın:
    ...
    ![Oturum açma riski İlkesi](./media/active-directory-identityprotection/1015.png "oturum açma riski İlkesi")
* İlke tetikleyen oturum açma riski düzeyi eşiği (düşük, Orta veya yüksek) ayarlayın:

    ![Oturum açma riski İlkesi](./media/active-directory-identityprotection/1016.png "oturum açma riski İlkesi")
* İlke tetiklendiğinde zorlanacak denetimleri ayarlayın:  

    ![Oturum açma riski İlkesi](./media/active-directory-identityprotection/1017.png "oturum açma riski İlkesi")
* İlke durumu anahtarı:

    ![MFA kaydı](./media/active-directory-identityprotection/403.png "MFA kaydı")
* Gözden geçirin ve bunu etkinleştirdikten önce bir değişikliğin etkisini değerlendirin:

    ![Oturum açma riski İlkesi](./media/active-directory-identityprotection/1018.png "oturum açma riski İlkesi")
...
* [Riskli oturum açma kurtarma](identity-protection/flows.md#risky-sign-in-recovery)
* [Riskli engellenen oturum açma](identity-protection/flows.md#risky-sign-in-blocked)  
* [Azure AD kimlik koruması ile oturum açma deneyimleri](identity-protection/flows.md)  
...
- Üzerinde **Azure AD kimlik koruması** dikey penceresindeki **yapılandırma** bölümünde **oturum açma riski İlkesi**.
    ...
    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1014.png "kullanıcı riski İlkesi")



## <a name="users-flagged-for-risk"></a>Riskli oldukları belirlenen kullanıcılar

Tüm etkin [risk olayları](active-directory-identity-protection-risk-events.md) , algılandı Azure Active Directory tarafından katkıda bulunan bir kullanıcı için mantıksal bir kavramken kullanıcı riski çağrılır. Riskli olduğu belirlenen bir kullanıcı gizliliği bozulmuş olabilecek bir kullanıcı hesabının göstergesidir.
...
![Kullanıcı risk](./media/active-directory-identityprotection/1031.png "kullanıcı risk")
...
![Eylemler](./media/active-directory-identityprotection/34.png "eylemleri")
...
![Eylemler](./media/active-directory-identityprotection/2222.png "eylemleri")
...
![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1009.png "kullanıcı riski İlkesi")
...
* Kullanıcıları ve grupları ilkenin uygulanacağı ayarlayın:
    ...
    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1010.png "kullanıcı riski İlkesi")
* İlke tetikleyen kullanıcı risk düzeyi eşiği (düşük, Orta veya yüksek) ayarlayın:

    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1011.png "kullanıcı riski İlkesi")
* İlke tetiklendiğinde zorlanacak denetimleri ayarlayın:

    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1012.png "kullanıcı riski İlkesi")
* İlke durumu anahtarı:

    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/403.png "MFA kaydı")
* Gözden geçirin ve bunu etkinleştirdikten önce bir değişikliğin etkisini değerlendirin:

    ![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1013.png "kullanıcı riski İlkesi")
...
* [Hesap kurtarma akışı tehlikeye](identity-protection/flows.md#compromised-account-recovery).  
* [Engellenen hesap akış tehlikeye](identity-protection/flows.md#compromised-account-blocked).  
...
![Kullanıcı riski İlkesi](./media/active-directory-identityprotection/1019.png "kullanıcı riski İlkesi")
...
* [Çok faktörlü kimlik doğrulaması kayıt akışını](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Azure AD kimlik koruması ile karşılaştığında oturum açma](identity-protection/flows.md).  
...
* [Azure Active Directory kimlik Koruması'nı etkinleştirme](identity-protection/enable.md)

* [Azure Active Directory kimlik koruması tarafından algılanan güvenlik açıklarını](identity-protection/vulnerabilities.md)

* [Azure Active Directory risk olayları](active-directory-identity-protection-risk-events.md)

* [Azure Active Directory kimlik koruması bildirimleri](identity-protection/notifications.md)

* [Azure Active Directory kimlik koruması Kılavuzu](identity-protection/playbook.md)

* [Azure Active Directory kimlik koruması Kılavuzu sözlüğü](identity-protection/glossary.md)

* [Azure AD kimlik koruması ile oturum açma deneyimleri](identity-protection/flows.md)

* [Azure Active Directory kimlik koruması - kullanıcı engellemesini kaldırma](identity-protection/howto-unblock-user.md)

* [Microsoft Graph ve Azure Active Directory kimlik koruması ile çalışmaya başlama](identity-protection/graph-get-started.md)
