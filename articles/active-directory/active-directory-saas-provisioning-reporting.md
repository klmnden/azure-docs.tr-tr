...
* Son eşitleme çalıştırıldı. Eşitlemeler düğümlerin her 20-40 dakika sonra bir [ilk eşitleme](active-directory-saas-app-provisioning.md#what-happens-during-provisioning) tamamlandı.

* Olup olmadığı bir [ilk eşitleme](active-directory-saas-app-provisioning.md#what-happens-during-provisioning) tamamlandı
