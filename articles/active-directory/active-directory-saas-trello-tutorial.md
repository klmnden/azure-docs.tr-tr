...
3. **[Trello test kullanıcısı oluşturma](#creating-a-trello-test-user)**  - Britta Simon, karşılık gelen kullanıcı Azure AD gösterimini bağlı Trello sağlamak için.
...
6. Üzerinde **Trello yapılandırma** 'yi tıklatın **yapılandırma Trello** açmak için **yapılandırma oturum açma** penceresi. Kopya **SAML çoklu oturum açma hizmet URL'si** gelen **hızlı başvuru bölümü.**

    ![Çoklu oturum açmayı yapılandırın](./media/active-directory-saas-trello-tutorial/tutorial_trello_configure.png) 

9. Uygulamanız için yapılandırılmış SSO almak için şu adrese gidin [Trello Kurumsal SSO yapılandırma](https://trello.com/sso-configuration) göndermek için sayfadaki [Trello destek ekibi](mailto:support@trello.com) **SAML çoklu oturum açma hizmet URL'si** ve attach **sertifika (Base64)**.
...
Bu bölümde, Trello içinde Britta Simon adlı bir kullanıcı oluşturun. Bu bölümde, Trello içinde Britta Simon adlı bir kullanıcı oluşturun. İlk Azure AD'den oturum açtığınızda yeni bir hesap oluşturulur ve Trello yalnızca zaman sağlama destekler.
