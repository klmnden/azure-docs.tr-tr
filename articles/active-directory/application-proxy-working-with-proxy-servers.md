...
3. Seçin **Başlat yerel izleme**.
   ...
   ![Ağ Yakalama Başlat](./media/application-proxy-working-with-proxy-servers/start-local-trace.png)

3. Azure AD uygulama ara sunucusu Bağlayıcısı hizmetini başlatın.
4. Ağ yakalama işlemini durdurun.

   ![Ağ yakalama işlemini durdurun](./media/application-proxy-working-with-proxy-servers/stop-trace.png)
