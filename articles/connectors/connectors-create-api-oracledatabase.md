...
[Mantıksal uygulama oluşturma](../logic-apps/logic-apps-create-a-logic-app.md)ve Logic Apps içinde kullanılabilir bağlayıcılar keşfetme bizim [API'leri listesi](apis-list.md).
