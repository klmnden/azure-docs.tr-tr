...
S3 RUs için gerekli olan **VideoAnalyzerPreset** ve **AudioAnalyzerPreset** V3 hazır.
...
V3 üzerinde oluşturulan yönetimi ve işlemleri işlevselliği kullanıma sunan bir birleşik API yüzeyi temel **Azure Resource Manager**. İle uyumlu olarak **Azure Resource Manager**, kaynak adları her zaman benzersizdir. Bu nedenle, herhangi bir benzersiz tanımlayıcısı dizesi (örneğin, GUID'ler), kaynak adları için kullanabilirsiniz. 
