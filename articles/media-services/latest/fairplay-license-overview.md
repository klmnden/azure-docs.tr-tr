---
title: Azure Media Services ve Apple FairPlay lisansı desteği | Microsoft Docs
description: Bu konu, gereksinimler Apple FairPlay lisansı genel bir bakış sağlar ve yapılandırma.
author: juliako
manager: cfowler
editor: ''
