...
description: Bu konuda Azure Media Services akış uç noktası (Orgin) hizmetinden alabileceğiniz hataları açıklanır.
author: Juliako
manager: femila
editor: ''
...
Bu konuda, Azure Media Services'den alabilirsiniz hataları açıklanır [akış uç noktası hizmetinize](streaming-endpoint-concept.md).
