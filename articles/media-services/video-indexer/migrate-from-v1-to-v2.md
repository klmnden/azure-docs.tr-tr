---
title: Azure Video Indexer API v1'den v2'ye geçirme
...
İşleri kolaylaştırmak için kullanabileceğiniz **yetkilendirme** API > **GetAccounts** hesaplarınızı kullanıcı sağlanmadan önce belirteci alma işlemi. Ayrıca, hesapları geçerli belirteçlerle almayı da isteyebilirsiniz. Böylece hesap belirteci almak için yapılacak ek bir çağrıyı atlayabilirsiniz.
...
|---|---|---|
|Deneme|trial|Deneme hesapları için kullanılır. Örneğin: https://api.videoindexer.ai/trial/Accounts/{accountId}/Videos/{videoId}/Index?language=English.|
|Batı ABD|westus2|Azure Batı ABD 2 bölgesi için kullanılır.  Örneğin: https://api.videoindexer.ai/westus2/Accounts/{accountId}/Videos/{videoId}/Index?language=English.|
|Kuzey Avrupa |northeurope|Azure Kuzey Avrupa bölgesi için kullanılır. Örneğin:  https://api.videoindexer.ai/northeurope/Accounts/{accountId}/Videos/{videoId}/Index?language=English. |
|Doğu Asya|eastasia|Azure Doğu Asya bölgesi için kullanılır. Örneğin:  https://api.videoindexer.ai/eastasia/Accounts/{accountId}/Videos/{videoId}/Index?language=English.|
...
Video Indexer API tanımlarını buna uygun olarak güncelleştirildi ve aracılığıyla indirilebilir [Video Indexer Geliştirici Portalı](https://api-portal.videoindexer.ai/docs/services/authorization/operations/Get-Account-Access-Token).
