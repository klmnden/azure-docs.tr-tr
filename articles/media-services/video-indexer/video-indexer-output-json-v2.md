...
![İçgörüler](./media/video-indexer-output-json/video-indexer-summarized-insights.png)
...
|kimlik|Çalma listesi'nın kimliği.|
...
|kimlik|Video kimliği. Örneğin, 63c6d532ff.|
