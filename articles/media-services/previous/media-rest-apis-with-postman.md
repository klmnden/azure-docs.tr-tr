...
ms.locfileid: "55981069"
---
# <a name="configure-postman-for-media-services-rest-api-calls-legacy"></a>Media Services REST API çağrıları (eski) için Postman'ı yapılandırma
