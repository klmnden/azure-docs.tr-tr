...
ms.locfileid: "55984231"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>.NET (eski) kullanarak bir Media Services hesabına dosya yükleme
