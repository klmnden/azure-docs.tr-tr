...
ms.locfileid: "56003643"
---
# <a name="dynamic-encryption-configure-a-content-key-authorization-policy-legacy"></a>Dinamik şifreleme: (Eski) bir içerik anahtarı yetkilendirme ilkesini yapılandırma
