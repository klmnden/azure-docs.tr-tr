<properties 
    pageTitle="Azure portalı ile çoklu bit hızına sahip akışlar oluşturmak üzere Azure Media Services’i kullanarak canlı akış gerçekleştirme | Microsoft Azure" 
...
3. Bir olay/program oluşturun (ayrıca bir varlık oluşturur). 
...
1.  Bir olay/program (ve bir varlık) oluşturma
