...
Rol tanımı tanımlayıcısı tarafından belirtilen tek bir rol bilgilerini alır. Görünen adını kullanarak tek bir rol hakkında bilgi almak için bkz: [tüm rolleri listesinde](role-assignments-rest.md#list-all-roles).
