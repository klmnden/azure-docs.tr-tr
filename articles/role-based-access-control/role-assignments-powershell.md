...
![RBAC PowerShell-Get AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition belirli bir rol için - ekran görüntüsü](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![RBAC PowerShell - Get-AzureRmRoleAssignment bir kaynak grubu için - ekran görüntüsü](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![RBAC PowerShell - Get-AzureRmRoleAssignment bir kullanıcı için - ekran görüntüsü](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![RBAC PowerShell - AzureRmRoleAssignment yeni - ekran görüntüsü](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![RBAC PowerShell - AzureRmRoleAssignment yeni - ekran görüntüsü](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![RBAC PowerShell - AzureRmRoleAssignment yeni - ekran görüntüsü](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
Özel bir rol oluşturmak için PowerShell kullandığınızda baştan başlayın veya birini kullanın [yerleşik roller](built-in-roles.md) bir başlangıç noktası olarak. Bu bölümdeki örnek yerleşik bir rol ile başlar ve daha fazla ayrıcalıklarla özelleştirir. Eklemek için öznitelikleri düzenlemenize *Eylemler*, *notActions*, veya *kapsamları* ve yeni bir rol olarak değişiklikleri kaydedin.
...
![RBAC PowerShell-Get AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![RBAC PowerShell - Set-AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![RBAC PowerShell - Set-AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![RBAC PowerShell - Remove-AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![RBAC PowerShell-Get AzureRmRoleDefinition - ekran görüntüsü](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)

## <a name="see-also"></a>Ayrıca bkz.
* [Azure Resource Manager ile Azure PowerShell'i kullanma](../azure-resource-manager/powershell-azure-resource-manager.md)
