...
> | | |
> | --- | --- |
> | **Açıklama** | Depolama hesaplarının yönetimini izin verir. Paylaşılan anahtar yetkilendirme aracılığıyla verilere erişmek için kullanılan hesap anahtarı erişim sağlar. |
