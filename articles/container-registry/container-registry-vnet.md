...
Tüm Azure kaynaklarını aynı kaynak grubunda ve artık ihtiyacınız oluşturduysanız, isteğe bağlı olarak kaynakları tek bir kullanarak silebilirsiniz [az grubu Sil](/cli/azure/group#az_group_delete) komutu:
