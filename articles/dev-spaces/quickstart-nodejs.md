...
ms.locfileid: "57761336"
---
# <a name="quickstart-create-a-kubernetes-dev-space-with-azure-dev-spaces-nodejs"></a>Hızlı Başlangıç: Azure geliştirme alanları (Node.js) ile Kubernetes geliştirme alanı oluşturma
