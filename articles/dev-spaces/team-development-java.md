---
title: Java ve VS Code kullanarak Azure Dev Spaces ile ekip geliştirmesi | Microsoft Docs
...
Şimdi nasıl çalıştığını görelim. `mywebapi` için VS Code penceresine gidin ve `String index()` yönteminde bir kod düzenlemesi yapın; örneğin:
