...
|----------------------|---------------------------------|----------|----------------------|-------------------------------------------------------|
| PipelineSucceededRuns | İşlem hattı çalıştırmaları ölçümleri başarılı oldu | Sayı    | Toplam                | Toplam işlem hatlarını çalıştırır başarılı bir dakikalık bir pencere içinde |
