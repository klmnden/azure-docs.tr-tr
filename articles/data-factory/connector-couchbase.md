...
ms.locfileid: "45633563"
---
# <a name="copy-data-from-couchbase-using-azure-data-factory"></a>Couchbase, Azure Data Factory kullanarak verileri kopyalama
...
| bağlantı dizesi | Couchbase için bağlanmak için bir ODBC bağlantı dizesi. Data Factory'de güvenle depolamak için bir SecureString olarak bu alanı işaretleyin veya [Azure Key Vault'ta depolanan bir gizli dizi başvuru](store-credentials-in-key-vault.md). | Evet |
...
Couchbase verileri kopyalamak için dataset öğesinin type özelliği ayarlamak **CouchbaseTable**. Ek bir türe özel özellik bu tür bir veri kümesi yok.
