...
### <a name="servicenowsource-as-source"></a>Kaynak olarak ServiceNowSource
...
| sorgu | Verileri okumak için özel SQL sorgusu kullanın. Örneğin: `"SELECT * FROM alm.asset"`. | Evet |
