...
| Ön eki                   | Filtre kaynak nesneleri veri kümesine yapılandırılan belirli demeti altında S3 nesnesinin anahtarı için önek. Seçili bir nesne anahtarları bu öneki ile başlayın. <br>Yalnızca geçerli `wildcardFolderPath` ve `wildcardFileName` özellikler belirtilmedi. | Hayır                                                          |
