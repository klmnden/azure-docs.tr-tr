...
## [Makale dizini](data-factory-alltopcat.md)
## Kavramlar
### [Veri kümeleri](data-factory-create-datasets.md)
### [İşlem hatları ve etkinlikler](data-factory-create-pipelines.md)
### [Veri taşıma etkinlikleri](data-factory-data-movement-activities.md)
### [Veri dönüştürme etkinlikleri](data-factory-data-transformation-activities.md)
...
## [Öğretici: buluta şirket içinden veri taşıma](data-factory-move-data-between-onprem-and-cloud.md)
## [Öğretici: İşlem hattında özel etkinlik oluşturma ve kullanma](data-factory-use-custom-activities.md)

# Nasıl yapılır?
## Veri Taşıma
### [Data Factory Kopyalama Sihirbazı](data-factory-copy-wizard.md)
### [Kopyalama Sihirbazı ile 15 dakika içinde 1 TB yükleme](data-factory-load-sql-data-warehouse.md)
### [Kopyalama Etkinliği](data-factory-data-movement-activities.md)
### [Karma veri taşıma](data-factory-move-data-between-onprem-and-cloud.md)
### [Veri Yönetimi Ağ Geçidi](data-factory-data-management-gateway.md)
### [Kopyalama Etkinliği Performansı ve Ayarlama Kılavuzu](data-factory-copy-activity-performance.md)
### [Azure Blob Depolama](data-factory-azure-blob-connector.md)
### [Azure Tabloları](data-factory-azure-table-connector.md)
...
## Geliştirme
### [Azure Portalını kullanma](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [Azure Resource Manager şablonu kullanma](data-factory-how-to-use-resource-manager-templates.md)
### [REST API’sini kullanma](data-factory-copy-activity-tutorial-using-rest-api.md)
### [.NET API’sini kullanma](data-factory-copy-activity-tutorial-using-dotnet-api.md)
...
## İzleme ve Yönetme
### [Azure Portalını kullanma](data-factory-api-change-log.md)
### [İzleme ve Yönetme Uygulamasını kullanma](data-factory-monitor-manage-app.md)
...
## [Sık sorulan sorular](data-factory-faq.md)
