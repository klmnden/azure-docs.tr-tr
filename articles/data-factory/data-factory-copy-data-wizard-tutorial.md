...
> [AZURE.IMPORTANT] Öğreticiye genel bakış edinmek ve bu öğreticiyi uygulamadan önce **önkoşul** adımlarını tamamlamak için [Öğreticiye genel bakış ve önkoşullar](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md) makalesine göz atın.
...
3. Kaynak Grubu için aşağıdaki adımlardan birini uygulayın: 1. Var olan bir kaynak grubu seçmek için **Var olanı kullan**’ı seçin.
2. Bir kaynak grubunun adını girmek için **Yeni oluştur**’u seçin.
    ...
    3. Veri fabrikası için bir **konum** seçin.
    4. Dikey pencerenin alt kısmındaki **Panoya sabitle** onay kutusunu seçin.  
    5. **Oluştur**’ tıklayın.
...
5. **Azure Blob depolama hesabı belirtin** sayfasında:
    ...
    3. Seçili abonelikte bulunan Azure depolama hesapları listesinden bir **Azure depolama hesabı** seçin. Ayrıca **Hesap seçme yöntemi** için **El ile gir** öğesini seçip **İleri**’ye tıklayarak depolama hesabı ayarlarını el ile girmeyi seçebilirsiniz. 
...
9. **Azure SQL veritabanı belirtin** sayfasında:
    ...
    3. Azure **aboneliğinizi** seçin.  
    2. **Sunucu adı** ve **Veritabanı** öğelerini seçin.
...
13. Oluşturduğunuz işlem hattını izleme hakkında bilgi almak için [İzleme Uygulamasını kullanarak işlem hattını izleme ve yönetme](data-factory-monitor-manage-app.md) bölümündeki yönergeleri kullanın. Dilimi görmek için **ETKİNLİK PENCERELERİ** listesindeki **Yenile** simgesine tıklayın. 
    ...
    > [AZURE.NOTE] En son durumu görmek için alt kısmındaki **ETKİNLİK PENCERELERİ** listesinde **Yenile** düğmesine tıklayın. Durum otomatik olarak yenilenmez. 
