...
[Log analytics'te sorgu](../log-query/log-query-overview.md) ile bir tablo başlatmak veya [arama](/azure/kusto/query/searchoperator) veya [birleşim](/azure/kusto/query/unionoperator) işleci.
