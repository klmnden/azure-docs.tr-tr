...
![Örnek Pano](./media/dashboards/oms-dashboards-example-dash.png)
...
* [OMS mobil uygulamasını Microsoft Store](https://www.windowsphone.com/store/app/operational-insights/4823b935-83ce-466c-82bb-bd0a3f58d865)
* [OMS mobil uygulamasını Apple iTunes](https://itunes.apple.com/app/microsoft-operations-management/id1042424859?mt=8)

![Mobil Pano](./media/dashboards/oms-search-mobile.png)
...
![Genel Bakış](./media/dashboards/oms-dashboards-overview.png)
...
![Resimsel](./media/dashboards/oms-dashboards-pictorial01.png)
...
![Kutucuk 1 Ekle](./media/dashboards/oms-dashboards-pictorial02.png)

Tıkladığınızda **artı** sembol, My Pano Görünümü'nde yeni bir kutucuk görünür.

![2 kutucuk Ekle](./media/dashboards/oms-dashboards-pictorial03.png)
...
![Kutucukları düzenleme](./media/dashboards/oms-dashboards-pictorial04.png)

![Kutucukları düzenleme](./media/dashboards/oms-dashboards-pictorial05.png)
...
![Pano düzenleme](./media/dashboards/oms-dashboards-organize.png)
