...
1. Gözat **etkinlik günlüğü** kullanarak bölümü **tüm hizmetleri** portalın sol tarafındaki arama.
   ...
   ![Etkinlik günlüğü Portalı'ndaki Hizmetler listesinden seçme](./media/activity-logs-stream-event-hubs/activity-logs-portal-navigate-v2.png)
2. Seçin **dışarı aktarma, olay Hub'ına** günlüğü üstünde düğme.
   
   ![Portalda Dışarı Aktar](./media/activity-logs-stream-event-hubs/activity-logs-portal-export-v2.png)
...
3. Görüntülenen bölümde, seçin **tüm bölgeler**. Belirli bölgelerde seçmeyin.
   ...
   ![Dışarı aktarma bölümü](./media/activity-logs-stream-event-hubs/export-audit.png)
...
Etkinlik günlüğü için şema kullanılabilir [Azure etkinlik günlüğü ile abonelik etkinliğini İzle](../../azure-monitor/platform/activity-logs-overview.md). JSON bloblarını adlı bir dizide her olaydır *kayıtları*.
