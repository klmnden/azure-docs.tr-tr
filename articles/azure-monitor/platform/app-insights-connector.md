...
- Kullanım [günlük araması](../../log-analytics/log-analytics-queries.md) Application Insights uygulamalarınız için ayrıntılı bilgileri görüntülemek için.
