...
|CurrentConnections|Bağlantı: Geçerli bağlantılar|Count|Ortalama|Kurulan istemci bağlantılarının geçerli sayısı.|ServerResourceType|
...
|Ölçüm|Ölçüm görünen adı|Birim|Toplama Türü|Açıklama|Boyutlar|
|---|---|---|---|---|---|
|connectedclients|Bağlı İstemciler|Count|Maksimum||ShardId|
...
|getcommands|Alınanlar|Count|Toplam||ShardId|
|setcommands|Kümeler|Count|Toplam||ShardId|
...
|SuccessfulCalls|Başarılı Çağrılar|Count|Toplam|Başarılı olan çağrıların sayısı.|ApiName, OperationName, bölge|
|TotalErrors|Hatalar Toplamı|Count|Toplam|Hata yanıtıyla sonuçlanan toplam çağrı sayısı (HTTP yanıt kodu 4xx veya 5xx).|ApiName, OperationName, bölge|
|BlockedCalls|Engellenen Çağrılar|Count|Toplam|Oran veya kota sınırını aşan çağrı sayısı.|ApiName, OperationName, bölge|
...
|Elinden|Data Girişi|Bayt|Toplam|Gelen verilerin bayt cinsinden boyutu.|ApiName, OperationName, bölge|
|DataOut|Giden Veriler|Bayt|Toplam|Giden verilerin bayt cinsinden boyutu.|ApiName, OperationName, bölge|
|Gecikme|Gecikme|Milisaniye|Ortalama|Milisaniye cinsinden gecikme süresi.|ApiName, OperationName, bölge|
|CharactersTranslated|Çevrilen Karakterler|Count|Toplam|Gelen metin isteğindeki toplam karakter sayısı.|ApiName, OperationName, bölge|
...
|Disk Okuma İşlemi/Sn|Disk Okuma İşlemi/Sn|CountPerSecond|Ortalama|Disk Okuma IOPS|Boyut yok|
|Disk Yazma İşlemi/Sn|Disk Yazma İşlemi/Sn|CountPerSecond|Ortalama|Disk Yazma IOPS|Boyut yok|
|Kalan CPU Kredisi|Kalan CPU Kredisi|Count|Ortalama|Veri bloğunun kullanabileceği toplam kredi sayısı|Boyut yok|
|Tüketilen CPU Kredisi|Tüketilen CPU Kredisi|Count|Ortalama|Sanal Makine tarafından tüketilen toplam kredi sayısı|Boyut yok|
|Disk Başına Okuma Bayt/sn|Veri Disk Okuma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskten okunan Bayt/Sn|SlotId|
|Disk Başına Yazma Bayt/sn|Veri Diski Yazma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diske yazılan Bayt/Sn|SlotId|
|Disk Başına Okuma İşlemi/Sn|Veri Diski Okuma İşlemi/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Okuma IOPS sayısı|SlotId|
|Disk Başına Yazma İşlemi/Sn|Veri Diski Yazma İşlemi/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Yazma IOPS sayısı|SlotId|
|Disk Başına QD|Veri Diski Kuyruk Derinliği (Kullanım Dışı)|Count|Ortalama|Veri Diski Sıra Derinliği (veya Sıra Uzunluğu)|SlotId|
|İşletim Sistemi Diski Başına Okuma Bayt/sn|İşletim Sistemi Diski Okuma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskten okunan Bayt/Sn|Boyut yok|
|İşletim Sistemi Diski Başına Yazma Bayt/sn|İşletim Sistemi Diski Yazma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diske yazılan Bayt/Sn|Boyut yok|
|İşletim Sistemi Diski Başına Okuma İşlemi/Sn|İşletim Sistemi Diski Okuma İşlemi/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki okuma IOPS sayısı|Boyut yok|
|İşletim Sistemi Diski Başına Yazma İşlemi/Sn|İşletim Sistemi Diski Yazma İşlemi/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki Yazma IOPS sayısı|Boyut yok|
|İşletim Sistemi Disk Başına QD|İşletim Sistemi Diski Kuyruk Derinliği (Kullanım Dışı)|Count|Ortalama|İşletim Sistemi Diski Sıra Derinliği (veya Sıra Uzunluğu)|Boyut yok|
|Veri Diski Okuma Bayt/sn|Veri Disk Okuma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskten okunan Bayt/Sn|LUN|
...
|Veri Diski Okuma İşlemi/Sn|Veri Diski Okuma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Okuma IOPS sayısı|LUN|
|Veri Diski Yazma İşlemi/Sn|Veri Diski Yazma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Yazma IOPS sayısı|LUN|
|Veri Diski Kuyruk Derinliği|Veri Diski Kuyruk Derinliği (Önizleme)|Count|Ortalama|Veri Diski Sıra Derinliği (veya Sıra Uzunluğu)|LUN|
|İşletim Sistemi Diski Okuma Bayt/sn|İşletim Sistemi Diski Okuma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskten okunan Bayt/Sn|Boyut yok|
|İşletim Sistemi Diskine Yazma Bayt/sn|İşletim Sistemi Diski Yazma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diske yazılan Bayt/Sn|Boyut yok|
|İşletim Sistemi Diski Okuma İşlemi/Sn|İşletim Sistemi Diski Okuma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki okuma IOPS sayısı|Boyut yok|
|İşletim Sistemi Diski Yazma İşlemi/Sn|İşletim Sistemi Diski Yazma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki Yazma IOPS sayısı|Boyut yok|
|İşletim Sistemi Diski Kuyruk Derinliği|İşletim Sistemi Diski Kuyruk Derinliği (Önizleme)|Count|Ortalama|İşletim Sistemi Diski Sıra Derinliği (veya Sıra Uzunluğu)|Boyut yok|
|Gelen Akışlar|Gelen Akışlar (Önizleme)|Count|Ortalama|Gelen Akışlar, geliş yönündeki (VM'ye gelen trafik) akışların mevcut sayısıdır|Boyut yok|
...
|Disk Okuma İşlemi/Sn|Disk Okuma İşlemi/Sn|CountPerSecond|Ortalama|Disk Okuma IOPS|VMName|
|Disk Yazma İşlemi/Sn|Disk Yazma İşlemi/Sn|CountPerSecond|Ortalama|Disk Yazma IOPS|VMName|
|Kalan CPU Kredisi|Kalan CPU Kredisi|Count|Ortalama|Veri bloğunun kullanabileceği toplam kredi sayısı|Boyut yok|
|Tüketilen CPU Kredisi|Tüketilen CPU Kredisi|Count|Ortalama|Sanal Makine tarafından tüketilen toplam kredi sayısı|Boyut yok|
|Disk Başına Okuma Bayt/sn|Veri Disk Okuma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskten okunan Bayt/Sn|SlotId|
|Disk Başına Yazma Bayt/sn|Veri Diski Yazma Bayt/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İzleme döneminde tek bir diske yazılan Bayt/Sn|SlotId|
...
|İşletim Sistemi Diski Başına Yazma İşlemi/Sn|İşletim Sistemi Diski Yazma İşlemi/Sn (Kullanım Dışı)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki Yazma IOPS sayısı|Boyut yok|
|İşletim Sistemi Disk Başına QD|İşletim Sistemi Diski Kuyruk Derinliği (Kullanım Dışı)|Count|Ortalama|İşletim Sistemi Diski Sıra Derinliği (veya Sıra Uzunluğu)|Boyut yok|
|Veri Diski Okuma Bayt/sn|Veri Disk Okuma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskten okunan Bayt/Sn|LUN, VMName|
...
|Veri Diski Okuma İşlemi/Sn|Veri Diski Okuma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Okuma IOPS sayısı|LUN, VMName|
|Veri Diski Yazma İşlemi/Sn|Veri Diski Yazma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İzleme döneminde tek bir diskteki Yazma IOPS sayısı|LUN, VMName|
|Veri Diski Kuyruk Derinliği|Veri Diski Kuyruk Derinliği (Önizleme)|Count|Ortalama|Veri Diski Sıra Derinliği (veya Sıra Uzunluğu)|LUN, VMName|
|İşletim Sistemi Diski Okuma Bayt/sn|İşletim Sistemi Diski Okuma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskten okunan Bayt/Sn|VMName|
|İşletim Sistemi Diskine Yazma Bayt/sn|İşletim Sistemi Diski Yazma Bayt/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diske yazılan Bayt/Sn|VMName|
|İşletim Sistemi Diski Okuma İşlemi/Sn|İşletim Sistemi Diski Okuma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki okuma IOPS sayısı|VMName|
|İşletim Sistemi Diski Yazma İşlemi/Sn|İşletim Sistemi Diski Yazma İşlemi/Sn (Önizleme)|CountPerSecond|Ortalama|İşletim sistemi diski için izleme döneminde tek bir diskteki Yazma IOPS sayısı|VMName|
|İşletim Sistemi Diski Kuyruk Derinliği|İşletim Sistemi Diski Kuyruk Derinliği (Önizleme)|Count|Ortalama|İşletim Sistemi Diski Sıra Derinliği (veya Sıra Uzunluğu)|VMName|
|Gelen Akışlar|Gelen Akışlar (Önizleme)|Count|Ortalama|Gelen Akışlar, geliş yönündeki (VM'ye gelen trafik) akışların mevcut sayısıdır|VMName|
...
|Ölçüm|Ölçüm görünen adı|Birim|Toplama Türü|Açıklama|Boyutlar|
|---|---|---|---|---|---|
|NICReadThroughput|Okuma Aktarım Hızı (Ağ)|BytesPerSecond|Ortalama|Ağ geçidindeki tüm birimlerin raporlama döneminde cihazdaki ağ arabiriminin okuma aktarım hızı.|InstanceName|
|NICWriteThroughput|Yazma Aktarım Hızı (Ağ)|BytesPerSecond|Ortalama|Ağ geçidindeki tüm birimlerin raporlama döneminde cihazdaki ağ arabiriminin yazma aktarım hızı.|InstanceName|
|CloudReadThroughputPerShare|Bulut İndirme Aktarım Hızı (Paylaşım)|BytesPerSecond|Ortalama|Raporlama döneminde bir paylaşımdan Azure'a indirme aktarım hızı.|Paylaş|
|CloudUploadThroughputPerShare|Bulut Karşıya Yükleme Aktarım Hızı (Paylaşım)|BytesPerSecond|Ortalama|Raporlama döneminde bir paylaşımdan Azure'a yükleme aktarım hızı.|Paylaş|
|BytesUploadedToCloudPerShare|Karşıya Yüklenen Bulut Baytı (Paylaşım)|Bayt|Ortalama|Raporlama döneminde bir paylaşımdan Azure'a yüklenen toplam bayt sayısı.|Paylaş|
|TotalCapacity|Toplam Kapasite|Bayt|Ortalama|Toplam Kapasite|Boyut yok|
|Requiredcapacity|Kullanılabilir Kapasite|Bayt|Ortalama|Raporlama döneminde bayt cinsinden kullanılabilir kapasite.|Boyut yok|
...
|Ölçüm|Ölçüm görünen adı|Birim|Toplama Türü|Açıklama|Boyutlar|
|---|---|---|---|---|---|
|FailedRuns|Başarısız Çalışma Sayısı|Count|Toplam||pipelineName, activityName|
|SuccessfulRuns|Başarılı Çalışma Sayısı|Count|Toplam||pipelineName, activityName|
...
|EventGridLatency|Event Grid gecikme süresi (Önizleme)|Milisaniye|Ortalama|Ortalama gecikme süresi (milisaniye) olay giriş IOT hub'ına olay giriş arasındaki Event Grid ile. Bu sayı, tüm olay türleri arasındaki bir ortalamadır. Belirli bir olay türü gecikme görmek için EventType boyut kullanın.|EventType|
...
|Jobs.Completed|Tamamlanan işler|Count|Toplam|Tüm tamamlanmış işlerin sayısı.|Boyut yok|
...
|ActiveConnections|ActiveConnections|Count|Ortalama|Microsoft.EventHub için Toplam Etkin Bağlantı.|Boyut yok|
...
|Boyutlandır|Boyutlandır|Bayt|Ortalama|EventHub'ın Bayt cinsinden boyutu.|EntityName|
...
|EHINMSGS|Gelen İletiler (Kullanım dışı)|Count|Toplam|(Kullanım dışı) bir ad alanı için toplam gelen ileti sayısı|Boyut yok|
...
|EHOUTMSGS|Giden İletiler (Kullanım dışı)|Count|Toplam|Toplam Giden iletiler için bir ad alanı (kullanım dışı)|Boyut yok|
...
|ActiveConnections|ActiveConnections (Önizleme)|Count|Ortalama|Microsoft.EventHub için Toplam Etkin Bağlantı. (Önizleme)|Boyut yok|
...
|ObservedCapacity|Gözlenen Kapasite|Count|Ortalama|Otomatik ölçeklendirme yürütüldüğünde bildirilen kapasite.|Boyut yok|
...
|availabilityResults/süresi|Kullanılabilirlik testi süresi|Milisaniye|Ortalama|Kullanılabilirlik testi süresi|availabilityResult/ad, availabilityResult/konum, availabilityResult/başarılı|
...
|Sayfa görüntülemesi/sayısı|Sayfa görünümleri|Count|Count|Sayfa görüntüleme sayısı.|işlem/Sentetik|
...
|izlemeleri/sayısı|İzlemeler|Count|Count|İzleme belgesi sayısı|İzleme/Err, işlemi/Sentetik, bulut/roleName, bulut/Roleınstance|
...
|BillingUsageStorageConsumption|Depolama Tüketimi Yürütmelerinin Kullanımının Faturalandırılması|Count|Toplam|Faturalandırılan depolama tüketimi yürütmelerinin sayısı.|Boyut yok|
|BillingUsageNativeOperation|Yerel İşlem Yürütmelerinin Kullanımının Faturalanması|Count|Toplam|Faturalandırılan yerel işlem yürütmelerinin sayısı.|Boyut yok|
|BillingUsageStandardConnector|Standart Bağlayıcı Yürütmelerinin Kullanımının Faturalandırılması|Count|Toplam|Faturalandırılan standart bağlayıcı yürütmelerinin sayısı.|Boyut yok|
|BillingUsageStorageConsumption|Depolama Tüketimi Yürütmelerinin Kullanımının Faturalandırılması|Count|Toplam|Faturalandırılan depolama tüketimi yürütmelerinin sayısı.|Boyut yok|
...
|Başarısız Çalışma Sayısı|Başarısız Çalışma Sayısı|Count|Toplam|Bu çalışma alanı için başarısız çalıştırma sayısı|Senaryo|
...
|VipAvailability|Veri yolu kullanılabilirliği|Count|Ortalama|IP adresi kullanılabilirlik zaman süresi başına ortalama|Port|
...
|Ölçüm|Ölçüm görünen adı|Birim|Toplama Türü|Açıklama|Boyutlar|
|---|---|---|---|---|---|
|Performans|Performans|BytesPerSecond|Toplam|Uygulama ağ geçidi hizmet saniye başına bayt sayısı|Boyut yok|
...
|Ölçüm|Ölçüm görünen adı|Birim|Toplama Türü|Açıklama|Boyutlar|
|---|---|---|---|---|---|
|registration.all|Kayıt İşlemleri|Count|Toplam|Tüm başarılı kayıt işlemlerinin sayısı (oluşturma, güncelleştirme, sorgu ve silme işlemleri). |Boyut yok|
|registration.Create|Kayıt Oluşturma İşlemleri|Count|Toplam|Tüm başarılı kayıt oluşturma işlemlerinin sayısı.|Boyut yok|
|registration.Update|Kayıt Güncelleme İşlemleri|Count|Toplam|Tüm başarılı kayıt güncelleştirmelerinin sayısı.|Boyut yok|
|registration.get|Kayıt Okuma İşlemleri|Count|Toplam|Tüm başarılı kayıt sorgularının sayısı.|Boyut yok|
|registration.Delete|Kayıt Silme İşlemleri|Count|Toplam|Tüm başarılı kayıt silme işlemlerinin sayısı.|Boyut yok|
|gelen|Gelen İletiler|Count|Toplam|Başarılı olan tüm gönderme API'si çağrılarının sayısı. |Boyut yok|
|incoming.Scheduled|Zamanlanan Anında İletme Bildirimleri Gönderildi|Count|Toplam|Zamanlanan anında iletme bildirimleri iptal edildi|Boyut yok|
...
|installation.all|Yükleme Yönetimi İşlemleri|Count|Toplam|Yükleme Yönetimi İşlemleri|Boyut yok|
|installation.get|Yükleme İşlemlerini Al|Count|Toplam|Yükleme İşlemlerini Al|Boyut yok|
|installation.upsert|Yükleme İşlemleri Oluştur veya Güncelleştir|Count|Toplam|Yükleme İşlemleri Oluştur veya Güncelleştir|Boyut yok|
|installation.Patch|Yükleme İşlemlerine Düzeltme Eki Uygula|Count|Toplam|Yükleme İşlemlerine Düzeltme Eki Uygula|Boyut yok|
|installation.Delete|Yükleme İşlemlerini Sil|Count|Toplam|Yükleme İşlemlerini Sil|Boyut yok|
...
|outgoing.WNS.tokenproviderunreachable|WNS Yetkilendirme Hataları (Ulaşılamıyor)|Count|Toplam|Windows Live hizmetine erişilemiyor.|Boyut yok|
...
|outgoing.WNS.dropped|WNS Bırakılan Bildirimler|Count|Toplam|Bildirim, kayıttaki ChannelURI kısıtlandığı için bırakıldı (X-WNS-NotificationStatus: bırakıldı, ancak X-WNS-DeviceConnectionStatus: bağlantısı kesildi durumda değil).|Boyut yok|
...
|notificationhub.pushes|Tüm Giden Bildirimler|Count|Toplam|Bildirim hub'ındaki tüm giden bildirimler|Boyut yok|
|incoming.all.Requests|Tüm Gelen İstekler|Count|Toplam|Bildirim hub'ı için toplam gelen istek sayısı|Boyut yok|
|incoming.all.failedrequests|Tüm Gelen Başarısız İstekler|Count|Toplam|Bildirim hub'ı için toplam gelen başarısız istek sayısı|Boyut yok|
...
|Average_ boş alan yüzdesi|% Boş alan|Count|Ortalama|Average_ boş alan yüzdesi|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_Total bayt|Toplam Bayt|Count|Ortalama|Average_Total bayt|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Alınan Average_Total paketleri|Alınan toplam paket sayısı|Count|Ortalama|Alınan Average_Total paketleri|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_Physical Disk Bayt/sn|Fiziksel Disk Bayt/sn|Count|Ortalama|Average_Physical Disk Bayt/sn|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_Used bellek KB|Kullanılan bellek KB|Count|Ortalama|Average_Used bellek KB|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_ % kullanıcı zamanı|% Kullanıcı Zamanı|Count|Ortalama|Average_ % kullanıcı zamanı|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_Users|Kullanıcılar|Count|Ortalama|Average_Users|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
|Average_Avg. Disk sn/Okuma|Ort. Disk sn/Okuma|Count|Ortalama|Average_Avg. Disk sn/Okuma|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
|Average_Avg. Disk sn/yazma|Ort. Disk sn/yazma|Count|Ortalama|Average_Avg. Disk sn/yazma|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Average_Bytes toplam/sn|Toplam Bayt/sn|Count|Ortalama|Average_Bytes toplam/sn|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
|Average_ % işlemci zamanı|% İşlemci zamanı|Count|Ortalama|Average_ % işlemci zamanı|Bilgisayar, ObjectName, InstanceName, sayaç yolu, Analytics'teki|
...
|Güncelle|Güncelle|Count|Ortalama|Güncelle|Bilgisayar, ürün, Sınıflandırma, isteğe bağlı, onaylanan UpdateState|
|Olay|Olay|Count|Ortalama|Olay|Kaynak, EventLog, bilgisayar, EventCategory, EventLevel, EventLevelName, EventID|
...
|Boyutlandır|Boyut (Önizleme)|Bayt|Ortalama|Sıranın/Konunun Bayt cinsinden boyutu. (Önizleme)|EntityName|
|İletiler|Bir Sıradaki/Konudaki iletilerin sayısı. (Önizleme)|Count|Ortalama|Bir Sıradaki/Konudaki iletilerin sayısı. (Önizleme)|EntityName|
...
|IndexCapacity|Dizin Kapasitesi|Bayt|Ortalama|ADLS 2. Nesil (Hiyerarşik) Dizini tarafından kullanılan depolamanın bayt cinsinden miktarı.|Boyut yok|
|İşlemler|İşlemler|Sayı|Toplam|Bir depolama hizmetine yapılan isteklerin veya belirtilen API işlemi sayısı. Bu sayı başarılı ve başarısız isteklerin yanı sıra hataları üretilen istekleri içerir. Farklı tür yanıtların sayısı için ResponseType boyutunu kullanın.|ResponseType, GeoType, ApiName, kimlik doğrulaması|
|Giriş|Giriş|Bayt|Toplam|Bayt olarak giriş verileri miktarı. Bu sayı, dış istemciden Azure Depolama'ya giren ve Azure içinde giren verileri içerir.|GeoType, ApiName, kimlik doğrulaması|
|Çıkış|Çıkış|Bayt|Toplam|Bayt cinsinden çıkış verileri miktarı. Bu sayı, dış istemciden Azure Depolama'ya çıkan ve Azure içinde çıkan verileri içerir. Sonuç olarak bu sayı, faturalanabilir çıkışı yansıtmaz.|GeoType, ApiName, kimlik doğrulaması|
|SuccessServerLatency|Başarı Sunucu Gecikme Süresi|Milisaniye|Ortalama|Milisaniye cinsinden başarılı bir isteği işlemek için Azure Depolama tarafından kullanılan ortalama gecikme süresi. Bu değer AverageE2ELatency'de belirtilen ağ gecikmesini içermez.|GeoType, ApiName, kimlik doğrulaması|
...
|FileCount|Dosya Sayısı|Count|Ortalama|Depolama hesabının Dosya hizmetindeki dosya sayısı.|Boyut yok|
|FileShareCount|Dosya Paylaşım Sayısı|Count|Ortalama|Depolama hesabının Dosya hizmetindeki dosya paylaşımlarının sayısı.|Boyut yok|
|İşlemler|İşlemler|Sayı|Toplam|Bir depolama hizmetine yapılan isteklerin veya belirtilen API işlemi sayısı. Bu sayı başarılı ve başarısız isteklerin yanı sıra hataları üretilen istekleri içerir. Farklı tür yanıtların sayısı için ResponseType boyutunu kullanın.|ResponseType, GeoType, ApiName, kimlik doğrulaması|
|Giriş|Giriş|Bayt|Toplam|Bayt olarak giriş verileri miktarı. Bu sayı, dış istemciden Azure Depolama'ya giren ve Azure içinde giren verileri içerir.|GeoType, ApiName, kimlik doğrulaması|
|Çıkış|Çıkış|Bayt|Toplam|Bayt cinsinden çıkış verileri miktarı. Bu sayı, dış istemciden Azure Depolama'ya çıkan ve Azure içinde çıkan verileri içerir. Sonuç olarak bu sayı, faturalanabilir çıkışı yansıtmaz.|GeoType, ApiName, kimlik doğrulaması|
|SuccessServerLatency|Başarı Sunucu Gecikme Süresi|Milisaniye|Ortalama|Milisaniye cinsinden başarılı bir isteği işlemek için Azure Depolama tarafından kullanılan ortalama gecikme süresi. Bu değer AverageE2ELatency'de belirtilen ağ gecikmesini içermez.|GeoType, ApiName, kimlik doğrulaması|
...
|StorageSyncSyncSessionAppliedFilesCount|Dosyalar Eşitlendi|Count|Toplam|Eşitlenmiş dosyaları sayısı|SyncGroupName, ServerEndpointName, SyncDirection|
|StorageSyncSyncSessionPerItemErrorsCount|Dosyalar eşitlenmiyor|Count|Toplam|Eşitlenemeyen dosya sayısı|SyncGroupName, ServerEndpointName, SyncDirection|
...
|DroppedOrAdjustedEvents|Sıralama dışındaki Olaylar|Count|Toplam|Sıralama dışındaki Olaylar|LogicalName, bölüm kimliği|
...
|Diskten Okunan Bayt|Diskten Okunan Bayt|Bayt|Toplam|Örnek süre okuma işlemleri nedeniyle toplam disk aktarım hızı.|Boyut yok|
|Diske Yazılan Bayt|Diske Yazılan Bayt|Bayt|Toplam|Örnek süre yazma işlemleri nedeniyle toplam disk aktarım hızı.|Boyut yok|
...
|Disk Okuma İşlemi/Sn|Disk Okuma İşlemi/Sn|CountPerSecond|Ortalama|Okuma işlemleri önceki örnek dönemdeki ortalama g/ç sayısı. Bu işlemler, değişken boyutlu olabileceğine dikkat edin.|Boyut yok|
|Disk Yazma İşlemi/Sn|Disk Yazma İşlemi/Sn|CountPerSecond|Ortalama|Önceki örnek dönemdeki ortalama g/ç sayısı yazma işlemlerini. Bu işlemler, değişken boyutlu olabileceğine dikkat edin.|Boyut yok|
...
|Tanıtıcılar|Tanıtıcı Sayısı|Count|Ortalama|Tanıtıcı Sayısı|Örnek|
...
|RequestsInApplicationQueue|Uygulama Kuyruğundaki İstekler|Count|Ortalama|Uygulama Kuyruğundaki İstekler|Örnek|
...
|TotalFrontEnds|Toplam Ön Uç Sayısı|Count|Ortalama|Toplam Ön Uç Sayısı|Boyut yok|
...
|LargeAppServicePlanInstances|Uzun App Service Planı Çalışanları|Count|Ortalama|Uzun App Service Planı Çalışanları|Boyut yok|
