...
[Otomatik ölçeklendirmeyi PowerShell kullanarak yönetme](../../monitoring-and-diagnostics/insights-powershell-samples.md#create-and-manage-autoscale-settings)
