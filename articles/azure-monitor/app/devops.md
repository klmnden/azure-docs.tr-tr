...
* Zaten çalışan bir web uygulaması izleme. Bu, tüm yerleşik performans telemetrisine sağlar. İçin kullanılabilir [Java](../../azure-monitor/app/java-live.md) ve [IIS sunucuları](../../azure-monitor/app/monitor-performance-live-website-now.md), için ve ayrıca [Azure App Service](../../azure-monitor/app/app-insights-overview.md).
