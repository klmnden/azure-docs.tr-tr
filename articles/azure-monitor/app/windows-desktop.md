...
1. [Azure portalında](https://portal.azure.com) [bir Application Insights kaynağı oluşturun](../../application-insights/app-insights-create-new-resource.md). Uygulama türü olarak ASP.NET uygulamasını seçin.
