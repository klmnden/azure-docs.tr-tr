...
Yapılandırma parametreleri tam bir listesi için lütfen bkz [GitHub sayfasına](https://github.com/microsoft/applicationinsights-js#configuration). Bazı kullanılabilir Parametreler şunlardır:
