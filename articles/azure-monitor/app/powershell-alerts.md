...
Yapılandırılmasını otomatikleştirebilirsiniz [uyarılar](../../azure-monitor/app/alerts.md) içinde [Application Insights](../../application-insights/app-insights-overview.md).
