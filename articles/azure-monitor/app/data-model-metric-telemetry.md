...
Ölçüm telemetri tarafından desteklenen iki tür vardır [Application Insights](../../application-insights/app-insights-overview.md): tek bir ölçüm ve önceden toplanmış ölçümü. Yalnızca bir ad ve değer bunun tek ölçümüdür. Önceden toplanmış ölçüm toplama aralığı ve standart sapmasını ölçüm minimum ve maksimum değerini belirtir.
