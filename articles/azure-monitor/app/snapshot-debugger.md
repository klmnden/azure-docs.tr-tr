...
3. Pakete eklenen varsayılan seçenekleri gözden [Applicationınsights.config](../../azure-monitor/app/configuration-with-applicationinsights-config.md):
...
1. Uygulamanızı Application Insights ile izlenen olması değil, başlayın [Application Insights'ı etkinleştirme ve izleme anahtarı ayarını](../../application-insights/app-insights-windows-desktop.md).
...
Belirli bir özel durum veya bir sorun kimliği için bir anlık görüntü kullanılabiliyorsa bir **Aç hata ayıklama anlık görüntüsü** düğmesinin üzerindeki [özel durum](../../azure-monitor/app/asp-net-exceptions.md) Application Insights portalında.

![Özel durum hata ayıklama anlık görüntüsü düğmesinde Aç](./media/snapshot-debugger/snapshot-on-exception.png)
...
* [Akıllı algılama](../../application-insights/app-insights-proactive-diagnostics.md) performans anormalliklerini otomatik olarak bulur.
