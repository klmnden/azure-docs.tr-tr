...
* CodeLens’teki istekler
* Yapılandırma penceresi
* HockeyApp SDK'sı için v4.2.2 güncelleştirildi
* Hata düzeltmeleri

## <a name="version-72-visual-studio-2015"></a>Sürüm 7.2 (Visual Studio 2015)
...
![Application Insights eğilimleri](./media/release-notes-vsix/Trends.png)
...
![CodeLens’teki özel durumlar](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![ASP.NET Core desteği](./media/release-notes-vsix/NetCoreSupport.png)
...
![Tanılama araçları desteği](./media/release-notes-vsix/DiagnosticTools.png)
...
![Evrensel Windows uygulamaları için proje bağlam menüsü](./media/release-notes-vsix/UniversalContextMenu.png)
...
![Karşıya Yükle iletişim kutusu için evrensel Windows uygulamaları](./media/release-notes-vsix/UniversalUploadDialog.png)
...
![Karşıya yükleme tamamlandı bildirimi](./media/release-notes-vsix/UploadComplete.png)
...
![HockeyApp portalı](./media/release-notes-vsix/HockeyAppPortal.png)
...
![Windows Forms uygulamaları için proje bağlam menüsü](./media/release-notes-vsix/WinFormContextMenu.png)

Bu bir evrensel Windows uygulaması birinde benzer HockeyApp karşıya yükleme iletişim kutusunu açar.

![Karşıya Yükle iletişim kutusu Windows Forms uygulamaları](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
![Karşıya yükleme tamamlandı](./media/release-notes-vsix/LocalSearch.png)
...
![Günlük bildirimi](./media/release-notes-vsix/LoggingToast.png)

Yüklü günlük bağdaştırıcısı varsa, uygulamanızı çalıştırın ve Tanılama Araçları sekmesinde, bu gibi veri gördüğünüzden emin olun:

![İzlemeler](./media/release-notes-vsix/Traces.png)
...
![Eşleşme bulunamadı](./media/release-notes-vsix/FindMatch.png)
...
![Arama penceresi](./media/release-notes-vsix/SearchWindow.png)
...
![İlgili öğeler](./media/release-notes-vsix/RelatedItems.png)
...
![Özel durum ayrıntıları tıklayın](./media/release-notes-vsix/jumptocode.png)
...
![Çözüm Gezgini'nde Ara](./media/release-notes-vsix/searchentry.png)
...
![Yayımlama tamamlandı bildirimi](./media/release-notes-vsix/publishtoast.png)
...
![Arama penceresi](./media/release-notes-vsix/search.png)
...
![Tanılama araçları sayfası](./media/release-notes-vsix/diagtools.png)
...
![Yeni Proje iletişim kutusu](./media/release-notes-vsix/newproject.png)
