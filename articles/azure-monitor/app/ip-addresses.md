...
> [!NOTE]
> Bu adresler statik olsa da, biz zaman zaman değiştirileceği gerekir mümkündür. Tüm Application Insights trafiği giden trafiği kullanılabilirlik izleme ve gelen güvenlik duvarı kuralları gerektiren Web kancaları dışında temsil eder.
> 
> 

> [!TIP]
> Bir RSS akışı ekleyerek olarak bu sayfaya abone ol https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/azure-monitor/app/ip-addresses.md.atom en son değişiklikleri bildirim almak için sık kullandığınız RSS/ATOM okuyucunuz için.
> 
> 
...
| Depolama alanı | *. core.windows.net | dinamik tür farkı | 443
