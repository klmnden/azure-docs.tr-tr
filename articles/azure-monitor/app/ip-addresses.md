...
[Azure Application Insights](../../application-insights/app-insights-overview.md) hizmeti IP adresi sayısını kullanır. İzlemekte olduğunuz uygulamanın bir güvenlik duvarının arkasında barındırılıyorsa bu adresleri bilmeniz gerekebilir.
...
> [!TIP]
> Bir RSS akışı ekleyerek olarak bu sayfaya abone ol https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/application-insights/ip-addresses.md.atom en son değişiklikleri bildirim almak için sık kullandığınız RSS/ATOM okuyucunuz için.
> 
> 
...
Adreslerini listesidir [kullanılabilirlik web testleri](../../azure-monitor/app/monitor-web-app-availability.md) çalıştırılır. Uygulamanıza web testleri çalıştırmak istediğiniz, ancak web sunucunuz, belirli istemcileri sunulması için sınırlıdır, gelen trafiği, test sunucuları bizim kullanıma sunulmasından izin gerekir.
