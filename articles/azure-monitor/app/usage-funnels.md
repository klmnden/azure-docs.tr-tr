...
2. İçin Huni dışarı aktarabilirsiniz [Power BI](../../application-insights/app-insights-export-power-bi.md).
...
## <a name="next-steps"></a>Sonraki adımlar
  ...
  * [Power BI’a aktarma](../../application-insights/app-insights-export-power-bi.md)
