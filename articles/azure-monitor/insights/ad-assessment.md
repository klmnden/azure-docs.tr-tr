...
* Kullanım [Log Analytics'te günlük aramaları](../../log-analytics/log-analytics-queries.md) ayrıntılı veri AD sistem durumunu denetleyin ve önerileri çözümleme hakkında bilgi edinmek için.
