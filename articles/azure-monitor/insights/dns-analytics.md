...
- Olmalıdır bir [Windows](../../azure-monitor/platform/agent-windows.md) veya [Operations Manager](../../log-analytics/log-analytics-om-agents.md) aracıyı izlemek istediğiniz her bir DNS sunucusunda.
