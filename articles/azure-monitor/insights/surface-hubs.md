...
* Kullanım [Log Analytics'te günlük aramaları](../../log-analytics/log-analytics-queries.md) ayrıntılı Surface Hub verilerini görüntülemek için.
