...
* Kullanım [Log Analytics'te günlük aramaları](../../log-analytics/log-analytics-queries.md) ayrıntılı Azure anahtar kasası verilerini görüntülemek için.
