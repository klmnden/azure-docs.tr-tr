---
title: Azure Cloud Services ve ASP.NET kullanmaya başlama | Microsoft Docs
...
5. **Bulut Hizmeti Oluştur**’a tıklayın.
...
3. **Sunucu** açılır listesinden **Yeni SQL Database sunucusu** öğesini seçin.
   
    Alternatif olarak, aboneliğiniz zaten bir sunucuya sahipse aşağı açılan listeden bu sunucuyu seçebilirsiniz.
4. Bulut hizmeti için seçtiğiniz aynı **Bölge**’yi seçin.
...
5. Bir yönetici için **Kullanıcı Adı** ve **Parola** girin.
...
6. **SQL Veritabanı Oluştur**’a tıklayın.
   
    ![Yeni SQL Veritabanı](./media/cloud-services-dotnet-get-started/newdb.png)
7. Azure veritabanını oluşturmayı tamamladıktan sonra portalın sol bölmesindeki **SQL Veritabanları** sekmesine ve ardından yeni veritabanının adına tıklayın.
8. **Pano** sekmesine tıklayın.
9. **İzin verilen IP adreslerini yönet** öğesine tıklayın.
10. **İzin Verilen Hizmetler** altında **Azure Hizmetleri** seçeneğini **Evet** olarak değiştirin.
...
2. **URL** kutusuna bir URL ön eki girin.
...
3. **Bölge** açılır listesini bulut hizmeti için seçtiğiniz bölgeye ayarlayın.
...
4. **Çoğaltma** açılır listesini **Yerel olarak yedekli** olarak ayarlayın.
...
> [!NOTE]
> Bu bölümde ve sonraki bölümde kimlik bilgilerini proje dosyalarına depolarsınız. [Hassas verileri ortak kaynak kodu depolarına kaydetmeyin](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/source-control#secrets).
> 
> 
...
3. *Web.Release.config* dönüşüm dosyasında `{connectionstring}` öğesini silin ve yerine klasik Azure portalındaki ADO.NET bağlantı dizesini yapıştırın.
