...
[Klasik Azure portalına hizmet sertifikanızı karşıya](cloud-services-configure-ssl-certificate.md) (veya [Azure portal](cloud-services-configure-ssl-certificate-portal.md)).
