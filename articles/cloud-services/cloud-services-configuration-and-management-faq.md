...
```
Konum csdef ve cscfg karşıya blob veya yerel seçin olanağı yakında sunulacaktır. Kullanarak [yeni AzureDeployment](/powershell/module/azure/new-azuredeployment?view=azuresmps-4.0.0), her bir konum değeri ayarlayabilirsiniz.
...
- F12 Geliştirici aracı Internet Explorer/Edge etkinleştirmek ve protokolü doğrulamak için ağ sekmesine gidin. 
...
Bulut Hizmetleri için Azure tanılama günlüğü etkinleştirme hakkında daha fazla bilgi için bkz. [tanılama ayarlama, Azure bulut Hizmetleri ve sanal makineler için ayarlayın](../vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines.md#turn-on-diagnostics-in-cloud-service-projects-before-you-deploy-them)
