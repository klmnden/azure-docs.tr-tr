...
Sıralama ve kullanılabilirlik arasındaki dengelemeyi açıklamasına yardımcı olmak için bkz: [CAP Teoremi](https://en.wikipedia.org/wiki/CAP_theorem), Brewer'ın Teoremi olarak da bilinir. Bu Teoremi tutarlılık, kullanılabilirlik ve bölüm dayanıklılık arasında seçim açıklanır.
...
Sıralama, ayrıca çalışma zamanı, en üst düzeye çıkarma sırasında emin olmak için olası bir çözüm için olayları, olay işleme uygulama bir parçası olarak olacaktır. Bunu yapmanın en kolay yolu olan bir özel sıra numarası özelliği, olay damga olmaktır. Aşağıdaki kod örneği gösterir:
