...
### <a name="limit-on-calls-to-the-getruntimeinformation-method"></a>Getruntimeınformation metodu çağrıları sınırı
Azure Event Hubs, saniyede en fazla 50 çağrıları saniyede GetRuntimeInfo destekler. Sınıra ulaşıldığında aşağıdakine benzer bir özel durum iletisiyle karşılaşabilirsiniz:
