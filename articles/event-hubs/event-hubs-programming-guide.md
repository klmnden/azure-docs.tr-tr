---
title: Azure Event Hubs için programlama kılavuzu | Microsoft Docs
...
## <a name="send-events-to-an-event-hub"></a>Bir Event Hub'ına olay gönderme
...
* [Olay işlemcisi konağı API başvurusu](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventprocessorhost.aspx)
