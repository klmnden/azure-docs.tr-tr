...
Sanal makine ölçek kümesindeki sanal makineleri için parolayı sıfırlamak için VM erişimi uzantılarını kullanın. 
...
Bir sanal makine ölçek kümesindeki VM'lerin sayısını değiştirmek için bkz: [bir sanal makine ölçek kümesi örnek sayısını değiştirme](https://msftstack.wordpress.com/2016/05/13/change-the-instance-count-of-an-azure-vm-scale-set/).
...
Yeni VM oluşturulduğunda, VM InstanceView özelliğinin ekran görüntüsü vb. için ayrıntıları gösterir. Örnek aşağıda verilmiştir:
