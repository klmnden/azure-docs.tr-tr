---
title: Sanal Makine Ölçek Kümelerine Genel Bakış | Microsoft Docs
...
* Depolama hesabı başına 20 VM’den fazlasını planlamayın (*overprovision* özelliği "false" olarak ayarlanırsa 40’a kadar gidilebilir).
