        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Sanal Makine Ölçek Kümeleri hakkında bilgi edinin</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/virtualmachinescalesets/">Sanal Makine Ölçek Kümeleri REST API’si Başvurusu</a></p>
                    </div>
                </div>
            </div>
        </div>
