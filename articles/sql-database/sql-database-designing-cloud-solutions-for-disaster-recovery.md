...
## <a name="scenario-1-using-two-azure-regions-for-business-continuity-with-minimal-downtime"></a>Senaryo 1: en düşük kapalı kalma süresi ile iş sürekliliği için iki Azure bölgeleri'ni kullanma
...
## <a name="scenario-2-azure-regions-for-business-continuity-with-maximum-data-preservation"></a>Senaryo 2: En fazla veri koruma ile iş sürekliliği için Azure bölgeleri
...
## <a name="scenario-3-application-relocation-to-a-different-geography-without-data-loss-and-near-zero-downtime"></a>Senaryo 3: Uygulama konum değiştirme için farklı bir Coğrafya veri kaybı olmadan ve neredeyse sıfır kapalı kalma süresi 
...
* Coğrafi çoğaltma ve yük devretme grupları hakkında daha fazla bilgi için bkz: [etkin coğrafi çoğaltma](sql-database-geo-replication-overview.md)  
