...
description: Azure portalında bir Azure SQL veritabanı sunucusu ve veritabanı oluşturun ve sorgulayın.
...
Bir Azure SQL veritabanı bir dizi tanımlanmış olan [işlem ve depolama kaynaklarını](sql-database-service-tiers-dtu.md). Veritabanında oluşturduğunuz bir [SQL veritabanı sunucusu](sql-database-features.md) içinde bir [Azure kaynak grubu](../azure-resource-manager/resource-group-overview.md).
