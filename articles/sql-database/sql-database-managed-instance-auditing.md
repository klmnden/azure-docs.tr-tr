...
Yönetilen örnek denetim günlüklerinden bile hub veya Azure İzleyicisi'ni kullanarak Log Analytics'e gönderilir. Bu bölümde, bunun nasıl yapılandırıldığı açıklanmaktadır:
