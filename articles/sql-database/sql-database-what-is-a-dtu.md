<properties
    pageTitle="SQL Veritabanı: DTU nedir? | Microsoft Azure"
...
## Veritabanı İşlem Birimleri (DTU'lar) nedir?
...
## Esnek Veritabanı İşlem Birimleri (eDTU'lar) nedir?
...
## İş yükümün ihtiyacı olan DTU sayısını nasıl belirleyebilirim?
...
## Esnek bir kaynak havuzundan fayda sağlayıp sağlayamayacağımı nasıl öğrenebilirim?
...
## Maksimum DTU sayıma ulaştığımda ne olur?
