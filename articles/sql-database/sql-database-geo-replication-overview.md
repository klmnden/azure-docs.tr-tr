...
* **Esnek havuz veritabanlarının Destek**: her çoğaltma ayrı bir esnek havuz katılmak veya tüm esnek havuzda hiç olmamalıdır. Her çoğaltma için havuz seçim ayrıdır ve herhangi bir çoğaltma yapılandırması sırasında bağlı değildir (birincil veya ikincil olup olmadığını). Her esnek havuz tek bir bölge içinde yer alan, bu nedenle aynı topolojisi içinde birden fazla çoğaltma bir esnek havuz hiçbir zaman paylaşabilirsiniz.
