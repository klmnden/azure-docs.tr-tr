...
| [az sql db oluşturun](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-create) | Tek bir veritabanı veya veritabanı içinde bir elastik havuz oluşturur. |
