...
| [New-AzureRmSqlServer](/powershell/module/azurerm.sql/new-azurermsqlserver) | Barındıran bir SQL veritabanı sunucusu oluşturur bir tek bir veritabanı veya elastik havuz. |
