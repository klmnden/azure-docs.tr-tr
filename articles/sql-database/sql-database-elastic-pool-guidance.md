---
title: "Elastik havuz ne zaman kullanılmalıdır?"
description: "Elastik havuz, bir elastik veritabanı grubu tarafından paylaşılan kullanılabilir kaynaklar koleksiyonudur. Bu belgede bir veritabanı grubu için elastik havuz kullanmanın uygunluğunu değerlendirmeye yardımcı olan yönergeler verilmektedir."
...
---
# <a name="when-should-an-elastic-pool-be-used"></a>Elastik havuz ne zaman kullanılmalıdır?
Elastik havuz kullanımının uygun maliyetli olup olmadığını değerlendirmek için veritabanı kullanım modellerini ve elastik havuz ile tek veritabanları arasındaki fiyatlandırma farklarını göz önünde bulundurun. Var olan bir SQL veritabanı kümesi için gereken geçerli havuz boyutunu belirlemeye yardımcı olmak üzere ek yönergeler de verilmektedir.  

* Havuzlara genel bakış için bkz. [SQL Veritabanı elastik havuzları](sql-database-elastic-pool.md).
...
Kullanılabilir boyutlar için bkz. [Elastik havuzlar ve elastik veritabanları için eDTU ve depolama limitleri](sql-database-elastic-pool.md#edtu-and-storage-limits-for-elastic-pools).
...
V12'den önceki sunucular için geçici boyutlandırma tahminlerinin yanı sıra farklı sunuculardaki veritabanlarına yönelik boyutlandırma tahminleri sağlayan daha elastik kaynak kullanım değerlendirmeleri için bkz. [Elastik havuz için uygun veritabanlarını tanımlamaya yönelik Powershell betiği](sql-database-elastic-pool-database-assessment-powershell.md).
...
* [Esnek havuz oluşturma](sql-database-elastic-pool-create-portal.md)
* [Elastik havuzları izleme, yönetme ve boyutlandırma](sql-database-elastic-pool-manage-portal.md)
...
* [Elastik havuz için uygun veritabanlarını tanımlamaya yönelik PowerShell betiği](sql-database-elastic-pool-database-assessment-powershell.md)
