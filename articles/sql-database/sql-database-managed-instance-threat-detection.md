...
ms.locfileid: "44717004"
---
# <a name="azure-sql-database-managed-instance-threat-detection"></a>Azure SQL veritabanı yönetilen örnek tehdit algılama

SQL tehdit algılama, olağan dışı ve zararlı gösteren anormal etkinlikleri çalışır bir Azure SQL veritabanı yönetilen örneği'nı (Önizleme) içinde veritabanı açıklıklarından yararlanmaya yönelik erişim algılar.
