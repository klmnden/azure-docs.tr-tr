---
title: "SQL Veritabanı performansı ve seçenekleri: Hizmet katmanları | Microsoft Belgeleri"
...
## <a name="service-tiers-and-database-options"></a>Hizmet katmanları ve veritabanı seçenekleri
...
## <a name="standalone-database-service-tiers-and-performance-levels"></a>Tek başına veritabanı hizmet katmanları ve performans düzeyleri
...
### <a name="choosing-a-service-tier-for-a-standalone-database"></a>Tek başına veritabanı için hizmet katmanı seçme
