...
description: Azure SQL veritabanını Azure portalını kullanarak bir BACPAC dosyasına dışarı aktarma
...
) veya [Azure Otomasyonu](https://github.com/Microsoft/azure-docs/blob/2461f706f8fc1150e69312098640c0676206a531/articles/automation/automation-intro.md) düzenli aralıklarla SQL arşivlemek için veritabanları tercih ettiğiniz bir zamanlamaya göre PowerShell kullanarak. Bir örnek için indirme [PowerShell Betiği örnek](https://github.com/Microsoft/sql-server-samples/tree/master/samples/manage/azure-automation-automated-export) github'dan.
>
