---
title: "Azure SQL Veritabanı Belgeleri - Öğreticiler, API Başvurusu | Microsoft Docs"
description: "Azure SQL veritabanlarını kullanmayı öğrenin."
    ...
    <div class="introHolder" style="justify-content: space-between;">
        ...
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Azure’da SQL veritabanı oluşturun. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">5 Dakikalık Hızlı Başlangıçlar</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">SQL Veritabanı oluşturma, SQL Management Studio kullanarak yönetme ve C#, Java, Python, Node.js ve Ruby dillerinde geliştirme hakkında bilgi edinin:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>SQL veritabanı kullanarak veritabanları oluşturma, yönetme ve geçirme hakkında bilgi edinin</p>
<ol>
    <li><a href="/azure/sql-database/sql-database-design-first-database">Yeni SQL Veritabanı için şema oluşturma ve tasarlama</a></li>
    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Mevcut SQL Server Veritabanını Azure SQL Veritabanı kullanmak üzere geçirme</a></li>
    <li><a href="/azure/sql-database/sql-database-security-tutorial">SQL Veritabanınızın güvenliğini sağlama</a></li> 
    <li><a href="/azure/sql-database/sql-database-performance-tutorial">SQL Veritabanı performansını iyileştirme</a></li> 
</ol>
...
<h2 style="margin-top: 36px">Örnekler</h2>
<p>Yaygın görevleri yönetmeye yönelik betikleri bulma</p>
<ul class="spaced">
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (Elastik DB)</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server Araçları</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">SQL Server Araçları</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt238290.aspx">SQL Server Management Studio (SSMS)</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt204009.aspx">SQL Server Veri Araçları (SSDT)</a></p>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">SQL Veritabanı Yönetim Kitaplığı paketi</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>SQL Server Sürücüleri</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">SQL Server Sürücüleri</a></p>
