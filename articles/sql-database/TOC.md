...
### Tek veritabanları
#### Öğrenin
##### [Azure portalı öğreticisi: Azure portalını kullanarak Azure SQL veritabanı oluşturma](sql-database-get-started.md)
#### Yapın
##### [Azure portalı öğreticisi: Azure portalını kullanarak Azure SQL veritabanı oluşturma](sql-database-get-started.md)
##### [Azure portalı öğreticisi: PowerShell’i kullanarak Azure SQL veritabanı oluşturma](sql-database-get-started-powershell.md)
##### [Azure portalı öğreticisi: C# kullanarak Azure SQL veritabanı oluşturma](sql-database-get-started-csharp.md)
...
### Ölçeği genişletme
#### Öğrenin
##### [Ölçeği genişletme](sql-database-elastic-scale-introduction.md)
...
##### [Esnek işleri kaldırma](sql-database-elastic-jobs-uninstall.md)
...
##### [SQL Server Management Studio Geçiş Sihirbazı](sql-database-cloud-migrate-compatible-using-ssms-migration-wizard.md)
...
## Kimlik doğrulaması ve erişim verme
### Öğrenin
...
### Yapın
### [Öğretici: SQL kimlik doğrulaması ve erişim](sql-database-get-started-security.md)
...
##### [Windows sertifika deposu](sql-database-always-encrypted.md)
...
#### Coğrafi Geri Yükleme veritabanları
...
#### Etkin Coğrafi Çoğaltma ile yük devretme
...
### Müşterilerin hizmet olarak yazılım uygulamaları
...
#### [Azure portalında esnek işler oluşturma ve yönetme](sql-database-elastic-jobs-create-and-manage.md)
...
#### [Azure portalını kullanma](sql-database-scale-up.md)
#### [PowerShell’i kullanma](sql-database-scale-up-powershell.md)
