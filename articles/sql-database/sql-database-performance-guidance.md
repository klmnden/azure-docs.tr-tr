...
El ile uygulanan yöntemleri ne karar vermeniz gerekir çünkü bunlar [hizmet katmanları](sql-database-service-tiers.md) seçmeniz veya uygulama ya da veritabanı kodu yeniden yazma ve değişiklikleri deply gerekir.
