...
- Azure SQL veritabanı iki yönlü, anında, güncelleştirilebilir veya eşler arası çoğaltma desteklemez.      
 ...
 3.  İlk veri kümesi, genellikle anlık görüntü aracısı tarafından oluşturulan ve dağıtılan ve Dağıtım Aracısı tarafından uygulanan bir anlık görüntüdür. İlk veri kümesi, ayrıca bir yedekleme ya da SQL Server Integration Services gibi diğer yollarla aracılığıyla sağlanabilir.  
...
-   [Bir itme aboneliği oluşturmak](https://docs.microsoft.com/sql/relational-databases/replication/create-a-push-subscription/create-a-push-subscription) abonesi olarak Azure SQL veritabanı mantıksal sunucusu adı kullanarak (örneğin **N'azuresqldbdns.database.windows.net'**) ve hedef veritabanı (Azure SQL veritabanı adıyla Örneğin **AdventureWorks**).  
   
 ## <a name="see-also"></a>Ayrıca Bkz.  
 - [Bir yayın oluşturun](https://docs.microsoft.com/sql/relational-databases/replication/publish/create-a-publication)   
 - [Gönderme temelli bir abonelik oluşturun](https://docs.microsoft.com/sql/relational-databases/replication/create-a-push-subscription/create-a-push-subscription)   
