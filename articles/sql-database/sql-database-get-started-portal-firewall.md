...
ms.locfileid: "47161922"
---
# <a name="create-a-server-level-firewall-rule-for-your-sql-database-using-the-azure-portal"></a>Azure portalı kullanarak SQL veritabanınız için sunucu düzeyinde bir güvenlik duvarı kuralı oluşturun
