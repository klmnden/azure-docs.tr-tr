...
- Sistem ve kullanıcı veritabanlarını içeren ve bir kaynak kümesini paylaşan, [yönetilen örnek](sql-database-managed-instance.md) (genel önizlemede) olarak bilinen veritabanı koleksiyonunun bir parçası
