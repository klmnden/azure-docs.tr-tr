...
Elastik İş cmdlet'lerini almak için **AzureRM.Sql** modülünün en son önizleme sürümünü yükleyin. Aşağıdaki komutları yükseltilmiş komut isteminden (yönetici olarak çalıştır) çalıştırın.
