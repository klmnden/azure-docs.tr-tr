...
- Tempdb boyutu sınırları hakkında daha fazla bilgi için https://docs.microsoft.com/en-us/sql/relational-databases/databases/tempdb-database#tempdb-database-in-sql-database bakın.
