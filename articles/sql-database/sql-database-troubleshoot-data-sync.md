...
## <a name="troubleshooting-sync"></a>Eşitleme sorunlarını giderme
...
## <a name="troubleshooting-the-client-agent"></a>İstemci Aracısı sorunlarını giderme
...
**İstemci aracısı ve eşitleme grubu olan farklı veri merkezleri**
...
-   Yeni bir aracı aynı veri merkezinde eşitleme grup olarak oluşturun. Ardından bu aracı ile veritabanı kaydedin.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Sorun giderme Kurulum ve Bakım
...
3. Kullanıcı hesabını eklemek **hizmet oturum açma** **özellikleri** iletişim kutusu.
...
Kayıp veya bozuk bir veritabanını bir yedekten geri yakınsaması veritabanının ait olduğu eşitleme gruplara veri olabilir.
