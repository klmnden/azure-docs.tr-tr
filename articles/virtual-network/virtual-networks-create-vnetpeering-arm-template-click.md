---
title: "Resource Manager şablonları kullanarak Sanal Ağ Eşlemesi oluşturma | Microsoft Belgeleri"
...
---
# <a name="create-vnet-peering-using-resource-manager-templates"></a>Resource Manager şablonları kullanarak VNet Eşlemesi oluşturma
...
4. Şablon dosyasını dağıtmak için, dağıtımı oluşturmak veya güncelleştirmek üzere New-AzureRmResourceGroupDeployment cmdlet'ini çalıştırabilirsiniz. Resource Manager şablonlarının kullanımı hakkında daha fazla bilgi edinmek için lütfen bu [makaleye](../resource-group-template-deploy.md) bakın.
   ...
   > [!NOTE]
   > Lütfen kaynak grubu adını ve şablon dosyasını uygun şekilde değiştirin.
   > 
   > 
