...
- **PowerShell**: [AzureRmVirtualNetworkPeering Ekle](/powershell/module/azurerm.network/add-azurermvirtualnetworkpeering)
...
4. Altında **ayarları**seçin **eşlemeler**.
5. Eşleme için ayarlarını görüntülemek veya değiştirmek istiyorsanız seçin.
6. Uygun ayarını değiştirin. Her bir ayar için seçenekleri hakkında bilgi edinin [6. adım](#add-peering) bir eşleme oluştur. 
7. **Kaydet**’i seçin.
...
3. Sanal ağlar listesinden eşleme silmek istediğiniz sanal ağı seçin.
4. Altında **ayarları**seçin **eşlemeler**.
5. Silmek istediğiniz eşlemesi sağdaki, seçin **...** seçin **Sil**, ardından **Evet** ilk sanal ağdan eşlemesini silmek için.
6. Eşlemedeki diğer sanal ağ eşlemesini silmek için önceki adımları tamamlayın.
...
- Resource Manager ile oluşturulmuş olan iki sanal ağı eşlerken eşlemedeki her sanal ağ için bir eşleme yapılandırılması gerekir. Eşleme durumu için aşağıdaki türlerinden birini görürsünüz: 
    - *Başlatılan:* ilk sanal ağdan ikinci sanal ağa eşleme oluşturduğunuzda eşleme durumu olan *başlatılan*. 
    - *Bağlı:* ikinci sanal ağdan ilk sanal ağa eşleme oluşturduğunuzda eşleme durumu olan *bağlı*. İlk sanal ağ için eşleme durumunu görüntülerseniz, değiştirildi durumu gördüğünüz *başlatılan* için *bağlı*. Her iki sanal ağ eşlemesi için eşleme durumunu olana kadar Eşleme başarıyla oluşturulmuş olmaz *bağlı*.
