...
Bu makale, klasik dağıtım modelini kapsamaktadır. Ayrıca [kontrol Yönlendirme ve Resource Manager dağıtım modelinde sanal gereçler kullanma](virtual-network-create-udr-arm-cli.md).
