...
- **[Azure App Service'e](https://docs.microsoft.com/azure/app-service/app-service-ip-restrictions)** : Uygulama hizmet kullanılabilir olduğu tüm Azure bölgelerinde kullanıma sunuldu
