...
Bu belge, Klasik dağıtım modeli kullanarak VNet oluşturma kapsar. Ayrıca [Resource Manager dağıtım modelinde bir sanal ağ oluşturma](virtual-networks-create-vnet-arm-ps.md).
