...
Bu belgede Resource Manager dağıtım modeli kullanılarak bir sanal ağın oluşturulması ele alınmaktadır. Ayrıca [klasik dağıtım modelinde bir sanal ağ oluşturabilirsiniz](virtual-networks-create-vnet-classic-netcfg-ps.md).
