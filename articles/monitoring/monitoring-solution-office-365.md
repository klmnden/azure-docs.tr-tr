...
Bu çözüm, tüm yönetim paketlerinde yüklemez [bağlı Yönetim grupları](../log-analytics/log-analytics-om-agents.md).
  
## <a name="install-and-configure"></a>Yükleme ve yapılandırma
Başlangıç ekleyerek [aboneliğinizi Office 365 çözüme](monitoring-solutions.md#install-a-management-solution). Eklendikten sonra Office 365 aboneliğinize erişimi vermek için bu bölümdeki yapılandırma adımları gerçekleştirmeniz gerekir.
...
1. **Yeni uygulama kaydı**’na tıklayın.
    ...
    ![Uygulama kaydı ekleme](media/monitoring-solution-office-365/add-app-registration.png)
1. Bir uygulama girin **adı** ve **oturum açma URL'si**.  Adı açıklayıcı olmalıdır.  Kullanım _http://localhost_ URL'si ve canlı _Web uygulaması / API_ için **uygulama türü**
    ...
    ![Uygulama oluştur](media/monitoring-solution-office-365/create-application.png)
1. Tıklayın **Oluştur** ve uygulama bilgilerini doğrulayın.

    ![Kayıtlı uygulama](media/monitoring-solution-office-365/registered-app.png)
...
1. Seçin **özellikleri**. Değişiklik **çok kiracılı** için _Evet_.
    ...
    ![Ayarları multitenant](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Tıklayın **bir API seçin** ardından **Office 365 Yönetim API'leri**. tıklayın **Office 365 Yönetim API'leri**. **Seç**'e tıklayın.
    ...
    ![API seçin](media/monitoring-solution-office-365/select-api.png)
...
1. Altında **izinleri seçin** hem de aşağıdaki seçenekleri belirleyin **uygulama izinleri** ve **temsilci izinleri**:
    ...
    ![API seçin](media/monitoring-solution-office-365/select-permissions.png)

1. Tıklayın **seçin** ardından **Bitti**.
1. Tıklayın **izinleri verin** ve ardından **Evet** doğrulama için sorulduğunda.

    ![İzinleri verme](media/monitoring-solution-office-365/grant-permissions.png)
...
1. Tıklayın **Kaydet** kopyalayın **değer** , oluşturulur.
    ...
    ![Anahtarlar](media/monitoring-solution-office-365/keys.png)
...
1. Aşağıdakine benzer bir pencere ile sunulur. Tıklayın **kabul**.
    ...
    ![Yönetici onayı](media/monitoring-solution-office-365/admin-consent.png)
...
### <a name="troublshooting"></a>Sorun giderme
...
Bağlantısındaki işlemi kullanarak Office 365 yönetim çözümü kaldırabilirsiniz [bir yönetim çözümünü Kaldır](../monitoring/monitoring-solutions.md#remove-a-management-solution). Bu, Office 365'ten Log Analytics'e ancak toplanan verilerin durdurmaz. Office 365'ten aboneliği ve veri toplamayı durdurmak için aşağıdaki yordamı izleyin.
...
![Office 365 Özet kutucuğu](media/monitoring-solution-office-365/tile.png)  

Tıklayarak **Office 365** açmak için kutucuğa **Office 365** Pano.

![Office 365 Panosu](media/monitoring-solution-office-365/dashboard.png)  
