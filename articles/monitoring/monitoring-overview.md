---
title: Azure uygulamalarını ve kaynaklarını izleme | Microsoft Docs
...
Bu ölçüm ve günlükleri Azure Log Analytics popüler ve ayrıntılı analiz için gönderme veya proaktif olarak size, analiz sonucunda kritik sorunları bildirmek için ek uyarı kuralları oluşturun.  
...
[Ağ Performans İzleyicisi (NPM)](https://blogs.msdn.microsoft.com/azuregov/2017/09/05/network-performance-monitor-general-availability/), genel bulutlar, veri merkezleri ve şirket içi ortamlar arasında bağlantıyı izleyen, bulut tabanlı bir ağ izleme çözümüdür.

[ExpressRoute İzleyicisi](https://azure.microsoft.com/blog/monitoring-of-azure-expressroute-in-preview/), Azure ExpressRoute devrelerindeki uçtan uca bağlantı ve performansı izleyen bir NPM özelliğidir.
