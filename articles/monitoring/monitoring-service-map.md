...
3. Market arama sonuçları sayfasını seçin **hizmet eşlemesi** listeden.<br><br> ![Azure Market araması sonuçlarından hizmet eşlemesi çözümünü seçin](./media/monitoring-service-map/marketplace-search-results.png)<br>
4. Üzerinde **hizmet eşlemesi** genel bakış bölmesinde, çözüm ayrıntıları gözden geçirin ve ardından **Oluştur** Log Analytics çalışma alanınıza onboarding işlemine başlamak için.<br><br> ![Yerleşik hizmet eşlemesi çözümünü](./media/monitoring-service-map/service-map-onboard.png).
...
Hizmet eşlemesi, Log Analytics çalışma alanını Azure portalından erişmek ve seçeneğini **çözümleri** sol bölmeden.<br><br> ![Çalışma alanındaki çözümler seçeneğini](./media/monitoring-service-map/select-solution-from-workspace.png).<br> Çözümleri listesinden seçin **ServiceMap(workspaceName)** ve hizmet eşlemesi Özet kutucuğu hizmet eşlemesi çözümü genel bakış sayfasını tıklatın.<br><br> ![Hizmet eşlemesi Özet kutucuğu](./media/monitoring-service-map/service-map-summary-tile.png).
...
![Hizmet eşlemesi genel bakış](media/monitoring-service-map/service-map-overview.png)
...
![Durumu rozetlerinin](media/monitoring-service-map/status-badges.png)
...
![Gruplar sekmesinde](media/monitoring-service-map/machine-groups-tab.png)

Ardından bu makine grubu için haritada görüntülemek için Grup adını seçin.
![Makine grubu](media/monitoring-service-map/machine-group.png) grubuna ait makineleri harita beyaz özetlenen.

Grup genişletme makine grubu oluşturan makineleri listeler.

![Makine grubu makineler](media/monitoring-service-map/machine-groups-machines.png)
...
![Makine grubu işlemleri filtrelendi](media/monitoring-service-map/machine-groups-filtered.png)
...
![Makine grubundan Kaldır](media/monitoring-service-map/machine-groups-remove.png)
...
![Rol simgeleri](media/monitoring-service-map/role-icons.png)
...
![Başarısız bağlantılar](media/monitoring-service-map/context-menu.png)
...
![Makine özellikleri bölmesi](media/monitoring-service-map/machine-properties.png)
...
![İşlem özellikleri bölmesi](media/monitoring-service-map/process-properties.png)
...
![İşlem özeti bölmesi](media/monitoring-service-map/process-summary.png)
...
![Uyarılar bölmesinde makine](media/monitoring-service-map/machine-alerts.png)
...
![Makine günlüğü olaylarını bölmesi](media/monitoring-service-map/log-events.png)
...
![Makine hizmet Masası bölmesi](media/monitoring-service-map/service-desk.png)
...
![Makine değişiklik izleme bölmesinde](media/monitoring-service-map/change-tracking.png)
...
![ConfigurationChange olay](media/monitoring-service-map/configuration-change-event-01.png)
...
![Makine performans bölmesi](media/monitoring-service-map/machine-performance.png)
...
Güncelleştirme yönetimi ile tümleştirme hizmet eşlemesi, her iki çözüm de etkin ve yapılandırılmış günlük Anlaytics çalışma alanınızda otomatiktir.
...
![Makine değişiklik izleme bölmesinde](media/monitoring-service-map/machine-updates.png)

## <a name="log-analytics-records"></a>Log Analytics kayıtları
Hizmet eşlemesi bilgisayar ve envanter verileri için kullanılabilir [arama](../log-analytics/log-analytics-log-searches.md) Log analytics'te. Geçiş planlaması kapasite analizi, bulma ve isteğe bağlı performans sorunlarını giderme senaryoları için bu verileri uygulayabilirsiniz.
...
Daha fazla bilgi edinin [günlük aramaları](../log-analytics/log-analytics-log-searches.md) hizmet eşlemesi tarafından toplanan verileri almak için Log analytics'te.


## <a name="troubleshooting"></a>Sorun giderme
Bkz: [hizmet eşlemesi yapılandırma belgesinin bölümü sorun giderme]( monitoring-service-map-configure.md#troubleshooting).
