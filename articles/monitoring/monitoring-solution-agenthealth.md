...
Aracı durumu çözümü açıklanan işlemi kullanarak Log Analytics çalışma alanınıza eklemek [çözüm ekleme](monitoring-solutions.md). Başka bir yapılandırma işlemi gerekmez.
