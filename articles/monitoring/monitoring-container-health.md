...
4. Değeri düzenlemek **aksResourceId**, **aksResourceLocation** üzerinde bulabilirsiniz değerlerle **AKS genel bakış** AKS kümesi için sayfa.  Değeri **Workspaceıd** günlük analizi çalışma alanı adı olması ve çalışma alanı oluşturulur için konumu belirtin **workspaceRegion**.    
