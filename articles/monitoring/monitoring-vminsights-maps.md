...
![Bilgisayarın Sistem Özellikleri](./media/monitoring-vminsights-maps/properties-pane-01.png)
...
![Özellikler bölmesinde günlük arama listesi](./media/monitoring-vminsights-maps/properties-pane-logs-01.png)
...
![Özellikler bölmesinde makine uyarıları](./media/monitoring-vminsights-maps/properties-pane-alerts-01.png)
...
![Ağ bağlantısı grafikler bölmesinde örneği](./media/monitoring-vminsights-maps/map-group-network-conn-pane-01.png)  
...
![Harita üzerinde başarısız bağlantı örneği](./media/monitoring-vminsights-maps/map-group-failed-connection-01.png)
...
![Harita üzerinde istemci grupları örneği](./media/monitoring-vminsights-maps/map-group-client-groups-01.png)
...
![Harita üzerinde istemci grubu IP adresi listesi örneği](./media/monitoring-vminsights-maps/map-group-client-group-iplist-01.png)
...
![Harita üzerinde sunucu bağlantı noktası grubu örneği](./media/monitoring-vminsights-maps/map-group-server-port-groups-01.png)  
...
![Doğrudan VM eşlemesi genel bakış](./media/monitoring-vminsights-maps/map-direct-vm-01.png)
