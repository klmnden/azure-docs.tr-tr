...
![OMSIngestionAPI Modülü](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Runbook’u düzenleme](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Runbook testi](media/monitoring-runbook-datacollect/test-runbook.png)
...
![Runbook yayımlama](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Günlüğe kaydetme ve izleme](media/monitoring-runbook-datacollect/logging.png)
...
![Runbook zamanlama](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
5. Aşağıdaki görüntüye benzer bir giriş bulunacak En Alta kaydırın.<br>![Ayrıntılı](media/monitoring-runbook-datacollect/verbose.png)
