...
![Tüm çözümler listesi](media/monitoring-solutions/list-solutions-all.png)
...
![Çözüm yükleme](media/monitoring-solutions/install-solution.png)
...
* Alma bir [Microsoft gelen yönetim çözümlerinin listesini](monitoring-solutions-inventory.md).
