---
title: "Azure DocumentDB .NET değiştirmek akış işlemci SDK & kaynakları | Microsoft Docs"
description: "Tüm değişiklik akış işlemci API ve yayın tarih, sona erme tarihlerini ve DocumentDB .NET değişiklik akış işlemci SDK her sürümü arasında yapılan değişiklikler dahil olmak üzere SDK'sı hakkında bilgi edinin."
services: cosmos-db
...
---
# <a name="documentdb-net-change-feed-processor-sdk-download-and-release-notes"></a>DocumentDB .NET değişiklik akış işlemci SDK: İndirme ve sürüm notları
...
|**Kullanmaya başlama**|[DocumentDB değişiklik akış işlemci .NET SDK ile çalışmaya başlama](change-feed.md)|
...
* Uyumlu [DocumentDB .NET SDK'sı](documentdb-sdk-dotnet.md) sürümleri 1.17.0 ve üstü.
* Uyumlu [DocumentDB .NET Core SDK](documentdb-sdk-dotnet-core.md) sürümleri 1.5.1 ve üstü.

### <a name="a-name111111"></a><a name="1.1.1"/>1.1.1
* Bir sorunu kalan çalışma tahmin hesaplanması değişiklik akışı boş veya hiçbir iş bekleyen giderir.
* Uyumlu [DocumentDB .NET SDK'sı](documentdb-sdk-dotnet.md) sürümleri 1.13.2 ve üstü.
...
* GA SDK'SI
* Uyumlu [DocumentDB .NET SDK'sı](documentdb-sdk-dotnet.md) sürümleri 1.14.1 ve aşağıdaki.
