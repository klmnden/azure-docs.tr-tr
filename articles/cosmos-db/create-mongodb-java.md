...
Artık [Robomongo](../documentdb/documentdb-mongodb-robomongo.md) / [Studio 3T](../documentdb/documentdb-mongodb-mongochef.md) kullanarak yeni verileri sorgulayabilir, değiştirebilir ve onlarla çalışabilirsiniz.
