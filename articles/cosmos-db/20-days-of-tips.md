...
![Her gün yeni bir Azure Cosmos DB ipucu öğrenin](./media/20-days-of-tips/20-days-of-azure-cosmos-db-tips-header.png)

Simona Cotin göre Azure Cosmos DB ipuçları 20 gün gördüğünüz varsa [twitter](https://twitter.com/simona_cotin) ve [LinkedIn](https://www.linkedin.com/in/simona-cotin-2ba8747/detail/recent-activity/shares/), bunlar tüm kullanılabilir tek bir yerde isteyebilir. İyi, burada oldukları!

Her gün yeni bir ipucu gelen Eylül 5 - Eylül 29 için bu sayfayı ziyaret edin!
...
İpucu 8: Derleme bir @nodejs SQL API ve Azure #CosmosDB kullanarak uygulama. Belgeleri sayfasında daha fazla bilgi edinin [https://aka.ms/Bd77a8](https://aka.ms/Bd77a8)  
...
İpucu 9: Node.js içinde MongoDB API kullanarak Azure #CosmosDB sorgu. Belgeleri sayfasında daha fazla bilgi edinin [https://aka.ms/Dert0r](https://aka.ms/Dert0r)  
...
İpucu 15: sürekli bırakmadan yeni Azure #CosmosDB hesabı oluşturma @code. Uzantı yükleme [https://aka.ms/Wy547u](https://aka.ms/Wy547u) 
...
Okuyarak Azure Cosmos DB hakkında daha fazla bilgi ['na Hoş Geldiniz Azure Cosmos DB](introduction.md) ve [Azure Cosmos DB teknik genel bakış](https://azure.microsoft.com/blog/a-technical-overview-of-azure-cosmos-db/).
