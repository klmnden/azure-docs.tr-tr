---
title: Python kullanarak Azure Tablo depolamayı ve Azure Cosmos DB Tablo API’sini kullanmaya başlama | Microsoft Docs
...
Bu örnekteki senaryolarda çalışırken [Python API'si için Azure Cosmos DB SDK'sı belgelerine](https://azure.github.io/azure-cosmosdb-python/) başvurmanız önerilir.
...
Python'da Azure Tablo Depolama’daki varlıklarla çalışmak için [TableService](https://azure.github.io/azure-cosmosdb-python/ref/azure.cosmosdb.table.tableservice.html) ve [Entity][py_Entity] sınıflarını kullanırsınız. Bunların ikisini de içeri aktarmak için şu kodu Python dosyanızın başına ekleyin:
...
Azure Depolama Tablo hizmetine bağlanmak için, bir [TableService](https://azure.github.io/azure-cosmosdb-python/ref/azure.cosmosdb.table.tableservice.html) nesnesi oluşturun ve Depolama hesabınızın adını ve hesap anahtarını geçin. `myaccount` ve `mykey` ifadelerini hesap adınız ve anahtarınız ile değiştirin.
...
Azure Cosmos DB'ye bağlanmak için, Azure portalından birincil bağlantı dizenizi kopyalayın ve kopyaladığınız bağlantı dizesini kullanarak bir [TableService](https://azure.github.io/azure-cosmosdb-python/ref/azure.cosmosdb.table.tableservice.html) nesnesi oluşturun:
...
* [Python API'si için Azure Cosmos DB SDK'sı belgeleri](https://azure.github.io/azure-cosmosdb-python/)
