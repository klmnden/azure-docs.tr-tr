---
title: "Azure PowerShell komut dosyası oluştur Azure Cosmos DB SQL API'si hesabınız | Microsoft Docs"
description: "Azure PowerShell Betiği örnek - bir Azure Cosmos DB SQL API hesap oluşturma"
services: cosmos-db
...
---
# <a name="azure-cosmos-db-create-a-sql-api-account-using-powershell"></a>Azure Cosmos DB: PowerShell kullanarak SQL API hesabı oluşturma

Bu örnek PowerShell komut dosyasını bir Azure Cosmos DB API hesabı oluşturur. 
