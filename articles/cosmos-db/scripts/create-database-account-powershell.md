---
title: "Azure PowerShell komut dosyası oluştur Azure Cosmos DB DocumentDB API'si hesabınız | Microsoft Docs"
...
---
# <a name="azure-cosmos-db-create-a-documentdb-api-account-using-powershell"></a>Azure Cosmos DB: PowerShell kullanarak DocumentDB API hesabı oluşturma
