---
title: "MongoDB uygulamaları için Azure PowerShell Betiği Get Azure Cosmos DB bağlantı dizesi | Microsoft Docs"
...
---
# <a name="get-an-azure-cosmos-db-connection-string-for-mongodb-apps-using-powershell"></a>PowerShell kullanarak MongoDB uygulamaları için Azure Cosmos DB bağlantı dizesi alma

Bu örnek bir PowerShell kullanarak MongoDB uygulamaları için Azure Cosmos DB bağlantı dizesini alır. 
