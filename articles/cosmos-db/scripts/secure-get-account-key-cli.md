...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | SQL Veritabanını barındıran bir mantıksal sunucu oluşturur. |
