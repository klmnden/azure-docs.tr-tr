---
title: Azure CLI betiği-Azure Cosmos DB tablo API'si hesap oluşturma, veritabanı ve tablo
...
ms.locfileid: "54035330"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-azure-cli"></a>Azure Cosmos DB: Azure CLI kullanarak bir tablo API hesabı oluşturma
