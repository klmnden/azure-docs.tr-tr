...
| [az cosmosdb listesi-bağlantı-dizeleri](https://docs.microsoft.com/cli/azure/cosmosdb#az_cosmosdb_list_connection_strings) | Hesap için bağlantı dizesini alır.|
