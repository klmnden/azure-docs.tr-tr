---
title: Azure PowerShell Betiği - Azure Cosmos hesabınız için anahtarları alma
description: Azure PowerShell betik örneği - bir Azure Cosmos hesap anahtarları alma
author: markjbrown
...
ms.locfileid: "65078408"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>PowerShell kullanarak bir Azure Cosmos hesap anahtarları alma
