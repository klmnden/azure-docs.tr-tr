---
title: Azure PowerShell Betiği - Azure Cosmos hesabınız için bağlantı dizelerini Get
description: Azure PowerShell betik örneği - Azure Cosmos hesabınız için bağlantı dizelerini Get
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>PowerShell kullanarak Azure Cosmos hesabınız için bağlantı dizeleri alma
