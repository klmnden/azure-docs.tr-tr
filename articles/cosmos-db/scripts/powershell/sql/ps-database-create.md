---
title: Azure PowerShell Betiği - Azure Cosmos veritabanı oluşturma
description: Azure PowerShell betik örneği - Azure Cosmos veritabanı oluşturma
author: markjbrown
...
ms.locfileid: "65077823"
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>PowerShell kullanarak Azure Cosmos veritabanı oluşturma
