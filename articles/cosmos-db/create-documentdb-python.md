...
Bu hızlı başlangıç belgesinde Azure portalı kullanarak bir Azure Cosmos DB hesabını, belge veritabanını ve koleksiyonunu nasıl oluşturacağınız anlatılmıştır. Bu adımların ardından [DocumentDB Python API'si](../documentdb/documentdb-sdk-python.md) kullanarak bir konsol uygulaması derleyebilir ve çalıştırabilirsiniz.
...
> [DocumentDB API'si için Azure Cosmos DB içine veri aktarma](../documentdb/documentdb-import-data.md)
