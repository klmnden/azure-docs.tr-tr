...
ms.locfileid: "41919223"
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-azure-cosmos-db-sql-api-and-javascript-sdk-20-preview"></a>Node.js öğreticisi: Azure Cosmos DB SQL API ve JavaScript SDK 2.0 (önizleme) ile bir Node.js konsol uygulaması oluşturma

> [!div class="op_single_selector"]
> * [.NET](sql-api-get-started.md)
> * [.NET Core](sql-api-dotnetcore-get-started.md)
> * [Node.js](sql-api-nodejs-get-started.md)
> * [Node.js - v2.0 Önizleme](sql-api-nodejs-get-started-preview.md)
...
* Daha karmaşık bir Node.js örneği ister misiniz? Bkz. [Azure Cosmos DB kullanarak bir Node.js web uygulaması oluşturma](sql-api-nodejs-application-preview.md).
