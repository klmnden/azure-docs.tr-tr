...
ms.locfileid: "65077778"
---
# <a name="create-azure-cosmos-db-api-for-mongodb-resources-from-a-resource-manager-template"></a>Azure Cosmos DB API için MongoDB kaynaklardan bir Resource Manager şablonu oluşturma

Bir Azure Resource Manager şablonu kullanarak MongoDB kaynaklar için bir Azure Cosmos DB API oluşturmayı öğrenin. Aşağıdaki örnek, MongoDB API'si için Azure Cosmos DB hesabı oluşturur. bir [Azure Hızlı Başlangıç şablonu](https://aka.ms/mongodb-arm-qs). Bu şablon, 400 RU/sn aktarım hızı ve veritabanı düzeyinde paylaşan iki koleksiyon ile MongoDB API'si için bir Azure Cosmos hesabı oluşturur.
