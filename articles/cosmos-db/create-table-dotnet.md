...
ms.locfileid: "54038611"
---
# <a name="quickstart-build-a-table-api-app-with-net-and-azure-cosmos-db"></a>Hızlı Başlangıç: API uygulaması .NET ve Azure Cosmos DB ile tablo oluşturma 
