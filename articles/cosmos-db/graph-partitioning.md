---
title: Graph API bölümleme | Microsoft Docs
...
- **Köşe ve kenarlar hem JSON belgeleri olarak depolanır** arka uç bir Azure Cosmos DB Graph API kapsayıcısının içinde.
...
Bu makaledeki kavramları ve bir Azure Cosmos DB Graph API ile bölümleme için en iyi bir genel bakış sağlanmadı. 

* Hakkında bilgi edinin [bölümleme ve ölçeklendirme Azure Cosmos DB'de](partition-data.md).
* Hakkında bilgi edinin [Graph API, Gremlin desteği](gremlin-support.md).
* Hakkında bilgi edinin [Graph API giriş](graph-introduction.md).
