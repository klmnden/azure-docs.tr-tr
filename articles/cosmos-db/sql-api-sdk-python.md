...
<tr><td>**SDK'sını indirin**</td><td>[PyPI](https://pypi.python.org/pypi/pydocumentdb)</td></tr>

<tr><td>**API belgeleri**</td><td>[Python API başvuru belgeleri](https://docs.microsoft.com/python/api/pydocumentdb?view=azure-python)</td></tr>
