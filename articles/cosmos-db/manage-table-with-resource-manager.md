...
ms.locfileid: "65077613"
---
# <a name="create-azure-cosmos-db-table-api-resources-from-a-resource-manager-template"></a>Azure Cosmos DB tablo API'si kaynakları bir Resource Manager şablonu oluşturma

Bir Azure Resource Manager şablonu kullanarak bir Azure Cosmos DB tablo API'si kaynakları oluşturmayı öğrenin. Aşağıdaki örnek, Azure Cosmos DB tablo API'si oluşturur. bir [Azure Hızlı Başlangıç şablonu](https://aka.ms/table-arm-qs). Bu şablon, tek bir tabloya 400 RU/sn aktarım hızı ile tablo API'si için bir Azure Cosmos hesabı oluşturur.
