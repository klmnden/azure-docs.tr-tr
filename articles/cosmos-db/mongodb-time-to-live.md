...
description: Belirli bir süre sonunda sistemden otomatik olarak temizlemek için MongoDB API aracılığıyla oluşturulan Azure Cosmos DB belgelerinin yaşam süresini nasıl ayarlayacağınızı öğrenin.
services: cosmos-db
author: orestis-ms
ms.author: orkostak
