...
ms.locfileid: "65077763"
---
# <a name="create-azure-cosmos-db-core-sql-api-resources-from-a-resource-manager-template"></a>Azure Cosmos DB Çekirdek (SQL) API kaynakları bir Resource Manager şablonu oluşturma

Bir Azure Resource Manager şablonu kullanarak bir Azure Cosmos DB kaynaklarını oluşturmayı öğrenin. Aşağıdaki örnek, bir Azure Cosmos DB hesabınızdan oluşturur. bir [Azure Hızlı Başlangıç şablonu](https://aka.ms/sql-arm-qs). Bu şablon, 400 RU/sn aktarım hızı ve veritabanı düzeyinde paylaşan iki kapsayıcı içeren bir Azure Cosmos hesabı oluşturur.
