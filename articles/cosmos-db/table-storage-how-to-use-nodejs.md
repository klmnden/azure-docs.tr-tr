---
title: Node.js uygulamasından Azure Tablo depolama veya Azure Cosmos DB Tablo API’sini kullanma | Microsoft Docs
...
## <a name="add-an-azure-comsos-db-connection"></a>Azure Cosmos DB bağlantısı ekleme
...
Hem **PartitionKey** hem de **RowKey** dize değerleri olmalıdır. Daha fazla bilgi için bkz. [Tablo Hizmeti Veri Modelini anlama](http://msdn.microsoft.com/library/azure/dd179338.aspx).
...
İşlem başarılı olursa `result`, eklenen kaydın [ETag](http://en.wikipedia.org/wiki/HTTP_ETag) öğesini içerir ve `response`, işlemle ilgili bilgileri içerir.
