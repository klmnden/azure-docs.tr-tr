...
[!code-azurecli-interactive[Ana](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "çok katmanlı uygulama için sanal ağ")]
