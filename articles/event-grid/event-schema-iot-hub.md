...
Veri nesnesi, içeriğini, her olay yayımcısı için farklıdır. IOT Hub olaylarını veri nesnesinin aşağıdaki özellikleri içerir:
...
| ETag | dize | Cihaz ikizi içeriğini açıklayan bilgi parçası. Her bir etag cihaz ikizi benzersiz olması garanti edilir. | 
