...
description: Event Grid için Azure PowerShell örnekleri
services: event-grid
author: tfitzmac
manager: timlt
...
|**Event Grid konuları**||
| [Özel konu oluşturma](scripts/event-grid-powershell-create-custom-topic.md) | Özel bir VHD’den işletim sistemi diski olarak veya bir veri VHD’sinden veri diski olarak yönetilen bir disk oluşturur.  |
| | |
