...
- **Göster**: güvenlik duvarı kuralı Azure MySQL sunucusu ayrıntılarını göster.
- **Güncelleştirme**: bir Azure MySQL sunucusu güvenlik duvarı kuralını güncelleştir.
