...
Node.js'yi yüklemek için platformunuza uygun yönergeleri izleyin. Proje klasörünüze mysql2 paketini ve bağımlılıklarını yüklemek için npm kullanın.
...
3. Komut istemini başlatın ve cd komutuyla proje klasörüne geçin; örneğin, `cd c:\nodejsmysql\`
...
2. Komut istemini veya bash kabuğunu başlatın. Dizini, proje klasörünüzle değiştirin (`cd nodejsmysql`).
