---
title: Azure veritabanı için MySQL ile iş sürekliliği genel bakış
description: Azure veritabanı için MySQL ile iş sürekliliği genel bakış.
services: mysql
author: kamathsun
ms.author: sukamat
manager: kfile
...
ms.locfileid: "35263584"
---
# <a name="overview-of-business-continuity-with-azure-database-for-mysql"></a>Azure veritabanı için MySQL ile iş sürekliliği genel bakış

Bu genel bakışta, iş devamlılığı ve olağanüstü durum kurtarma için Azure veritabanı için MySQL sağlar özellikleri açıklanmaktadır. Veri kaybına neden ya da veritabanı ve uygulamanızın kullanılamaz hale gelmesine neden kesintiye uğratan olaylarından kurtarma seçenekleri hakkında bilgi edinin. Bir kullanıcı veya uygulama hatası veri bütünlüğü etkiler, bir Azure bölgesinin bir kesinti veya bakım uygulamanızın gerektirdiği olmadığında yapmanız gerekenler hakkında bilgi edinin.
...
- Otomatik yedekleme hakkında daha fazla bilgi için bkz: [MySQL için Azure veritabanı yedeklemeleri](concepts-backup.md).
