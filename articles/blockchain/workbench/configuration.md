...
| Alan | Açıklama | Gereklidir | En büyük uzunluk |
|-------|-------------|:--------:|-----------:|
...
| dize  | Dize veri türü. 4000 karakter üst sınırı. Bkz: [örnek yapılandırma](#example-configuration-of-type-string). |
