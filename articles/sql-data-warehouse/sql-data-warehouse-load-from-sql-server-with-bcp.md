---
title: SQL Server'dan Azure SQL Data Warehouse'a Veri Yükleme (bcp) | Microsoft Docs
...
SQL Data Warehouse henüz istatistiklerin otomatik olarak oluşturulup güncelleştirilmesini desteklemiyor. Sorgularınızdan en iyi performansı elde edebilmeniz için ilk yüklemeden veya verilerdeki önemli değişikliklerden sonra istatistiklerin tüm sütunlarda oluşturulması önemlidir. İstatistiklerin ayrıntılı bir açıklaması için bkz. [İstatistikler][İstatistikler]. 
...
SQL Data Warehouse'da tablo oluşturma hakkında daha fazla bilgi için bkz. [Tabloya Genel Bakış][Tabloya Genel Bakış] veya [CREATE TABLE söz dizimi][CREATE TABLE söz dizimi].
