<properties
   pageTitle="Azure SQL Data Warehouse'u sorgulama (Visual Studio) | Microsoft Azure"
...
+ Var olan bir SQL veri ambarı. Bir tane oluşturmak için bkz. [SQL Data Warehouse oluşturma][].
+ Visual Studio için SSDT. Visual Studio varsa büyük olasılıkla buna da sahip olursunuz. Yükleme yönergeleri ve seçenekleri için bkz. [Visual Studio’yu ve SSDT’yi yükleme][].
+ Tam SQL server adı. Bunu bulmak için bkz. [SQL Data Warehouse'a bağlanma][].
...
Ortamınızı Azure Active Directory kimlik doğrulaması için yapılandırmak üzere bkz. [SQL Data Warehouse’da kimlik doğrulama][].
