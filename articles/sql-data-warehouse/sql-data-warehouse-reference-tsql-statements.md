...
* [ALTER MATERIALIZED görünümü](/sql/t-sql/statements/alter-materialized-view-transact-sql?view=azure-sqldw-latest) (Önizleme) 
...
* [MATERIALIZED görünümü AS SELECT oluşturma](/sql/t-sql/statements/create-materialized-view-as-select-transact-sql?view=azure-sqldw-latest) (Önizleme) 
