---
title: Azure portalında SQL Veri Ambarı Oluşturma | Microsoft Docs
...
* **Azure hesabı**: Hesap oluşturmak için [Azure Ücretsiz Deneme Sürümü][Azure Ücretsiz Deneme Sürümü] veya [MSDN Azure Kredileri][MSDN Azure Kredileri] sayfasını ziyaret edin.
* **Azure SQL sunucusu**: Daha ayrıntılı bilgi için bkz. [Azure portalı ile Azure SQL Veritabanı mantıksal sunucusu oluşturma][Azure portalı ile Azure SQL Veritabanı mantıksal sunucusu oluşturma].

> [!NOTE]
> SQL Veri Ambarı'nın oluşturulması ek hizmet ücretlerinin alınmasına neden olabilir.  Ayrıntılı bilgi için bkz. [SQL Data Warehouse fiyatlandırması][SQL Data Warehouse fiyatlandırması].
> 
> 
