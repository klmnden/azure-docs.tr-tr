...
## Sonraki adımlar
SQL Veri Ambarı hakkında biraz bilgi sahibi olduğunuza göre hızlıca [SQL Veri Ambarı oluşturma][SQL Veri Ambarı oluşturma] ve [örnek verileri yükleme][örnek verileri yükleme] hakkında bilgi edinin.
