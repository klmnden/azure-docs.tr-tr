---
title: SQL Data Warehouse için destek bileti oluşturma | Microsoft Docs
...
7. [Azure destek planınızı][Azure destek planınızı] seçin.
   ...
   * **Onarım** desteği [Geliştirici][Geliştirici], [Standart][Standart], [Professional Direct][Professional Direct] veya [Premier][Premier] destek aracılığıyla sağlanır. Onarım sorunları, müşterilerin Azure'ı kullandığı sırada karşılaştıkları ve ilgili sorunun Microsoft'tan kaynaklandığına ilişkin makul bir olasılığın bulunduğu sorunlardır.
...
## Diğer Kaynaklar
Ayrıca, [Stack Overflow][Stack Overflow] veya [Azure SQL Data Warehouse MSDN forumu][Azure SQL Data Warehouse MSDN forumu] üzerinden SQL Data Warehouse topluluğuna bağlanabilirsiniz.
