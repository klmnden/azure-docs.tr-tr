...
---
# <a name="sql-data-warehouse-data-integration-partners"></a>SQL veri ambarı veri tümleştirme ortakları
Uçtan uca veri ambarı çözüm oluşturmak için çok çeşitli endüstri lideri araçları seçin. Bu makalede, Azure SQL Data Warehouse destekleyen veri tümleştirme çözümleri Microsoft iş ortağı şirketlerden vurgular.

## <a name="our-data-integration-partners"></a>Veri tümleştirme ortaklarımızın
| Partner | Açıklama | Bağlantılar | Videolar |
| --- | --- | --- | --- |
| ![Alteryx][1] |**Alteryx**<br> Alteryx Tasarımcısı tekrarlanabilir bir iş akışı değil geleneksel yaklaşım tipik hafta saat içinde daha ayrıntılı Öngörüler müşteri adayları Self Servis veri analizi için sağlar! Veri hazırlama, veri karıştırma ve analizi – Tahmine dayalı, istatistiksel ve uzamsal – aynı sezgisel bir kullanıcı arabirimini kullanarak birleştirerek veri çözümleyiciler Alteryx Tasarımcısı güçlendirir. |[Market][alteryx_marketplace]<br>[Web sitesi][alteryx_designer_website]<br>[Teknik incelemesi][alteryx_whitepaper]<br>[Veri sayfası][alteryx_designer_datasheet]<br>[Twitter][alteryx_designer_twitter]<br>[YouTube][alteryx_designer_youtube] |[![Alteryx video](./media/sql-data-warehouse-partner-data-integration/alteryx_designer_video.jpg)](https://www.youtube.com/watch?v=CdqSDPyNDKc) |
| ![Attunity][2] |**Attunity**<br>Attunity CloudBeam SQL Data warehouse'a veri yükleme için otomatik ve en iyi duruma getirilmiş bir çözüm sağlar. "Tıklatın yük" tasarım ile basitleştirir ve hem toplu yükleme, hem de SQL Server, Oracle, DB2, Sybase ve mySQL dahil olmak üzere birçok heterojen veritabanlarındaki artımlı çoğaltma hızlandırır. |[Market][attunity_marketplace]<br>[Hızlı Başlangıç][attunity_quickstart]<br>[Web sitesi][attunity_cloudbeam_website]<br>[Veri sayfası][attunity_cloudbeam_datasheet]<br>[Twitter][attunity_cloudbeam_twitter]<br>[YouTube][attunity_cloudbeam_youtube] |[![Attunity video](./media/sql-data-warehouse-partner-data-integration/attunity_video.jpg)](https://www.youtube.com/watch?v=w14zuSjMlok) |
| ![Bryte sistemleri][3] |**Bryte sistemleri**<br>Bryte sistemleri çeşitli veritabanları ve kaynakları SQL Data Warehouse'a veri aktarımı otomatikleştirir. Bryte sistemleri veri hareketlerini ve tümleştirme teknolojileri uzmanlaşmış. Bunlar, ölçeklenebilir bulut tabanlı veri ambarlarında ve veri Göller Öngörüler ortaya çıkarmaya oluşturun. |[Market][bryte_systems_marketplace]<br>[Web sitesi][bryte_systems_azure_website] | |
| ![Informatica][4] |**Azure Kullandıkça Öde Informatica bulut Hizmetleri**<br> Azure hizmetlerinizi değeri iyileştirmek ve eyleme dönüştürülebilir Öngörüler, Azure – Kullandıkça Öde için Informatica bulut hizmetleriyle tüm karma veri kümeleri dışında türetilir. Informatica bulut veri tümleştirme, bulut analiz, uygulama tümleştirme ve veri yönetimi için en iyi sınıf bir çözüm sunar. Self Servis veri geçişi ile tümleştirme ve yönetim yetenekleri müşteriler hızlı ve güvenilir bir şekilde içeri aktarma, dışarı aktarabilir, eşitleme ve zamanlama petabaytlarca verileri Azure kaynakları SaaS uygulamaları, Hadoop tabanlı veri Göller gibi çeşitli ve diğer şirket içi veri kaynakları (Oracle, SAP).  Azure için Informatica bulut Hizmetleri yerel, yüksek birim, Azure SQL Data Warehouse, Sgl veritabanı, Blob Storage, Data Lake Store ve Azure Cosmos DB yüksek performanslı bağlantı sağlar. |[Market][informatica_Cloud_Services_marketplace]<br>[Ücretsiz deneme sürümü][informatica_cloud_free_trial]<br>[Yapılandırma Kılavuzu][informatica_cloud_services_config]<br>[Web sitesi][informatica_Cloud_Services_website]<br>[Veri sayfası][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
| ![Informatica][4] |**Informatica PowerCenter**<br>Informatica dünyanın en tanınabilir bağımsız sağlayıcıları veri tümleştirme yazılımın biridir. PowerCenter tüm veri tümleştirme girişimlerini temelini oluşturur. PowerCenter analytics, veri ambarı, uygulama geçiş, birleştirme veya veri yönetimi için kullanın. |[Market (standart)][informatica_PowerCenter_std_marketplace]<br>[Market (Gelişmiş)][informatica_PowerCenter_adv_marketplace]<br>[Web sitesi][informatica_PowerCenter_website]<br>[Veri sayfası][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
| ![Redgate][5] |**Redgate veri platformu Studio (Önizleme)**<br>Redgate'nın veri platformu Studio şirket içi SQL veritabanları Azure SQL veri ambarı'na geçirmek için basit ve güvenilir bir yol sağlar. Tam otomatik geçiş için akıllı kararlar almak için tasarlanmıştır ve bir kerelik geçişler için kullanımı ücretsizdir. |[Web sitesi][redgate_website]<br>[Twitter][redgate_twitter]<br>[YouTube][redgate_youtube] |[![Redgate video](./media/sql-data-warehouse-partner-data-integration/redgate_video.jpg)](https://www.youtube.com/watch?v=IR9HNvnU46s) |
| ![SnapLogic][6] |**SnapLogic**<br>Hizmet (iPaaS) olarak SnapLogic tümleştirme platformu müşterilerin içine ve dışına Microsoft Azure SQL veri ambarı hızlı veri aktarımı sağlar.  SnapLogic uygulamaları, hizmetleri ve bir çözümde IOT senaryolarını yüzlerce tümleştirme olanağı sunar. Hızlı ve etkili Öngörüler bulut, şirket içi veya karma modda SnapLogic ile teslim! |[Market][snaplogic_marketplace]<br>[Web sitesi][snaplogic_website]<br>[Veri sayfası][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] |[![Snaplogic video](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y) |

## <a name="next-steps"></a>Sonraki Adımlar
Diğer ortaklarımızın bazıları hakkında daha fazla bilgi için bkz: [iş zekası ortakları] [ bi_partners] ve [veri yönetimi ortakları][dm_partners].
