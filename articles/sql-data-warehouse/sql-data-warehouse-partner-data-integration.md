...
| ![Informatica][4] |**Azure Kullandıkça Öde Informatica bulut Hizmetleri**<br> Azure hizmetlerinizi değeri iyileştirmek ve eyleme dönüştürülebilir Öngörüler, Azure – Kullandıkça Öde için Informatica bulut hizmetleriyle tüm karma veri kümeleri dışında türetilir. Informatica bulut veri tümleştirme, bulut analiz, uygulama tümleştirme ve veri yönetimi için en iyi sınıf bir çözüm sunar. Self Servis veri geçişi ile tümleştirme ve yönetim yetenekleri müşteriler hızlı ve güvenilir bir şekilde içeri aktarma, dışarı aktarabilir, eşitleme ve zamanlama petabaytlarca verileri Azure kaynakları SaaS uygulamaları, Hadoop tabanlı veri Göller gibi çeşitli ve diğer şirket içi veri kaynakları (Oracle, SAP).  Azure için Informatica bulut Hizmetleri yerel, yüksek birim, Azure SQL Data Warehouse, Sgl veritabanı, Blob Storage, Data Lake Store ve DocumentDB için yüksek performanslı bağlantı sağlar. |[Market][informatica_Cloud_Services_marketplace]<br>[Ücretsiz deneme sürümü][informatica_cloud_free_trial]<br>[Yapılandırma Kılavuzu][informatica_cloud_services_config]<br>[Web sitesi][informatica_Cloud_Services_website]<br>[Veri sayfası][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
