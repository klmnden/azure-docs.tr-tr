## <a name="a-nameos-configaadd-ip-addresses-to-a-vm-operating-system"></a><a name="os-config"></a>Bir VM işletim sistemine IP adresleri ekleme
...
```
>[!NOTE]
>Yukarıda kullanmakta olduğunuz özel IP adresiyle ilişkili bir genel IP adresi yoksa İnternet’e ping gönderemezsiniz.
