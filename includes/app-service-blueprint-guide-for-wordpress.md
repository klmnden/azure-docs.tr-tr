## <a name="wordpress-and-azure-app-service"></a>WordPress ve Azure uygulama hizmeti
...
* [Web uygulamanızı yedekleme](../articles/app-service/web-sites-backup.md) ve [web uygulamanızı geri yükleme](../articles/app-service/web-sites-restore.md)
