...
Yerel olarak çalışan PowerShell sürümünü bulmak için 'Get-Module - ListAvailable AzureRM' cmdlet'ini kullanın. Yükseltmeniz gerekirse bkz. [Azure PowerShell modülünü yükleme](/powershell/azure/install-azurerm-ps). Daha fazla bilgi için bkz. [Azure PowerShell’i yükleme ve yapılandırma](/powershell/azure/overview).