...
3. **Yeni hesap** dikey penceresinde, Azure Cosmos DB hesabı için istenen yapılandırmayı belirtin. 
    ...
    **Yeni hesap** dikey penceresini tablodaki bilgilerden yararlanarak doldurun.
    ...
    API|MongoDB|Bu makalenin ilerleyen bölümlerinde [MongoDB API'si](../articles/documentdb/documentdb-protocol-mongodb.md) ile programlama yapacağız.|
...
6.  Dağıtım tamamlandığında Tüm Kaynaklar kutucuğundan yeni hesabı açın. 
    ...
    ![Tüm Kaynaklar kutucuğunda DocumentDB hesabı](./media/cosmos-db-create-dbaccount-mongodb/azure-documentdb-all-resources.png)
