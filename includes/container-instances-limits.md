...
| Kapsayıcı örneği günlük boyutu - çalışan örneği | 4 MB |
| Kapsayıcı örneği günlük boyutu - durdurulan bir örnek | 16 KB veya 1.000 satır |
...
<sup>1</sup>sınır artırma isteğinde bulunmak için oluşturun bir [Azure destek isteği][azure-support].<br />
