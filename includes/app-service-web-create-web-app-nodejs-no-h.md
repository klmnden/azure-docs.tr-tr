...
Aşağıdaki komutta çalışma kümesine `NODE|6.9`. Desteklenen tüm çalışma zamanları görmek için çalıştırın [az webapp listesi-çalışma zamanları](/cli/azure/webapp#list-runtimes). 
