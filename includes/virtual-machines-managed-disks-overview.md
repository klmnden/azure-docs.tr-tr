...
ms.locfileid: "39037756"
---
# <a name="azure-managed-disks-overview"></a>Azure yönetilen disklere genel bakış

Azure yönetilen diskler yöneterek Azure Iaas Vm'leri için disk yönetimini basitleştirir [depolama hesapları](../articles/storage/common/storage-introduction.md) VM diskleriyle ilişkili. Yalnızca türünü belirtmeniz gerekir ([standart HDD](../articles/virtual-machines/windows/standard-storage.md), standart SSD veya [Premium SSD](../articles/virtual-machines/windows/premium-storage.md)) ihtiyacınız disk boyutunu ve Azure oluşturur ve diski oluşturup yönetebilmesi.
...
**Depolama türü:** yönetilen diskler 3 performans katmanı sunar: [standart HDD](../articles/virtual-machines/windows/standard-storage.md), standart SSD (Önizleme) ve [Premium](../articles/virtual-machines/windows/premium-storage.md). Faturalama yönetilen disk depolama türü için disk üzerinde seçmiş olduğunuz bağlıdır.
...
| **Premium yönetilen <br>Disk türü** | **P4** | **P6** |**P10** | **P15** | **P20** | **P30** | **P40** | **P50** | 
|------------------|---------|---------|---------|---------|---------|----------------|----------------|----------------|  
...
| **Standart SSD yönetilen <br>Disk türü** | **E10** | **E15** | **E20** | **E30** | **E40** | **E50** |
|------------------|--------|--------|--------|----------------|----------------|----------------| 
| Disk Boyutu        | 128 GiB | 256 giB | 512 GiB | 1024 (1 TiB) giB | 2048 giB (2 tib'a kadar) | 4095 giB (4 tib'a kadar) | 
...
* [Genelleştirmek ve Azure CLI 2.0 kullanarak bir Linux sanal makinesini yakalama](../articles/virtual-machines/linux/capture-image.md)
