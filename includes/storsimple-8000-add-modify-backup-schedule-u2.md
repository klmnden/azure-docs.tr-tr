...
2. İlkelerini tablosal listesinde, seçin ve değiştirmek istediğiniz ilkeye tıklayın. Bağlam menüsünü açmak ve ardından sağ tıklama **Ekle zamanlama**.

    ![Zamanlamaları Yönet](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule1.png)

3. İçinde **Ekle zamanlama** dikey penceresinde değiştirmek anlık görüntü türü, yedekleme sıklığını, bekletme ve başlangıç tarihi ve saati. **Ekle**'yi tıklatın.
