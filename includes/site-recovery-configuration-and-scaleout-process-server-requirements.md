...
**Internet erişimi** | Sunucu bu URL'leri erişmesi (doğrudan veya proxy üzerinden) <br> - \*.accesscontrol.windows.net<br> - \*.backup.windowsazure.com <br>- \*.store.core.windows.net<br> - \*.blob.core.windows.net<br> - \*.hypervrecoverymanager.windowsazure.com <br> - https://cdn.mysql.com/archives/mysql-5.5/mysql-5.5.37-win32.msi (yapılandırma sunucusunu ayarlamayı ayarladığınız ise) <br> - time.nist.gov <br> - time.windows.com 
**Bağlantı Noktaları** | 443 (Denetim kanalı düzenleme)<br>9443 (Veri aktarımı) 
**(Yapılandırma/işlem sunucusu VMware VM olarak ayarladığınızda) VMWARE**
**NIC türü** | VMXNET3  
**VMware vSphere Powerclı VM üzerinden çalışan* | [Powerclı sürüm 6.0](https://my.vmware.com/web/vmware/details?productId=491&downloadGroup=PCLI600R1 "Powerclı 6.0")
