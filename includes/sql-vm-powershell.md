...
Çalıştırma [ **Add-AzureRmAccount** ](http://msdn.microsoft.com/library/mt619267.aspx) cmdlet'ini sunulabilir kimlik bilgilerinizi girmeniz için bir oturum ile ekranında. Azure portala giriş yapmak için kullandığınız kimlik bilgilerinin aynısını kullanın.
