...
| source | Kaynak bağlantı noktaları | Hedef | Hedef hizmet etiketi | Hedef bağlantı noktaları | Protocol | Eylem |
| --- | --- | --- | --- | --- | --- | --- |
| Tüm | * | [Hizmet etiketi](../articles/virtual-network/security-overview.md#service-tags) | `Storage` (aynı bölgede Batch hesabı ve sanal ağ olarak) | 443 | TCP | İzin Ver |
