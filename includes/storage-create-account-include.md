...
Azure'da şu anda bir depolama hesabı oluşturmamayı tercih ederseniz ve yerel bir ortamda kodunuzu test çalıştırmak için Azure storage öykünücüsü de kullanabilirsiniz. Daha fazla bilgi için bkz. [Geliştirme ve Sınama için Azure Storage Öykünücüsünü Kullanma](../articles/storage/common/storage-use-emulator.md).
