...
| Boyutlandır | vCPU | Bellek: GiB | Geçici depolama (SSD) GiB | GPU | GPU bellek: GiB | Maksimum veri diskleri | En fazla NIC |
| --- | --- | --- | --- | --- | --- | --- | ---- |
...
| Boyutlandır              | vCPU | GPU              | Bellek  | NIC'ler (Maks.) | En çok, Disk boyutu           | En çok, Veri diskleri (her biri 1.023 GB) | En fazla ağ bant genişliği | 
|-------------------|------|------------------|---------|------------|--------------------------|--------------------------------|-----------------------|
...
<sup>1</sup> NVv3 serisi sanal makineler Intel® Hyper-Threading teknolojisine özelliği
