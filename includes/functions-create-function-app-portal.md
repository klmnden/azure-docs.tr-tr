...
2. Görüntünün aşağıdaki tabloda belirtildiği gibi işlev uygulama ayarları kullanın.
    ...
    | **OS** | Windows | Sunucusuz barındırma şu anda yalnızca Windows üzerinde çalışan olduğunda kullanılabilir. Linux barındırmak için bkz: [Azure CLI kullanarak Linux üzerinde çalışan ilk işlevinizi oluşturma](../articles/azure-functions/functions-create-first-azure-function-azure-cli-linux.md). |
