...
1. "Yerine dev.s." URL ön eki "scott.s" ile değiştirin. web tarayıcınızda. Bu URL güncelleştirilen bildirim hala çözümler. Bu URL için benzersiz _dev/scott_ alanı. Özel URL Hizmetleri'nde ilk yol "tan" URL'ye istekleri dener gösterir _dev/scott_ , başarısız olursa, ancak alanı, bunlar geri döner hizmetlere _geliştirme_ alanı.
