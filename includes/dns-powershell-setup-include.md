...
PowerShell konsolunuzu açın ve hesabınıza bağlanın. Daha fazla bilgi için [oturum](/azure/install-az-ps.md?view=azps-1.2.0#sign-in)(/ powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).
