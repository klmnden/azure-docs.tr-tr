...
ms.locfileid: "66148431"
---
> [!IMPORTANT]
> Azure Güvenlik Duvarı şu anda yönetilen genel önizleme aşamasındadır. `Register-AzProviderFeature` PowerShell komutunu kullanarak bu uygulamayı açıkça etkinleştirmiş olursunuz.
>
