...
If you are using Mobile Services please refer to the [Get Started with Push]() tutorials. If you want to use Java or PHP refer to [How to use Notification Hubs from Java/PHP](/tr-tr/documentation/articles/notification-hubs-java-backend-how-to/). You can send notifications from any backend using the [Notification Hubs REST interface].
...
<!-- URLs. -->
[get-started]: /tr-tr/documentation/articles/notification-hubs-windows-store-dotnet-get-started/
