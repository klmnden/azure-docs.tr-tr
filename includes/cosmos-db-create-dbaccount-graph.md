...
5. Dağıtım sürecini izlemek için üst araç çubuğunda **Bildirimler** simgesine ![Bildirimler simgesi](./media/cosmos-db-create-dbaccount-graph/notification-icon.png) tıklatın.
