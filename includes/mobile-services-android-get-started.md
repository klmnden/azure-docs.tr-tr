...
4. Uygulama görüntülendiğinde, *Öğreticiyi tamamla* gibi anlamlı bir metin yazın ve ardından **Ekle** seçeneğine tıklayın.
   ...
   > [!NOTE]
   > Sorgulamak ve ToDoActivity.java dosyasında bulunan verileri eklemek için, mobil hizmetinize erişen kodu gözden geçirebilirsiniz.
   > 
   > 
5. **Klasik Azure Portalı**’na geri dönün, **Veri** sekmesine ve sonra TodoItems tablosuna tıklayın.
