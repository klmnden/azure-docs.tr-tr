...
2. **Yeni**’ye tıklayın, **SQL Veritabanı** yazın ve **SQL Veritabanı (yeni mantıksal sunucu)** seçeneğine tıklayın.
   
      ![Yeni mantıksal sunucu](./media/sql-database-create-new-server-portal/sql-database-create-new-server-portal-1.png)
3. **SQL Veritabanı (yeni mantıksal sunucu)** öğesine tıklayın.
