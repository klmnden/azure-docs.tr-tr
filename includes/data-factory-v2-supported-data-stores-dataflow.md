...
ms.locfileid: "67509935"
---
| Category | Veri deposu | Desteklenen bir [kopyalama etkinliği](../articles/data-factory/copy-activity-overview.md) kaynak | Desteklenen bir [kopyalama etkinliği](../articles/data-factory/copy-activity-overview.md) havuz | [Azure IR](../articles/data-factory/concepts-integration-runtime.md#azure-integration-runtime) tarafından desteklenen | [Şirket içinde barındırılan IR](../articles/data-factory/concepts-integration-runtime.md#self-hosted-integration-runtime) tarafından desteklenen | Tarafından desteklenen [veri akışı](../articles/data-factory/concepts-data-flow-overview.md)
|:--- |:--- |:--- |:--- |:--- |:--- |
