...
ms.locfileid: "37100853"
---
Azure Active Directory hizmetine yönelik kullanım kısıtlamaları ve diğer hizmet sınırlamaları aşağıda verilmiştir.

| Kategori | Sınırlar |
| --- | --- |
| Dizinler |Tek bir kullanıcı en fazla 500 Azure Active Directory dizin ile ilişkili olabilir.<br />Olası birleşimlerin örnekleri: <ul> <li>Tek bir kullanıcı 500 dizinler oluşturur.</li><li>Tek bir kullanıcı için 500 dizinleri bir üye olarak eklenir.</li><li>Tek bir kullanıcı 250 dizinler oluşturur ve daha sonra başkaları tarafından 250 farklı dizinlere eklenir.</li></ul> |
