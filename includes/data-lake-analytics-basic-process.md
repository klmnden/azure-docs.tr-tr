**Temel Data Lake Analytics süreci:**
    
![Azure Data Lake Analytics süreç akışı diyagramı](./media/data-lake-analytics-basic-process-include/data-lake-analytics-process.png)
