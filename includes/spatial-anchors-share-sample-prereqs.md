...
* Bir veya daha fazla cihazları (iOS veya Android) dağıtın ve uygulamayı çalıştırın.
  * Android kullanıyorsanız, sahip olmanız gerekir:
    * <a href="https://developer.android.com/studio/" target="_blank">Android Studio 3.3</a> ya da sonraki <a href="https://unity3d.com/get-unity/download" target="_blank">Unity 2018.3</a> veya sonraki bir sürümü ve <a href="https://git-scm.com/download/win" target="_blank">Git için Windows</a> Windows bilgisayarınızda yüklü.
    * A <a href="https://developer.android.com/studio/debug/dev-options" target="_blank">Geliştirici özellikli</a> ve <a href="https://developers.google.com/ar/discover/supported-devices" target="_blank">ARCore özellikli</a> Android cihaz.
  * İOS kullanıyorsanız, sahip olmanız gerekir:
