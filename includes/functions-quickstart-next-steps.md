...
* [Azure İşlevleri için En İyi Uygulamalar](../articles/azure-functions/functions-best-practices.md)
...
* [Azure İşlevlerini test etme](../articles/azure-functions/functions-test-a-function.md)  
  İşlevlerinizi test etmek için çeşitli araçları ve teknikleri açıklar.
* [Azure İşlevlerini ölçeklendirme](../articles/azure-functions/functions-scale.md)  
