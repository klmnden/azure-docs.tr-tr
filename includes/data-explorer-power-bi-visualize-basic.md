...
1. Ana Power BI penceresinin sol tarafında rapor görünümünü seçin.
    ...
    ![Rapor görünümü](media/data-explorer-power-bi-visualize-basic/report-view.png)

1. **GÖRSELLEŞTİRMELER** bölmesinde yığılmış sütun grafiği seçin.

    ![Sütun grafiği ekleme](media/data-explorer-power-bi-visualize-basic/add-column-chart.png)
