...
| Konu başına abonelik sayısı |Varlık |Konu için ek bir abonelik oluşturmak için sonraki istekler reddedilir. Sonuç olarak, portal üzerinden yapılandırdıysanız, bir hata iletisi gösterilir. Yönetim API'SİNDEN çağrılırsa bir özel durum çağıran kod tarafından alınır. |2,000 |
