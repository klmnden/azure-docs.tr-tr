...
> [!IMPORTANT]
> VPN ağ geçidini silmeyin. Böyle bir durumda, bağlantıyı yeniden oluşturma adımlarını tekrar etmeniz ve şirket içi yönlendiricinizi, yeni oluşturulan ağ geçidine atanan IP adresi ile yeniden yapılandırmanız gerekir.
> 
> 
