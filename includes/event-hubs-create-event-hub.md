...
5. Ad alanını oluşturmak için **Oluştur**’a tıklayın.
...
9. Olay Hub'ı için bir ad yazın, ardından **Oluştur**’a tıklayın.
   
    ![](./media/event-hubs-create-event-hub/create-event-hub5.png)
10. Event Hubs listesinde yeni oluşturulan Olay Hub’ı adına tıklayın. 
    
     ![](./media/event-hubs-create-event-hub/create-event-hub6.png)
11. Ad alanı dikey penceresine (ilgili Olay Hub’ı dikey penceresine değil) geri dönerek **Paylaşılan erişim ilkeleri** ve ardından **RootManageSharedAccessKey** öğesine tıklayın.
    
     ![](./media/event-hubs-create-event-hub/create-event-hub7.png)
12. **RootManageSharedAccessKey** bağlantı dizesini panoya kopyalamak için kopyala düğmesine tıklayın. Daha sonra öğreticide kullanmak üzere bu bağlantı dizesini kaydedin.
