...
ms.locfileid: "66238671"
---
| Resource | Varsayılan limit | Üst sınır |
| --- | --- | --- |
| Güvenilen adresler veya aralıklar sayısı</a> abonelik başına |0 |50 |
| Gün sayısı cihazlarımı anımsa |14 |60 |
| En fazla uygulama sayısı. |0 |Sınırsız |
| MFA çağrısı sırasında **X** denemeye izin ver |1 |99 |
| İki yönlü metin iletisi zaman aşımı saniye sayısı |60 |600 |
