...
|Boyut – Boyut\Ad | vCPU |Bellek|NIC'ler (Maks.)|En fazla geçici disk boyutu |En çok, Veri diskleri (her biri 1.023 GB)|En çok, IOPS (disk başına 300)|
|---|---|---|---|---|---|---|
...
| Boyutlandır | vCPU | Bellek: GiB | Geçici depolama (HDD): GiB | Maksimum veri diskleri | Maksimum veri diski aktarım hızı: IOPS | Maks NIC / beklenen ağ bant genişliği (MB/sn)  |
| --- | --- | --- | --- | --- | --- | --- |
...
| Boyutlandır | vCPU | Bellek: GiB | Geçici depolama (HDD): GiB | Maksimum veri diskleri | Maksimum veri diski aktarım hızı: IOPS | En fazla NIC|
| --- | --- | --- | --- | --- | --- | --- |
