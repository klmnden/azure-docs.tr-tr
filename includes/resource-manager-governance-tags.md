...
Etiketleri uyguladıktan sonra aboneliğinizde bu etiket adını ve değerini taşıyan tüm kaynakları alabilirsiniz. Etiketler ilgili kaynakları farklı kaynak gruplarından almanıza olanak sağlar. Bu yaklaşım, faturalama veya yönetim için kaynakları düzenlemeniz gerektiğinde yararlıdır.
...
* Bulut Hizmetleri gibi Klasik kaynakları etiketleri uygulanamaz.
