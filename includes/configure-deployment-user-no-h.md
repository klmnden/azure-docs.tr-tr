...
Şu örnekte, *\<username>* ve *\<password>* kısımlarını (köşeli ayraçlar dahil) yeni bir kullanıcı adı ve parola ile değiştirin. Kullanıcı adı benzersiz olmalıdır. Parola, en az sekiz karakter uzunluğunda olma ve şu üç öğeyi de içermelidir: harf, rakam, sembol. 
