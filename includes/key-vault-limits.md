...
Bkz: [Azure anahtar kasası Kılavuzu azaltma](../articles/key-vault/key-vault-ovw-throttling.md) bu sınırları aşıldığında azaltma nasıl ele alınacağını hakkında bilgi için.
